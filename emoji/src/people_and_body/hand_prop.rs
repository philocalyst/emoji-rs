...
pub const WRITING_HAND: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["hand", "hand wat skryf", "pen", "skryf", "skryfhand", "skrywende hand"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "az",
			tts:      Some("yazı əli"),
			keywords: &["orqan", "qələm", "qələmlə yazmaq", "yazan əl", "yazmaq", "yazı əli", "əl"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["psací", "psaní", "psát", "písmo", "píšící ruka", "ruka", "tělo"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			...
			keywords: &["લખતો", "લખવ\u{ac1}\u{a82}", "લખાણ", "લખી રહ\u{ac7}લો હાથ", "શરીર", "હાથ"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		crate::Annotation {
			...
			keywords: &["लिखता ह\u{941}आ हाथ", "लिखना", "लिखन\u{947} वाला हाथ", "शरीर", "हाथ"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			...
			keywords: &["disegnare", "mano che scrive", "penna", "scrivere", "scrivere a mano"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			...
			keywords: &["რომელიც წერს", "სხეული", "ტანი", "წერა", "ხელი", "ხელი, რომელიც წერს"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
		...
		crate::Annotation {
			...
			keywords: &["ल\u{947}खिरह\u{947}को हात", "ल\u{947}ख\u{94d}न\u{947}", "शरीर", "हात"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			...
			keywords: &["ਲਿਖਣ ਵਾਲਾ ਹ\u{a71}ਥ", "ਲਿਖਣਾ", "ਲਿਖਣਾ, ਲਿਖਾਈ", "ਲਿਖਾਈ", "ਲਿਖਾਵਟ", "ਹ\u{a71}ਥ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			...
			keywords: &["dłoń", "długopis", "pisać", "pisać odręcznie", "pisząca dłoń", "piszę", "ręka"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			...
			keywords: &["mână", "mână care scrie", "mână scriind", "scriere", "scris"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-128"), keywords: &["E10-128"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		#[cfg(feature = "sat")]
		crate::Annotation { lang: "sat", tts: Some("ᱚᱞ ᱛᱤ"), keywords: &["ᱚᱞ ᱛᱤ"] },
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("لکندڙ هٿ"),
		...
		crate::Annotation {
			...
			keywords: &["ม\u{e37}อ", "อว\u{e31}ยวะ", "เข\u{e35}ยน", "เข\u{e35}ยนหน\u{e31}งส\u{e37}อ"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
...
pub const NAIL_POLISH: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "as",
			tts:      Some("নেইল প’লিচ"),
			keywords: &["কছমেটিক\u{9cd}স", "নখ", "নেইল প’লিচ", "প’লিচ", "মেনিকিয\u{9bc}ৰ", "যত\u{9cd}ন"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["Лак за нокти", "козметика", "лак", "лак за нокти", "маникюр", "нокти"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["kozmetika", "lak za nokte", "lakiranje noktiju", "nokti", "uljepšavanje"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("neglelak"),
			keywords: &["hånd", "kosmetik", "manicure", "negle", "neglelak"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["cosmética", "esmalte", "manicura", "pintarse las uñas", "uñas"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			lang:     "et",
			tts:      Some("küünelakk"),
			keywords: &["hooldus", "keha", "kosmeetika", "küünelakk", "küüs", "lakk", "maniküür"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("لاک زدن"),
			keywords: &["آرایش", "بدن", "توجه", "رسیدگی", "زیبایی", "لاک", "لاک زدن", "مانیکور", "ناخن"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("nail polish"),
			keywords: &["cosmetics", "daliri", "kamay", "kuko", "manicure", "nail polish", "polish"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			lang:     "fr_CA",
			tts:      Some("↑↑↑"),
			keywords: &["manucure", "maquillage", "ongle", "vernis", "vernis à ongles"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("vearnais ingne"),
			keywords: &["cosmaidí", "dubh dóite", "lámh-mhaisiú", "smideadh", "vearnais ingne"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"सौन\u{94d}दर\u{94d}य प\u{94d}रसाधन",
			],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["კოსმეტიკა", "მანიკური", "მოვლა", "სხეული", "ტანი", "ფრჩხილების ლაქი"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
			tts:      Some("iɣmi n waccaren"),
			keywords: &["iɣmi n waccaren"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("маникюр"),
			keywords: &["бояу", "косметика", "күтім", "маникюр", "сұлулық салоны", "тырнақ"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ನ\u{cc8}ಲ\u{ccd} ಪಾಲ\u{cc0}ಷ\u{ccd}"),
			keywords: &[
				"ಉಗುರ\u{cbf}ನ ಆರ\u{cc8}ಕ\u{cc6}",
				"ಉಗುರು ಪಾಲ\u{cbf}ಷ\u{ccd}",
				"ಉಗುರು ಬಣ\u{ccd}ಣ",
				"ನಾನು ಮಾಡ\u{cbf}ದ\u{ccd}ದ\u{cc7}ನ\u{cc6}",
				"ನ\u{cc8}ಲ\u{ccd} ಪಾಲ\u{cc0}ಷ\u{ccd}",
				"ಬ\u{cc7}ಸರ",
				"ಮ\u{cc7}ಕಪ\u{ccd}",
				"ಮ\u{ccd}ಯಾನ\u{cbf}ಕ\u{ccd}ಯುರ\u{ccd}",
				"ಯಾವುದಾದರ\u{cc2}",
				"ಸ\u{ccc}ಂದರ\u{ccd}ಯವರ\u{ccd}ಧಕಗಳು",
				"ಹಸ\u{ccd}ತಪ\u{ccd}ರಸಾಧನ",
				"ಹಸ\u{ccd}ತಾಲಂಕಾರ",
		...
		crate::Annotation {
			...
			keywords: &[
				"जतन",
				"न\u{947}ल पॉलिश",
				"म\u{945}निक\u{94d}य\u{941}अर",
				"सौ\u{902}दर\u{94d}यप\u{94d}रसाधन",
			],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			...
			keywords: &["косметика", "маникюр", "тырмак", "тырмак боёо", "өзүнө кам көрүү"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		crate::Annotation {
			...
			keywords: &["ທາເລ\u{eb1}ບ", "ທາເລ\u{eb1}ບມ\u{eb7}", "ເລ\u{eb1}ບມ\u{eb7}"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
			tts:      Some("nagų lakas"),
			keywords: &["kosmetika", "lakas", "manikiūras", "nagai", "nagų lakas", "priežiūra"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["maikūkū", "pani", "tiaki", "whakapai maikūkū", "whakapaipai"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &[
				"नख",
				"नखा\u{902}ची निगा राखण\u{947}",
				"नख\u{947}",
				"निगा",
				"निगा राखण\u{947}",
				"न\u{947}ल पॉलिश",
				"न\u{947}ल पॉलीश",
				"न\u{947}लप\u{947}\u{902}ट",
				"पॉलीश",
				"सौ\u{902}दर\u{94d}य प\u{94d}रसाधन\u{947}",
				"हाता\u{902}ची निगा राखण\u{947}",
			],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			...
			keywords: &["bosan", "kosmetik", "kuku", "pengilat", "penjagaan", "rias tangan"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
			tts:      Some("nail polish"),
			keywords: &["dwiefer", "kosmetiċi", "kura", "manicure", "nail polish", "polish"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			lang:     "pa_Arab",
			tts:      Some("نوں پالش"),
			keywords: &["احتیاط", "سنگھار دا سامان", "نوں پالش", "ن\u{64f}و", "پالش", "ہتھاں دی صفائی"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			lang:     "ps",
			tts:      Some("نوکانو رنګ"),
			keywords: &["رنګ", "مانیکیور", "نوک", "نوکانو رنګ", "پاملرنه", "کاسمټکیس"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("esmalte de unha"),
			keywords: &["cosméticos", "esmalte", "esmalte de unha", "manicure", "mão", "unhas"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("verniz para as unhas"),
			keywords: &["cosméticos", "manicura", "unha", "verniz", "verniz para as unhas"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("esmalte sillukunapaq"),
			keywords: &["cosmeticos", "esmalte", "esmalte sillukunapaq", "manicura", "qhaway", "sillu"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-578"), keywords: &["E10-578"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("маникюр"),
		...
		#[cfg(feature = "sat")]
		crate::Annotation {
			lang: "sat", tts: Some("ᱨᱟᱢᱟ ᱡᱚᱛᱚᱱ"), keywords: &["ᱨᱟᱢᱟ ᱡᱚᱛᱚᱱ"]
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("ننهن پالش"),
			keywords: &["رنگڻ", "سنڀال", "سينگار", "ننهن", "ننهن مکڻي", "ننهن پالش", "ننهن ڪتڻ"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["kozmetika", "lak", "lak za nohte", "manikira", "nega", "noht", "telo"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "sq",
			tts:      Some("manikyr"),
			keywords: &["i mërzitur", "kozmetikë", "kujdes", "lyej", "makijazh", "manikyr", "thua"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("лак за нокте"),
			keywords: &["козметика", "лак", "маникир", "нега", "нокат", "свеједно", "смор"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("↑↑↑"),
			keywords: &["козметика", "лак за нокте", "маникир", "нокат", "њега"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("lak za nokte"),
			keywords: &["kozmetika", "lak", "manikir", "nega", "nokat", "smor", "svejedno"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("↑↑↑"),
			keywords: &["kozmetika", "lak za nokte", "manikir", "njega", "nokat"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &[
				"క\u{c3e}స\u{c4d}మ\u{c46}ట\u{c3f}క\u{c4d}స\u{c4d}",
				"క\u{c47}ర\u{c4d}",
				"గ\u{c4b}ర\u{c4d}ల రంగు",
				"గ\u{c4b}ళ\u{c4d}లు",
				"న\u{c48}ల\u{c4d}",
				"ప\u{c4b}ల\u{c3f}ష\u{c4d}",
				"బ\u{c4b}ర\u{c4d}డ\u{c4d}",
				"మ\u{c47}కప\u{c4d}",
				"మ\u{c4d}య\u{c3e}న\u{c3f}క\u{c4d}యూర\u{c4d}",
				"రంగు",
				"స\u{c4c}ందర\u{c4d}యం",
			],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			...
			keywords: &["косметика", "лок", "лок барои нохунҳо", "маникюр", "нохун", "ғамхорӣ"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ጽፍሪ ምጽራይ"),
			keywords: &["መመላኽዒ", "መመላኽዒታት", "ማንኪዩር", "ተገይሩ", "ኣሰልቺዩዎ", "ክንክን", "ዝኾነ ይኹን", "ጽፍሪ", "ፖሊሽ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("dyrnak lagy"),
			keywords: &["dyrnak", "dyrnak lagy", "ideg", "kosmetika", "lak", "manikýur"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
			tts:      Some("valivali ngeʻesinima"),
			keywords: &["ngeʻesinima", "valivali"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("oje sürme"),
			keywords: &["kozmetik", "manikür", "oje", "oje sürme", "tırnak", "tırnak bakımı"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
			tts:      Some("تىرناق بوياش"),
			keywords: &["ئاسراش", "تىرناق", "تىرناق ئېلىش", "تىرناق بوياش", "خېنە", "گىرىم"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		crate::Annotation {
			...
			keywords: &["chăm sóc", "làm móng tay", "móng tay", "mỹ phẩm", "sơn móng tay", "đánh bóng"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			...
			keywords: &["Ikun Eekanna", "aṣaralóge", "kíkùn", "àkun ojú", "èékánná", "ìtọ\u{301}jú"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Ikun Eekanna"),
			keywords: &["Ikun Eekanna", "asharalóge", "kíkùn", "àkun ojú", "èékánná", "ìtɔ\u{301}jú"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("涂指甲油"),
			keywords: &["修指甲", "忙完了", "护手", "指甲油", "涂指甲油", "美甲", "闷", "随便啦"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("指甲油"),
			keywords: &["修指甲", "指甲油", "沒事了", "無聊", "美甲"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
...
pub const SELFIE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("صورة سيلفي"),
			keywords: &["سيلفي", "صورة ذاتية", "صورة ذاتيىة", "صورة سيلفي", "كاميرا", "موبايل", "هاتف"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		#[cfg(feature = "ast")]
		crate::Annotation { lang: "ast", tts: Some("selfie"), keywords: &["selfie"] },
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
			tts:      Some("özçəkim"),
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("emboltred"), keywords: &["emboltred"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("selfi"),
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("selfie"),
			keywords: &["arm", "foto", "kamera", "mobiltelefon", "selfie", "tager selfies", "telefon"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			lang:     "el",
			tts:      Some("selfie"),
			keywords: &["selfie", "κάμερα", "σέλφι", "τηλέφωνο", "φωτογραφική μηχανή"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["hoton kanka", "hoton ɗauki da kanka", "kyamara", "salfi", "waya", "wayar hannu"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["טלפון", "יד מצלמת סלפי", "מצלמה", "סלפי", "צילום", "שיחת וידאו"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			tts:      Some("स\u{947}ल\u{94d}फ\u{93c}ी"),
			keywords: &["क\u{948}मरा", "फ\u{93c}ोन", "स\u{947}ल\u{94d}फ\u{93c}ी", "स\u{947}ल\u{94d}फी"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("selfie"),
			keywords: &["cari signal", "foto selfie", "kamera", "ponsel", "selfi", "selfie"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("asilfi"), keywords: &["asilfi"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("селфи"),
		...
		crate::Annotation {
			lang:     "km",
			tts:      Some("selfie"),
			keywords: &["selfie", "កាមេរ\u{17c9}ា", "ថត", "ទ\u{17bc}រស\u{17d0}ព\u{17d2}ទ"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			lang:     "lo",
			tts:      Some("ເຊວຟ\u{eb5}"),
			keywords: &["ກ\u{ec9}ອງຖ\u{ec8}າຍຮ\u{eb9}ບ", "ເຊວຟ\u{eb5}", "ໂທລະສ\u{eb1}ບ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		#[cfg(feature = "mn")]
		crate::Annotation { lang: "mn", tts: Some("селфи"), keywords: &["селфи"] },
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			tts:      Some("स\u{947}ल\u{94d}फी"),
		...
		crate::Annotation {
			...
			keywords: &["ကင\u{103a}မရာ", "ဆယ\u{103a}ဖ\u{102e}", "ဖ\u{102f}န\u{103a}း"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			lang:     "or",
			tts:      Some("ସେଲଫ\u{b3f}"),
			keywords: &["କ\u{b4d}ୟ\u{b3e}ମେର\u{b3e}", "ଫୋନ\u{b4d}\u{200c}", "ସେଲଫ\u{b3f}"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("selfie"),
			keywords: &["camera", "celular", "câmera", "foto", "selfie", "smartphone"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		crate::Annotation {
			lang:     "ro",
			tts:      Some("selfie"),
			keywords: &["aparat de fotografiat", "camera", "mobil", "selfie", "telefon"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1045"), keywords: &["E10-1045"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("селфи"),
		...
		#[cfg(feature = "sat")]
		crate::Annotation {
			lang: "sat", tts: Some("ᱥᱮᱞᱯᱷᱤ"), keywords: &["ᱥᱮᱞᱯᱷᱤ"]
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["foto vetjake", "kamerë", "selfi", "sellfi", "telefon", "vetjake"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["селфи"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("selfi"),
		...
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["selfi"] },
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
			tts:      Some("selfie"),
			keywords: &["arm som tar en selfie med telefon", "kamera", "selfie", "telefon"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
		...
		crate::Annotation {
			...
			keywords: &["క\u{c46}మ\u{c46}ర\u{c3e}", "ఫ\u{c4b}న\u{c4d}", "స\u{c46}ల\u{c4d}ఫ\u{c40}"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang:     "tg",
		...
		crate::Annotation {
			lang:     "tr",
			tts:      Some("selfie"),
			keywords: &["kamera", "kendi çekim", "selfie", "telefon", "öz çekim", "özçekim"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("سیلفی"),
			keywords: &["اشارہ", "تصویر", "خود کی تصطیر لینا", "سیلفی", "فون", "کیمرا", "کیمرہ"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			...
			keywords: &["Yiya Ara ẹni", "fóònù", "fọ\u{301}tò àdáyà", "kámẹ\u{301}rà"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Yiya Ara ɛni"),
			keywords: &["Yiya Ara ɛni", "fóònù", "fɔ\u{301}tò àdáyà", "kámɛ\u{301}rà"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
