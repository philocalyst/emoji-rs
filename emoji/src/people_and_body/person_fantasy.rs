...
pub const BABY_ANGEL: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("babig ael"), keywords: &["ael", "babig"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("anđelak"),
		...
		crate::Annotation {
			lang:     "lb",
			tts:      Some("Engelchen"),
			keywords: &["Bëbee", "Engel", "Engelchen", "Fantasie", "Gesiicht", "Mäerchen", "Puppelchen"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["canug", "khiyaali", "malaa’ig", "malaa’igta caruurta", "sheeko cirfiid", "waji"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			...
			keywords: &["bé con", "mặt", "thiên thần", "thiên thần nhỏ", "truyện cổ tích", "tưởng tượng"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
...
pub const SANTA_CLAUS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("Kersvader"),
			keywords: &["Kersfees", "Kersvader", "sprokie", "vader", "viering"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("بابا نويل"),
			keywords: &["بابا نويل", "حدوتة", "خرافة", "سانتا", "سانتا كلوز", "عيد", "عيد الميلاد", "قصة"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["Nedeleg", "fest", "gouel", "lid", "tad"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("julemand"),
			keywords: &["eventyr", "fantasi", "jul", "julemand", "nisse", "nissehue"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			lang:     "de_CH",
			tts:      Some("↑↑↑"),
			keywords: &["Samichlaus", "Weihnachten", "Weihnachtsmann"],
		},
		#[cfg(feature = "el")]
		crate::Annotation {
			lang:     "el",
		...
		crate::Annotation {
			lang:     "en_AU",
			tts:      Some("Santa"),
			keywords: &["Christmas", "Father Christmas", "Santa", "Santa Claus", "celebration"],
		},
		#[cfg(feature = "en_CA")]
		crate::Annotation {
			lang:     "en_CA",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("Santa Claus"),
			keywords: &["Claus", "Navidad", "Noel", "Papá Noel", "celebración", "fiesta", "santa"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("↑↑↑"),
			keywords: &["Navidad", "claus", "noel", "papá", "santa"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
			tts:      Some("jõuluvana"),
			keywords: &["fantaasia", "isa", "jõulud", "jõuluvana", "pühad", "tähistamine"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("aita noel"),
			keywords: &["Bizarzuri", "aita noel", "fantasia", "gabonak", "ospakizuna"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("بابا نوئل"),
			keywords: &["بابا نوئل", "جشن", "جن و پری", "سانتا", "فانتزی", "پدر", "کریسمس"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("père Noël"),
			keywords: &["Noël", "Santa Claus", "bonnet", "fêtes", "magie", "noël", "père", "tradition"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["Nollaig", "athair", "bodach na Nollaig", "comharrachadh"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("סנטה קלאוס"),
			keywords: &["חג המולד", "כריסמס", "מתנות", "סנטה", "סנטה קלאוס"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["Djed Božićnjak", "bajka", "božić", "djed mraz", "mašta", "slavlje"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("mikulás"),
			keywords: &["arc", "fej", "karácsony", "mikulás", "télapó", "ünnep", "ünneplés"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
			tts:      Some("Սանտա Կլաուս"),
			keywords: &["Սանտա Կլաուս", "Սուրբ ծնունդ", "հայր", "հեքիաթ", "սանտա", "տոն", "ֆանտազիա"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["Ekeresìmesì", "Emume", "Nna Ekeresìmesi", "claus", "nna", "santa"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			...
			keywords: &["Babbo Natale", "Natale", "Santa Claus", "cappello", "fest", "festa", "uomo"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			lang:     "kk",
			tts:      Some("санта клаус"),
			keywords: &["Аяз ата", "Рождество", "аяз ата", "жаңа жыл", "клаус", "санта", "тойлау", "әке"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("산타클로스"),
			keywords: &["산타", "산타 할아버지", "산타클로스", "아버지", "크리스마스", "클로스"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["Ziemassvētku vecītis", "salavecis", "santaklauss", "vecītis", "ziemassvētki"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			lang:     "mn",
			tts:      Some("Санта Клаус"),
			keywords: &["Зул сарын баяр", "аав", "баяр тэмдэглэх", "клаус", "санта"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			tts:      Some("सा\u{902}ता क\u{94d}लॉज"),
			keywords: &["उत\u{94d}सव", "क\u{94d}लॉज", "ख\u{94d}रिसमस", "नाताळ", "फादर", "सा\u{902}ता"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["Milied", "klaws", "missier", "santa", "ċelebarazzjoni"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("kerstman"),
			keywords: &["Kerstmis", "fantasie", "feestdag", "kerst", "kerstman", "viering", "vrolijk"],
		},
		#[cfg(feature = "nn")]
		...
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Sántá Klọz"),
			keywords: &["Fáda", "Klọz", "Krísmas", "Papá", "Sánta", "Sántá Klọz", "Sẹlibréshọn"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("Papai Noel"),
			keywords: &["comemoração", "festas", "natal", "noel", "papai"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("pai natal"),
			keywords: &["celebração", "comemoração", "conto de fadas", "fantasia", "natal", "pai"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("Papa Noel"),
			keywords: &["Navidad", "noel", "papa", "raymi", "tata"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-330"), keywords: &["E10-330"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("Санта-Клаус"),
		...
		crate::Annotation {
			...
			keywords: &["Noheli", "data", "ibirori", "papa"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			lang:     "sl",
			tts:      Some("Božiček"),
			keywords: &["Božiček", "božič", "božiček", "fantazija", "oče", "pravljica", "slavje"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "sr",
			tts:      Some("Деда Мраз"),
			keywords: &["бoжић", "баjкa", "празник", "прослава"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("Дјед Мраз"),
			keywords: &["Дјед Мраз", "бajкa", "бoжић", "бoжић бата", "дјед мрaз", "прослава"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("Deda Mraz"),
			keywords: &["bajka", "božić", "praznik", "proslava"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("Djed Mraz"),
			keywords: &["Djed Mraz", "bajka", "božić", "božić bata", "djed mraz", "proslava"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &["baba", "kichimbakazi", "krismasi", "njozi", "santa", "sherehe"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &["бобои барфӣ", "клаус", "мавлуди Исо", "падар", "санта", "ҷашн"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("አባባ ገና"),
			keywords: &["ርሑስ", "ሳንታ", "በዓል", "በዓል ልደት", "ኣቦ", "ዓንቀጽ", "ጽምብል", "ጽንጽዋይ", "ጽውጽዋይ", "ፍንጣጣ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("Aýaz baba"),
			keywords: &["Roždestwo", "aýaz", "baba", "baýramçylyk", "kaka"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			lang:     "tr",
			tts:      Some("Noel Baba"),
			keywords: &["Noel Baba", "insan", "kutlama", "noel", "noel baba", "santa claus"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "wo",
			tts:      Some("Pere nowel"),
			keywords: &["màggal", "nowel", "papa", "pere"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
			tts:      Some("U-Santa Claus"),
			keywords: &["Ikrismesi", "U-Santa Claus", "u-claus", "u-santa", "umbhiyozo", "utata"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Baba Keresi"),
			keywords: &["Baba Keresi", "ayɛyɛ", "baba", "kérésì"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("圣诞老人"),
			keywords: &["圣诞", "圣诞老人", "圣诞节", "节日"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("聖誕老人"),
			keywords: &["爸爸", "聖誕", "聖誕老人", "聖誕老公公"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
...
pub const MX_CLAUS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("ሚክስ ክላውስ"),
			keywords: &["ሚክስ ክላውስ", "ሰው", "ሳንታ ክላውስ", "በዓል", "ክላውስ", "ኮፍያ", "የገና አባት", "ገና"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &[
				"উদ\u{9cd}\u{200c}য\u{9be}পন",
				"এক\u{9cd}সম\u{9be}ছ",
				"কল\u{9cd}পন\u{9be}",
				"ক\u{9cd}ল’জ",
				"খ\u{9cd}ৰীষ\u{9cd}টম\u{9be}চ",
				"ছ\u{9be}ন\u{9cd}ত\u{9be}",
				"পৰী",
				"বন\u{9cd}ধৰ দিন",
				"মেক\u{9cd}স",
				"মেৰী",
				"স\u{9be}ধ\u{9c1}কথ\u{9be}",
			],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
			tts:      Some("mx klaus"),
			keywords: &["Klaus", "bayram", "insan", "milad", "mx klaus", "papaq", "santa"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("спадарыня Клаус"),
			keywords: &["Клаус", "Раство", "каляды", "спадарыня Клаус"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("г-х коледа"),
			keywords: &["г-х коледа", "дядо коледа", "коледа", "празник", "червена шапка", "човек"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
			...
			keywords: &[
				"কল\u{9cd}স",
				"ক\u{9cd}রিসম\u{9be}স",
				"বড\u{9bc} দিনের ট\u{9c1}পি",
				"বড\u{9bc}দিন",
				"ব\u{9cd}যক\u{9cd}তি",
				"মেরি ক\u{9cd}রিসম\u{9be}স",
				"ম\u{9cd}য\u{9be}ক\u{9cd}স ক\u{9cd}লস",
				"ল\u{9be}ল ট\u{9c1}পি পর\u{9be} ম\u{9c1}খ",
				"লোক",
				"স\u{9be}ন\u{9cd}ত\u{9be}",
				"স\u{9be}ন\u{9cd}ত\u{9be} ক\u{9cd}লজ",
				"স\u{9be}ন\u{9cd}ত\u{9be} ক\u{9cd}লজের ট\u{9c1}পি",
				"স\u{9cd}য\u{9be}ন\u{9cd}টি",
			],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("Noel"),
			keywords: &["Nadal", "Noel", "festes", "persona", "santa claus"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᏧᏠᏱ ᏧᏠᎦᎴᏓ"),
			keywords: &["ᏓᏂᏍᏓᏲᎯᎲᎢ", "ᏧᏠᎦᎴᏓ", "ᏧᏠᏱ ᏧᏠᎦᎴᏓ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			lang:     "en_CA",
			tts:      Some("Mx. Claus"),
			keywords: &["Christmas", "Claus", "Mx. Claus"],
		},
		#[cfg(feature = "en_GB")]
		crate::Annotation { lang: "en_GB", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_IN")]
		...
		crate::Annotation {
			lang:     "et",
			tts:      Some("päkats"),
			keywords: &["fantaasia", "jõulud", "päkapikk", "pühad", "tähistamine"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("bizarzuri"),
			keywords: &["bizarzuri", "eguberriak", "gabonak"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("tonttu"),
			keywords: &["joulu", "joulupukki", "joulutonttu", "xmas"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			lang:     "ga",
			tts:      Some("Saintí"),
			keywords: &["Daidí na Nollag", "Saintí", "an Nollaig", "duine", "hata"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("Neach na Nollaig"),
			keywords: &["Neach na Nollaig", "bean Bodach na Nollaig", "bodach na Nollaig", "neach"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"क\u{94d}रिसमस",
				"क\u{94d}ला\u{945}\u{945}\u{945}\u{945}ज\u{93c}",
				"टोपी",
				"म\u{947}री एक\u{94d}समस",
				"म\u{947}री क\u{94d}रिसमस",
				"शख\u{94d}स",
				"सा\u{902}ता",
				"स\u{947}\u{902}टा क\u{94d}लॉज\u{93c}",
				"हॉलिड\u{947}",
				"हॉलीड\u{947}",
			],
		},
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("osoba Mraz"),
			keywords: &["Božić", "Djed Božićnjak", "Djed Mraz", "Mraz", "Sretan Božić", "osoba", "šešir"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("télapó"),
			keywords: &["Mikulás", "ember", "karácsony", "mikulás", "sapka", "télapó", "ünnepek"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
			tts:      Some("Ձմեռ պապ"),
			keywords: &["Ձմեռ պապ", "Սուրբ Ծնունդ", "հեքիաթ", "ուրախ", "տոն", "տոնակատարություն"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			lang:     "ig",
			tts:      Some("mx claus"),
			keywords: &["claus", "ekeresìmesì", "mx claus"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("frú sveinki"),
			keywords: &["Sveinki", "frú sveinki", "jól"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("サンタさん"),
			keywords: &["クリスマス", "サンタ", "サンタさん", "サンタクロース", "人", "帽子"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("bapa/ibu klas"),
			keywords: &["Klas", "bapa/ibu klas", "natal"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ಕ\u{ccd}ರ\u{cbf}ಸ\u{ccd}\u{200c}ಮಸ\u{ccd}\u{200c}",
				"ಕ\u{ccd}ಲಾಸ\u{ccd}",
				"ಟ\u{ccb}ಪ\u{cbf}",
				"ಮ\u{cc6}ರ\u{ccd}ರ\u{cbf} ಕ\u{ccd}ರ\u{cbf}ಸ\u{ccd}ಮಸ\u{ccd}",
				"ರಜಾದ\u{cbf}ನ",
				"ಸಂತ",
				"ಸಂತಕ\u{ccd}ಲಾಸ\u{ccd}",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("산타"),
			keywords: &["메리 크리스마스", "모자", "사람", "산타", "산타클로스", "크리스마스", "휴일"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["Kalėdos", "Kalėdų asmuo", "Kalėdų senelis", "kepurė", "žmogus"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ക\u{d4d}രിസ\u{d4d}ത\u{d41}മസ\u{d4d}",
				"ക\u{d4d}രിസ\u{d4d}മസ\u{d4d}",
				"തൊപ\u{d4d}പി",
				"വ\u{d4d}യക\u{d4d}തി",
				"സ\u{d3e}ന\u{d4d}ത",
				"സ\u{d3e}ന\u{d4d}റ\u{d3e}ക\u{d4d}ലോസ\u{d4d}",
				"സ\u{d3e}ൻറക\u{d4d}ലോസ\u{d4d}",
			],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ख\u{94d}रिसमस",
				"टोपी",
				"म\u{947}री ख\u{94d}रिसमस",
				"व\u{94d}यक\u{94d}ती",
				"स\u{941}ट\u{94d}टी",
				"स\u{945}\u{902}टा क\u{94d}लॉज",
			],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &[
				"ਐਮਐਕਸ ਕਲਾਜ\u{a3c}",
				"ਕਲਾਜ\u{a3c}",
				"ਕਲਾਜ\u{a3c}, ਕ\u{a4d}ਰਿਸਮਸ",
				"ਕ\u{a4d}ਰਿਸਮਸ",
				"ਛ\u{a41}\u{a71}ਟੀਆ\u{a02}",
				"ਟ\u{a4b}ਪੀ",
				"ਸ\u{a48}\u{a02}ਟਾ",
			],
		},
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("Sra. Natal"),
			keywords: &["Natal", "Sra. Natal", "chapéu", "feriado", "pai natal", "pessoa"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("mx claus"),
			keywords: &[
				"Mx", "Navidad", "claus", "fantasia", "kusi", "kusisqa", "raymi", "santa", "willay",
			],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-084"), keywords: &["E13-084"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("Санта"),
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"නත\u{dca}තල\u{dca}",
				"නත\u{dca}තල\u{dca} ස\u{dd3}ය\u{dcf}",
				"න\u{dd2}ව\u{dcf}ඩ\u{dd4}",
				"වගන\u{dca}ත\u{dd2}",
				"සත\u{dd4}ට\u{dd4}ය\u{dd2}",
				"සැමර\u{dd4}ම",
				"ස\u{dd4}රංගන\u{dcf}",
				"ෆැන\u{dca}ටස\u{dd2}",
			],
		...
		crate::Annotation {
			lang:     "sr",
			tts:      Some("особа Мраз"),
			keywords: &["божић", "деда", "мраз", "празник", "прослава"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("osoba Mraz"),
			keywords: &["božić", "deda", "mraz", "praznik", "proslava"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		crate::Annotation {
			...
			keywords: &["jul", "jultomte", "könsneutral tomte", "tomte"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
		...
		crate::Annotation {
			...
			keywords: &[
				"கிறிஸ\u{bcd}துமஸ\u{bcd}",
				"கிறிஸ\u{bcd}மஸ\u{bcd}",
				"கொண\u{bcd}ட\u{bbe}ட\u{bcd}டம\u{bcd}",
				"க\u{bcd}ள\u{bbe}ஸ\u{bcd}",
				"க\u{bcd}ள\u{bbe}ஸ\u{bcd}, கிறிஸ\u{bcd}துமஸ\u{bcd}",
				"ச\u{bbe}ண\u{bcd}ட\u{bbe}",
				"ச\u{bbe}ன\u{bcd}ட\u{bbe}",
				"தொப\u{bcd}பி",
		...
		crate::Annotation {
			...
			keywords: &[
				"క\u{c4d}ర\u{c3f}స\u{c4d}టమస\u{c4d}",
				"క\u{c4d}ర\u{c3f}స\u{c4d}మస\u{c4d}",
				"క\u{c4d}ల\u{c3e}జ\u{c4d}",
				"ట\u{c4b}ప\u{c40}",
				"పండుగ",
				"మ\u{c46}ర\u{c4d}ర\u{c40} క\u{c4d}ర\u{c3f}స\u{c4d}మస\u{c4d}",
				"మ\u{c47}ర\u{c40}",
				"వ\u{c47}డుక",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("mx claus"),
			keywords: &["claus", "kérésìmesì", "mx claus"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
		...
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("跨性別聖誕老人"),
			keywords: &["節日", "耶誕快樂", "耶誕節", "耶誕老人", "聖誕", "聖誕快樂", "聖誕老人"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["人物", "假期", "帽子", "節日", "聖誕快樂", "聖誕節", "聖誕老人"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("u-mx claus"),
			keywords: &["Claus", "mx claus", "u-mx claus", "ukhisimusi"],
		},
	],
};
#[doc = "🧑🏻\u{200d}🎄"]
...
pub const SUPERHERO: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("суперхерој"),
			keywords: &["добро", "супер моќи", "супермен", "суперсила", "суперхерој", "хероина", "херој"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["betmen", "qahramon", "superkuch", "supermen", "superqahramon", "yaxshi", "zo‘r"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
...
pub const MAN_SUPERHERO: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["kişi", "kişi superqəhrəman", "qəhrəman", "supergüc", "xeyirxah"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("мужчына-супергерой"),
			keywords: &["герой", "дабро", "мужчына", "мужчына-супергерой", "суперсіла"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
		...
		crate::Annotation {
			...
			keywords: &["dobro", "heroj", "muškarac", "superheroj muškarac", "supermoć"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("superhrdina"),
			keywords: &["hrdina", "kladná postava", "muž", "superhrdina", "superschopnost"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			lang:     "es",
			tts:      Some("superhéroe"),
			keywords: &["bueno", "hombre", "héroe", "superhombre", "superhéroe", "superpoder"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation { lang: "es_419", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_MX")]
		...
		crate::Annotation {
			...
			keywords: &["gizon", "gizonezko superheroi", "heroi", "on", "superbotere"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("ابرقهرمان مرد"),
			keywords: &["ابرقدرت", "ابرقهرمان", "ابرقهرمان مرد", "خوب", "دلاور", "شیرمرد", "قهرمان"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("miessupersankari"),
			keywords: &["hyvis", "hyvä", "miessupersankari", "sankari", "supervoimat"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
			tts:      Some("lalaking superhero"),
			keywords: &["hero", "lalaki", "lalaking superhero", "malakas", "superhero", "superpower"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
			tts:      Some("mannlig superhetja"),
			keywords: &["góður", "hetja", "mannlig superhetja", "maður", "super", "yvirnát´úrligur"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("super-héros homme"),
			keywords: &["bien", "homme", "héros", "super-héros homme", "super-pouvoir"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
			tts:      Some("super-héros"),
			keywords: &["bien", "homme", "héros", "super-héros", "super-pouvoir"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("superheroe"),
			keywords: &["heroe", "home", "superpoderes"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("babban jarumin namiji"),
			keywords: &["abu mai kyau", "babban iko", "babban jarumin namiji", "jarumi", "na miji"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("superjunak"),
			keywords: &["dobročinitelj", "junak", "muškarac", "superjunak", "supermoći"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("férfi szuperhős"),
			keywords: &["férfi", "férfi szuperhős", "hős", "hősnő", "jó", "szuperképesség"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			keywords: &["baik", "kekuatan super", "pahlawan", "pahlawan super pria", "pria"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("dike nwoke"),
			keywords: &["di mma", "dike nwoke", "ike", "nwoke", "odogwu"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			...
			keywords: &["becik", "kadigdayan linuwih", "lanang", "satriya", "satriya mandraguna lanang"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &["उत\u{94d}तम", "दादलो", "दादलो स\u{941}परहिरो", "स\u{941}परपावर", "हिरो"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["ຈອມພະລ\u{eb1}ງ", "ດ\u{eb5}", "ບ\u{eb8}ລ\u{eb8}ດ", "ພະເອກ", "ພະເອກຍອດຊາຍ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
			tts:      Some("vyras superherojus"),
			keywords: &["geras", "herojus", "supergalia", "vyras", "vyras superherojus"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("vīrietis supervaronis"),
			keywords: &["labais", "superspēks", "varonis", "vīrietis", "vīrietis supervaronis"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["adi wira lelaki", "baik", "lelaki", "sangat berkuasa", "wira"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			...
			keywords: &["goed", "held", "man", "mannelijke superheld", "superkrachten"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["bohater", "mężczyzna", "mężczyzna superbohater", "pozytywny", "supermoc"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-043"), keywords: &["E11-043"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("мужчина-супергерой"),
			keywords: &["герой", "мужчина-супергерой", "супергерой", "супермен", "суперсила"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["awood sareeysa", "geesi", "nin", "nin halyeey ah", "wanaagsan"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("burrë superhero"),
			keywords: &["burrë", "burrë superhero", "hero", "heroinë", "superfuqi", "zemërmirë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("мушкарац супер херој"),
			keywords: &["добро", "мушкарац", "мушкарац супер херој", "супер моћ", "херој"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
		...
		crate::Annotation {
			...
			keywords: &["dobro", "heroj", "muškarac", "muškarac super heroj", "super moć"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
		...
		crate::Annotation {
			...
			keywords: &["mwanamume", "mzuri", "nguvu zisizo za kawaida", "shujaa", "shujaa wa kiume"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰብኣይ ሱፐር ሂሮ"),
			keywords: &["ልዕለ ሓይሊ", "ሰብኣይ", "ሱፐር ሂሮ", "ጅግና", "ጽቡቕ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("erkek supergahryman"),
			keywords: &["erkek adam", "erkek supergahryman", "gahryman", "gowy", "supergüýç"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["erkek", "erkek süper kahraman", "iyi", "kahraman", "süper güç"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("чоловік-супергерой"),
			keywords: &["герой", "добро", "суперсила", "чоловік", "чоловік-супергерой"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["erkak qahramon", "qahramon", "superkuch", "supermen", "zo‘r"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("nam siêu anh hùng"),
			keywords: &["anh hùng", "nam giới", "nam siêu anh hùng", "siêu năng lực", "tốt"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("ọkùnrin akọni ńlá"),
			keywords: &["agbára ńlá", "akọni", "dára", "ọkùnrin", "ọkùnrin akọni ńlá"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("ɔkùnrin akɔni ńlá"),
			keywords: &["agbára ńlá", "akɔni", "dára", "ɔkùnrin", "ɔkùnrin akɔni ńlá"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
...
pub const WOMAN_SUPERHERO: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["qadın", "qadın superqəhrəman", "qəhrəman", "supergüc", "xeyirxah"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("жанчына-супергерой"),
			keywords: &["гераіня", "герой", "дабро", "жанчына", "жанчына-супергерой", "суперсіла"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
		...
		crate::Annotation {
			...
			keywords: &["ᎠᎨᏯ", "ᎠᎨᏯ ᏄᎬᏫᏳᏒᎩ ᏩᏥᎸᏉᏛ", "ᎣᏍᏓ", "ᏄᎬᏫᏳᏒᎩ ᎤᏟᏂᎩᏓ", "ᏩᏥᎸᏉᏛ", "ᏬᏂᎸᏉᏛᎢ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["archarwr benywaidd", "archbŵer", "arwr", "arwres", "da", "menyw"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("kvindelig superhelt"),
			keywords: &["god", "helt", "heltinde", "kvinde", "kvindelig superhelt", "superkraft"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["ήρωας", "γυναίκα", "γυναίκα υπερήρωας", "ηρωίδα", "καλή", "υπερδύναμη"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["bien", "heroína", "héroe", "mujer", "mujer superheroína", "superpoder"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation {
			...
			keywords: &["hea", "kangelane", "kangelanna", "naine", "naissuperkangelane", "supervõimed"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("emakumezko superheroi"),
			keywords: &["emakume", "emakumezko superheroi", "heroi", "on", "superbotere"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("ابرقهرمان زن"),
			keywords: &["ابرقدرت", "ابرقهرمان", "ابرقهرمان زن", "خوب", "دلاور", "شیرزن", "قهرمان"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("naissupersankari"),
			keywords: &["hyvis", "hyvä", "naissupersankari", "sankari", "sankaritar", "supervoimat"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
			tts:      Some("babaeng superhero"),
			keywords: &["babae", "babaeng superhero", "hero", "superhero", "superpower"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
			tts:      Some("kvinnulig superhetja"),
			keywords: &["góð", "hetja", "kvinnulig superhetja", "super", "yvirnátúrlig"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("super-héroïne"),
			keywords: &["bien", "femme", "héros", "héroïne", "super-héroïne", "super-pouvoir"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			...
			keywords: &["ban-sárlaoch", "banloach", "bean", "laoch", "maith", "sárchumhacht"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("superheroína"),
			keywords: &["heroe", "heroína", "muller", "supermuller"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("jaruma"),
			keywords: &["abu mai kyau", "babban karfi", "jaruma", "jaruma ta mace", "jarumi", "na mace"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["dobročinitelj", "junak", "junakinja", "superjunakinja", "supermoći", "žena"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("női szuperhős"),
			keywords: &["hős", "hősnő", "jó", "nő", "női szuperhős", "szuperképesség"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			keywords: &["baik", "kekuatan super", "pahlawan", "pahlawan super wanita", "wanita"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("dike nwanyị"),
			keywords: &["di mma", "dike nwanyi", "dike nwanyị", "ike", "nwanyị", "odogwu nwanyị"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("ofurkona"),
			keywords: &["góð", "hetja", "kona", "kvenhetja", "ofurkona", "ofurkraftur"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			...
			keywords: &["ヒロイン", "ヒーロー", "善", "女性", "女性のスーパーヒーロー", "超人"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("srikandhi"),
			keywords: &["becik", "kadigdayan linuwih", "satriya", "srikandhi", "wadon"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("სუპერგმირი ქალი"),
			keywords: &["გმირი", "გმირი ქალი", "ზებუნებრივი", "კეთილი", "სუპერგმირი ქალი"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		crate::Annotation {
			...
			keywords: &["उत\u{94d}तम", "बायल", "बायल स\u{941}परहिरो", "स\u{941}परपावर", "हिरो", "हिरोईन"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
			tts:      Some("супер баатыр кыз"),
			keywords: &["аял", "баатыр", "баатыр кыз", "жакшы", "супер баатыр кыз", "эбегейсиз зор күч"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["geras", "herojus", "herojė", "moteris", "moteris superherojė", "supergalia"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("sieviete supervarone"),
			keywords: &["labais", "sieviete", "sieviete supervarone", "superspēks", "varone", "varonis"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("жена-суперхерој"),
			keywords: &["добро", "жена", "жена-суперхерој", "суперсила", "хероина", "херој"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["छान", "महिला", "महिला स\u{941}परहिरो", "स\u{941}परपॉवर", "हीरो", "हीरोईन"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
			tts:      Some("adi wira wanita"),
			keywords: &["adi wira wanita", "baik", "sangat berkuasa", "wanita", "wira", "wirawati"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			...
			keywords: &["goed", "held", "heldin", "superkrachten", "vrouw", "vrouwelijke superheld"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
			tts:      Some("kvinneleg superhelt"),
			keywords: &["god", "helt", "heltinne", "kvinne", "kvinneleg superhelt", "superkrefter"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["bohaterka", "kobieta", "kobieta superbohater", "pozytywna", "supermoc"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			...
			keywords: &["boa", "heroína", "herói", "mulher", "super-heroína", "superpoder"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		crate::Annotation {
			...
			keywords: &["allin", "heroe", "heroina", "superpoder", "warmi", "warmi superheroe"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("supererou femeie"),
			keywords: &["bună", "eroină", "erou", "femeie", "supererou femeie", "superputere"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-042"), keywords: &["E11-042"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("женщина-супергерой"),
			keywords: &["героиня", "женщина-супергерой", "супервумен", "супергероиня", "суперсила"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("عورت سپر هيرو"),
			keywords: &["بهترين", "سپر پاور", "عورت", "عورت سپر هيرو", "هيرو", "هيروئين"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["grua", "hero", "heroinë", "superfuqi", "superheroinë", "zemërmirë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &["mwanamke", "mzuri", "nguvu zisizo za kawaida", "shujaa", "shujaa wa kike"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ጓል ኣንስተይቲ ሱፐር ሂሮ"),
			keywords: &["ልዕለ ሓያል ሓይሊ", "ሰበይቲ", "ሱፐር ሂሮ", "ዋዕሮ", "ጅግና", "ጽቡቕ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("zenan supergahryman"),
			keywords: &["gahryman", "gowy", "supergüýç", "zenan", "zenan supergahryman"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["iyi", "kadın", "kadın süper kahraman", "kahraman", "süper güç"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("жінка-супергерой"),
			keywords: &["герой", "добро", "жінка", "жінка-супергерой", "супер", "супервумен"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("خاتون سپر ہیرو"),
			keywords: &["اچھا", "خاتون سپر ہیرو", "سپر پاور", "عورت", "ہیرو", "ہیروئن"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("ayol superqahramon"),
			keywords: &["ayol", "ayol superqahramon", "qahramon", "superkuch", "zo‘r"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("nữ siêu anh hùng"),
			keywords: &["anh hùng", "nữ anh hùng", "nữ siêu anh hùng", "phụ nữ", "siêu năng lực", "tốt"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("obìnrin akọni ńlá"),
			keywords: &["agbára ńlá", "akọni", "dára", "obìnrin", "obìnrin akọni ńlá"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("obìnrin akɔni ńlá"),
			keywords: &["agbára ńlá", "akɔni", "dára", "obìnrin", "obìnrin akɔni ńlá"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
...
pub const SUPERVILLAIN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("superskurk"),
			keywords: &["kriminel", "ond", "person", "skurk", "superkraft", "superkræfter", "superskurk"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["krimināls", "nelietis", "noziedznieks", "superspēks", "superļaunais", "ļaunums"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			lang:     "sv",
			tts:      Some("superskurk"),
			keywords: &["brottsling", "elak", "ond", "skurk", "superkraft", "superkrafter", "superskurk"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
...
pub const MAN_SUPERVILLAIN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["boos", "krimineel", "man", "manlike superskurk", "skurk", "superkrag"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["جريمة", "رجل", "شر", "شرير", "شرير خارق رجل", "قوة خارقة", "مجرم"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["cani", "kişi", "kişi supercani", "kriminal", "pis", "supergüc"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["зло", "злодей", "мъж", "мъж суперзлодей", "престъпник", "суперсила"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["criminal", "dolent", "home", "home superdolent", "malvat", "superpoder"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎠᏍᎦᏯ ᏄᎬᏫᏳᏒᎩ ᎠᏍᎦᏂ"),
			keywords: &["ᎠᏍᎦᏂ", "ᎠᏍᎦᏯ", "ᎠᏍᎦᏯ ᏄᎬᏫᏳᏒᎩ ᎠᏍᎦᏂ", "ᎤᏍᎦᏅᏨᎯ ᎨᏒᎢ", "ᎤᏐᏅᎢ", "ᏄᎬᏫᏳᏒᎩ ᎤᏟᏂᎩᏓ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["archbŵer", "archleidr gwrywaidd", "drwg", "dyn", "troseddwr"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("mandlig superskurk"),
			keywords: &["kriminel", "mand", "mandlig superskurk", "ond", "skurk", "superkraft"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["άντρας", "άντρας αρχικακός", "κακοποιός", "κακό", "κακός", "υπερδύναμη"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["delito", "hombre", "hombre supervillano", "mal", "superpoder", "villano"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation {
			lang:     "es_US",
		...
		crate::Annotation {
			...
			keywords: &["bilau", "gaizto", "gizon", "gizonezko superbilau", "kriminal", "superbotere"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("ابرشرور مرد"),
			keywords: &["آدم شرور", "ابرشرور مرد", "ابرقدرت", "اهریمن", "تبهکار", "مرد"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["criminel", "homme", "mal", "méchant", "super-pouvoir", "super-vilain homme"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
			tts:      Some("↑↑↑"),
			keywords: &["criminel", "homme", "mal", "méchant", "super-pouvoir", "super-vilain"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("fear-dhrochdhuine"),
			keywords: &["coirpeach", "drochdhuine", "fear", "fear-dhrochdhuine", "olc", "sárchumhacht"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("supervilán"),
			keywords: &["home", "malo", "superpoderes", "vilán"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("mugun namiji"),
			keywords: &["babban iko", "mai laifi", "mugu", "mugun abu", "mugun namiji", "na miji"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["כוחות הרשע", "כוחות על", "נבל", "פושע", "רשע", "רשע בעל כוחות על"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["kriminalac", "muškarac", "stripovski zločinac", "supermoći", "zlo", "zločinac"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("férfi főgonosz"),
			keywords: &["bűnöző", "férfi", "férfi főgonosz", "gazember", "gonosz", "szuperképesség"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			keywords: &["jahat", "kekuatan super", "kriminal", "penjahat", "penjahat super pria", "pria"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("nwoke onye ọjọọ"),
			keywords: &["ihe ojoo", "ike", "nwoke", "nwoke onye ọjọọ", "omempụ"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			...
			keywords: &["cattivo", "criminale", "supercattivo uomo", "superpotere", "uomo"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			...
			keywords: &["ер", "ер супер залым", "залым", "супер күш", "шайтан", "қылмыстық"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &["blogas", "nusikaltėlis", "piktadarys", "supergalia", "vyras"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["зло", "криминалец", "маж", "маж супернегативец", "негативец", "суперсила"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["boef", "crimineel", "man", "mannelijke superschurk", "slecht", "superkrachten"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
			tts:      Some("mannleg superskurk"),
			keywords: &["kriminell", "mann", "mannleg superskurk", "skurk", "superkrefter", "vond"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["جنايتکار", "خراب", "سړی لوي ورانکاری", "لوي قوت", "ورانکاری"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("homem supervilão"),
			keywords: &["criminoso", "homem", "homem supervilão", "mal", "superpoder", "vilão"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["criminoso", "homem", "homem supervilão", "mau", "superpoderoso", "vilão"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("runa supervillano"),
			keywords: &["criminal", "runa", "runa supervillano", "supay", "superpoder", "villano"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-046"), keywords: &["E11-046"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			lang:     "si",
			tts:      Some("ප\u{dd2}ර\u{dd2}ම\u{dd2} ස\u{dd4}ප\u{dd2}ර\u{dd2} ද\u{dd4}ෂ\u{dca}ටය\u{dcf}"),
			keywords: &[
				"අපර\u{dcf}ධක\u{dcf}රයෙක\u{dca}",
				"ද\u{dd4}ෂ\u{dca}ටය\u{dcf}",
				"නරකය\u{dd2}",
		...
		crate::Annotation {
			...
			keywords: &["darebák", "muž", "superdarebák", "superschopnosť", "zlo", "zloduch", "zločinec"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["burrë superzuzar", "i lig", "kriminel", "superfuqi", "zuzar"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &["brottsling", "man", "manlig superskurk", "ond", "skurk", "superkraft"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰብኣይ ሱፐርቪላን"),
			keywords: &["ልዕለ ሓያል ሓይሊ", "ሕማቕ", "ሰብኣይ", "ሱፐርቪላን", "ክፍኣት", "ገበነኛ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("erkek superbetpäl"),
			keywords: &["betpäl", "erbet", "erkek adam", "erkek superbetpäl", "jenaýatçy", "supergüýç"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["erkek", "erkek süper kötü", "kötü", "suçlu", "süper güç", "şeytani"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("суперлиходій"),
			keywords: &["зло", "злодій", "злочинець", "суперлиходій", "суперсила", "чоловік"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["erkak", "jinoyat", "salbiy", "superkuch", "superqahramon", "yovuz", "yovuzlik"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("ọkùnrin aṣèbàjẹ\u{301} ńlá"),
			keywords: &[
				"agbára ńlá",
				"aṣèbájẹ\u{301}",
				"ibi",
				"ọkùnrin",
				"ọkùnrin aṣèbàjẹ\u{301} ńlá",
				"ọ\u{300}daràn",
			],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("ɔkùnrin ashèbàjɛ\u{301} ńlá"),
			keywords: &[
				"agbára ńlá",
				"ashèbájɛ\u{301}",
				"ibi",
				"ɔkùnrin",
				"ɔkùnrin ashèbàjɛ\u{301} ńlá",
				"ɔ\u{300}daràn",
			],
		},
		#[cfg(feature = "yue")]
...
pub const WOMAN_SUPERVILLAIN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["boos", "krimineel", "skurk", "superkrag", "vrou", "vroulike superskurk"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["cani", "kriminal", "pis", "qadın", "qadın supercani", "supergüc"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("суперзлачынка"),
			keywords: &["жанчына", "злачынца", "зло", "ліхадзей", "суперзлачынка", "суперсіла"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("жена суперзлодей"),
			keywords: &["жена", "жена суперзлодей", "зло", "злодей", "престъпник", "суперсила"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["kriminalac", "supermoć", "zlikovac", "zlo", "žena super zlikovac"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			tts:      Some("dona superdolenta"),
			keywords: &["criminal", "dolenta", "dona", "dona superdolenta", "malvada", "superpoder"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎠᎨᏯ ᏄᎬᏫᏳᏒᎩ ᎠᏍᎦᏂ"),
			keywords: &["ᎠᎨᏯ", "ᎠᎨᏯ ᏄᎬᏫᏳᏒᎩ ᎠᏍᎦᏂ", "ᎠᏍᎦᏂ", "ᎤᏍᎦᏅᏨᎯ ᎨᏒᎢ", "ᎤᏐᏅᎢ", "ᏄᎬᏫᏳᏒᎩ ᎤᏟᏂᎩᏓ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["archbŵer", "archleidr benywaidd", "drwg", "dyn drwg", "menyw", "troseddwr"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("kvindelig superskurk"),
			keywords: &["kriminel", "kvinde", "kvindelig superskurk", "ond", "skurk", "superkraft"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["γυναίκα", "γυναίκα αρχικακός", "κακή", "κακοποιός", "κακό", "υπερδύναμη"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("↑↑↑"),
			keywords: &["delito", "mal", "mujer", "superpoder", "supervillana", "villana"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		...
		crate::Annotation {
			...
			keywords: &["bilau", "emakume", "emakumezko superbilau", "gaizto", "kriminal", "superbotere"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("ابرشرور زن"),
			keywords: &["آدم شرور", "ابرشرور زن", "ابرقدرت", "اهریمن", "تبهکار", "زن"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["criminelle", "femme", "mal", "méchante", "super-pouvoir", "super-vilain femme"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["ban-drochdhuine", "bean", "coirpeach", "drochdhuine", "olc", "sárchumhacht"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("supervilá"),
			keywords: &["mala", "muller", "superpoderes", "vilá"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			...
			keywords: &["kriminalka", "stripovska zločinka", "supermoći", "zlo", "zločinka", "žena"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("női főgonosz"),
			keywords: &["bűnöző", "gazember", "gonosz", "nő", "női főgonosz", "szuperképesség"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "ig",
			tts:      Some("nwanyị onye ọjọọ"),
			keywords: &["ihe ojoo", "ike", "nwanyị", "nwanyị onye ọjọọ", "omempụ"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			...
			keywords: &["cattivo", "criminale", "donna", "supercattiva", "superpotere"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			...
			keywords: &["залым", "супер күш", "шайтан", "қылмыстық", "әйел", "әйел супер залым"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &["жена", "жена супернегативец", "зло", "криминалец", "негативец", "суперсила"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["kriminell", "kvinne", "kvinneleg superskurk", "skurk", "superkrefter", "vond"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("supervilã"),
			keywords: &["criminosa", "mulher", "má", "superpoder", "supervilã", "vilã"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("mulher supervilã"),
			keywords: &["criminosa", "mulher", "mulher supervilã", "má", "superpoder", "vilã"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("warmi supervillana"),
			keywords: &["criminal", "supay", "superpoder", "villana", "warmi", "warmi supervillana"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-045"), keywords: &["E11-045"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["kriminalka", "negativka", "super moč", "super negativka", "zlobna", "ženska"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["жена", "жена негативац", "зло", "злочинац", "криминал", "супер моћ"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			...
			keywords: &["kriminal", "super moć", "zlo", "zločinac", "žena", "žena negativac"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		crate::Annotation {
			...
			keywords: &["brottsling", "kvinna", "kvinnlig superskurk", "ond", "skurk", "superkraft"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ጓል ኣንስተይቲ ሱፐርቪላን"),
			keywords: &["ልዕለ ሓያል ሓይሊ", "ሕማቕ", "ሰበይቲ", "ሱፐርቪላን", "ክፍኣት", "ዕሱብ", "ገበነኛ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("zenan superbetpäl"),
			keywords: &["betpäl", "erbet", "jenaýatçy", "supergüýç", "zenan", "zenan superbetpäl"],
		},
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("fefine kākā"), keywords: &["fefine kākā"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("kadın süper kötü"),
			keywords: &["kadın", "kadın süper kötü", "kötü", "suçlu", "süper güç", "şeytani"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("суперлиходійка"),
			keywords: &["жінка", "зло", "злодій", "злочинець", "суперлиходійка", "суперсила"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("obìnrin aṣèbàjẹ\u{301} ńlá"),
			keywords: &[
				"agbára ńlá",
				"aṣèbàjẹ\u{301}",
				"ibi",
				"obìnrin aṣèbàjẹ\u{301} ńlá",
				"ọbìnrin",
				"ọ\u{300}daràn",
			],
		},
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("obìnrin ashèbàjɛ\u{301} ńlá"),
			keywords: &[
				"agbára ńlá",
				"ashèbàjɛ\u{301}",
				"ibi",
				"obìnrin ashèbàjɛ\u{301} ńlá",
				"ɔbìnrin",
				"ɔ\u{300}daràn",
			],
		},
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"জ\u{9be}দ\u{9c1}করী",
				"ড\u{9be}ইনি",
				"ম\u{9be}য\u{9bc}\u{9be}বিনী",
				"মেজ",
			],
		},
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("maj"), keywords: &["maj", "sorser"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("čarobnjak"),
		...
		crate::Annotation {
			lang:     "el",
			tts:      Some("μάγος"),
			keywords: &["μάγισσα", "μάγος", "μαγεία", "ξόρκια", "παιχνίδι ρόλων", "φαντασία"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["mahika", "mangkukulam", "pantasya", "salamangkero", "wizard"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			...
			tts:      Some("મ\u{ac7}જ"),
			keywords: &[
				"ચમત\u{acd}કાર બતાવનાર",
				"જાદ\u{ac1}",
				"જાદ\u{ac1}ઈ મ\u{a82}ત\u{acd}ર",
				"જાદ\u{ac1}ગર",
				"જાદ\u{ac1}ગર સ\u{acd}ત\u{acd}રી",
				"જાદ\u{ac1}ટોણો કરનાર",
				"નજરબ\u{a82}ધી કરનાર",
				"મ\u{ac7}જ",
			],
		},
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("mai dabo"),
			keywords: &["kwaikwayo", "mafarki", "mai dabo", "mai sihiri", "matsafi", "maye", "mayya"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("קוסם"),
			keywords: &["אדם", "אשף", "כישוף", "מכשף", "משחק תפקידים", "פנטזיה", "קוסם", "קסם"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		#[cfg(feature = "hy")]
		crate::Annotation { lang: "hy", tts: Some("մոգ"), keywords: &["կախարդ", "մոգ"] },
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("magi"),
		...
		crate::Annotation {
			...
			keywords: &["ធ\u{17d2}មប\u{17cb}", "អ\u{17d2}នកមន\u{17d2}តអាគម", "អ\u{17d2}នកវេទមន\u{17d2}ត"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
			...
			keywords: &[
				...
				"ಸ\u{ccb}ರ\u{ccd}ಸ\u{cc6}ರರ\u{ccd}",
				"ಸ\u{ccb}ರ\u{ccd}ಸ\u{ccd}\u{200c}ರ\u{cc6}ಸ\u{ccd}",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("mags"),
			keywords: &["burvestība", "burvis", "fantāzija", "mags", "maģija", "ragana"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
			tts:      Some("tāngata matakite"),
			keywords: &["rūānuku", "tohunga mākutu", "tāngata matakite", "wahine mākutu"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["စ\u{102f}န\u{103a}းမ", "မ\u{103e}ော\u{103a}ဆရာ", "ဝ\u{102d}ဇ\u{1039}ဇာ"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			...
			keywords: &[
				"ଡ\u{b3e}ହ\u{b3e}ଣୀ",
				"ତନ\u{b4d}ତ\u{b4d}ରକ\u{b3e}ର\u{b3f}ଣୀ",
				"ଯ\u{b3e}ଦ\u{b41}କର",
			],
		},
		#[cfg(feature = "pa")]
		...
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Majíshan"),
			keywords: &["Jujú Man", "Jujú Wúman", "Majíshan", "Mán Wích", "Wich"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("mag"),
			keywords: &["czarnoksiężnik", "czarnownica", "czarodziej", "fantasy", "magia"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			lang:     "qu",
			tts:      Some("watuq"),
			keywords: &["runa layqa", "runa watuq", "warmi layqa", "warmi watuq", "watuq"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1130"), keywords: &["E10-1130"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("маг"),
			keywords: &["волшебник", "заклинание", "колдун", "маг", "магия", "чародей"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("↑↑↑"),
			keywords: &["вјештица", "маг", "чаробница", "чаробњак"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
		...
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("↑↑↑"),
			keywords: &["mag", "vještica", "čarobnica", "čarobnjak"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			lang:     "sw",
			tts:      Some("mlozi"),
			keywords: &["mchawi", "mchawi wa kike", "mlozi", "mlozi mwanamke", "mwanga"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			lang:     "tg",
			tts:      Some("коҳин"),
			keywords: &["зани афсунгар", "коҳин", "марди афсунгар", "соҳир", "ҷодугар"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("አስማተኛ"),
			keywords: &["ማጂክ", "አስማተኛ", "ዋዛ", "ጠንቋሊ", "ጠንቋሊት", "ጥንቆላ", "ጸዋታ", "ጻውዒት", "ፊደል", "ፍንጣጣ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["faʻahikehe", "taula", "tokotaha taula-faʻahikehe"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("büyücü"),
			keywords: &["büyü", "büyücü", "cadı", "sihir", "sihirbaz"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "uz",
			tts:      Some("sehrgar"),
			keywords: &["afsungar", "jodugar", "kohin", "sehr", "sehrgar"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("onídán"),
			keywords: &["onídán", "oshó", "àjɛ\u{301}"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
...
pub const MAN_MAGE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("አስማተኛ ወንድ"), keywords: &["አስማተኛ ወንድ"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation { lang: "ar", tts: Some("ساحر"), keywords: &["ساحر"] },
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["উইজ\u{9be}র\u{9cd}ড", "জ\u{9be}দ\u{9c1}কর", "প\u{9c1}র\u{9c1}ষ মেজ"],
		},
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("hudour"), keywords: &["hudour"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["gandakallur", "gandur", "kallur", "maður", "trøllmaður", "ævintýr"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang: "hy", tts: Some("կախարդ"), keywords: &["կախարդ", "մոգ"]
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["dibia nwoke", "nwoke abrakatabra", "nwoke kwenyere n’ike abrakatabra"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang: "kk", tts: Some("ер сиқыршы"), keywords: &["ер сиқыршы"]
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &["जाद\u{942}टोणो करपी दादलो", "व\u{94d}हिझार\u{94d}ड", "सोरस\u{947}रर"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["ജ\u{d3e}ലവിദ\u{d4d}യക\u{d4d}ക\u{d3e}രൻ", "മന\u{d4d}ത\u{d4d}രവ\u{d3e}ദി"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["မ\u{103e}ော\u{103a}ဆရာ", "အမျ\u{102d}\u{102f}းသား မ\u{103e}ော\u{103a}ဆရာ"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			...
			keywords: &[
				"ତ\u{b3e}ନ\u{b4d}ତ\u{b4d}ର\u{b3f}କ",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1251"), keywords: &["E10-1251"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("волшебник"),
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Ɔkùnrin onídán"),
			keywords: &["Oshó", "Ɔkùnrin onídán"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("男巫"), keywords: &["男巫"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("男巫師"),
...
pub const WOMAN_MAGE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("አስማተኛ ሴት"), keywords: &["አስማተኛ ሴት"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation { lang: "ar", tts: Some("ساحرة"), keywords: &["ساحرة"] },
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
			tts:      Some("মহিল\u{9be} য\u{9be}দ\u{9c1}কৰ"),
			keywords: &["ড\u{9be}ইনি", "মহিল\u{9be} য\u{9be}দ\u{9c1}কৰ", "য\u{9be}দ\u{9c1}কৰণী"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("hudourez"), keywords: &["hudourez"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation { lang: "el", tts: Some("μάγισσα"), keywords: &["μάγισσα"] },
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
			tts:      Some("woman mage"),
		...
		crate::Annotation {
			...
			keywords: &["gandakelling", "gandakona", "gandur", "kelling", "kona", "kvinna", "ævintýr"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			...
			keywords: &["dibia nwanyị", "nwanyị kwenyere n’ike abrakatabra", "nwanyị onye abrakatabra"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		#[cfg(feature = "it")]
		crate::Annotation { lang: "it", tts: Some("maga"), keywords: &["maga", "strega"] },
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
			tts:      Some("女の魔法使い"),
		...
		#[cfg(feature = "lb")]
		crate::Annotation { lang: "lb", tts: Some("Hex"), keywords: &["Hex"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["ജ\u{d3e}ലവിദ\u{d4d}യക\u{d4d}ക\u{d3e}രി", "മന\u{d4d}ത\u{d4d}രവ\u{d3e}ദിനി"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["စ\u{102f}န\u{103a}း", "အမျ\u{102d}\u{102f}းသမ\u{102e}း မ\u{103e}ော\u{103a}ဆရာ"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			...
			keywords: &["Jujú Wúman", "Wúmán Majíkshan", "Wúmán Majíshan", "Wúmán Wích"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1250"), keywords: &["E10-1250"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("волшебница"),
		...
		crate::Annotation {
			...
			keywords: &["ఇంద\u{c4d}రజ\u{c3e}ల\u{c3f}కుర\u{c3e}లు", "మంత\u{c4d}రగత\u{c4d}త\u{c46}"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang:     "tg",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Obìnrin onídán"),
			keywords: &["Obìnrin onídán", "àjé\u{329}", "àjɛ\u{301}"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("女巫師"), keywords: &["女巫師"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const FAIRY: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("ጠንቋይ"),
			keywords: &["ተረት", "አፈ ታሪክ", "ክንፎች", "የሰው ፌሪ", "የቢሆን ዓለም", "ጠንቋይ", "ፌሪ", "ፒክሲ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("фея"),
			keywords: &["Оберон", "Пук", "Титания", "крила", "мит", "фантазия", "фея"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("fe"),
			keywords: &["Titania", "eventyr", "fantasi", "fe", "magi", "myte", "sagn", "vinger"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["alas", "campanilla", "hada", "hada madrina", "maga", "ninfa", "titania"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("diwata"),
			keywords: &["Oberon", "Puck", "Titania", "diwata", "mitikal", "mito", "pantasya"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		#[cfg(feature = "gl")]
		crate::Annotation { lang: "gl", tts: Some("fada"), keywords: &["fada"] },
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			tts:      Some("પરી"),
			keywords: &["કાલ\u{acd}પનિક", "પર", "પરી", "પરીકથા", "પા\u{a82}ખ", "વનદ\u{ac7}વ"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
			tts:      Some("aljana"),
			keywords: &["Oberon", "Puck", "Titania", "aljana", "almara", "mai fiffike", "tatsuniya"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("פיה"),
			keywords: &["אגדה", "טיטניה", "טינקרבל", "כנפיים", "מיתוס", "פיה", "פנטזיה", "שדונת"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("peri"),
			keywords: &["Oberon", "Puck", "Titania", "dongeng", "fantasi", "mitos", "peri", "sayap"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			...
			keywords: &["Oberon", "Puck", "Titania", "bangsa dewi", "dewi", "peri", "suwiwi"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang: "ka", tts: Some("ფერია"), keywords: &["ტიტანია", "ფერია"]
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ಕ\u{cbf}ನ\u{ccd}ನರಲ\u{ccb}ಕ",
				"ಗಂಧರ\u{ccd}ವ ಲ\u{ccb}ಕ",
		...
		crate::Annotation {
			...
			tts:      Some("fėja"),
			keywords: &[
				"Oberon", "Puck", "Titania", "fėja", "fėjus", "laumius", "laumė", "mitas", "pasaka",
				"sparnai",
			],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("feja"),
			keywords: &["Oberons", "Paks", "Titānija", "fantāzija", "feja", "mīts", "pasaka"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("самовила"),
			keywords: &["бајка", "дух", "крила", "мит", "пикси", "самовила", "фантазија"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("elfje"),
			keywords: &["fantasie", "mythe", "persoon", "pixie", "sprookje", "vleugels"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		crate::Annotation {
			...
			keywords: &[
				"ଓବେରନ\u{b4d}\u{200d}",
				"ତ\u{b3f}ତ\u{b3e}ନ\u{b3f}ଆ",
				"ପରୀ",
				"ପ\u{b41}କ\u{b4d}\u{200d}",
			],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "pl",
			tts:      Some("wróżka"),
			keywords: &["Oberon", "Puk", "Tytania", "bajka", "baśń", "fantasy", "wróżka"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("fada"),
			keywords: &["asas", "conto de fadas", "fada", "fantasia", "ser encantado"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["asas", "conto", "fada", "fantasia", "fábula"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		crate::Annotation {
			...
			tts:      Some("zână"),
			keywords: &[
				"Oberon", "Puck", "Titania", "aripi", "basm", "fantezie", "mit", "poveste", "zână",
			],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1131"), keywords: &["E10-1131"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("фея"),
		...
		crate::Annotation {
			...
			keywords: &["ඔබෙරෝන\u{dca}", "ටය\u{dd2}ට\u{dcf}න\u{dd2}ය\u{dcf}", "පක\u{dca}", "ස\u{dd4}රඟන"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			...
			keywords: &["fantazija", "krila", "mit", "pravljica", "vila", "vilinsko bitje", "škratovka"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "sr",
			tts:      Some("вила"),
			keywords: &["бајка", "вила", "крила", "мит", "особа", "прича", "фантазија"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("vila"),
			keywords: &["bajka", "fantazija", "krila", "mit", "osoba", "priča", "vila"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
			tts:      Some("fé"),
			keywords: &["Oberon", "Puck", "Titania", "fé", "vingar", "älva"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
			tts:      Some("kichimbakazi"),
			keywords: &["jini", "kichimbakazi", "kichimbakazi malkia", "kichimbakazi mfalme"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &["คน", "นางฟ\u{e49}า", "น\u{e34}ทาน", "ป\u{e35}ก", "แฟร\u{e35}\u{e48}"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ፅውፅዋይ"),
			keywords: &["ሰብ", "ክንፊ", "ጽንጽዋይ", "ጽውጽዋይ", "ፍንጣጣ", "ፒክሲ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("feeli"), keywords: &["feeli"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("peri"),
			keywords: &["Oberon", "Puck", "Titania", "kanat", "masal", "mitoloji", "peri"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "uk",
			tts:      Some("фея"),
			keywords: &["Оберон", "Пак", "Титанія", "казка", "крила", "метелик", "фея"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			lang:     "uz",
			tts:      Some("pari"),
			keywords: &["Titaniya", "afsona", "ertak", "pari", "qanot", "qanotlar", "sehrli", "sohira"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
...
pub const MAN_FAIRY: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ጠንቋይ ወንድ"), keywords: &["ጠንቋይ ወንድ"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation { lang: "ar", tts: Some("جن\u{651}ي"), keywords: &["جن\u{651}ي"] },
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "el",
			tts:      Some("νεράιδος"),
			keywords: &["Oberon", "Puck", "Όμπερον", "Πακ", "νεράιδος"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("پری مرد"),
			keywords: &["ابرون", "جن و پری", "لولو", "هاب\u{200c}گابلین", "پادشاه پریان", "پری مرد"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["féetaud", "homme"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		#[cfg(feature = "is")]
		crate::Annotation { lang: "is", tts: Some("álfakarl"), keywords: &["álfakarl"] },
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		#[cfg(feature = "kk")]
		crate::Annotation { lang: "kk", tts: Some("ер пері"), keywords: &["ер пері"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
			tts:      Some("ទេវប\u{17bb}ត\u{17d2}រ"),
			keywords: &["ទេវប\u{17bb}ត\u{17d2}រ", "ផាក\u{17cb}", "អ\u{17bc}បេរ\u{17c9}\u{17bb}ន"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಪುರುಷ ಕಾಲ\u{ccd}ಪನ\u{cbf}ಕ"),
			keywords: &["ಒಬ\u{cc6}ರನ\u{ccd}", "ಪಕ\u{ccd}", "ಪುರುಷ ಕಾಲ\u{ccd}ಪನ\u{cbf}ಕ"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("남자 요정"), keywords: &["남자 요정"] },
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("दादलो परी"),
		...
		crate::Annotation {
			...
			keywords: &["ഒബ\u{d4d}റോൺ", "ഗന\u{d4d}ധർവ\u{d4d}വൻ", "പ\u{d41}ക\u{d4d}ക\u{d4d}"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["ଓବେରନ\u{b4d}\u{200d}", "ପ\u{b41}କ\u{b4d}\u{200d}", "ପ\u{b41}ର\u{b41}ଷ ପରୀ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1253"), keywords: &["E10-1253"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("мужчина-фея"),
			keywords: &["крылья", "мужчина", "мужчина-фея", "сказка", "фея", "фэнтези"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["ඔබෙරෝන\u{dca}", "පක\u{dca}", "ප\u{dd2}ර\u{dd2}ම\u{dd2} ස\u{dd4}රඟන"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		#[cfg(feature = "sl")]
		crate::Annotation { lang: "sl", tts: Some("vilinec"), keywords: &["vilinec"] },
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰብኣይ ጽንጽዋይ"),
			keywords: &["ሰብ", "ሰብኣይ", "ኦቤሮን", "ክንፊ", "ጽንጽዋይ", "ጽውጽዋይ", "ፍንጣጣ", "ፑክ", "ፒክሲ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Iwin ɔkùnrin"),
			keywords: &["Iwin ɔkùnrin", "Oberon", "Puck"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("男妖精"), keywords: &["男妖精"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("男仙子"),
...
pub const WOMAN_FAIRY: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ጠንቋይ ሴት"), keywords: &["ጠንቋይ ሴት"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation { lang: "ar", tts: Some("جن\u{651}ية"), keywords: &["جن\u{651}ية"] },
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
			tts:      Some("স\u{9c1}ন\u{9cd}দৰী পৰী"),
			keywords: &["ট\u{9be}ইটেনিয\u{9bc}\u{9be}", "পৰী", "স\u{9c1}ন\u{9cd}দৰী পৰী"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		#[cfg(feature = "de")]
		crate::Annotation { lang: "de", tts: Some("Fee"), keywords: &["Fee", "Titania"] },
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation {
			...
			keywords: &["Titania", "Τιτάνια", "γυναίκα νεράιδα"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["kona", "kvinna", "kvinnulig álva", "álva", "álvadrotning", "ævintýr"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation { lang: "fr", tts: Some("fée"), keywords: &["Titania", "fée"] },
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["femme", "fée"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			...
			keywords: &["Campaíña", "fada", "fada de sexo feminino", "fada madriña", "muller"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		#[cfg(feature = "hr")]
		crate::Annotation { lang: "hr", tts: Some("vila"), keywords: &["Kosjenka", "vila"] },
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("női tündér"),
		...
		#[cfg(feature = "is")]
		crate::Annotation { lang: "is", tts: Some("álfadís"), keywords: &["álfadís"] },
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("fata donna"),
		...
		#[cfg(feature = "jv")]
		crate::Annotation { lang: "jv", tts: Some("dewi"), keywords: &["Titania", "dewi"] },
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("ქალი ფერია"),
		...
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang: "kk", tts: Some("әйел пері"), keywords: &["әйел пері"]
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("여자 요정"), keywords: &["여자 요정"] },
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("बायल परी"),
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1252"), keywords: &["E10-1252"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("женщина-фея"),
			keywords: &["Динь-Динь", "Титания", "женщина-фея", "крылья", "сказка", "фея", "фэнтези"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		#[cfg(feature = "sk")]
		crate::Annotation { lang: "sk", tts: Some("víla"), keywords: &["rozprávka", "víla"] },
		#[cfg(feature = "sl")]
		crate::Annotation { lang: "sl", tts: Some("vila"), keywords: &["vila"] },
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["เทพธ\u{e34}ดา", "แฟร\u{e35}\u{e48}ผ\u{e39}\u{e49}หญ\u{e34}ง"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰበይቲ ጽንጽዋይ"),
			keywords: &["ሰበይቲ", "ሰብ", "ታይታንያ", "ክንፊ", "ጽንጽዋይ", "ጽውጽዋይ", "ፍንጣጣ", "ፒክሲ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("女妖精"), keywords: &["女妖精"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("女仙子"),
...
pub const VAMPIRE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang: "ps", tts: Some("بلا"), keywords: &["بلا", "نامړ", "ډریکولا"]
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
...
pub const MAN_VAMPIRE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang: "ar", tts: Some("مصاص دماء"), keywords: &["مصاص دماء"]
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["Dracula", "levende død", "mandlig vampyr"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["Dracula", "fear", "neamh-mharbh", "vaimpír", "vaimpír fhireann"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("男の吸血鬼"),
			keywords: &["ドラキュラ", "バンパイア", "吸血鬼", "男", "男の吸血鬼", "男性"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang: "kk", tts: Some("ер вампир"), keywords: &["ер вампир"]
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ಪುರುಷ ವ\u{ccd}ಯಾಂಪ\u{cc7}ರ\u{ccd}",
				"ಶವ",
			],
		},
		#[cfg(feature = "ko")]
		...
		crate::Annotation {
			...
			keywords: &["ड\u{94d}र\u{945}क\u{941}ला", "दादलो पिशाच\u{94d}च", "न मरपी"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["भ\u{942}त", "म\u{941}र\u{94d}कट\u{94d}टा", "म\u{943}त आत\u{94d}मा"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			...
			keywords: &["Drakúla", "Dẹ\u{301}d Pẹ\u{301}sin Wé De Dú Laik Sé I Dé Alaif", "Mán Vámpáya"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1255"), keywords: &["E10-1255"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("мужчина-вампир"),
			keywords: &["Дракула", "вампир", "граф", "зубы", "кровь", "мужчина", "мужчина-вампир"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["อมตะ", "แดร\u{e47}กค\u{e39}ล\u{e48}า", "แวมไพร\u{e4c}ผ\u{e39}\u{e49}ชาย"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰብኣይ ቫምፓየር"),
			keywords: &["ሃሎዊን", "ልዕለ ባህርያዊ", "መንካዕ", "ሰብኣይ", "ቫምፓየር", "ኣስናን", "ዘይሞተ", "ዘፍርሕ", "ደም"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Fánpáyà ɔkùnrin"),
			keywords: &["Dàràkúlà", "Fánpáyà ɔkùnrin", "àìkú"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("男吸血鬼"), keywords: &["男吸血鬼"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const WOMAN_VAMPIRE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["অম\u{9c3}ত\u{9cd}য\u{9c1}", "মহিল\u{9be} ভেম\u{9cd}প\u{9be}য\u{9bc}\u{9be}ৰ"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["আধমর\u{9be}", "মহিল\u{9be} ভ\u{9cd}য\u{9be}ম\u{9cd}প\u{9be}য\u{9bc}\u{9be}র"],
		},
		#[cfg(feature = "br")]
		crate::Annotation {
			lang:     "br",
		...
		crate::Annotation {
			...
			keywords: &["kvindelig vampyr", "levende død", "vampyr"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["bean", "neamh-mharbh", "vaimpír baineann", "vaimpír bhaineann"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang: "gu", tts: Some("મહિલા પિશાચ"), keywords: &["મહિલા પિશાચ"]
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("女の吸血鬼"),
			keywords: &["ドラキュラ", "バンパイア", "吸血鬼", "女", "女の吸血鬼", "女性"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang: "kk", tts: Some("әйел вампир"), keywords: &["әйел вампир"]
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &[
				"ಮಹ\u{cbf}ಳಾ ವ\u{ccd}ಯಾಂಪ\u{cc7}ರ\u{ccd}",
		...
		crate::Annotation {
			...
			keywords: &["जिव\u{902}त नसल\u{947}ला", "स\u{94d}त\u{94d}री व\u{94d}ह\u{901}पायर"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["ପ\u{b4d}ରେତ\u{b3e}ତ\u{b4d}ମ\u{b3e}", "ମହ\u{b3f}ଳ\u{b3e} ପ\u{b3f}ଶ\u{b3e}ଚ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		crate::Annotation {
			...
			keywords: &["Dẹ\u{301}d Pẹ\u{301}sin Wé De Dú Laik Sé I Dé Alaif", "Wúmán Vámpáya"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang: "ps", tts: Some("ښځه بلا"), keywords: &["نامړ", "ښځه بلا"]
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1254"), keywords: &["E10-1254"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("عورت ڀوت"), keywords: &["جن", "عورت ڀوت"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["ఆడ రక\u{c4d}తప\u{c3f}ప\u{c3e}స\u{c3f}", "మరణం ల\u{c47}న\u{c3f}ద\u{c3f}"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang:     "tg",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰበይቲ ቫምፓየር"),
			keywords: &["ሃሎዊን", "ልዕለ ባህርያዊ", "መንካዕ", "ሰበይቲ", "ቫምፓየር", "ኣስናን", "ዘይሞቱ", "ዘፍርሕ", "ደም"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("女吸血鬼"), keywords: &["女吸血鬼"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"dənizin altında",
				"folklor",
				"kişi cinsindən olan su pərisi",
				"okeanda yaşayan varlıqlar",
				"qadın cinsindən olan su pərisi",
				"sehrli nağıl",
				"su pərisi",
				"üçbaşlı əsa",
			],
		...
		crate::Annotation {
			lang:     "es",
			tts:      Some("persona sirena"),
			keywords: &["persona sirena", "sirena", "tritón"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("merenväki"),
			keywords: &["Ahti", "kalanpyrstö", "merenhaltija", "pyrstö", "vedenhaltija", "vetehinen"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		#[cfg(feature = "gl")]
		crate::Annotation { lang: "gl", tts: Some("serea"), keywords: &["serea"] },
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			...
			keywords: &[
				...
				"પરીઓની વાર\u{acd}તા",
				"પરીકથા",
				"મત\u{acd}સ\u{acd}યકન\u{acd}યા",
				"મત\u{acd}સ\u{acd}યપ\u{ac1}ર\u{ac1}ષ",
				"મત\u{acd}સ\u{acd}યસ\u{acd}ત\u{acd}રી",
				"મરપર\u{acd}સન",
				"સમ\u{ac1}દ\u{acd}રની અ\u{a82}દર",
			],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("בתולת ים"),
			keywords: &["בת הים", "בת ים", "בתולת ים", "ים"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			...
			keywords: &[
				"जलपरी",
				"पानी क\u{947} अ\u{902}दर",
				"प\u{941}र\u{941}ष मरम\u{947}ड",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("sellő"),
			keywords: &["hablegény", "hableány", "mese", "sellő", "szirén", "tündérmese", "óceán"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ಮ\u{ccb}ಹ\u{cbf}ನ\u{cbf}",
				"ಸಾಗರ ಜ\u{cc0}ವ\u{cbf}ಗಳು",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "mn",
			tts:      Some("лусын хүн"),
			keywords: &["лусын дагина", "лусын хүн", "лусын эмэгтэй", "лусын эрэгтэй"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		crate::Annotation {
			...
			tts:      Some("zeemeermin"),
			keywords: &[
				"drietand", "folklore", "meermin", "oceaan", "schepsel", "sirene", "sprookje", "zee",
			],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		...
		crate::Annotation {
			...
			keywords: &["Mamíwọtá", "Mán Mamíwọtá", "Pẹ\u{301}sin Wé Bi Mamíwọtá", "Wúmán Mamíwọtá"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("syrena"),
			keywords: &["Warszawa", "bajka", "baśń", "magia", "morze", "syrena", "syrenka", "tryton"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1133"), keywords: &["E10-1133"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("русалка"),
		...
		crate::Annotation {
			...
			keywords: &["madamusamaki", "mugabosamaki", "mukobwasamaki", "muntusamaki"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["gabareey-maanyo", "haweeney cajiib ah", "qof cajiib ah", "wiilo-maanyo"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			...
			keywords: &["бајка", "море", "океан", "сирена", "створење", "трозубац", "фолклор"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			...
			keywords: &["bajka", "folklor", "more", "okean", "sirena", "stvorenje", "trozubac"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			lang:     "sw",
			tts:      Some("nguva mtu"),
			keywords: &["nguva", "nguva dume", "nguva jike", "nguva kike", "nguva mtu"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		crate::Annotation {
			...
			keywords: &[
				"கடற\u{bcd}கன\u{bcd}னி",
				"கடல\u{bcd}",
				"கடல\u{bcd} உயிரினம\u{bcd}",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"మత\u{c4d}స\u{c4d}య పురుషుడు",
				"మర\u{c4d}ఉమన\u{c4d}",
				"మర\u{c4d}మన\u{c4d}",
				"మర\u{c4d}మ\u{c46}య\u{c3f}డ\u{c4d}",
				"సముద\u{c4d}ర జ\u{c40}వులు",
				"స\u{c3e}గర కన\u{c4d}య",
			],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &[
				"คร\u{e36}\u{e48}งคนคร\u{e36}\u{e48}งปลา",
				"ทะเล",
				"นางเง\u{e37}อก",
				"ประหลาด",
				"มหาสม\u{e38}ทร",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰብ ዓሳ"),
			keywords: &["ሰብ ዓሳ", "ሳይረን", "ስሉስ መንኮርኮር", "ባሕሪ", "ውቅያኖስ", "ጽውጽዋይ", "ፍጡር", "ፎክሎር"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["ika", "meimeite", "tokotaha meimeite"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			...
			keywords: &["جل دیو", "جل پری", "جلدیوی", "سمندری مخلوق", "پانی کے جاندار", "پریوں کی کہانی"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			...
			keywords: &["sireen", "sireen bu góor", "sireen bu jigéen", "sireen bu nit"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Yemɔja ènìyàn"),
			keywords: &["Yemɔja", "Yemɔja ènìyàn"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("人魚"),
			keywords: &["三叉戟", "人魚", "傳說", "塞壬", "海中", "海底", "童話", "美人魚", "龍宮"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["ariel", "人魚", "海底生物", "童話", "美人魚"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const MERMAN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("morgan"), keywords: &["morgan"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("mořský muž"),
			keywords: &["mořský", "mořský muž", "nymfa", "panic", "poseidón", "tritón"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation { lang: "cy", tts: Some("morwas"), keywords: &["Triton", "morwas"] },
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("havmand"),
		...
		#[cfg(feature = "fr")]
		crate::Annotation { lang: "fr", tts: Some("triton"), keywords: &["Triton"] },
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["triton"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("murúch fir"),
		...
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang: "gu", tts: Some("મરમ\u{ac7}ન"), keywords: &["મરમ\u{ac7}ન"]
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		#[cfg(feature = "he")]
		crate::Annotation {
			lang: "he", tts: Some("בן ים"), keywords: &["בן ים", "טריטון"]
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("남자 인어"), keywords: &["남자 인어"] },
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang: "mk", tts: Some("маж сирена"), keywords: &["маж сирена"]
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("merman"), keywords: &["Triton", "merman"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
			tts:      Some("ရေသ\u{1030}ထ\u{102e}း"),
			keywords: &["ထရ\u{103d}\u{102d}င\u{103a}တ\u{103d}န\u{103a}", "ရေသ\u{1030}ထ\u{102e}း"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			...
			keywords: &["ଟ\u{b4d}ର\u{b3e}ଇଟନ\u{b4d}\u{200d}", "ମରମ\u{b4d}ୟ\u{b3e}ନ\u{b4d}"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		crate::Annotation {
			...
			keywords: &["Mán Mamíwọtá", "Trítọn: Wọ\u{301}n Bád Spírit Wé De Lív Fọ Wọta"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang: "ps", tts: Some("مرمین"), keywords: &["مرمین", "ټريټان"]
		},
		#[cfg(feature = "pt")]
		crate::Annotation { lang: "pt", tts: Some("sereio"), keywords: &["Tritão", "sereio"] },
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("tritão (homem)"),
			keywords: &["tritão", "tritão (homem)"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1257"), keywords: &["E10-1257"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("тритон"),
		...
		#[cfg(feature = "tr")]
		crate::Annotation { lang: "tr", tts: Some("balık adam"), keywords: &["balık adam"] },
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
			tts:      Some("بېلىق ئەر"),
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Yemɔja ɔkùnrin"),
			keywords: &["Triton", "Yemɔja ɔkùnrin"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh")]
		crate::Annotation { lang: "zh", tts: Some("男人鱼"), keywords: &["特里同", "男人鱼"] },
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("男人魚"), keywords: &["男人魚"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const MERMAID: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		#[cfg(feature = "af")]
		crate::Annotation { lang: "af", tts: Some("meermin"), keywords: &["meermin"] },
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("morganez"), keywords: &["morganez"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation { lang: "en_IN", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es")]
		crate::Annotation { lang: "es", tts: Some("sirena"), keywords: &["sirena"] },
		#[cfg(feature = "es_419")]
		crate::Annotation { lang: "es_419", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		...
		#[cfg(feature = "eu")]
		crate::Annotation { lang: "eu", tts: Some("lamina"), keywords: &["lamina", "sirena"] },
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("پری دریایی"),
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("merenneito"),
			keywords: &["kalanpyrstö", "merenneito", "merenväki", "pyrstö", "seireeni", "vedenväki"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		#[cfg(feature = "fo")]
		crate::Annotation { lang: "fo", tts: Some("havfrúgv"), keywords: &["havfrúgv"] },
		#[cfg(feature = "fr")]
		crate::Annotation { lang: "fr", tts: Some("sirène"), keywords: &["sirène"] },
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation { lang: "ga", tts: Some("murúch"), keywords: &["bean", "murúch"] },
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("maighdeann-mhara"),
			keywords: &["maighdeann-chuain", "maighdeann-mhara", "sluagh-mara", "òigh-mhara"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &["मत\u{94d}स\u{94d}यकन\u{94d}या", "मत\u{94d}स\u{94d}यस\u{94d}त\u{94d}री"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang: "kk", tts: Some("су перісі"), keywords: &["су перісі"]
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &["ಮತ\u{ccd}ಸ\u{ccd}ಯ ಕನ\u{ccd}ಯ\u{cc6}", "ಮತ\u{ccd}ಸ\u{ccd}ಯ ಮಹ\u{cbf}ಳ\u{cc6}"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("여자 인어"), keywords: &["여자 인어"] },
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("मत\u{94d}स\u{94d}यकन\u{94d}या"),
		...
		#[cfg(feature = "lt")]
		crate::Annotation { lang: "lt", tts: Some("undinėlė"), keywords: &["undinėlė"] },
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("nāra"),
		...
		crate::Annotation {
			...
			keywords: &["മത\u{d4d}സ\u{d4d}യകന\u{d4d}യക", "മത\u{d4d}സ\u{d4d}യസ\u{d4d}\u{200c}ത\u{d4d}രീ"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["ရေသ\u{1030}မ", "ရေသ\u{1030}မ (အမျ\u{102d}\u{102f}းသမ\u{102e}း)"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang: "pa", tts: Some("ਜਲਪਰੀ"), keywords: &["ਜਲ ਔਰਤ", "ਜਲਪਰੀ"]
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("مرمیډ"), keywords: &["مرمیڈ"] },
		#[cfg(feature = "pt")]
		crate::Annotation { lang: "pt", tts: Some("sereia"), keywords: &["sereia"] },
		#[cfg(feature = "pt_PT")]
		crate::Annotation { lang: "pt_PT", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "qu")]
		crate::Annotation {
		...
		#[cfg(feature = "ro")]
		crate::Annotation { lang: "ro", tts: Some("sirenă"), keywords: &["sirenă"] },
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1256"), keywords: &["E10-1256"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		#[cfg(feature = "sd")]
		crate::Annotation { lang: "sd", tts: Some("جل پري"), keywords: &["جل پري"] },
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
			tts:      Some("ද\u{dd2}යක\u{dd2}ඳ\u{dd4}ර\u{dcf}"),
			keywords: &["ද\u{dd2}යක\u{dd2}ඳ\u{dd4}ර\u{dcf}", "ද\u{dd2}යක\u{dd2}ඳ\u{dd4}ර\u{dd2}ය"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			...
			keywords: &["கடல\u{bcd}கன\u{bcd}னி", "கடல\u{bcd}மனிதன\u{bcd}", "பெண\u{bcd}"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
		...
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang: "tg", tts: Some("парии обӣ"), keywords: &["парии обӣ"]
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang: "th", tts: Some("เง\u{e37}อก"), keywords: &["เง\u{e37}อก"]
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰብይቲ ዓሳ"),
			keywords: &["መርመይድ", "ሰብይቲ ዓሳ", "ሳይረን", "ስሉስ መንኮርኮር", "ባሕሪ", "ውቅያኖስ", "ጽውጽዋይ", "ፍጡር", "ፎክሎር"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["ayol", "ayol suv parisi", "suv parisi", "yarim ayol", "yarim baliq"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("iyemɔja"),
			keywords: &["Yemɔja obìnrin", "iyemɔja"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh")]
		crate::Annotation { lang: "zh", tts: Some("美人鱼"), keywords: &["女人鱼", "美人鱼"] },
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("美人魚"), keywords: &["美人魚"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const ELF: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "cy")]
		crate::Annotation { lang: "cy", tts: Some("coblyn"), keywords: &["coblyn", "hudol"] },
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("elver"),
		...
		crate::Annotation {
			lang:     "it",
			tts:      Some("elfo"),
			keywords: &["creatura", "elfetto", "elfo", "fantasy", "fiaba", "folclore", "magia", "magico"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang: "ky", tts: Some("эльф"), keywords: &["сыйкырдуу", "эльф"]
		},
		#[cfg(feature = "lb")]
		...
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang: "tg", tts: Some("пакана"), keywords: &["пакана", "соҳирӣ"]
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("小精靈"), keywords: &["小精靈", "神奇"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("小精灵"),
...
pub const MAN_ELF: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ወንድ ኤልፍ"), keywords: &["ወንድ ኤልፍ"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("جن\u{651}ي صغير ذكر"),
			keywords: &["جن\u{651}ي صغير ذكر", "ذكر إلف", "ذكر إيلف", "كائن سحري", "مخلوق سحري"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("elf"), keywords: &["elf"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("mieshaltia"),
			keywords: &["Legolas", "alf", "haltia", "keiju", "mieshaltia", "suippokorva"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		#[cfg(feature = "is")]
		crate::Annotation { lang: "is", tts: Some("huldukarl"), keywords: &["huldukarl"] },
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("elfo uomo"),
		...
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("남자 엘프"), keywords: &["남자 엘프"] },
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("वनद\u{947}व"),
		...
		crate::Annotation {
			...
			keywords: &["ပယောဂဆန\u{103a}သော", "အမျ\u{102d}\u{102f}းသား နတ\u{103a}သ\u{1030}ငယ\u{103a}"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
			tts:      Some("सानो छोरोमान\u{94d}छ\u{947}को स\u{94d}वर\u{941}प भएको जीव"),
			keywords: &["जाद\u{941}मय", "सानो छोरोमान\u{94d}छ\u{947}को स\u{94d}वर\u{941}प भएको जीव"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1259"), keywords: &["E10-1259"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("мужчина-эльф"),
			keywords: &["магия", "мужчина", "мужчина-эльф", "сказка", "уши", "фэнтези", "эльф"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["ප\u{dd2}ර\u{dd2}ම\u{dd2} එල\u{dca}ෆ\u{dca}", "ම\u{dcf}ය\u{dcf}ව\u{dd3}"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation { lang: "sk", tts: Some("elf"), keywords: &["elf", "fantasy"] },
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("škrat"),
		...
		crate::Annotation {
			...
			keywords: &["మ\u{c3e}ంత\u{c4d}ర\u{c3f}క", "మ\u{c3e}ంత\u{c4d}ర\u{c3f}కుడు"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang:     "tg",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰብ ኤልፍ"),
			keywords: &["ማጂክ", "ምድንጋር", "ሰብኣይ", "ስሕበት ዘለዎ", "ኤልፋት", "ኤልፍ", "ፅውፅዋይ", "ፍንጣጣ", "ፎክሎር"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("egbére ɔkùnrin"),
			keywords: &["egbére ɔkùnrin", "ìdán"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("男精靈"), keywords: &["男精靈", "神奇"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("男精灵"),
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("男精靈"), keywords: &["男精靈"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const WOMAN_ELF: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ሴት ኤልፍ"), keywords: &["ሴት ኤልፍ"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("جني\u{651}ة صغيرة"),
			keywords: &["أنثى إلف", "أنثى إيلف", "جني\u{651}ة صغيرة", "كائن سحري", "مخلوقة سحرية"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("elfez"), keywords: &["elfez"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("haltiatar"),
			keywords: &["Galadriel", "alf", "haltia", "haltiatar", "keiju", "suippokorva"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		#[cfg(feature = "is")]
		crate::Annotation { lang: "is", tts: Some("huldukona"), keywords: &["huldukona"] },
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("elfo donna"),
		...
		crate::Annotation {
			...
			keywords: &["ಮಹ\u{cbf}ಳ\u{cc6} ಯಕ\u{ccd}ಷ\u{cbf}ಣ\u{cbf}", "ಮಾಂತ\u{ccd}ರ\u{cbf}ಕ"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("여자 엘프"), keywords: &["여자 엘프"] },
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		#[cfg(feature = "lt")]
		crate::Annotation { lang: "lt", tts: Some("elfė"), keywords: &["elfė", "magiška"] },
		#[cfg(feature = "lv")]
		crate::Annotation { lang: "lv", tts: Some("elfa"), keywords: &["elfa", "maģiska"] },
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["जाद\u{941}मय", "सानो छोरीमान\u{94d}छ\u{947}को स\u{94d}वर\u{941}प भएको जीव"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1258"), keywords: &["E10-1258"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["ඉන\u{dca}ද\u{dca}රජ\u{dcf}ල\u{dd2}ක", "ගෑන\u{dd4} එල\u{dca}ෆ\u{dca}"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation { lang: "sk", tts: Some("elfka"), keywords: &["elfka", "fantasy"] },
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("škratovka"),
		...
		crate::Annotation {
			...
			keywords: &["మ\u{c3e}ంత\u{c4d}ర\u{c3f}క", "మ\u{c3e}ంత\u{c4d}ర\u{c3f}కుర\u{c3e}లు"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang:     "tg",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰበይቲ ኤልፍ"),
			keywords: &["ማጂክ", "ምድንጋር", "ሰበይቲ", "ስሕበት ዘለዎ", "ኤልፋት", "ኤልፍ", "ጽውጽዋይ", "ፍንጣጣ", "ፎክሎር"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("女精靈"), keywords: &["女精靈", "神奇"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("女精灵"),
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("女精靈"), keywords: &["女精靈"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const GENIE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("ጅኒ"),
			keywords: &["ምስጢራዊ", "ምኞቶች", "አፈታሪካዊ", "የሕልም ዓለም", "የሰው ጅኒ", "ጂን", "ጅኒ", "ጋኔን", "ፋኖሱን መፈግፈግ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		#[cfg(feature = "as")]
		crate::Annotation {
			lang: "as", tts: Some("জিন"), keywords: &["জিন", "প\u{9cd}ৰেত"]
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		#[cfg(feature = "be")]
		crate::Annotation { lang: "be", tts: Some("джын"), keywords: &["джын"] },
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("женски джин"),
			keywords: &["джин", "дух", "желание", "женски джин", "мистично", "потъркай лампата"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
			tts:      Some("জীনি"),
			keywords: &[
				"আশ\u{9cd}চর\u{9cd}য প\u{9cd}রদীপ",
				"জিনি",
				"জীনি",
				"জ\u{9cd}বিন",
				"জ\u{9cd}বীন জ\u{9be}তি",
				"প\u{9cd}রদীপ ঘষ\u{9be}",
				"র\u{9c2}পকথ\u{9be}",
			],
		},
		#[cfg(feature = "bs")]
		...
		#[cfg(feature = "chr")]
		crate::Annotation { lang: "chr", tts: Some("ᏥᎾᏱ"), keywords: &["ᏥᎾᏱ", "ᏥᏂ"] },
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		#[cfg(feature = "cy")]
		crate::Annotation { lang: "cy", tts: Some("genie"), keywords: &["djinn", "genie"] },
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("magisk ånd"),
		...
		crate::Annotation {
			lang:     "el",
			tts:      Some("τζίνι"),
			keywords: &["ευχές", "λυχνάρι", "μυθικός", "μύθος", "παραμύθι", "τζίνι", "φαντασία"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation { lang: "en_IN", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es")]
		crate::Annotation { lang: "es", tts: Some("genio"), keywords: &["genio", "lámpara"] },
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["deseos", "frotar la lámpara", "genio", "lámpara", "magia", "pedir deseos"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			lang:     "et",
			tts:      Some("džinn"),
			keywords: &["džinn", "fantaasia", "hõõruma", "lamp", "müstiline", "müütiline", "soovid"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation { lang: "eu", tts: Some("iratxo"), keywords: &["djinn", "iratxo"] },
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("جن"),
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("genie"),
			keywords: &["djinn", "genie", "kahilingan", "mistikal", "pantasya", "taong genie"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation { lang: "fo", tts: Some("andi"), keywords: &["andi", "ævintýr"] },
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("génie"),
		...
		#[cfg(feature = "gl")]
		crate::Annotation { lang: "gl", tts: Some("xenio"), keywords: &["desexos", "xenio"] },
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			tts:      Some("જીની"),
			keywords: &[
				...
				"જીન",
				"જીની",
				"દ\u{a82}તકથાન\u{ac7} લગત\u{ac1}\u{a82}",
				"પિશાચ",
				"રહસ\u{acd}યમય",
				"રાક\u{acd}ષસ",
			],
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("שד"),
			keywords: &["ג׳ין", "ג׳יני", "משאלה", "משאלות", "שד", "שדון"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		#[cfg(feature = "hy")]
		crate::Annotation { lang: "hy", tts: Some("ջին"), keywords: &["հեքիաթ", "ջին"] },
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("jin"),
		...
		#[cfg(feature = "is")]
		crate::Annotation { lang: "is", tts: Some("andi"), keywords: &["andi", "djinn"] },
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("genio"),
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("精霊"),
			keywords: &["ジニー", "ファンタジー", "ランプをこする", "不可思議", "神話", "精霊", "魔人"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang: "ka", tts: Some("ჯინი"), keywords: &["ლამპარი", "ჯინი"]
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಜ\u{cbf}ನ\u{cc0}"),
			keywords: &[
				"ಕಲ\u{ccd}ಪನಾತ\u{cc0}ತ",
				"ಜ\u{cbf}ಂಜನ\u{ccd}",
				"ಜ\u{cbf}ನ\u{cc0}",
				"ಜ\u{cbf}ನ\u{cc0} ವ\u{ccd}ಯಕ\u{ccd}ತ\u{cbf}",
				"ಜ\u{cbf}ನ\u{ccd}",
				"ದ\u{cc0}ಪವನ\u{ccd}ನು ಉಜ\u{ccd}ಜ\u{cbf}",
				"ಫ\u{ccd}ಯಾಂಟಸ\u{cbf}",
				"ವರಗಳನ\u{ccd}ನು ಪಡ\u{cc6}",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("지니"),
			keywords: &["램프 문지르기", "소원", "정령", "지니", "판타지"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("जिनी"),
			keywords: &["इत\u{94d}सा मागप", "घा\u{902}सप", "जिनी", "जीन", "द\u{902}तकथा", "दिवो", "नवल"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation { lang: "ky", tts: Some("жин"), keywords: &["жин"] },
		#[cfg(feature = "lb")]
		crate::Annotation { lang: "lb", tts: Some("Genie"), keywords: &["Djinn", "Genie"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
			tts:      Some("ຈ\u{eb4}ນ\u{eb5}\u{ec8}"),
			keywords: &[
				"ຈ\u{eb4}ນ\u{eb5}\u{ec8}",
				"ດ\u{eb5}ຈ\u{eb4}ນ",
				"ຕະກຽງວ\u{eb4}ເສດ",
				"ພອນ",
				"ລ\u{eb9}ບຕະກຽງ",
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("džins"),
			keywords: &["burvis", "džins", "pasaka", "vēlēties vēlēšanos", "vēlēšanās"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation { lang: "mi", tts: Some("tūrehu"), keywords: &["djinn", "tūrehu"] },
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("џини"),
		...
		crate::Annotation {
			...
			keywords: &[
				"അത\u{d4d}ഭ\u{d41}തവിളക\u{d4d}ക\u{d4d}",
				"അറബിക\u{d4d}കഥ",
				"ക\u{d41}ടത\u{d4d}തിലെ ഭ\u{d42}തം",
				"ജിന\u{d4d}ന\u{d4d}",
				"ജീനി",
			],
		},
		#[cfg(feature = "mn")]
		crate::Annotation { lang: "mn", tts: Some("жини"), keywords: &["Жин", "жини"] },
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			tts:      Some("जिनी"),
			keywords: &[
				"इच\u{94d}छाप\u{942}र\u{94d}ती",
				"जिनी",
				"जिन\u{94d}न",
				"जीनी",
				"दिव\u{94d}यातला राक\u{94d}षस",
			],
		},
		#[cfg(feature = "ms")]
		crate::Annotation { lang: "ms", tts: Some("jin"), keywords: &["jin"] },
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("ġenju"), keywords: &["djinn", "ġenju"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਜਿ\u{a70}ਨ"),
			keywords: &["ਇ\u{a71}ਛਾ", "ਕਲਪਨਾ", "ਚਿਰਾਗ ਦਾ ਜਿ\u{a70}ਨ", "ਜਿਨੀ", "ਜਿ\u{a70}ਨ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			lang:     "pl",
			tts:      Some("dżin"),
			keywords: &["Aladyn", "Alladyn", "bajka", "baśń", "dżin", "lampa", "życzenie"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("جینی"), keywords: &["جين", "جینی"] },
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("gênio"),
			keywords: &["desejos", "fantasia", "gênio", "gênio da lâmpada", "lâmpada mágica", "místico"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "ro")]
		crate::Annotation { lang: "ro", tts: Some("duh"), keywords: &["djinn", "duh"] },
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1135"), keywords: &["E10-1135"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("джинн"),
		...
		#[cfg(feature = "rw")]
		crate::Annotation { lang: "rw", tts: Some("igini"), keywords: &["igini", "ijini"] },
		#[cfg(feature = "sd")]
		crate::Annotation { lang: "sd", tts: Some("جن"), keywords: &["جن"] },
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("džin"),
			keywords: &["aladin", "džin", "fľaša", "kúzelný lampáš", "kúzlo", "lampa"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			lang:     "sq",
			tts:      Some("xhind"),
			keywords: &["dëshira", "fantazi", "fërkoj llambën", "mistik", "mitik", "xhind"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("добри дух"),
			keywords: &["дух", "жеље", "лампа", "мит", "протрљати", "фантазија"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("dobri duh"),
			keywords: &["duh", "fantazija", "lampa", "mit", "protrljati", "želje"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
			tts:      Some("ande"),
			keywords: &["ande", "anden i flaskan", "djinn"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation { lang: "sw", tts: Some("jini"), keywords: &["jini", "pepo jini"] },
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		crate::Annotation {
			...
			tts:      Some("ஜ\u{bc0}னி"),
			keywords: &[
				"அல\u{bbe}வுத\u{bc0}ன\u{bcd}",
				"அல\u{bbe}வுத\u{bc0}ன\u{bcd} பூதம\u{bcd}",
				"ஜ\u{bc0}னி",
				"டிஜின\u{bcd}",
				"நபர\u{bcd} ஜ\u{bc0}னி",
				"விளக\u{bcd}கு",
			],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			...
			keywords: &[
				"అధ\u{c4d}భుత ద\u{c40}పం",
				"క\u{c4b}ర\u{c3f}కలు",
				"జ\u{c3f}న\u{c40}",
				"జ\u{c3f}న\u{c4d}",
				"జ\u{c40}న\u{c40}",
				"ద\u{c40}ప\u{c3e}న\u{c4d}న\u{c3f} రుద\u{c4d}దు",
				"ప\u{c4c}ర\u{c3e}ణ\u{c3f}కం",
				"ఫ\u{c3e}ంటస\u{c40}",
				"మ\u{c3e}యగ\u{c3e}డు",
				"మ\u{c3f}థ\u{c3f}కల\u{c4d}",
			],
		},
		#[cfg(feature = "tg")]
		crate::Annotation { lang: "tg", tts: Some("ҷин"), keywords: &["ҷин"] },
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
			...
			keywords: &[
				"ขอพร",
				"จ\u{e34}นน\u{e35}\u{e48}",
				"จ\u{e35}น\u{e35}\u{e48}",
				"ตะเก\u{e35}ยง",
				"ถ\u{e39}",
				"ย\u{e31}กษ\u{e4c}",
				"แฟนตาซ\u{e35}",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ጂኒ"),
			keywords: &["ላምባ", "ምሕኻኽ", "ትምኒቱ", "ድጂን", "ጂን", "ጽውጽዋይ", "ፍንጣጣ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("faʻahikehe"), keywords: &["faʻahikehe"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("cin"),
		...
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang: "ug", tts: Some("شاياتۇن"), keywords: &["جىن", "شاياتۇن"]
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("джин"),
			keywords: &["бажання", "джин", "казкова лампа", "міфічний", "примха", "чарівна лампа"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("jinne"), keywords: &["jinne"] },
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
			tts:      Some("i-genie"),
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Ànjɔ\u{300}nnú"),
			keywords: &["Ànjɔ\u{300}nnú", "Ànjɔ\u{300}nnú arabia"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("精靈"), keywords: &["傑尼", "精靈"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("燈神"),
			keywords: &["燈神", "神燈", "精靈", "許願", "許願燈", "阿拉丁神燈"],
		},
		#[cfg(feature = "zu")]
...
pub const MAN_GENIE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ወንድ ጅኒ"), keywords: &["ወንድ ጅኒ"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation { lang: "ar", tts: Some("مارد"), keywords: &["مارد"] },
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["lampeånd", "magi", "mand", "mandlig magisk ånd"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		#[cfg(feature = "kk")]
		crate::Annotation { lang: "kk", tts: Some("ер жын"), keywords: &["ер жын"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಪುರುಷ ಜ\u{cbf}ನ\u{cc0}"),
			keywords: &["ಜ\u{cbf}ನ\u{cc0}", "ಪುರುಷ ಜ\u{cbf}ನ\u{cc0}"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		#[cfg(feature = "lt")]
		crate::Annotation { lang: "lt", tts: Some("džinas"), keywords: &["džinas"] },
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["अलौ\u{902}किक शक\u{94d}ति भएको छोरामान\u{94d}छ\u{947}", "जिन"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		#[cfg(feature = "pt")]
		crate::Annotation { lang: "pt", tts: Some("homem gênio"), keywords: &["homem gênio"] },
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1261"), keywords: &["E10-1261"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("мужчина-джинн"),
			keywords: &["джинн", "лампа", "мужчина", "мужчина-джинн", "потереть", "сказка"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		#[cfg(feature = "sd")]
		crate::Annotation { lang: "sd", tts: Some("مرد جن"), keywords: &["جن", "مرد جن"] },
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
			tts:      Some("ප\u{dd2}ර\u{dd2}ම\u{dd2} බහ\u{dd2}රවය\u{dcf}"),
			keywords: &["ජ\u{dd2}න\u{dca}", "ප\u{dd2}ර\u{dd2}ම\u{dd2} බහ\u{dd2}රවය\u{dcf}"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰብ ጂን"),
			keywords: &["ላምባ", "ምሕኻኽ", "ሰብኣይ", "ትምኒቱ", "ድጂን", "ጂን", "ጽውጽዋይ", "ፍንጣጣ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang: "ug", tts: Some("ئەر جىن"), keywords: &["ئەر جىن", "جىن"]
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		#[cfg(feature = "ur")]
		crate::Annotation { lang: "ur", tts: Some("مرد جن"), keywords: &["جن", "مرد جن"] },
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("erkak jin"),
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Ànjɔ\u{300}nnú ɔkùnrin"),
			keywords: &["Ànjɔ\u{300}nnú arabia", "Ànjɔ\u{300}nnú ɔkùnrin"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh")]
		crate::Annotation { lang: "zh", tts: Some("男妖怪"), keywords: &["男妖怪", "男神灵"] },
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("藍精靈"), keywords: &["藍精靈"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("男燈神"),
...
pub const WOMAN_GENIE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation { lang: "am", tts: Some("ሴት ጅኒ"), keywords: &["ሴት ጅኒ"] },
		#[cfg(feature = "ar")]
		crate::Annotation { lang: "ar", tts: Some("ماردة"), keywords: &["ماردة"] },
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang: "chr", tts: Some("ᎠᎨᏯ ᏥᎾᏱ"), keywords: &["ᎠᎨᏯ ᏥᎾᏱ", "ᏥᏂ"]
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["kvinde", "kvindelig magisk ånd", "lampeånd", "magi"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		#[cfg(feature = "kk")]
		crate::Annotation { lang: "kk", tts: Some("әйел жын"), keywords: &["әйел жын"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಮಹ\u{cbf}ಳ\u{cc6} ಜ\u{cbf}ನ\u{cc0}"),
			keywords: &["ಜ\u{cbf}ಂಜನ\u{ccd}", "ಮಹ\u{cbf}ಳ\u{cc6} ಜ\u{cbf}ನ\u{cc0}"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		#[cfg(feature = "lt")]
		crate::Annotation { lang: "lt", tts: Some("džinė"), keywords: &["džinė"] },
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["अलौ\u{902}किक शक\u{94d}ति भएकी छोरीमान\u{94d}छ\u{947}", "जिन"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1260"), keywords: &["E10-1260"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("женщина-джинн"),
			keywords: &["джинн", "женщина", "женщина-джинн", "лампа", "потереть", "сказка"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("عورت جن"), keywords: &["جن", "عورت جن"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["జ\u{c3f}న\u{c4d}", "స\u{c4d}త\u{c4d}ర\u{c40} జ\u{c3f}న\u{c40}"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang:     "tg",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰበይቲ ጂን"),
			keywords: &["ላምባ", "ምሕኻኽ", "ሰበይቲ", "ትምኒት", "ድጂን", "ጂን", "ጽውጽዋይ", "ፍንጣጣ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang: "ur", tts: Some("عورت جن"), keywords: &["جن", "عورت جن"]
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Ànjɔ\u{300}nnú obìnrin"),
			keywords: &["Ànjɔ\u{300}nnú arabia", "Ànjɔ\u{300}nnú obìnrin"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh")]
		crate::Annotation { lang: "zh", tts: Some("女妖怪"), keywords: &["女妖怪", "女神灵"] },
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("女藍精靈"), keywords: &["女藍精靈"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("女燈神"),
...
pub const MAN_ZOMBIE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ወንድ ዞምቢ"), keywords: &["ወንድ ዞምቢ"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang: "ar", tts: Some("رجل زومبي"), keywords: &["رجل زومبي"]
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
			tts:      Some("প\u{9c1}ৰ\u{9c1}ষ জম\u{9cd}বি"),
			keywords: &["অম\u{9c3}ত\u{9cd}য\u{9c1}", "প\u{9c1}ৰ\u{9c1}ষ জম\u{9cd}বি", "ৱ\u{9be}কিং ডেড"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["আধমর\u{9be}", "ওয\u{9bc}\u{9be}কিং ডেড", "প\u{9c1}র\u{9c1}ষ জম\u{9cd}বি"],
		},
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("zombi"), keywords: &["zombi"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["levende død", "mand", "mandlig zombie"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("Zombiemann"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation {
			lang:     "el",
		...
		crate::Annotation {
			...
			keywords: &["mannligur sombi", "maður", "sombi", "uppvakningur", "zombie"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			...
			keywords: &["Walking Dead", "home", "non-morto", "zombi de sexo masculino"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			...
			keywords: &["akụkọ mmụọ", "ndị nwụrụ anwụ na-aga ije", "nwoke nwụrụ anwụ na-aga ije"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("karlkyns uppvakningur"),
			keywords: &["hinir gangandi dauðu", "hinir ódauðlegu", "karlkyns uppvakningur"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("argaz aẓumbi"),
			keywords: &["argaz aẓumbi"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation { lang: "kk", tts: Some("ер зомби"), keywords: &["ер зомби"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಪುರುಷ ಜ\u{cca}ಂಬ\u{cbf}"),
			keywords: &["ನಡ\u{cc6}ದಾಡುವ ಶವ", "ಪುರುಷ ಜ\u{cca}ಂಬ\u{cbf}", "ಶವ"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		crate::Annotation {
			...
			keywords: &["ຊອມບ\u{eb5}\u{ec9}ຜ\u{eb9}\u{ec9}ຊາຍ", "ຜ\u{eb5}ດ\u{eb4}ບ", "ວອກຄ\u{eb4}ງເດດ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["nemirstīgs", "staigājošais mironis", "vīrietis zombijs", "zombijvīrietis"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["അൺഡെഡ\u{d4d}", "ആൺ വേത\u{d3e}ളം", "വ\u{d3e}ക\u{d4d}കിംഗ\u{d4d} ഡെഡ\u{d4d}"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1263"), keywords: &["E10-1263"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("мужчина-зомби"),
			keywords: &["живой", "живой метрвец", "зомби", "мертвец", "мужчина", "мужчина-зомби"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["ஆண\u{bcd} ஜோம\u{bcd}பி", "ச\u{bbe}க\u{bbe}வரம\u{bcd} பெற\u{bcd}றது"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰብኣይ ዞምቢ"),
			keywords: &["ሃሎዊን", "ሞይቱ", "ራዕዲ", "ሰብኣይ", "ብእግሪ ምጉዓዝ", "ኣፖካሊፕስ", "ዘይሞቱ", "ዘፍርሕ", "ዞምቢ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Ɛbɔra ɔkùnrin"),
			keywords: &["Àìlèkú", "àkúdáàyà", "Ɛbɔra ɔkùnrin"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("男殭屍"), keywords: &["男殭屍"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("男喪屍"),
...
pub const WOMAN_ZOMBIE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ሴት ዞምቢ"), keywords: &["ሴት ዞምቢ"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang: "ar", tts: Some("امرأة زومبي"), keywords: &["امرأة زومبي"]
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
			tts:      Some("মহিল\u{9be} জম\u{9cd}বি"),
			keywords: &["অম\u{9c3}ত\u{9cd}য\u{9c1}", "মহিল\u{9be} জম\u{9cd}বি", "ৱ\u{9be}কিং ডেড"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			lang:     "bn",
			tts:      Some("মহিল\u{9be} জম\u{9cd}বি"),
			keywords: &["আধমর\u{9be}", "ওয\u{9bc}\u{9be}কিং ডেড", "মহিল\u{9be} জম\u{9cd}বি"],
		},
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("zombiez"), keywords: &["zombiez"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("žena zombi"),
		...
		crate::Annotation {
			...
			keywords: &["kona", "kvinna", "kvinnuligur sombi", "sombi", "uppvakna", "zombie"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			...
			keywords: &["Walking Dead", "muller", "non-morta", "zombi de sexo feminino"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			...
			keywords: &["मर कर भी जीवित", "महिला ज\u{93c}ॉम\u{94d}बी", "वॉकि\u{902}ग ड\u{947}ड"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			...
			keywords: &["akụkọ mmụọ", "ndị nwụrụ anwụ na-aga ije", "nwanyị nwụrụ anwụ na-aga ije"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("kvenkyns uppvakningur"),
			keywords: &["hinir gangandi dauðu", "hinir ódauðlegu", "kvenkyns uppvakningur"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("tameṭṭut taẓumbit"),
			keywords: &["tameṭṭut taẓumbit"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang: "kk", tts: Some("әйел зомби"), keywords: &["әйел зомби"]
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಮಹ\u{cbf}ಳ\u{cc6} ಜ\u{cca}ಂಬ\u{cbf}"),
			keywords: &["ನಡ\u{cc6}ದಾಡುವ ಶವ", "ಮಹ\u{cbf}ಳ\u{cc6} ಜ\u{cca}ಂಬ\u{cbf}", "ಶವ"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		crate::Annotation {
			...
			keywords: &["ຊອມບ\u{eb5}\u{ec9}ຍ\u{eb4}ງ", "ຜ\u{eb5}ດ\u{eb4}ບ", "ວອກຄ\u{eb4}ງເດດ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["nemirstīgs", "sieviete zombijs", "staigājošais mironis", "zombijsieviete"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["അൺഡെഡ\u{d4d}", "പെൺ വേത\u{d3e}ളം", "വ\u{d3e}ക\u{d4d}കിംഗ\u{d4d} ഡെഡ\u{d4d}"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["ਔਰਤ ਜ\u{a3c}\u{a4c}\u{a02}ਬੀ", "ਜੀਉ\u{a02}ਦਾ", "ਤ\u{a41}ਰਦਾ ਮਰਿਆ ਆਦਮੀ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1262"), keywords: &["E10-1262"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["ச\u{bbe}க\u{bbe}வரம\u{bcd} பெற\u{bcd}றது", "பெண\u{bcd} ஜோம\u{bcd}பி"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
		...
		crate::Annotation {
			...
			keywords: &["ซอมบ\u{e35}\u{e49}ผ\u{e39}\u{e49}หญ\u{e34}ง", "ผ\u{e35}ด\u{e34}บ"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰበይቲ ዞምቢ"),
			keywords: &["ሃሎዊን", "ሞይቱ", "ራዕዲ", "ሰበይቲ", "ብእግሪ ምጉዓዝ", "ኣፖካሊፕስ", "ዘይሞቱ", "ዘፍርሕ", "ዞምቢ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["isidumbu esihambayo", "isithunzela esilibhinqa", "ongafanga"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Ɛbɔra obìnrin"),
			keywords: &["Àìlèkú", "àkúdáàyà", "Ɛbɔra obìnrin"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("女殭屍"), keywords: &["女殭屍"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("女喪屍"),
