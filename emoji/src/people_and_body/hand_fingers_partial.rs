...
pub const OK_HAND: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("እሺ ምልክት እጅ"),
			keywords: &["ምርጥ", "በትክክል", "አሪፍ", "አካል", "አፌ ይቆረጥ", "እሺ", "እሺ ምልክት እጅ", "እጅ", "ጣቶች"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			tts:      Some("OK hand"),
			keywords: &[
				"OK", "awesome", "bet", "dope", "fleek", "fosho", "got", "gotcha", "hand", "legit", "okay",
				"pinch", "rad", "sure", "sweet", "three",
			],
		},
		#[cfg(feature = "en_AU")]
		...
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("señal de aprobación con la mano"),
			keywords: &["gesto", "mano", "ok", "señal", "señal de aprobación con la mano"],
		},
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			...
			keywords: &["ados", "adostasuna adierazten duen eskua", "eskua", "gorputza", "ok"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["OK", "main"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("lámh OK"),
			keywords: &["CGL", "OK", "beagán bídeach", "cgl", "gráinnín", "lámh", "tuigim"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["ok", "אוקיי", "אחלה", "אישור", "בסדר", "הבנתי", "יד", "מעולה", "סבבה", "צביטה"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("ok jel"),
			keywords: &["kéz", "ok jel", "oké", "perfekt", "rendben", "szuper", "test", "ujj"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			tts:      Some("oke"),
			keywords: &[
				"badan", "bagus", "baiklah", "cubit", "ok", "oke", "pasti", "setuju", "sip", "tangan",
				"tentu", "tubuh",
			],
		},
		#[cfg(feature = "ig")]
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("afus n IH"), keywords: &["afus n IH"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("ОК"),
			keywords: &["ОК", "дене", "жарайды", "жақсы", "түсінікті", "қол", "әрине"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("simbols OK"),
			keywords: &["labi", "lieliski", "ok", "roka", "sapratu", "simbols OK", "ķermenis"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation { lang: "mi", tts: Some("ringa ĀE"), keywords: &["ringa", "ĀE"] },
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("id OK"), keywords: &["OK", "id"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			...
			keywords: &["fantastisch", "geweldig", "goed", "hand", "oké", "prima", "top", "vingers"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		#[cfg(feature = "pcm")]
		crate::Annotation { lang: "pcm", tts: Some("OK Hand"), keywords: &["Hand", "OK"] },
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang: "ps", tts: Some("اوکی لاس"), keywords: &["اوکی", "لاس"]
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-521"), keywords: &["E10-521"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["අත", "හර\u{dd2}", "හර\u{dd2}\u{dd2} යන\u{dca}න දක\u{dca}වන අත"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			lang:     "sv",
			tts:      Some("OK-tecken"),
			keywords: &["Instämmer", "Javisst", "OK", "OK-tecken", "Ok", "hand", "tecken"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
		...
		crate::Annotation {
			...
			keywords: &["OK nha", "bàn tay làm dấu OK", "chắc chắn rồi", "ok", "tay", "tuyệt", "được"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("OK"),
			keywords: &["OK", "OK 手势", "可以", "同意", "好的", "当然", "手", "没问题", "确定"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			...
			keywords: &["isandla", "isandla sokuthi kulungile", "kulungile", "umzimba"],
		},
	],
};
#[doc = "👌🏻"]
...
pub const PINCHED_FINGERS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["жэст рукі", "зведзеныя", "пальцы", "пытанне", "сарказм", "шчыпок"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("събрани пръсти"),
			keywords: &["въпрос", "жест с ръка", "какво", "пръсти", "саркастично", "събрани", "търпение"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["elkartuta", "esku-keinua", "galdera", "hatz elkartuak", "hatzak", "sarkasmoa"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			...
			keywords: &["geste de la main", "interrogation", "main qui interroge", "sarcastique"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			...
			keywords: &["a tope", "ateigado", "de bote en bote", "petado", "xesto de \"ateigado\""],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			...
			keywords: &[
				...
				"પા\u{a82}ચ મિનિટ",
				"પ\u{ac2}છપરછ",
				"બિલક\u{ac1}લ ચ\u{ac2}પ",
				"રાહ",
				"રાહ જ\u{ac1}ઓ",
				"રિલ\u{ac7}ક\u{acd}સ",
				"શા\u{a82}તિ શા\u{a82}તિ",
				"હાથ",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("tsuke yatsu"),
			keywords: &[
				"an finciko",
				"baʼa",
				"ja bakinka kai shiru",
				"kucili",
				"mitsitsi",
				"motsin hannu",
				"tambaya",
		...
		crate::Annotation {
			...
			keywords: &["אצבעות", "כף יד", "סבלנות", "רגע", "רק רגע", "תיכף"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["basa tangan", "digathukake", "driji", "interogasi", "landhep", "sarkas"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("Iduḍan yemlalen"),
			keywords: &["Iduḍan yemlalen"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಮಡಚ\u{cbf}ಕ\u{cca}ಂಡ ಬ\u{cc6}ರಳುಗಳು"),
			keywords: &[
				"ಆಹ\u{ccd}",
				"ಏನು",
				"ಕಹ\u{cbf}ಯಾದ",
				...
				"ಕ\u{cc8} ಸ\u{cc2}ಚಕ",
				"ತಡ\u{cc0}ರ\u{cbf}",
				"ನ\u{cbf}ಲ\u{ccd}ಲ\u{cbf}",
				"ಬ\u{cc6}ರಳುಗಳು",
				"ಮಡಚ\u{cbf}ಕ\u{cca}ಂಡ",
				"ವ\u{cbf}ಚಾರಣ\u{cc6}",
				"ಸಮಧಾನ",
				"ಸ\u{ccd}ವಲ\u{ccd}ಪ",
				"ಹುಹ\u{ccd}",
		...
		crate::Annotation {
			...
			keywords: &["pastiepti pirksti", "pirksti", "rokas žests", "sarkastisks", "saspiests"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("To Pínch Fínga-dẹm Togẹ\u{301}da"),
			keywords: &[
				"Fínga-dẹm",
				"Hánd Sain",
				"To Pínch Fínga-dẹm Togẹ\u{301}da",
				"To Pínch Sọ\u{301}mtin Ọ Sọ\u{301}mbọ\u{301}di",
				"To Pút Fínga-dẹm Togẹ\u{301}da",
				"To Áks Pẹ\u{301}sin Plẹ\u{301}ntí Kwẹ\u{301}shọn",
				"Wẹ\u{301}n Wétín Yu Tọk Bi Ópózít Ọf Wétín Yu Min",
			],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["dedos", "dedos comprimidos", "gesto de mão", "mão", "sarcástico"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-004"), keywords: &["E13-004"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("щепоть"),
			keywords: &["вопрос", "жест", "пальцы", "рега", "сарказм", "щепотка", "щепоть"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("پنچ ٿيل آڱريون"),
			keywords: &["آڱريون", "انٽيروگيشن", "سارڪيسٽڪ", "هٿ جو اشرو", "پنچ ٿيل", "پنچ ٿيل آڱريون"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["fingerportmonnä", "fingrar", "förhör", "handgest", "nypa", "sarkastisk"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
		...
		crate::Annotation {
			...
			keywords: &[
				"ఆగండ\u{c3f}",
				"ఓప\u{c3f}క",
				"క\u{c4a}ంత ట\u{c48}మ\u{c4d} క\u{c3e}వ\u{c3e}ల\u{c3f}",
				"గ\u{c3f}చ\u{c4d}చడం",
		...
		crate::Annotation {
			...
			keywords: &["fakamaʻopoʻopo", "louhiʻinima", "nima", "taʻemāhino"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("dompat baaraam"), keywords: &[""] },
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("ìka kíkákò"),
		...
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("捏手指"),
			keywords: &["什麼", "呃", "手勢", "捏", "捏手指", "疑問", "等一下", "耐心", "蛤", "閉嘴"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
...
pub const PINCHING_HAND: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("እጅ መቆንጠጥ"),
			keywords: &["ትንሽ", "ትንሽ መጠን", "እንደሱ ነገር", "እጅ መቆንጠጥ", "ጣቶች", "ጥቂት"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["কম পৰিম\u{9be}ণ", "টিপ\u{9be} ম\u{9be}ৰি ৰখ\u{9be} হ\u{9be}তৰ চিহ\u{9cd}ন"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
			tts:      Some("sıxan əl"),
			keywords: &["barmaqlar", "bir az", "kiçik miqdar göstəricisi", "kiçik say", "sıxan əl"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"একট\u{9c1} খ\u{9be}নি",
				"এত ট\u{9c1}ক\u{9c1}",
				"চিমটি ক\u{9be}ট\u{9be} হ\u{9be}ত",
				"স\u{9be}ম\u{9be}ন\u{9cd}য",
				"হ\u{9be}ত",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &["dits", "mà que pessiga", "petit", "quantitat petita", "una mica"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["δάχτυλα", "κοντό", "μικρή ποσότητα", "μικρό", "περίπου", "χέρι που τσιμπάει"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["beag", "lámh ag pinseáil", "méara", "píosa beag"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("יד צובטת"),
			keywords: &["בכמות קטנה", "טיפונת", "מעט", "צביטה", "קטן", "קצת", "תנועת צביטה"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("ruka koja štipa"),
			keywords: &["mala količina", "malo", "prsti", "ruka koja štipa", "samo malo"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("csippentő kéz"),
			keywords: &["csippentő kéz", "kicsi", "kicsit", "kis összeg", "ujjak"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "ig",
			tts:      Some("tuo aka"),
			keywords: &["aka", "ego", "mkpịsị aka", "na-atụ", "nwaobere", "obere", "ụdị"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("tubbya n ufus"),
			keywords: &["tubbya n ufus"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("саусақпен қысып алу"),
			keywords: &["аз", "аз ғана мөлшер", "кішкене", "саусақ", "саусақпен қысып алу"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಗ\u{cbf}ಲ\u{ccd}ಲುವ ಕ\u{cc8}"),
			keywords: &[
				"ಕಡ\u{cbf}ಮ\u{cc6}",
				"ಕಡ\u{cbf}ಮ\u{cc6} ಪ\u{ccd}ರಮಾಣ",
				"ಗ\u{cbf}ಲ\u{ccd}ಲುವ ಕ\u{cc8}",
				"ಚ\u{cbf}ಟ\u{cbf}ಕ\u{cc6}",
				"ಬ\u{cc6}ರಳುಗಳು",
				"ಸ\u{ccd}ವಲ\u{ccd}ಪ ಪ\u{ccd}ರಮಾಣ",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("꼬집는 손"),
			keywords: &["꼬집는 손", "손가락", "적은 양을 나타내는 손", "조금", "한 꼬집"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["ຈຳ\u{200b}ນວນ\u{200b}ໜ\u{ec9}ອຍ", "ຢ\u{eb4}ບ\u{200b}ມ\u{eb7}", "ໜ\u{ec9}ອຍດຽວ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["कमी प\u{94d}रमाण", "चिमटा काढणारा हात", "चिम\u{942}ट", "च\u{941}टकी"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
			tts:      Some("tangan mencubit"),
			keywords: &["jari mencubit", "sedikit", "tangan mencubit"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			...
			keywords: &[
				"ਉ\u{a02}ਗਲ",
				"ਘ\u{a71}ਟ",
				"ਚ\u{a42}\u{a70}ਢੀ ਜਿ\u{a70}ਨਾ",
				"ਛ\u{a4b}ਟਾ",
				"ਥ\u{a4b}ੜ\u{a4d}ਹਾ ਜਿਹਾ",
			],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["dedos", "mão a dar um beliscão", "pequena quantidade", "um pouco"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E12–024"), keywords: &["E12–024"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("жест «мало»"),
			keywords: &["жест", "мало", "небольшое количество", "немного", "чуть-чуть"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("málo"),
			keywords: &["malé množstvo", "málo", "trocha", "troška", "štipka"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["dorështrënguar", "gishta", "gishta të mbledhur", "kurnac", "sasi e vogël"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("рука штипа"),
			keywords: &["малкице", "мало", "прстохват", "штипање"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("ruka štipa"),
			keywords: &["malkice", "malo", "prstohvat", "štipanje"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			...
			keywords: &["kiasi fulani", "kiasi kidogo", "kidogo", "kidunchu", "vidole vinavyobana"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &[
				"จ\u{e34}\u{e4b}ว",
				"ท\u{e48}าทาง",
				"น\u{e34}ดเด\u{e35}ยว",
				"บ\u{e35}บน\u{e34}\u{e49}ว",
				"ปร\u{e34}มาณ",
				"ม\u{e37}อ",
				"เล\u{e47}กน\u{e49}อย",
			],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("መቐንጠጢ ኢድ"),
			keywords: &["መጠን ገንዘብ", "ምስራዕ", "ምጭብባጥ", "ንእሽተይ", "ንእሽቶ", "ኢድ", "ኣጻብዕቲ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["fakamaʻopoʻopo", "nima", "siʻisiʻi"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			...
			keywords: &["biroz", "chimduvchi qoʻl", "kam", "kamgina", "kichik", "ozgina"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("tay chụm"),
			keywords: &["số lượng nhỏ", "tay chụm", "ít"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("ìka kíká"),
			keywords: &["owó kẹ\u{300}keré", "ìka kíká", "ọwọ\u{301} yínyín"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("ìka kíká"),
			keywords: &["owó kɛ\u{300}keré", "ìka kíká", "ɔwɔ\u{301} yínyín"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("捏手"), keywords: &["小量", "捏手"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("捏手"), keywords: &["小量", "捏手"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("捏合的手势"),
			keywords: &["一点", "一点点", "小", "少", "少量", "手指", "捏合的手势", "捏着", "某种程度上"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("捏"),
			keywords: &["一點點", "小", "少量", "很少", "手指", "捏"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("捏｜少少｜一啲啲"),
			keywords: &["一點", "少數", "少量", "捏指", "捏｜少少｜一啲啲", "有點", "略為", "細"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const VICTORY_HAND: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ቪ", "አካል", "እጅ", "የድል አድራጊነት ምልክት እጅ", "ድል", "ጣት"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("علامة النصر"),
			keywords: &["إشارة", "انتصار", "سلام", "علامة النصر", "مقص", "نصر", "يد"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["жест за победа", "мир", "победа", "ръка", "тяло"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["V", "mà", "pau", "senyal", "senyal de la victòria", "victòria"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎤᏓᏠᏒ ᎤᏬᏱ"),
			keywords: &["ᎤᏓᏠᏒ", "ᎤᏓᏠᏒ ᎤᏬᏱ", "ᎤᏬᏰᏂ", "Ꮩ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("v-tegn"),
			keywords: &["V-tegn", "fred", "sejr", "v-tegn", "yeah"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
			tts:      Some("Victory-Geste"),
			keywords: &["Sieg", "V", "Victory", "Victory-Geste"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			...
			keywords: &["mano", "mano con señal de victoria", "señal de victoria", "victoria"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("mano con señal de victoria"),
			keywords: &["amor y paz", "mano con señal de victoria", "tijera", "victoria"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation {
			lang:     "es_US",
			tts:      Some("mano con señal de victoria"),
			keywords: &["mano", "mano con señal de victoria", "v", "victoria"],
		},
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
			tts:      Some("võit"),
			keywords: &["käsi", "rahu", "v", "võit"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("garaipena adierazten duen eskua"),
			keywords: &["eskua", "garaipena", "garaipena adierazten duen eskua", "gorputza", "v"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			...
			keywords: &["જીત", "વિજય", "શા\u{a82}તિ", "હાથ"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
			tts:      Some("hannun nasara"),
			keywords: &["ana tare", "hannu", "hannun nasara", "nasara", "v"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["אצבעות", "אצבעות מסמנות ניצחון", "וי", "יד", "ניצחון", "פיס"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			tts:      Some("विजयी हाथ"),
			keywords: &["क\u{948}\u{902}ची", "जीत", "विजय", "विजयी हाथ", "हाथ"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
			tts:      Some("ruka sa znakom pobjede"),
			keywords: &["mir", "pobjeda", "v", "šaka"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["damai", "menang", "tangan", "v"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("aka mmeri"),
			keywords: &["hand", "peace", "udo", "v", "victory"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "it",
			tts:      Some("vittoria"),
			keywords: &["due", "forbice", "mano", "segno di vittoria", "vittoria", "yeah"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
			tts:      Some("Vサイン"),
			keywords: &["Vサイン", "チョキ", "ピース", "手", "指"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("tangan nuduhake tandha kamenangan"),
			keywords: &["kamenangan", "tangan", "tangan nuduhake tandha kamenangan", "v"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("გამარჯვების გამოხატვა ხელით"),
			keywords: &["v", "გამარჯვება", "გამარჯვების გამოხატვა ხელით", "სხეული", "ტანი", "ხელი"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
			tts:      Some("afus n rrbeḥ"),
			keywords: &["afus n rrbeḥ"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("саусақтармен «V» әрпін көрсету"),
			keywords: &[
				"V",
				"бейбітшілік",
				"жеңіс",
		...
		#[cfg(feature = "kl")]
		crate::Annotation { lang: "kl", tts: Some("v-tegn"), keywords: &["V-tegn", "yeah"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ವ\u{cbf}ಜಯದ ಕ\u{cc8}"),
			keywords: &[
				"ಕ\u{cc8}",
				"ಗ\u{cc6}ಲುವ\u{cbf}ನ ಗುರುತು",
				"ಗ\u{cc6}ಲುವ\u{cbf}ನ ಸಂಕ\u{cc7}ತ",
				"ಗ\u{cc6}ಲುವು",
				"ವ\u{cbf}ಕ\u{ccd}ಟರ\u{cbf}",
				"ವ\u{cbf}ಜಯ",
				"ವ\u{cbf}ಜಯದ ಕ\u{cc8}",
				"ವ\u{cbf}ಜಯದ ಸಂಕ\u{cc7}ತ",
				"ಶಾಂತ\u{cbf}",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("브이 표시"),
			keywords: &["가위", "브이 표시", "브이하는 손", "빅토리", "손", "승리", "찌", "평화"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["miers", "roka", "uzvara", "uzvaras simbols", "ķermenis"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["aman", "kejayaan", "tangan", "v"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["hand", "peace", "twee vingers", "v", "vredesteken", "winnende hand"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["degete", "mână", "pace", "semnul victoriei", "v", "victorie", "învingător"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-127"), keywords: &["E10-127"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("жест V"),
			keywords: &["виктория", "жест", "мир", "пальцы", "победа", "рука"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["dlan", "mir", "roka", "v", "zmaga"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["dora e fitores", "dorë", "fitore", "paqe", "trup", "v"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("знак победе"),
			keywords: &["пoбeдa", "рукa", "шaкa"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("знак побједе"),
			keywords: &["v", "знак побједе", "пoбeдa", "рукa"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("znak pobede"),
			keywords: &["pobeda", "ruka", "šaka"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("znak pobjede"),
			keywords: &["pobeda", "ruka", "v", "znak pobjede"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ప\u{c40}స\u{c4d}",
				"వ\u{c3f}జయ చ\u{c3f}హ\u{c4d}నం",
				"వ\u{c3f}జయ సంక\u{c47}తం",
				"వ\u{c3f}జయం",
				"వ\u{c40}",
				"శ\u{c3e}ంత\u{c3f} సంక\u{c47}తం",
				"సంక\u{c47}తం",
			],
		},
		#[cfg(feature = "tg")]
		...
		crate::Annotation {
			...
			keywords: &["barış", "el", "oleey", "zafer", "zafer eli", "zafer işareti"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["chiến thắng", "chữ v", "tay", "tay chiến thắng", "v"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
			tts:      Some("loxo ndam"),
			keywords: &["jaam", "jaam loxo", "ndam", "v"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("asheyɔrí ɔwɔ\u{301}"),
			keywords: &["asheyɔrí", "v", "ɔwɔ\u{301}"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("胜利手势"),
			keywords: &["V", "和平", "成功", "手", "胜利", "胜利手势"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("勝利"),
			keywords: &["V", "v", "勝利", "勝利手勢", "耶"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
...
pub const CROSSED_FINGERS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("ጣት ማጣመር"),
			keywords: &["ማጣመር", "ምኞት", "እድል", "እጅ", "ጣት", "ጸሎት"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("أصابع مشبكة"),
			keywords: &["أصابع", "أصابع مشبكة", "أمنية", "إشارة", "انشاء الله", "انشالله", "حظ", "يد"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["inam", "işarə", "uğur diləmək jesti", "ümid", "ümid edirəm", "əl"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ইস হয\u{9bc}ে য\u{9be}য\u{9bc} যেন",
				"ভ\u{9be}গ\u{9cd}য",
				"ভ\u{9be}গ\u{9cd}যের শিকে ছে\u{981}\u{981}ড\u{9bc}\u{9be}",
				"হ\u{9be}ত",
			],
		},
		#[cfg(feature = "bs")]
		...
		crate::Annotation {
			...
			keywords: &["creuar", "creuats", "dit", "dits", "mà", "sort"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			lang:     "el",
			tts:      Some("καλή τύχη"),
			keywords: &["δάχτυλα", "καλή τύχη", "σταυρωμένα δάχτυλα", "σταυρώνω", "τύχη", "χέρι"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "en_CA",
			tts:      Some("↑↑↑"),
			keywords: &["cross", "crossed fingers", "finger", "good luck", "hand", "luck"],
		},
		#[cfg(feature = "en_GB")]
		crate::Annotation { lang: "en_GB", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_IN")]
		...
		crate::Annotation {
			...
			keywords: &["انگشت", "انگشتان گره خورده", "بخت", "دست", "شانس", "پنجه", "گره"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("sormet ristissä"),
			keywords: &["käsi", "narrata", "onni", "risti", "sormet ristissä", "sormi"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["bonne chance", "chance", "croisés", "doigts", "main"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["beò an dòchas", "corrag", "dòchas", "fortan", "làmh", "meur"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &["hannu", "haɗa", "haɗa yatsu", "haɗaɗɗun yatsu", "neman saʼa", "sa’a", "yatsa"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"क\u{94d}रॉस बनाती उ\u{902}गलिया\u{902}",
				"भाग\u{94d}य",
				"हाथ",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &["aka", "chioma", "gafere", "mkpịsị aka", "obe"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("指をクロス"),
			keywords: &["幸運を", "手", "指", "指をクロス"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("driji loro tetalenan"),
			keywords: &["driji", "driji loro tetalenan", "kabegjan", "tangan", "tetalen"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("გადაჯვარედინებული თითები"),
			keywords: &["გადაჯვარედინება", "გადაჯვარედინებული თითები", "თითი", "იღბალი", "ხელი"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
			tts:      Some("iḍudan yemcubbaken"),
			keywords: &["iḍudan yemcubbaken"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("саусақтарын айқастырған"),
			keywords: &["айқастырған", "саусақ", "саусақтарын айқастырған", "сәттілік"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ನ\u{cbf}ರ\u{cc0}ಕ\u{ccd}ಷ\u{cc6}"),
			keywords: &[
				"ಅದೃಷ\u{ccd}ಟ",
				"ಅದೃಷ\u{ccd}ಟ ಬಯಸುವ ಕ\u{cc8} ಸ\u{cc2}ಚಕ",
				"ಅದೃಷ\u{ccd}ಟ ಬಯಸುವುದು",
				"ಕ\u{cc8}",
				"ಕ\u{cc8}ಗಳು",
				"ಕ\u{ccd}ರಾಸ\u{ccd} ಫ\u{cbf}ಂಗರ\u{ccd}",
				"ತ\u{cbf}ರುಪುವ\u{cbf}ಕ\u{cc6}",
				"ದ\u{cc7}ವರಲ\u{ccd}ಲ\u{cbf} ಬ\u{cc7}ಡ\u{cbf}ಕ\u{cca}ಳ\u{ccd}ಳುವ ಭಾವಸ\u{cc2}ಚ\u{cbf}",
				"ನ\u{cbf}ರ\u{cc0}ಕ\u{ccd}ಷ\u{cc6}",
				"ಬ\u{cc6}ರಳು",
				"ಹಣ\u{cc6}ಬರಹ",
			],
		},
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("검지와 중지 크로스"),
			keywords: &["검지", "검지와 중지 크로스", "교차", "손", "손가락", "중지", "크로스", "행운"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["pirksts", "roka", "sakrustot", "sakrustoti pirksti", "turēt īkšķus", "veiksme"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["вкрстени", "палци", "прсти", "среќа", "стискање палци"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
			tts:      Some("ഭ\u{d3e}ഗ\u{d4d}യസ\u{d42}ചന"),
			keywords: &["കൈ", "ഭ\u{d3e}ഗ\u{d4d}യം", "ഭ\u{d3e}ഗ\u{d4d}യസ\u{d42}ചന", "വിരൽ"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["gekruist", "geluk", "hand", "kruisen", "vinger", "vingers"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["ا\u{64f}نگل", "ا\u{64f}نگلاں آرپار کرنا", "قسمت", "پار کرنا", "ہتھ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			...
			keywords: &["kciuki", "powodzenia", "ręka", "skrzyżowane palce", "trzymam kciuki", "trzymać"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("dedos cruzados"),
			keywords: &["boa sorte", "cruzados", "dedos", "mão", "sorte", "torcendo"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		crate::Annotation {
			lang:     "qu",
			tts:      Some("chakatasqa rukanakuna"),
			keywords: &["chakatasqa rukanakuna", "chakatay", "maki", "rukana", "suerte"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1024"), keywords: &["E10-1024"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("скрещенные пальцы"),
			keywords: &["везение", "жест", "пальцы", "скрестить", "скрещенные", "удача"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("intoki zinyuranyemo"),
			keywords: &["amahirwe", "ikiganza", "intoki zinyuranyemo", "umusaraba", "urutoki"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["dorë", "fat", "gisht", "gishta të kryqëzuar", "kryq", "kryqëzim"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("прекрштени прсти"),
			keywords: &["жеља", "катанац", "обећање", "прекрштено", "прсти", "рука", "срећа", "шака"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("↑↑↑"),
			keywords: &["прекрштени прсти", "прекрштено", "прст", "рука", "срећа"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("prekršteni prsti"),
			keywords: &["katanac", "obećanje", "prekršteno", "prsti", "ruka", "sreća", "šaka", "želja"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("↑↑↑"),
			keywords: &["prekršteni prsti", "prekršteno", "prst", "ruka", "sreća"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &["bahati", "ishara ya kubahatisha", "kubahatisha", "mkono"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &["ангушт", "ангуштони ба ҳам гузошташуда", "даст", "муваффақият", "салиб"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ዝተቖላለፉ አጻብዕቲ"),
			keywords: &["መቑላፍ", "ኢድ", "ኣጻብዕቲ", "ዕድል", "ዝተቖላለፈ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["fehauaki", "louhiʻinima fehauaki", "nima"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("şans dileme"),
			keywords: &["el", "parmak", "söz verme", "çapraz", "şans", "şans dileme"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["пальці", "рука", "схрещені", "удача"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["iminwe enqamlezeneyo", "intlahla", "isandla", "ukunqamleza", "umnwe"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Igbekalera"),
			keywords: &["Igbekalera", "dábùú", "orírere", "ìka", "ɔwɔ\u{301}"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["交叉", "好運", "手", "手勢", "手指", "祝福"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("iminwe ebhanqiwe"),
			keywords: &["bhanqa", "iminwe ebhanqiwe", "inhlanhla", "isandla", "umunwe"],
		},
	],
};
#[doc = "🤞🏻"]
...
#[doc = "🫰"]
pub const HAND_WITH_INDEX_FINGER_AND_THUMB_CROSSED: crate::Emoji = crate::Emoji {
	glyph:                "🫰",
	codepoint:            "1FAF0",
	status:               crate::Status::FullyQualified,
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("hand met duim en wysvinger gekruis"),
			keywords: &[
				"duur",
				"geld",
				"hand",
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("አውራ እና ጠቋሚ ጣት የተጠመሩበት እጅ"),
			keywords: &[
				"<3",
				"ልብ",
				"ቀልጣፋ",
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("يد مع تقاطع السبابة والإبهام"),
			keywords: &[
				"أموال",
				"انطباق",
				"حب",
		...
		crate::Annotation {
			lang:     "as",
			tts:      Some(
				"তৰ\u{9cd}জনী আঙ\u{9c1}লি আৰ\u{9c1} ব\u{9c1}ঢ\u{9bc}\u{9be} আঙ\u{9c1}লি ক\u{9cd}ৰছ থক\u{9be} হ\u{9be}ত",
			),
			keywords: &[
				"টক\u{9be}",
				"তৰ\u{9cd}জনী আঙ\u{9c1}লি আৰ\u{9c1} ব\u{9c1}ঢ\u{9bc}\u{9be} আঙ\u{9c1}লি ক\u{9cd}ৰছ থক\u{9be} হ\u{9be}ত",
				"প\u{9cd}ৰেম",
				"ম\u{9c2}ল\u{9cd}যৱ\u{9be}ন",
				"স\u{9cd}নেপ",
				"হ\u{9c3}দয\u{9bc}",
			],
		},
		...
		crate::Annotation {
			lang:     "az",
			tts:      Some("əl barmağı və baş barmağı çarpazlanmış vəziyyətdə"),
			keywords: &[
				"<3",
				"bahalı",
				"pul",
		...
		crate::Annotation {
			lang:     "be",
			tts:      Some("рука са скрыжаванымі вялікім і ўказальным пальцамі"),
			keywords: &[
				"грошы",
				"дорага",
				"каханне",
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("ръка с преплетени палец и показалец"),
			keywords: &[
				"любов",
				"пари",
		...
		crate::Annotation {
			lang:     "bn",
			tts:      Some(
				"ব\u{9c1}ড\u{9bc}ো আঙ\u{9c1}লের সঙ\u{9cd}গে তর\u{9cd}জনী ঘোর\u{9be}নো হ\u{9be}ত",
			),
			keywords: &[
				"অর\u{9cd}থ",
				"ছবি",
		...
		crate::Annotation {
			lang:     "bs",
			tts:      Some("ruka s prekrštenim kažiprstom i palcem"),
			keywords: &[
				"ljubav",
				"novac",
				"pucketanje",
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("mà amb el dit índex i el polze creuats"),
			keywords: &[
				"<3",
				"amor",
				"car",
		...
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎤᏬᏰᏂ ᎾᎿ ᎠᏚᏂᎯ ᏯᏍᏓ ᎠᎴ ᎦᏰᏌᏛ"),
			keywords: &["ᎠᎧᏁᏍᏗ", "ᎠᏓᏅᏙ", "ᎠᏕᎳ", "ᎤᏬᏰᏂ ᎾᎿ ᎠᏚᏂᎯ ᏯᏍᏓ ᎠᎴ ᎦᏰᏌᏛ", "ᎬᎨᏳ", "ᏗᏓᏇᏄᎩᏍᏗ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
			tts:      Some("ruka se zkříženým palcem a ukazováčkem"),
			keywords: &[
				"K-pop",
				"drahota",
				"drahé",
		...
		crate::Annotation {
			lang:     "cy",
			tts:      Some("llaw gyda bys mynegai a bawd wedi’u croesi"),
			keywords: &[
				"arian",
				"calon",
				"cariad",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("krydset pegefinger og tommelfinger"),
			keywords: &[
				"<3",
				"dyrt",
				"elsker",
		...
		crate::Annotation {
			lang:     "de",
			tts:      Some("Hand mit gekreuztem Zeigefinger und Daumen"),
			keywords: &[
				"Daumen",
				"Finger",
				"Fingerherz",
		...
		crate::Annotation {
			lang:     "el",
			tts:      Some("δείκτης και αντίχειρας σταυρωμένοι"),
			keywords: &[
				"αγάπη",
				"ακριβό",
		...
		crate::Annotation {
			lang:     "en",
			tts:      Some("hand with index finger and thumb crossed"),
			keywords: &[
				"<3",
				"crossed",
				"expensive",
		...
		crate::Annotation {
			lang:     "es",
			tts:      Some("mano con dedo índice y pulgar cruzados"),
			keywords: &[
				"amor",
				"caro",
				"chasquido",
		...
		crate::Annotation {
			lang:     "et",
			tts:      Some("pöialt ja nimetissõrme risti hoidev käsi"),
			keywords: &[
				"<3",
				"armastus",
				"kallis",
		...
		crate::Annotation {
			lang:     "eu",
			tts:      Some("erakuslea eta erpurua gurutzatuta"),
			keywords: &[
				"<3",
				"bihotza",
				"dirua",
				"erakuslea eta erpurua gurutzatuta",
				"erakuslea eta erpurua gurutzatuta dauzkan eskua",
				"garestia",
				"klask",
				"klaskatu",
				"kriskitin",
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("دست با انگشت اشاره و شست متقاطع"),
			keywords: &[
				"افراد",
				"بدن",
				"بشکن",
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("etusormi ja peukalo ristissä"),
			keywords: &[
				"anna rahaa",
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("kamay na magkakrus ang hintuturo at hinlalaki"),
			keywords: &[
				"<3",
		...
		crate::Annotation {
			lang:     "fo",
			tts:      Some("krossa tummil og peikifingur"),
			keywords: &["fingrar", "hond", "krossa", "peikifingur", "tummil"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("main avec index et pouce croisés"),
			keywords: &[
				"amour",
				"argent",
				"cher",
		...
		crate::Annotation {
			lang:     "ga",
			tts:      Some("lámh a bhfuil a corrmhéar agus a ordóg trasna ar a chéile"),
			keywords: &[
				"airgead",
				"costasach",
				"croí",
		...
		crate::Annotation {
			lang:     "gd",
			tts:      Some("làmh le a colgag is òrdag ri chèile"),
			keywords: &[
				"airgead",
				"cnag",
				"cridhe",
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("man cos dedos índice e polgar cruzados"),
			keywords: &["caro", "chascar", "corazón", "diñeiro"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			tts:      Some("તર\u{acd}જની અન\u{ac7} અ\u{a82}ગ\u{ac2}ઠો ક\u{acd}રોસ કર\u{ac7}લો હાથ"),
			keywords: &[
				"આ\u{a82}ગળી અન\u{ac7} અ\u{a82}ગ\u{ac2}ઠો ક\u{acd}રોસ કર\u{ac7}લો હાથ",
				"તર\u{acd}જની અન\u{ac7} અ\u{a82}ગ\u{ac2}ઠો ક\u{acd}રોસ કર\u{ac7}લો હાથ",
				"પ\u{ac8}સા",
				"પ\u{acd}ર\u{ac7}મ",
				"મો\u{a82}ઘ\u{ac1}\u{a82}",
				"સ\u{acd}ન\u{ac7}પ",
				"હાથ",
				"હ\u{ac3}દય",
			],
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("hannu da yatsa da babban yatsa a kewaye"),
			keywords: &[
				"ba ni",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("קליק באצבעות"),
			keywords: &["אהבה", "אצבעות", "יאללה", "יקר", "כסף", "לצרוד", "קליק באצבעות"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			tts:      Some("क\u{94d}रॉस किए तर\u{94d}जनी और अ\u{902}ग\u{942}ठ\u{947} वाला हाथ"),
			keywords: &[
				"<3",
				"क\u{94d}रॉस किए तर\u{94d}जनी और अ\u{902}ग\u{942}ठ\u{947} वाला हाथ",
				"च\u{941}टकी बजाना",
				"दिल",
				"धन",
				"प\u{948}सा",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("ruka s prekriženim palcem i kažiprstom"),
			keywords: &[
				"<3",
				"ljubav",
				"novac",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("keresztezett mutató- és hüvelykujjú kéz"),
			keywords: &[
				"csettint",
				"drága",
		...
		crate::Annotation {
			lang:     "hy",
			tts:      Some("ցուցամատը եւ բութը խաչած ձեռք"),
			keywords: &["դրամ", "թանկ", "ճտտացնել", "սեր", "սիրտ", "ցուցամատը եւ բութը խաչած ձեռք"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("tangan dengan jari telunjuk dan ibu jari menyilang"),
			keywords: &[
				"cinta",
				"hati",
				"jari hati",
		...
		crate::Annotation {
			lang:     "is",
			tts:      Some("hendi með vísifingur og þumal í kross"),
			keywords: &[
				"dýr",
		...
		crate::Annotation {
			lang:     "it",
			tts:      Some("mano con indice e pollice incrociati"),
			keywords: &[
				"amore",
				"caro",
				"costa",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("親指と人差し指をクロス"),
			keywords: &["お金", "愛", "手", "指", "指をクロス", "指ハート", "親指と人差し指をクロス"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("tangan mawa jempol karo driji telunjuk tetalenan"),
			keywords: &[
				"ati",
				"dhuwit",
				"larang",
		...
		crate::Annotation {
			lang:     "ka",
			tts:      Some("ხელი საჩვენებელი თითით და ცერი გადაჯვარედინებული"),
			keywords: &[
				"გული",
				"ვადამდელი",
				"სიყვარული",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("afus s udebbuz d ccahed yemcubbaken"),
			keywords: &["afus s udebbuz d ccahed yemcubbaken"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("бас бармақ пен сұқ саусақ айқастырылған қол"),
			keywords: &[
				"ақша",
		...
		crate::Annotation {
			lang:     "km",
			tts:      Some(
				"សញ\u{17d2}ញាខ\u{17d2}វែងម\u{17d2}រាមមេន\u{17b7}ងម\u{17d2}រាមចង\u{17d2}អ\u{17bb}ល",
			),
			keywords: &[
				"ថ\u{17d2}លៃ",
				"បេះដ\u{17bc}ង",
				"ផ\u{17d2}ទាត\u{17cb}ម\u{17d2}រាមដៃ",
				"ល\u{17bb}យ",
				"សញ\u{17d2}ញាខ\u{17d2}វែងម\u{17d2}រាមមេន\u{17b7}ងម\u{17d2}រាមចង\u{17d2}អ\u{17bb}ល",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some(
				"ತ\u{ccb}ರುಬ\u{cc6}ರಳು ಮತ\u{ccd}ತು ಹ\u{cc6}ಬ\u{ccd}ಬ\u{cc6}ರಳು ಅಡ\u{ccd}ದವಾಗ\u{cbf}ರುವ ಕ\u{cc8}",
			),
			keywords: &[
				"ತ\u{ccb}ರುಬ\u{cc6}ರಳು ಮತ\u{ccd}ತು ಹ\u{cc6}ಬ\u{ccd}ಬ\u{cc6}ರಳು ಅಡ\u{ccd}ದವಾಗ\u{cbf}ರುವ ಕ\u{cc8}",
				"ತ\u{ccb}ರುಬ\u{cc6}ರಳು ಮತ\u{ccd}ತು ಹ\u{cc6}ಬ\u{ccd}ಬ\u{cc6}ರಳು ಕ\u{ccd}ರಾಸ\u{ccd} ಆಗ\u{cbf}ರುವ ಕ\u{cc8}",
				"ದುಬಾರ\u{cbf}",
		...
		crate::Annotation {
			lang:     "kok",
			tts:      Some("पयली दोन बोटा\u{902} आनी आखणो क\u{94d}रॉस क\u{947}ल\u{94d}लो हात"),
			keywords: &[
				"काळीज",
				"च\u{941}टकी मारप",
				"पयली दोन बोटा\u{902} आनी आखणो क\u{94d}रॉस क\u{947}ल\u{94d}लो हात",
				"मोग",
				"म\u{94d}हारग",
				"स\u{94d}न\u{945}प",
			],
		...
		crate::Annotation {
			lang:     "ky",
			tts:      Some("сөөмөй менен бармак кайчылаштырылган кол"),
			keywords: &["сөөмөй менен бармак кайчылаштырылган кол"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
			tts:      Some(
				"ມ\u{eb7}ນ\u{eb4}\u{ec9}ວຊ\u{eb5}\u{ec9} ແລະ ນ\u{eb4}\u{ec9}ວໂປ\u{ec9}ໄຂວ\u{ec8}ກ\u{eb1}ນ",
			),
			keywords: &[
				"ຄວາມຮ\u{eb1}ກ",
				"ດ\u{eb5}ດນ\u{eb4}\u{ec9}ວ",
				"ມ\u{eb7}ນ\u{eb4}\u{ec9}ວຊ\u{eb5}\u{ec9} ແລະ ນ\u{eb4}\u{ec9}ວໂປ\u{ec9}ໄຂວ\u{ec8}ກ\u{eb1}ນ",
				"ຫ\u{ebb}ວໃຈ",
				"ຫ\u{ebb}ວໃຈດວງນ\u{ec9}ອຍ",
				"ຮ\u{eb1}ກ",
				"ເງ\u{eb4}ນ",
				"ແພງ",
			],
		...
		crate::Annotation {
			lang:     "lt",
			tts:      Some("ranka sukryžiuotu smiliumi ir nykščiu"),
			keywords: &[
				"brangu",
				"meilė",
				"pinigai",
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("roka ar rādītājpirkstu un īkšķi sakrustota"),
			keywords: &[
				"dārgs",
				"knipis",
				"mīlestība",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("рака со вкрстени палец и показалец"),
			keywords: &["пари", "пукање", "рака со вкрстени палец и показалец", "скапо", "срце", "љубов"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
			tts:      Some("പണം കൊട\u{d41}ക\u{d4d}ക\u{d41}ക"),
			keywords: &[
				"ചെലവേറിയത\u{d4d}",
				"ചെലവ\u{d4d} ക\u{d42}ടിയത\u{d4d}",
				"ഞൊടിക\u{d4d}ക\u{d41}ക",
				"നൊടി",
				"പണം",
				"പണം കൊട\u{d41}ക\u{d4d}ക\u{d41}ക",
				"പണമ\u{d41}ണ\u{d4d}ടോ",
				"സ\u{d4d}നേഹം",
				"ഹ\u{d43}ദയം",
			],
		},
		...
		crate::Annotation {
			lang:     "mn",
			tts:      Some("долоовор хуруу, эрхий хуруугаа зөрүүлж барьсан гар"),
			keywords: &[
				"долоовор хуруу",
				...
				"мөнгө",
				"хайр",
				"эрхий хуруугаа зөрүүлж барьсан гар",
				"үнэтэй",
			],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			tts:      Some("तर\u{94d}जनी आणि अ\u{902}गठा क\u{94d}रॉस कर\u{942}न दर\u{94d}शविणारा हात"),
			keywords: &[
				"आयलव\u{94d}हय\u{942}",
				"च\u{941}टकी",
				"तर\u{94d}जनी आणि अ\u{902}गठा क\u{94d}रॉस कर\u{942}न दर\u{94d}शविणारा हात",
				"प\u{948}सा",
				"प\u{94d}र\u{947}म",
				"महागड\u{947}",
				"ह\u{943}दय",
		...
		crate::Annotation {
			lang:     "ms",
			tts:      Some("tangan dengan jari telunjuk dan ibu jari bersilang"),
			keywords: &[
				"bentuk hati",
				"mahal",
				"petik",
		...
		crate::Annotation {
			lang:     "my",
			tts:      Some(
				"လက\u{103a}မန\u{103e}င\u{1037}\u{103a} လက\u{103a}ည\u{103e}\u{102d}\u{102f}း ထပ\u{103a}ထားခြင\u{103a}း",
			),
			keywords: &[
				"ချစ\u{103a}ခြင\u{103a}း",
				"င\u{103d}ေ",
				"ဈေးကြ\u{102e}း",
				"န\u{103e}လ\u{102f}\u{1036}းသား",
				"လက\u{103a}မန\u{103e}င\u{1037}\u{103a} လက\u{103a}ည\u{103e}\u{102d}\u{102f}း ထပ\u{103a}ထားခြင\u{103a}း",
				"လျ\u{103e}ပ\u{103a}တစ\u{103a}ပြက\u{103a}",
			],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
			tts:      Some("ब\u{941}ढी औ\u{901}ला र चोर औ\u{901}ला क\u{94d}रस गर\u{947}को हात"),
			keywords: &[
				"तत\u{94d}काल",
				"दिल",
				"प\u{948}सा",
				"ब\u{941}ढी औ\u{901}ला र चोर औ\u{901}ला क\u{94d}रस गर\u{947}को हात",
				"मह\u{901}गो",
				"माया",
			],
		},
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("hand met wijsvinger en duim gekruist"),
			keywords: &[
				"duur",
				"geld",
				"hand",
		...
		crate::Annotation {
			lang:     "nn",
			tts:      Some("hand med peikefinger og tommel kryssa"),
			keywords: &[
				"dyrt",
		...
		crate::Annotation {
			lang:     "or",
			tts:      Some(
				"ଇଣ\u{b4d}ଡେକ\u{b4d}ସ ଆଙ\u{b4d}ଗ\u{b41}ଠ\u{b3f} ଏବଂ ଆଙ\u{b4d}ଗ\u{b41}ଠ\u{b3f} ଅତ\u{b3f}କ\u{b4d}ରମ କର\u{b3f} ହ\u{b3e}ତ",
			),
			keywords: &[
				"ଇଣ\u{b4d}ଡେକ\u{b4d}ସ ଆଙ\u{b4d}ଗ\u{b41}ଠ\u{b3f} ଏବଂ ଆଙ\u{b4d}ଗ\u{b41}ଠ\u{b3f} ଅତ\u{b3f}କ\u{b4d}ରମ କର\u{b3f} ହ\u{b3e}ତ",
				"ଟଙ\u{b4d}କ\u{b3e}",
		...
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਚ\u{a41}ਟਕੀ ਮਾਰਦਾ ਹ\u{a71}ਥ"),
			keywords: &[
				"<3",
				"ਕਿ\u{a70}ਨਾ",
				"ਖਰਚਾ",
				"ਚ\u{a41}ਟਕੀ",
				"ਚ\u{a41}ਟਕੀ ਮਾਰਦਾ ਹ\u{a71}ਥ",
				"ਚ\u{a41}ਟਕੀ ਵਜਾਉਣਾ",
				"ਦਿਲ",
				"ਪਿਆਰ",
				"ਪ\u{a48}ਸਾ",
		...
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Hand Wé Krọ\u{301}s Im Sẹ\u{301}kọ\u{301}n Fínga An Tọmb"),
			keywords: &[
				"Hand Wé Krọ\u{301}s Im Sẹ\u{301}kọ\u{301}n Fínga An Im Tọmb",
				"Hand Wé Krọ\u{301}s Im Sẹ\u{301}kọ\u{301}n Fínga An Tọmb",
				"Hat",
				"Kọ\u{301}sli",
				"Lọv",
				"Mọní",
				"To Mék Sháp Nọiz Wit Yọ Fínga An Tọmb",
			],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("dłoń ze skrzyżowanym palcem wskazującym i kciukiem"),
			keywords: &[
				"drogie",
		...
		crate::Annotation {
			lang:     "ps",
			tts:      Some("د شاخص د ګوتو او ګوتو سره لاس تېر شو"),
			keywords: &[
				"<3",
				"تجاوز",
				"زړه",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("mão com dedo indicador e polegar cruzados"),
			keywords: &[
				"<3",
				"amor",
				"army",
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["caro", "dinheiro", "dispendioso", "gesto de esfregar os dedos"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("maki chakatasqa iskay rukanawan"),
			keywords: &["chanin", "maki chakatasqa iskay rukanawan", "munay", "qullqi", "sunqu"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("mână cu degetul mare și arătătorul încrucișate"),
			keywords: &[
				"afecțiune",
				"bani",
				"ciubuc",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E14-012"), keywords: &["E14-012"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("жест «деньги»"),
			keywords: &["деньги", "дорого", "жест", "сердечко", "щелчок"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("پھرين آڱر ۽ آڱوٺو مڙيل ھٿ"),
			keywords: &["دل", "مھانگو", "پئسو", "پيار", "پھرين آڱر ۽ آڱوٺو مڙيل ھٿ", "چپٽي"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
			tts:      Some("දබරැඟ\u{dd2}ල\u{dca}ල සහ ම\u{dcf}පට ඇඟ\u{dd2}ල\u{dca}ල කත\u{dd2}ර කළ අත"),
			keywords: &[
				"ආදරය",
				"දබරැඟ\u{dd2}ල\u{dca}ල සහ ම\u{dcf}පට ඇඟ\u{dd2}ල\u{dca}ල කත\u{dd2}ර කළ අත",
				"ම\u{dd2}ල අධ\u{dd2}ක",
				"ම\u{dd4}දල\u{dca}",
				"සැණෙක\u{dd2}න\u{dca}",
				"හදවත",
			],
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("ruka s prekríženým ukazovákom a palcom"),
			keywords: &[
				"drahé",
				"lusknutie",
				"láska",
		...
		crate::Annotation {
			lang:     "sl",
			tts:      Some("roka s prekrižanima kazalcem in palcem"),
			keywords: &[
				"denar",
				"drago",
				"ljubezen",
		...
		crate::Annotation {
			lang:     "so",
			tts:      Some("gacanta farta caarada iyo suulka la dhaafay"),
			keywords: &[
				"dhaqso",
		...
		crate::Annotation {
			lang:     "sq",
			tts:      Some("dorë me gishtin tregues dhe të madhin të kapur"),
			keywords: &[
				"<3",
				"dashuri",
				"dorë",
		...
		crate::Annotation {
			lang:     "sr",
			tts:      Some("рука са прекрштеним палцем и кажипрстом"),
			keywords: &[
				"<3",
				"кажипрст",
				"новац",
		...
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("ruka sa prekrštenim palcem i kažiprstom"),
			keywords: &[
				"<3",
				"kažiprst",
				"ljubav",
		...
		crate::Annotation {
			lang:     "sv",
			tts:      Some("hand med tummen och pekfingret korsade"),
			keywords: &[
				"dyrt",
				...
				"pengaprassel",
				"pengar",
				"snäppa med fingrarna",
			],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
			tts:      Some("vidole vya shahada na gumba vinavyopitana"),
			keywords: &[
				"ghali",
				"hela",
				"moyo",
		...
		crate::Annotation {
			lang:     "ta",
			tts:      Some(
				"ஆள\u{bcd}க\u{bbe}ட\u{bcd}டி விரலுடன\u{bcd} கட\u{bcd}டைவிரல\u{bcd} குறுக\u{bcd}கிட\u{bcd}ட கை",
			),
			keywords: &[
				"அன\u{bcd}பு",
				"ஆள\u{bcd}க\u{bbe}ட\u{bcd}டி விரலுடன\u{bcd} கட\u{bcd}டைவிரல\u{bcd} குறுக\u{bcd}கிட\u{bcd}ட கை",
		...
		crate::Annotation {
			lang:     "te",
			tts:      Some(
				"చూపుడు వ\u{c47}లును బ\u{c4a}టనవ\u{c47}లుక\u{c3f} త\u{c3e}క\u{c3f}స\u{c4d}తున\u{c4d}న చ\u{c47}య\u{c3f}",
			),
			keywords: &[
				"ఖర\u{c40}ద\u{c48}నద\u{c3f}",
				"గుండ\u{c46}",
				"చ\u{c3f}ట\u{c3f}క",
				"చూపుడు వ\u{c47}లును బ\u{c4a}టనవ\u{c47}లుక\u{c3f} త\u{c3e}క\u{c3f}స\u{c4d}తున\u{c4d}న చ\u{c47}య\u{c3f}",
				"డబ\u{c4d}బు",
		...
		crate::Annotation {
			lang:     "th",
			tts:      Some("น\u{e34}\u{e49}วช\u{e35}\u{e49}ไขว\u{e49}น\u{e34}\u{e49}วโป\u{e49}ง"),
			keywords: &[
				"ด\u{e35}ด",
				"น\u{e34}\u{e49}วช\u{e35}\u{e49}ไขว\u{e49}น\u{e34}\u{e49}วโป\u{e49}ง",
				"ม\u{e34}น\u{e34}ฮาร\u{e4c}ท",
				"ม\u{e37}อ",
				"ร\u{e31}ก",
				"ห\u{e31}วใจ",
				"เง\u{e34}น",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ኢድ ምስ ጠቋሚ ኣጻብዕትን ዓባስ ኣጻብዕትን ዝተቖላለፉ"),
			keywords: &[
				"<3",
				"ልቢ",
				"ስናፕ ምግባር",
		...
		crate::Annotation {
			lang:     "tk",
			tts:      Some("süýem we başam barmagy çapraz el"),
			keywords: &[
				"berkitmek",
				"gymmat",
				"pul",
		...
		crate::Annotation {
			lang:     "to",
			tts:      Some("louhiʻinima moe motuʻatuhu fehauaki"),
			keywords: &["fisipā", "louhiʻinima moe motuʻatuhu fehauaki", "mamafa", "paʻanga"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("işaret parmağı ve baş parmak birbirine geçmiş el"),
			keywords: &[
				"<3",
				"aşk",
				"borç",
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("شہادت کی انگلی اور انگوٹھہ کراس کیے ہوئے ہاتھ"),
			keywords: &[
				"دل",
				"دولت",
				"رقم",
		...
		crate::Annotation {
			lang:     "uz",
			tts:      Some("bosh va koʻrsatkich barmoqlar kesishgan qoʻl"),
			keywords: &[
				"<3",
		...
		crate::Annotation {
			lang:     "vi",
			tts:      Some("bàn tay với ngón trỏ và ngón cái bắt chéo"),
			keywords: &[
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("ọwọ\u{301} pẹ\u{300}lú ìka kẹ\u{301}keré àti ìka ńlá ní pípapọ\u{300}"),
			keywords: &[
				"heart",
				"owó",
				"snap àti atanpako to wà papọ\u{300}",
				"wọ\u{301}n",
				"ìfẹ\u{301}",
				"ọwọ\u{301} pẹ\u{300}lú ìka kekeré",
				"ọwọ\u{301} pẹ\u{300}lú ìka kẹ\u{301}keré àti ìka ńlá ní pípapọ\u{300}",
			],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("ɔwɔ\u{301} pɛ\u{300}lú ìka kɛ\u{301}keré àti ìka ńlá ní pípapɔ\u{300}"),
			keywords: &[
				"heart",
				"owó",
				"snap àti atanpako to wà papɔ\u{300}",
				"wɔ\u{301}n",
				"ìfɛ\u{301}",
				"ɔwɔ\u{301} pɛ\u{300}lú ìka kekeré",
				"ɔwɔ\u{301} pɛ\u{300}lú ìka kɛ\u{301}keré àti ìka ńlá ní pípapɔ\u{300}",
			],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
			tts:      Some("食指同拇指交叉嘅手"),
			keywords: &["心心", "愛", "打斷", "貴", "錢", "食指同拇指交叉嘅手"],
		},
		#[cfg(feature = "yue_Hans")]
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("食指同拇指交叉嘅手"),
			keywords: &["心心", "打断", "爱", "贵", "钱", "食指同拇指交叉嘅手"],
		},
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
		...
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("食指和拇指交叉的手"),
			keywords: &["<3", "彈響指", "愛", "愛心", "手", "昂貴", "貴的", "錢", "食指和拇指交叉的手"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
...
pub const LOVE_YOU_GESTURE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("إشارة أحبك"),
			keywords: &["أحبك", "أصابع", "إشارة", "بحبك", "تأشير", "ثلاثة أصابع", "يد"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
			tts:      Some("ভ\u{9be}লপোৱ\u{9be}ৰ ইঙ\u{9cd}গিত"),
			keywords: &["প\u{9cd}ৰেম", "ভ\u{9be}লপোৱ\u{9be}ৰ ইঙ\u{9cd}গিত", "হ\u{9be}ত"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["жест „обичам те“", "обичам те", "ръка", "три пръста"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["dits", "gest de t’estimo", "mà", "tres dits", "t’estimo"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["elsker dig", "elsker dig-gestus", "hånd", "håndtegn", "tre fingre"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
			tts:      Some("Ich-liebe-dich-Geste"),
			keywords: &["Finger", "Geste", "Hand", "Ich-liebe-dich-Geste", "Liebe", "drei", "hdl"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation {
			...
			keywords: &["ILY", "κίνηση σε αγαπώ", "σε αγαπώ", "τρία δάχτυλα", "χέρι"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
			tts:      Some("love-you gesture"),
			keywords: &["ILY", "fingers", "gesture", "hand", "love", "love-you", "three", "you"],
		},
		#[cfg(feature = "en_AU")]
		crate::Annotation { lang: "en_AU", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_CA")]
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["amor", "mano", "rock", "te amo", "te quiero", "tres dedos"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			...
			keywords: &["armastan", "armastus", "kolm", "käsi", "sind", "sõrmed", "žest"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			...
			keywords: &["دست", "دوست دارم", "دوستت دارم", "سه انگشت", "علامت دوستت دارم"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("rakastan sinua -ele"),
			keywords: &["fanitus", "kolme sormea", "käsi", "rakastan sinua -ele", "rakkaus"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
			tts:      Some("love-you gesture"),
			keywords: &["ILY", "astig", "kamay", "love-you gesture", "rak-en-rol"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			...
			keywords: &["I Love You", "ILY", "man", "xesto", "xesto das iniciais de \"I Love You\""],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			...
			keywords: &[
				"તારાથી પ\u{acd}ર\u{ac7}મ છ\u{ac7}",
				"ત\u{acd}રણ આ\u{a82}ગળીયો",
				"પ\u{acd}રણય",
				"પ\u{acd}રીત",
				"પ\u{acd}ર\u{ac7}મ",
				"પ\u{acd}ર\u{ac7}મમા\u{a82}",
				"હાથ",
				"હાવભાવ પ\u{acd}રત\u{acd}ય\u{ac7} પ\u{acd}ર\u{ac7}મ",
			],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"तीन अ\u{902}ग\u{941}लिया\u{902}",
				"प\u{94d}यार का इशारा",
				"म\u{948}\u{902} त\u{941}मस\u{947} प\u{94d}यार करता ह\u{942}\u{901}",
				"हाथ",
			],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			...
			keywords: &["gesta \"volim te\"", "ljubav", "ruka", "tri prsta"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["ILU", "ILY", "gerakan sayang kamu", "mantap", "metal", "tangan", "tiga jari"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("afus n tayri"),
			keywords: &["afus n tayri"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("сені сүйемін белгісі"),
			keywords: &["сені сүйемін", "сені сүйемін белгісі", "қол", "үш саусақ"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಪ\u{ccd}ರ\u{cc0}ತ\u{cbf}ಸುತ\u{ccd}ತ\u{cc7}ನ\u{cc6} ಸ\u{cc2}ಚನ\u{cc6}"),
			keywords: &[
				"ಐ ಲವ\u{ccd} ಯ\u{cc2}",
				"ಐಎಲ\u{ccd}\u{200c}ವ\u{cc8}",
				"ಕ\u{cc8}",
				"ಪ\u{ccd}ರ\u{cc0}ತ\u{cbf}ಯ ಸಂಕ\u{cc7}ತ",
				"ಪ\u{ccd}ರ\u{cc0}ತ\u{cbf}ಸುತ\u{ccd}ತ\u{cc7}ನ\u{cc6} ಸ\u{cc2}ಚನ\u{cc6}",
				"ಮ\u{cc2}ರು ಬ\u{cc6}ರಳು",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("사랑을 표시하는 손"),
			keywords: &["사랑 제스처", "사랑을 표시하는 손", "사랑해", "손", "손가락 세개"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &[
				"ILY",
				"ທ\u{ec8}າເລ\u{eb5}ບຢ\u{eb9}",
				"ມ\u{eb7}",
				"ຮ\u{eb1}ກ",
				"ຮ\u{eb1}ກເດ\u{eb5}\u{ec9}",
			],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["дланка", "знак „те сакам“", "рака", "те сакам", "три прста"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &[
				"आय लव\u{94d}ह य\u{942}",
				"प\u{94d}र\u{947}म करतो/त\u{947} सा\u{902}गणार\u{947} हातवार\u{947}",
				"प\u{94d}र\u{947}माच\u{947} स\u{902}क\u{947}तचिन\u{94d}ह",
		...
		crate::Annotation {
			...
			keywords: &["ILY", "cinta", "gerak isyarat", "jari", "kamu", "sayang kamu", "tangan", "tiga"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["ILY", "glad i deg", "glad i deg-teikn", "hand", "teiknspråk"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ਪਿਆਰ",
				"ਪਿਆਰ ਦਾ ਇਜ\u{a3c}ਹਾਰ",
				"ਮ\u{a41}ਹ\u{a71}ਬਤ",
				"ਹ\u{a71}ਥ",
				"ਹ\u{a71}ਥ ਨਾਲ ਇਸ\u{a3c}ਾਰਾ",
			],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			...
			keywords: &["اسم صفت دے مطابق کیتا گیا کم", "تہاڈے نال پریم آ دا اشارہ", "ہتھ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("A Lọ\u{301}v Yu Sain"),
			keywords: &["A Lọ\u{301}v Yu Sain", "ALY", "Hand"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("gest Kocham cię"),
			keywords: &["dłoń", "gest", "kocham", "miłości", "miłość", "palce", "rogi", "ręka", "znak"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
			tts:      Some("د مینې اشاره"),
			keywords: &["ILY", "اشاره", "ته", "درې", "لاس", "مینه", "مینه-تاسو", "ګوتې"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("gesto de \"te amo\""),
			keywords: &["gesto de \"te amo\"", "mão", "te amo", "te amo, gesto de amor"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("gesto \"amo-te\""),
			keywords: &["amo-te", "gesto \"amo-te\"", "gesto de amo-te", "mão", "três dedos"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1025"), keywords: &["E10-1025"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("я-тебя-люблю"),
			keywords: &["жест", "люблю", "пальца", "пальцы", "рука", "три"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("ľúbim ťa"),
			keywords: &["gesto Ľúbim ťa", "prsty", "ruka", "tri prsty", "Ľúbim ťa", "ľúbim ťa", "ľúbiť"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("znak za ljubim te"),
			keywords: &["RTM", "ljubim te", "roka", "trije prsti", "znak za ljubim te"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("meedaarta waan ku jecelahay ah"),
			keywords: &["WKJ", "gacan", "meedaarta waan ku jecelahay", "meedaarta waan ku jecelahay ah"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			...
			keywords: &["волим", "прсти", "рукa", "три", "шака"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			...
			keywords: &["prsti", "ruka", "tri", "volim", "šaka"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"న\u{c3f}న\u{c4d}ను ప\u{c4d}ర\u{c47}మ\u{c3f}స\u{c4d}తున\u{c4d}న\u{c3e}ను అన\u{c47} సంజ\u{c4d}ఞ",
				"మూడు వ\u{c47}ళ\u{c4d}ల స\u{c48}గ",
				"లవ\u{c4d}-యూ జ\u{c46}స\u{c4d}చర\u{c4d}",
			],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ናይ ፍቕሪ ምልክት"),
			keywords: &["ምልክት", "ሰለስተ", "ንስኻ", "አ.የ.ኢ", "ኢድ", "ኣጻብዕቲ", "ፍቕሪ", "ፍቕሪ-ንዓኻ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["mafu", "nima", "nima fakaʻilonga mafu"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("seni seviyorum işareti"),
			keywords: &["SS", "el", "seni seviyorum", "seni seviyorum işareti"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["жест", "жест «кохаю тебе»", "піднята рука", "рука", "три пальці", "фанат"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["qoʻl", "sevaman degan ishora", "uch barmoq"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("cử chỉ yêu nhau"),
			keywords: &["anh yêu em", "ba ngón tay", "cử chỉ yêu nhau", "tay"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("ìfɔwɔ\u{301}júwè mo ní ìfɛ\u{301}"),
			keywords: &["ILY", "ìfɔwɔ\u{301}júwè mo ní ìfɛ\u{301}", "Ɔwɔ\u{301}"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("爱你的手势"),
			keywords: &["三种", "我爱你", "手", "爱你", "爱你的手势"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("愛你手勢"),
			keywords: &["ILY", "三指", "愛你", "愛你手勢", "我愛你", "手"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("我愛你手勢"),
			keywords: &["ILY", "三隻手指", "愛你", "愛你手勢", "我愛你", "我愛你手勢", "手", "手勢"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const SIGN_OF_THE_HORNS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("የቀንዶች ምልክት"),
			keywords: &["ቀንዶች", "አካል", "እጅ", "እጅ፣ ቀንዶች፣ ጣት፣ የቀንዶች ምልክት፣ መመቸት", "የቀንዶች ምልክት", "ጣት"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("إشارة قرون"),
			keywords: &["إشارة قرون", "إصبع", "الناس والأعضاء", "جسد", "روك", "قرون", "يد"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["знак на рогата", "метъл", "пръст", "рога", "рок", "рок музика", "ръка", "тяло"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("djævletegn"),
			keywords: &["djævletegn", "finger", "fingre", "heavy metal", "horn", "hånd", "metal", "rock"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["δάχτυλο", "κέρατα", "κουλ", "ροκ", "ροκάρω", "σώμα", "χέρι", "χειρονομία ροκ"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["cuernos", "dedo", "mano", "mano haciendo el signo de cuernos", "rock"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["cuernos", "dedos", "mano haciendo los cuernos", "rock", "roll"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation {
			...
			keywords: &["käsi", "märk", "rokk", "sarved", "sõrmed"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("adarrak adierazten dituen eskua"),
			keywords: &["adarra", "adarrak adierazten dituen eskua", "eskua", "gorputza", "hatza"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("نماد شاخ"),
			keywords: &["انگشت", "بدن", "دست", "راک", "شاخ", "شیطان", "نماد شاخ"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["lean ort", "lámh", "lámh na binne", "méar", "seinn ort", "siombail na n-adharc"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("samhla nan adharc"),
			keywords: &["adharc", "corrag", "làmh", "meur", "rocamaid", "samhla nan adharc"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("znak rogova"),
			keywords: &["prst", "rogovi", "rokaj", "ruka", "znak rogova", "šaka"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["aka", "akara nke mpi gasị", "mkpịsịaka", "mkpịsịaka abụọ", "mpi gasị"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("角の指サイン"),
			keywords: &["キツネ", "ロックオン", "人差し指と小指を立てた手", "手", "角の指サイン"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("tandha sungu"),
			keywords: &["driji", "isarat gandem apike", "sungu", "tandha sungu", "tangan"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("რქების ნიშანი"),
			keywords: &["თითი", "როკი", "რქები", "რქების ნიშანი", "სხეული", "ტანი", "ხელი"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
			tts:      Some("azamul n wacciwen"),
			keywords: &["azamul n wacciwen"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("мүйіз белгісі"),
			keywords: &["мүйіз", "мүйіз белгісі", "рок", "саусақ", "тамаша", "қол"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
			tts:      Some("djævletegn"),
			keywords: &["djævletegn", "finger", "heavy metal", "horn", "hånd", "krop"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಕ\u{cca}ಂಬುಗಳ ಸ\u{cc2}ಚನ\u{cc6}"),
			keywords: &[
				"ಕ\u{cc8}",
				"ಕ\u{cca}ಂಬು",
				"ಕ\u{cca}ಂಬುಗಳ ಸ\u{cc2}ಚನ\u{cc6}",
				"ಕ\u{cca}ಂಬುಗಳು",
				"ಬ\u{cc6}ರಳು",
				"ಯ\u{ccb}ಯ\u{ccb}",
				"ರಾಕ\u{ccd}-ಆನ\u{ccd}",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("뿔 모양 손짓"),
			keywords: &["락 음악", "뿔", "뿔 모양 손짓", "손", "손 모양", "손가락", "신남", "힙합"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["Dio", "pirksts", "ragi", "ragu simbols", "roka", "rokmūzika", "smagais metāls"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["औ\u{902}ला", "रक-अन", "सि\u{902}ङको चिन\u{94d}ह", "सिङ\u{94d}", "हात"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("duivelshorens"),
			keywords: &["hand", "hoorns", "rock on", "teken", "vinger"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["Fínga", "Hand", "Họn-dẹm", "Họ\u{301}n Sain", "Rọ\u{301}k-ọ\u{301}n Sain"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		crate::Annotation {
			...
			keywords: &["chifres", "dedos", "metal", "mão", "rock", "saudação do rock"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1018"), keywords: &["E10-1018"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("рокерский жест"),
			keywords: &["жест", "коза", "пальцы", "рок", "рокерский", "рука", "фанат"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["brirë", "dorë", "gisht", "rok", "shenja e brirëve"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("знак рогова"),
			keywords: &["метал", "прст", "рогови", "шака"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("↑↑↑"),
			keywords: &["знак рогова", "метал", "прст", "рогови", "рука"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("znak rogova"),
			keywords: &["metal", "prst", "rogovi", "šaka"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("↑↑↑"),
			keywords: &["metal", "prst", "rogovi", "ruka", "znak rogova"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &["cheza", "ishara ya pembe", "kidole", "mkono", "mwili", "pembe"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &[
				"ఆనంద\u{c4b}త\u{c4d}స\u{c3e}హం",
				"క\u{c4a}మ\u{c4d}ము",
				"క\u{c4a}మ\u{c4d}ములు",
				"క\u{c4a}మ\u{c4d}ములు సూచ\u{c3f}ంచ\u{c47} గుర\u{c4d}తు",
				"చ\u{c47}య\u{c3f}",
				"ర\u{c3e}క\u{c3e}న\u{c4d}",
				"ర\u{c3e}క\u{c4d} ఆన\u{c4d}",
				"వ\u{c47}ళ\u{c4d}లు",
				"స\u{c3f}ంబల\u{c4d}",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ምልክት ቀርኒ"),
			keywords: &["ምልክት", "ቀርኒ", "ኢድ", "ኣጻብዕቲ", "ከውሒ-ኣብ ልዕሊ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["nima", "nima fakaʻilonga fakatēvolo", "tēvolo"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			...
			keywords: &["baaraam", "béjjen", "lem", "loxo", "loxo def màndarga béjjen"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
			tts:      Some("uphawu lweempondo"),
			keywords: &["iimpondo", "isandla", "qhubeka", "umnwe", "uphawu lweempondo"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Aami Awɔn Iwo"),
			keywords: &["19900", "Aami Awɔn Iwo", "ìka", "ìwo", "ɔwɔ\u{301}"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("摇滚"),
			keywords: &["手", "摇滚", "摇滚精神", "燥起来", "角", "金属礼"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("ROCK"),
			keywords: &["ROCK", "手指", "搖滾手勢", "搖滾精神", "繼續搖滾"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["rock", "手", "手指", "搖滾"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("uphawu lwezimpondo"),
			keywords: &["isandla", "izimpondo", "umunwe", "umzimba", "uphawu lwezimpondo"],
		},
	],
};
#[doc = "🤘🏻"]
...
pub const CALL_ME_HAND: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["bel", "bel my hand", "bel my met selfoon", "hand", "maak oproep", "selfoon"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
			tts:      Some("ደውልልኝ የእጅ ምልክት"),
			keywords: &["አሪፍ", "እጅ", "ይመችህ", "ይመችሽ", "ደውል", "ደውልልኝ", "ደውልልኝ የእጅ ምልክት", "ደውይ", "ግጨው"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["\"mənə zəng et\" işarəsi", "mənə zəng et", "telefon", "yığmaq", "zəng", "əlaqə"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["hånd", "krop", "opringning", "ring til mig-hånd", "ringer", "telefonhånd"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
			tts:      Some("Ruf-mich-an-Handzeichen"),
			keywords: &["Anruf", "Hand", "Ruf-mich-an-Handzeichen", "Shaka", "anrufen", "ruf"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			lang:     "en_CA",
			tts:      Some("call-me hand"),
			keywords: &["Shaka", "call", "call me hand", "call-me hand", "hand", "hang loose"],
		},
		#[cfg(feature = "en_GB")]
		crate::Annotation { lang: "en_GB", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_IN")]
		...
		crate::Annotation {
			...
			keywords: &["llamar", "mano", "mano haciendo el gesto de llamar", "meñique", "pulgar"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("mano haciendo el gesto de llamar"),
			keywords: &["gesto", "llamada", "mano", "mano haciendo el gesto de llamar"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation {
			lang:     "es_US",
		...
		crate::Annotation {
			...
			keywords: &["تلفن", "تماس بگیر", "دست", "دست به شکل تلفن", "زنگ", "زنگ بزن"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["an lámh cur glao orm", "glao", "glaoch", "glaoigh orm", "guthán", "lámh"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["hannu", "hannun kira ni", "kira", "kira ni", "kira waya", "kiran waya"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["isyarat", "panggil saya", "tangan", "telepon", "telepon aku", "telepon saya"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			...
			keywords: &["ಕರ\u{cc6} ಮಾಡು", "ಕರ\u{cc6} ಮಾಡು ಸಂಜ\u{ccd}ಞ\u{cc6}", "ಕ\u{cc8}"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		crate::Annotation {
			...
			keywords: &["bel me-gebaar", "bel mij-gebaar", "bellen", "hand", "handgebaar voor bellen"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1019"), keywords: &["E10-1019"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["අත", "ඇමත\u{dd4}ම", "මට ඇමත\u{dd4}මක\u{dca} දෙන\u{dca}න ඇගව\u{dd3}ම"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			...
			keywords: &["dorë", "dorë me shenjën “më telefono”", "telefonatë", "telefono"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &["اشارہ", "جسم", "فون کرنا", "کال", "کال کرنے کا اشارہ", "ہاتھ"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("menga telefon qil"),
			keywords: &["Shaka", "ishora", "menga telefon qil", "qo‘l", "telefon qil"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
