...
pub const SPORTS_MEDAL: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["بطل", "جائزة", "ذهبية", "رابح", "رياضة", "ميدالية", "ميدالية رياضية"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["idman medalı", "medal", "qalib"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["злато", "медал", "награда", "победител", "спортен медал"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
			...
			keywords: &[
				"খেল\u{9be}র পদক",
				"পদক",
				"প\u{9c1}রস\u{9cd}ক\u{9be}র",
				"সোন\u{9be}",
				"স\u{9cd}বর\u{9cd}ণপদক",
			],
		},
		#[cfg(feature = "br")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["esport", "guanyador", "guanyadora", "medalla", "or", "premi"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["guld", "medalje", "sportsmedalje", "vinder"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
			tts:      Some("Sportmedaille"),
			keywords: &["Gewinn", "Goldmedaille", "Medaille", "Sportmedaille"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation {
			lang:     "el",
			tts:      Some("μετάλλιο"),
			keywords: &["έπαθλο", "βραβείο", "μετάλιο", "μετάλλιο", "νικητής", "χρυσό"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "et",
			tts:      Some("medal"),
			keywords: &["kuld", "medal", "sport", "võit"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			...
			keywords: &["bonn", "bonn spóirt", "bonn óir", "buaiteoir", "ór"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &[
				"ઈનામ",
				"ખ\u{ac7}લ-ક\u{ac2}દ માટ\u{ac7}નો મ\u{ac7}ડલ",
				"મ\u{ac7}ડલ",
				"વિજય",
				"વિજયી",
				"સ\u{ac1}વર\u{acd}ણ ચ\u{a82}દ\u{acd}રક",
			],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["ख\u{947}ल का पदक", "ख\u{947}ल पदक", "पदक", "स\u{94d}वर\u{94d}ण"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
			tts:      Some("sportska medalja"),
			keywords: &["medalja", "prva", "prvi", "sportska medalja", "zlatna medalja"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("sportérem"),
			keywords: &["aranyérem", "győztes", "medál", "sportérem", "érem"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
			tts:      Some("մարզական մեդալ"),
		...
		crate::Annotation {
			...
			keywords: &["emas", "medali", "menang", "olahraga", "penghargaan"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("メダル"),
			keywords: &["スポーツ", "メダル", "優勝", "表彰", "金", "金メダル"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("medali olahraga"),
			keywords: &["emas", "medali", "medali olahraga"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("cciɛa n waddal"),
			keywords: &["cciɛa n waddal"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("спорттық медаль"),
			keywords: &["жеңіс", "медаль", "спорттық медаль"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಕ\u{ccd}ರ\u{cc0}ಡಾ ಪದಕ"),
			keywords: &[
				"ಕ\u{ccd}ರ\u{cc0}ಡಾ ಪದಕ",
				"ಚ\u{cbf}ನ\u{ccd}ನದ ಪದಕ",
				"ಪದಕ",
				"ಪುರಸ\u{ccd}ಕಾರ",
				"ಮ\u{cc6}ಡಲ\u{ccd}",
				"ಮ\u{cca}ದಲ ಸ\u{ccd}ಥಾನದ ಪದಕ",
				"ವ\u{cbf}ಜ\u{cc7}ತ",
			],
		},
		#[cfg(feature = "ko")]
		...
		crate::Annotation {
			...
			keywords: &["auksas", "laimėtojas", "medalis", "nugalėtojas", "sporto medalis"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("sporta medaļa"),
			keywords: &["medaļa", "sporta medaļa", "sports", "uzvarētājs", "zelts"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["златен", "злато", "медал", "награда", "победник", "спорт", "спортски медал"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
			tts:      Some("സ\u{d4d}\u{200c}പോർട\u{d4d}\u{200c}സ\u{d4d} മെഡൽ"),
			keywords: &["മത\u{d4d}സരം", "മെഡൽ", "സ\u{d4d}\u{200c}പോർട\u{d4d}സ\u{d4d}"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["emas", "juara", "medal sukan", "pingat", "pingat sukan"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["medal", "medal sportowy", "nagroda", "sport", "zawody"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			...
			keywords: &["medalha", "medalha desportiva", "ouro", "vitória"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-389"), keywords: &["E10-389"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("спортивная медаль"),
			keywords: &["достижение", "медаль", "место", "победа", "спорт", "спортивная медаль"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["ක\u{dca}\u{200d}ර\u{dd3}ඩ\u{dcf} පදක\u{dca}කම", "පදක\u{dca}කම"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			...
			keywords: &["medalja", "zlato", "zmaga", "zmagovalec", "športna medalja"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["e artë", "fitues", "medalje", "medalje sportive", "sport"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("спортска медаља"),
			keywords: &["злато", "мeдaљa", "награда", "победник", "спорт"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("sportska medalja"),
			keywords: &["medalja", "nagrada", "pobednik", "sport", "zlato"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			...
			keywords: &[
				"தங\u{bcd}க பதக\u{bcd}கம\u{bcd}",
				"தங\u{bcd}கப\u{bcd}பதக\u{bcd}கம\u{bcd}",
				"பதக\u{bcd}கம\u{bcd}",
				"மெடல\u{bcd}",
				"விருது",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"పతకం",
				"బంగ\u{c3e}రు ప\u{c3e}తకము",
				"మ\u{c46}డల\u{c4d}",
				"వ\u{c3f}జ\u{c47}త",
				"వ\u{c3f}న\u{c4d}నర\u{c4d}",
			],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["ก\u{e35}ฬา", "ทอง", "ผ\u{e39}\u{e49}ชนะ", "รางว\u{e31}ล", "เหร\u{e35}ยญ"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ስፖርታዊ መዳልያ"),
			keywords: &["መዳልያ", "ስፖርት", "ሽልማት", "ተዓዋቲ", "ወርቂ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["mētali", "mētali fakasipoti", "sipoti"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("spor madalyası"),
			keywords: &["altın madalya", "madalya", "spor madalyası"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["золота медаль", "медаль", "спортивна медаль"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["gʻolib", "medal", "oltin", "sport medali", "yutuq"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("huy chương thể thao"),
			keywords: &["chiến thắng", "huy chương", "huy chương thể thao", "huy chương vàng", "vô địch"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("體育獎章"),
			keywords: &["冠軍", "獎牌", "獎章", "運動獎牌", "金牌", "體育獎章"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const SECOND_PLACE_MEDAL: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ثاني", "ثان\u{64d}", "فضية", "ميدالية", "ميدالية مركز ثان\u{64d}", "٢"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
			tts:      Some("২য\u{9bc} স\u{9cd}থ\u{9be}নৰ পদক"),
			keywords: &["দ\u{9cd}বিতীয\u{9bc}", "পদক", "২য\u{9bc} স\u{9cd}থ\u{9be}নৰ পদক", "ৰ\u{9c2}প"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["andenplads", "andenpræmie", "medalje", "sølv", "sølvmedalje", "vinder"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["medalla", "medalla de plata", "medalla de segundo lugar", "plata", "segundo"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			...
			keywords: &["2", "2ú", "airgead", "bonn", "bonn airgid", "dara", "dara háit"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["dua", "juara", "kedua", "medali", "perak", "peringkat", "posisi"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			...
			keywords: &["argento", "medaglia", "medaglia d’argento", "secondo posto", "sport"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			...
			keywords: &["ທ\u{eb5}ສອງ", "ຫ\u{ebc}ຽນ", "ຫ\u{ebc}ຽນເງ\u{eb4}ນ", "ເງ\u{eb4}ນ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
			tts:      Some("2-osios vietos medalis"),
			keywords: &["2 vieta", "2-osios vietos medalis", "antroji", "medalis", "sidabras"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("medaļa par 2. vietu"),
			keywords: &["2. vieta", "medaļa", "medaļa par 2. vietu", "otrā", "sudraba"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["kedua", "medal", "medal tempat ke-2", "perak", "pingat tempat kedua"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["medaille", "medaille 2e plaats", "tweede", "tweede plaats", "zilver"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		crate::Annotation {
			...
			keywords: &["2ୟ ସ\u{b4d}ଥ\u{b3e}ନ ପଦକ", "ଦ\u{b4d}ୱ\u{b3f}ତୀୟ", "ପଦକ", "ରୌପ\u{b4d}ୟ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਚਾ\u{a02}ਦੀ ਦਾ ਤਮਗਾ"),
			keywords: &["ਚਾ\u{a02}ਦੀ ਦਾ ਤਮਗਾ", "ਤਮਗਾ", "ਦ\u{a42}ਜਾ", "ਮ\u{a48}ਡਲ", "ਸਿਲਵਰ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			...
			keywords: &["2nd Plés Mẹ\u{301}dal", "Mẹ\u{301}dal", "Sílva", "Sẹ\u{301}kọn"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		crate::Annotation {
			...
			keywords: &["medalha", "medalha de 2.º lugar", "medalha de prata", "prata", "segundo"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		crate::Annotation {
			...
			keywords: &["al doilea", "argint", "locul doi", "medalie", "medalie locul II"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-1063"), keywords: &["E10-1063"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["gümüş", "ikinci", "ikincilik madalyası", "madalya", "İkincilik madalyası"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
