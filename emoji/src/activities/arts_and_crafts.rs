...
pub const PERFORMING_ARTS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["icra etmək", "incəsənət", "maska", "teatr", "teatr incəsənəti"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("выканальніцкія віды мастацтва"),
			keywords: &["выканальніцкія віды мастацтва", "маска", "мастацтва", "тэатр", "ігра"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
		...
		crate::Annotation {
			...
			keywords: &["izvedba", "maska", "pozorište", "scenske umjetnosti", "umjetnina"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎾᎾᏛᏁᎵᏍᎬᎢ"),
			keywords: &["ᎠᎵᎬᏚᎶᎢ", "ᎠᏛᏁᎸᏍᎬ", "ᎠᏛᏁᎸᏍᎬᎢ", "ᎤᎾᏛᏁᏟᏗᎢ", "ᎾᎾᏛᏁᎵᏍᎬᎢ", "ᏗᏟᎶᏍᏔᏅᎢ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["celf", "celfyddydau perfformiadol", "mwgwd", "perfformiadol", "theatr"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			...
			keywords: &["antzoki", "areto", "arte", "arte eszenikoak", "eszeniko", "maskara"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("هنرهای نمایشی"),
			keywords: &["تئاتر", "سالن تئاتر", "ماسک", "ماسک نقاب", "نمایش", "هنر", "هنرهای نمایشی"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["ballett", "leikhús", "list", "sjónleikur", "útinnandi leiklistir"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("spectacle vivant"),
			keywords: &["acteur", "actrice", "art", "masque", "spectacle", "spectacle vivant", "théâtre"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["aghaidh-choimheach", "cleasachd", "ealain-chluiche", "ealan", "taigh-cluich"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
			tts:      Some("máscaras"),
			keywords: &["actuación", "arte", "artes interpretativas", "máscaras", "teatro"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			...
			keywords: &["אמנויות הבמה", "במה", "דרמה", "מסיכות", "משחק", "פורים", "תיאטרון"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["izvedba", "izvedbene umjetnosti", "kazalište", "maska", "umjetnost"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["արվեստ", "դիմակ", "թատրոն", "կատարողական արվեստ", "ներկայացում"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["leikhúsgrímur", "leiklist", "list", "skemmtun", "sviðslistir"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("舞台芸術"),
			keywords: &["仮面", "俳優", "劇場", "女優", "役者", "演劇", "演芸", "舞台芸術", "芸術"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["თეატრალური ხელოვნება", "თეატრი", "ნიღაბი", "შესრულება", "ხელოვნება"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("igelmusen"), keywords: &["igelmusen"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		#[cfg(feature = "kl")]
		crate::Annotation { lang: "kl", tts: Some("masker"), keywords: &["masker", "teater"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
			tts:      Some(
		...
		crate::Annotation {
			...
			keywords: &["ການສະແດງ", "ສ\u{eb4}ລະປະ", "ສ\u{eb4}ລະປະການສະແດງ", "ໂຮງລະຄອນ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["maska", "māksla", "priekšnesums", "skatuves māksla", "teātris", "šekspīrs"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
			tts:      Some("ngā toi whakaaturanga"),
			keywords: &["ngā toi whakaaturanga", "toi", "whakaaturanga", "whare tapere", "ārai"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["അന\u{d41}ഷ\u{d4d}ഠ\u{d3e}ന കല", "ന\u{d3e}ടകം", "ന\u{d3e}ട\u{d4d}യകല"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["hiburan", "panggung", "pelakon", "persembahan", "seni", "teater", "topeng"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["اداکاری کرنا", "تھیٹر", "فن", "فن انجام دیندیاں ہوئیاں", "ماسک"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-365"), keywords: &["E10-365"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("маски"),
		...
		crate::Annotation {
			lang:     "rw",
			tts:      Some("imyiyereko"),
			keywords: &["imyiyereko", "inzu iberamo imyiyereko", "kwiyerekana", "masike", "ubugeni"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["gledališče", "maska", "nastopanje", "scenske umetnosti", "umetnost"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("fulinta farshaxanka"),
			keywords: &["farshaxan", "fulinta", "fulinta farshaxanka", "goobta", "masgaraato", "masraxa"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			...
			keywords: &["мaскa", "позориште", "сцена", "сценска умјетност", "умјeтнoст"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
		...
		crate::Annotation {
			...
			keywords: &["maska", "pozorište", "scena", "scenska umjetnost", "umjetnost"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			lang:     "sw",
			tts:      Some("sanaa"),
			keywords: &["barakoa", "kuigiza", "kusherehesha", "sanaa", "ukumbi wa maigizo"],
		},
		#[cfg(feature = "sw_KE")]
		...
		crate::Annotation {
			...
			keywords: &["иҷро кардан", "намдуҳои санъати иҷро", "ниқоб", "санъат", "театр"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			...
			keywords: &["መዘናግዒ", "ማስክ", "ምፍጻም", "ስነ ጥበብ", "ተዋሳኢት", "ተዋሳኣይ", "ቴስፒያ", "ትያትር"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["ئويۇن كۆرسىتىش", "تىياتىرخانا", "سەنئەت", "كىنوخانا", "كۆرسىتىش", "ماسكا"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("театральне мистецтво"),
			keywords: &["бал", "венеціанський", "венеційський", "вистава", "маска", "маскарад", "театр"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["biểu diễn", "mặt nạ", "nghệ thuật", "nghệ thuật biểu diễn", "nhà hát"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			...
			keywords: &["Ere Awokọṣe", "iṣẹ\u{301} ọná", "tíátà", "àwòkọ\u{301}ṣe", "ìbòjú", "ìtàgé"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Eré oríìtàgé"),
			keywords: &["Ere Awokɔshe", "ishɛ\u{301} ɔná", "tíátà", "àwòkɔ\u{301}she", "ìbòjú", "ìtàgé"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("表演艺术"),
			keywords: &["剧院", "女演员", "戏剧", "演员", "艺术", "莎士比亚", "表演", "表演艺术", "面具"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("表演藝術"),
			keywords: &["劇院", "娛樂", "演員", "藝術", "表演", "表演藝術", "話劇", "面具"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const FRAMED_PICTURE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("إطار وصورة"),
			keywords: &["إطار", "إطار وصورة", "رسم", "صورة", "غاليري", "فن", "متحف", "معرض"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["incəsənət", "muzey", "çəkmək", "çərçivə", "şəkil", "şəkilli çərçivə"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["izvedba", "maska", "pozorište", "umjetnost", "uramljena slika"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			...
			keywords: &["billede", "kunst", "maleri", "museum", "ramme", "ramme med billede"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["εικόνα", "εικόνα σε κορνίζα", "κάδρο", "μουσείο", "πίνακας", "τέχνη"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["arte", "koadro", "koadroa markoarekin", "margolan", "marko", "museo"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("عکس در قاب"),
			keywords: &["تصویر", "عکس در قاب", "قاب", "قاب عکس", "موزه", "نقاشی", "هنر"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("kuva kehyksissä"),
			keywords: &["kehys", "kuva kehyksissä", "maalaus", "museo", "taide", "taulu"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["dealbh", "dealbh le frèam", "ealan", "frèam", "taigh-tasgaidh"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &["אמנות", "מוזיאון", "מסגרת", "מסגרת עם תמונה", "ציור", "תמונה"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["muzej", "okvir", "slika", "slikarstvo", "umjetnost", "uokvirena slika"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["արվեստ", "թանգարան", "նկար", "նկարչություն", "շրջանակ", "շրջանակ նկարով"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("bingkai bergambar"),
			keywords: &["bingkai", "bingkai bergambar", "gambar", "lukisan", "museum", "seni"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("fòto nwere fremụ"),
			keywords: &["fremụ", "fòto", "fòto nwere fremụ", "ihe ǹkà", "ite àgbà", "ụlọ nchekwa ǹkà"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			...
			keywords: &["gambar", "gambar nganggo pigura", "lukisan", "museum", "pigura", "seni"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("ჩარჩო ნახატით"),
			keywords: &["მუზეუმი", "ნახატი", "სურათი", "ჩარჩო", "ჩარჩო ნახატით", "ხატვა", "ხელოვნება"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
		...
		crate::Annotation {
			...
			keywords: &["жақтаулы сурет", "кадр", "музей", "мұражай", "сурет", "сурет салу", "өнер"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &["Bild", "Konscht", "Musée", "Rumm", "Tableau", "agerummt Bild"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["menas", "muziejus", "paveikslas", "piešinys", "rėmas", "rėmas su paveikslu"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["anga", "papa tongarewa", "pikitia", "pikitia whai anga", "toi", "toi peita"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["arti", "frejm", "mużew", "pittura", "stampa", "stampa fi frejm"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			...
			keywords: &["afbeelding", "kunst", "lijst", "lijst met afbeelding", "museum", "schilderij"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
			tts:      Some("innramma bilete"),
			keywords: &["bilete", "innramma bilete", "kunst", "museum", "måleri", "ramme"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["تصویر", "عجائب گھر", "فریم آلی تص\u{651}ویر", "فن", "پینٹینگ", "چوکھٹا"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			...
			keywords: &["malarstwo", "muzeum", "obraz", "obrazek", "ramka", "sztuka", "w ramce"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			...
			keywords: &["arte", "moldura", "museu", "pintura", "quadro", "quadro emoldurado"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		crate::Annotation {
			...
			keywords: &["kancha", "kanchapi rikchay", "llimpi", "museo", "rikchay", "t’iktu"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("tablou înrămat"),
			keywords: &["artă", "muzeu", "pictură", "ramă", "tablou", "tablou cu ramă", "înrămat"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-815"), keywords: &["E10-815"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("картина"),
		...
		crate::Annotation {
			...
			keywords: &["تصوير", "عجائب گھر", "فريم", "فريم ٿيل تصوير", "فن", "نقاشي"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["galéria", "maľba", "múzeum", "obraz", "rám", "umenie", "zarámovaný obraz"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("uokvirjena slika"),
			keywords: &["muzej", "okvir", "risba", "slika", "umetnost", "uokvirjena slika"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("↑↑↑"),
			keywords: &["музej", "рам", "рам са сликом", "сликa", "сликaрствo", "умјетнoст"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
		...
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("↑↑↑"),
			keywords: &["muzej", "ram", "ram sa slikom", "slika", "slikarstvo", "umjetnost"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &["fremu", "fremu yenye picha", "kuchora", "makumbusho", "picha", "sanaa"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &["осорхона", "расм", "санъат", "сурат", "сурати чорчӯбадор", "чорчӯба"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			...
			keywords: &["muzeý", "sungat", "surat", "surat çekmek", "çarçuwa", "çarçuwaly surat"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["müze", "resim", "resimli çerçeve", "sanat", "yağlı boya", "çerçeve"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
			tts:      Some("رامكىلىق رەسىم"),
			keywords: &["رامكا", "رامكىلىق رەسىم", "رەسىم", "رەسىم سىزىش", "سەنئەت", "مۇزېي"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("картина в рамці"),
			keywords: &["картина", "картина в рамці", "мистецтво", "музей", "рама", "рама з картиною"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["hoshiya", "muzey", "ramka", "ramkali surat", "rasm", "rassomlik", "san’at"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("tranh trong khung"),
			keywords: &["bảo tàng", "khung", "nghệ thuật", "tranh", "tranh trong khung"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
			tts:      Some("nataal buñ kaadare"),
			keywords: &["art", "kaadar", "muse", "nataal", "nataal buñ kaadare", "pentiir"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			...
			keywords: &["férémù", "ilé ọnà", "iṣẹ\u{301} ọná", "kíkùn", "àwòrán", "àwọrán inú férémù"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("àwɔrán inú férémù"),
			keywords: &["férémù", "ilé ɔnà", "ishɛ\u{301} ɔná", "kíkùn", "àwòrán", "àwɔrán inú férémù"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("带框的画"),
			keywords: &["加框的照片", "博物馆", "带框的画", "框", "照片", "画", "画框", "艺术"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("相片連相框"),
			keywords: &["博物館", "油畫", "畫", "畫作", "畫框", "相片連相框", "繪畫", "美術館", "藝術"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("ifulemu enesithombe"),
			keywords: &["ifulemu", "ifulemu enesithombe", "imyuziyemu", "isithombe", "ubuciko"],
		},
	],
};
#[doc = "🎨"]
pub const ARTIST_PALETTE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("የሠዓሊ ሳሕን"),
			keywords: &["ሥነ ጥበብ", "ቤተ መዘክር", "የሠዓሊ ሳሕን", "የሥዕል ቅብ ሥራ", "ፓሌት"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["карціна", "мастацтва", "музей", "палітра", "палітра мастака"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("палитра на художник"),
			keywords: &["изкуство", "картина", "музей", "палитра", "палитра на художник"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "fr_CA",
			tts:      Some("↑↑↑"),
			keywords: &["art", "musée", "palette", "peinture"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("pailéad dathanna"),
			keywords: &["dathannach", "ealaín", "ealaíontóir", "pailéad dathanna", "pictiúr", "péint"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("paileat neach-ealain"),
			keywords: &["dealbh", "ealan", "paidhleat", "paileat neach-ealain", "taigh-tasgaidh"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"કલાકાર",
				"કલાત\u{acd}મક ક\u{ac7} વ\u{ac8}જ\u{acd}ઞાનિક વસ\u{acd}ત\u{ac1}ઓન\u{ac1}\u{a82} સ\u{a82}ગ\u{acd}રહસ\u{acd}થાન",
				"કળા",
				"ચિત\u{acd}રકાર",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("slikarska paleta"),
			keywords: &["muzej", "paleta", "slikarska paleta", "slikarstvo", "umjetnost"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("絵の具パレット"),
			keywords: &["パレット", "画家", "絵", "絵の具パレット", "絵画", "美術館", "芸術"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["მუზეუმი", "მხატვრის პალიტრა", "ნახატი", "პალიტრა", "ხატვა", "ხელოვნება"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("палитра"),
			keywords: &["бояу", "музей", "мұражай", "палитра", "сурет салу", "өнер"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ಕಲಾವ\u{cbf}ದರ ಪ\u{ccd}ಯಾಲ\u{cc6}ಟ\u{ccd}",
				"ಕಲಾವ\u{cbf}ದರ ವರ\u{ccd}ಣಫಲಕ",
				"ಕಲ\u{cc6}",
				"ಚ\u{cbf}ತ\u{ccd}ರಕಲ\u{cc6}",
				"ಪ\u{ccd}ಯಾಲ\u{cc6}ಟ\u{ccd}",
				"ಬಣ\u{ccd}ಣದ ಹಲಗ\u{cc6}",
				"ಮನರಂಜನ\u{cc6}",
				"ವರ\u{ccd}ಣ ಸಾಧನ",
				"ವರ\u{ccd}ಣಚ\u{cbf}ತ\u{ccd}ರಕಾರ",
				"ವರ\u{ccd}ಣಫಲಕ",
				"ವರ\u{ccd}ಣರಂಜ\u{cbf}ತ",
				"ಸಂಗ\u{ccd}ರಹಾಲಯ",
				"ಸೃಜಾನಾತ\u{ccd}ಮಕ",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &["Bild", "Faarfpalett", "Konscht", "Musée", "Palett", "Tableau"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["dailininko paletė", "menas", "muziejus", "paletė", "piešinys"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("gleznotāja palete"),
			keywords: &["glezna", "gleznot", "gleznotāja palete", "māksla", "palete"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
			tts:      Some("papapeita tohunga toi"),
			keywords: &["papa tongarewa", "papapeita", "papapeita tohunga toi", "toi", "toi peita"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["hiburan", "lukisan", "muzium", "palet", "palet artis", "seni", "warna-warni"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["ਕਲਾ", "ਕਲਾਕਾਰ", "ਪ\u{a48}ਲਅਟ", "ਮਿਊਜ\u{a3c}ੀਅਮ", "ਰ\u{a70}ਗ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
			tts:      Some("مصور دی تختی"),
			keywords: &["عجائب گھر", "فن", "مصور دی تختی", "مص\u{651}ور دی تختی", "پینٹینگ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Plet Wé Átist De Ték Míks Pent"),
			keywords: &["Drọ\u{301}ying", "Miuziọm", "Plet", "Plet Wé Átist De Ték Míks Pent"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("paleta malarska"),
			keywords: &["farby", "kolory", "malarska", "malarz", "muzeum", "paleta", "sztuka"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("paleta de artista"),
			keywords: &["arte", "museu", "paleta", "paleta de artista", "pintor", "pintura"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-360"), keywords: &["E10-360"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("палитра с красками"),
			keywords: &["краски", "палитра", "палитра с красками", "рисовать", "творить", "художник"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["رنگن جي تختي", "عجائب گھر", "نقاشي", "پينٽر جي رنگ جي تختي", "ڪلا"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			lang:     "sl",
			tts:      Some("slikarska paleta"),
			keywords: &["muzej", "paleta", "slika", "slikanje", "slikarska paleta", "umetnost"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("farshaxan saxan"),
			keywords: &["farshaxan saxan", "farshaxanka", "matxafka", "rinjiyeen", "saxan"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("↑↑↑"),
			keywords: &["музej", "пaлeтa", "сликaрствo", "сликарска палета", "умјетнoст"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
		...
		crate::Annotation {
			...
			tts:      Some("రంగుల ఫలకం"),
			keywords: &[
				"ఆర\u{c4d}ట\u{c3f}స\u{c4d}ట\u{c4d} ప\u{c3e}ల\u{c46}ట\u{c4d}",
				"ఆర\u{c4d}ట\u{c4d}",
				"కలర\u{c4d}\u{200c}ఫుల\u{c4d}",
				"క\u{c4d}ర\u{c3f}య\u{c47}ట\u{c3f}వ\u{c4d}",
				"ప\u{c3e}ల\u{c46}ట\u{c4d}",
				"ప\u{c46}య\u{c3f}ంటర\u{c4d}",
				"ప\u{c46}య\u{c3f}ంట\u{c3f}ంగ\u{c4d}",
				"ఫలకం",
				"రంగు",
			],
		...
		crate::Annotation {
			...
			keywords: &["лавҳачаи рассомии рассом", "лавҳачаи рассомӣ", "осорхона", "расм", "санъат"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ስነጥበባዊ ፓለቲካ"),
			keywords: &["ሕብራዊ", "መዘናግዒ", "ስነ ጥበባዊ", "ስነ ጥበብ", "ስእሊ", "ቀባኢ", "ቤተ መዘክር", "ፈጠራዊ", "ፓለቲካ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("suratkeş palitrasy"),
			keywords: &["muzeý", "palitra", "sungat", "surat çekmek", "suratkeş palitrasy"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
			tts:      Some("tāvalivali"),
			keywords: &["tā", "tāvalivali", "valivali"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("boya paleti"),
			keywords: &["boya", "boya paleti", "palet", "ressam", "sanat", "sanatçı", "sanatçı paleti"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["картина", "кольори", "мистецтво", "музей", "палітра", "палітра художника"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			lang:     "uz",
			tts:      Some("palitra"),
			keywords: &["muzey", "paletra", "palitra", "rang-barang", "rassomlik", "san’at"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			...
			keywords: &["imuziyam", "iplanga lepeyinti legcisa", "ubugcisa", "umfanekiso"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("Pẹpẹ Oṣere"),
			keywords: &["Pẹpẹ Oṣere", "ilé ọnà", "iṣẹ\u{301} ọná", "kíkùn", "pálẹ\u{301}tì"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Pɛpɛ Oshere"),
			keywords: &["Pɛpɛ Oshere", "ilé ɔnà", "ishɛ\u{301} ɔná", "kíkùn", "pálɛ\u{301}tì"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			...
			keywords: &["ibhodi lengcweti yokupenda", "imyuziyemu", "isithombe esipendiwe", "ubuciko"],
		},
	],
};
#[doc = "🧵"]
pub const THREAD: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("garing"),
			keywords: &["gare", "garing", "naald", "naaldwerk", "stik", "tol", "tolletjie"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("بكرة خيط"),
			keywords: &["إبرة", "بكرة", "حياكة", "خياطة", "خيط", "خيوط", "فتلة", "مغزل", "نسيج"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["aguja", "bordar", "carrete", "coser", "cuerda", "hilar", "hilo", "tejer"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("نخ"),
			keywords: &["خیاطی", "دوخت و دوز", "سوزن", "قرقره", "ماسوره", "نخ", "نخ و سوزن"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("lankarulla"),
			keywords: &["lanka", "lankarulla", "neula", "ompelu", "rulla", "rullalanka"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["aiguille", "bobine", "bobine de fil", "coudre", "couture", "ficelle", "fil"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("snáth"),
			keywords: &["biorán", "eiteán", "fuáil", "snáithead", "snáth", "spól", "spól snátha", "téad"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "gu",
			tts:      Some("દોરો"),
			keywords: &["દોરી", "દોરી પરોવવી", "દોરો", "સીવણ", "સીવવ\u{ac1}\u{a82}", "સોય", "સોય-દોરો"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("benang"),
			keywords: &["benang", "gulungan", "jahit", "jarum", "kelos", "menjahit", "tali"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			lang:     "it",
			tts:      Some("filo"),
			keywords: &["ago", "bobina", "corda", "cucire", "filo", "rocchetto", "rotolo"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("lqezz"), keywords: &["lqezz"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("жіп"),
		...
		crate::Annotation {
			lang:     "kok",
			tts:      Some("धागो"),
			keywords: &["धाग\u{947}", "धागो", "शि\u{902}वप", "स\u{941}त", "स\u{941}य"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਧਾਗਾ"),
			keywords: &["ਡ\u{a4b}ਰੀ", "ਤ\u{a70}ਦ", "ਧਾਗਾ", "ਫਿਰਕੀ", "ਸਿਲਾਈ", "ਸ\u{a42}ਈ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			lang:     "pl",
			tts:      Some("nić"),
			keywords: &["dratwa", "igła", "nawlekać", "nitka", "nić", "szpulka", "szycie", "szyć"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		#[cfg(feature = "qu")]
		crate::Annotation { lang: "qu", tts: Some("hilo"), keywords: &["hilo", "qisa"] },
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("ață"),
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-063"), keywords: &["E11-063"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("filo"), keywords: &["filo"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("iplik"),
			keywords: &["dikiş", "dikmek", "ip", "iplik", "iğne", "kırmızı ip", "makara", "terzi"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("нитка"),
			keywords: &["голка", "жилка", "котушка", "нитка", "пряжа", "шиття", "шпулька"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("woñ"), keywords: &[""] },
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("òwú"),
...
pub const SEWING_NEEDLE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["вышыўка", "пашыў", "швейная іголка", "швы", "шыццё", "шыўкі", "іголка"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("шивашка игла"),
			keywords: &["бодове", "бродиране", "игла", "шевове", "шивач", "шивашка игла", "шиене"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["igla", "igla za šivenje", "krojenje", "šav", "šavovi", "šivanje", "šivenje"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("synål"),
			keywords: &["broderi", "nål", "skræddersyning", "sting", "sutur", "syning", "synål", "tråd"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["aguja", "aguja de coser", "bordado", "coser", "hilar", "punto", "tejer"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["aguja de coser"] },
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
			tts:      Some("õmblusnõel"),
			keywords: &["niit", "nõel", "rätsep", "tikkimine", "õmblemine", "õmblused"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("jostorratz"),
			keywords: &["brodatua", "josi", "joskintza", "jostorratz", "jostura", "orratza", "puntada"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("سوزن خیاطی"),
			keywords: &["بخیه", "خیاطی", "دوختن", "سوزن", "نخ", "کوک", "گل\u{200c}دوزی"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			lang:     "fo",
			tts:      Some("nál"),
			keywords: &["baldýring", "lappa", "nál", "seyminál", "stingur", "íseyming"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			...
			keywords: &["bróidnéireacht", "fuáil", "greim", "snáthaid fuála", "táilliúireacht"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["igla", "krojenje", "vezenje", "šavovi", "šivanje", "šivaća igla"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("varrótű"),
			keywords: &["cérna", "hímzés", "szabászat", "tű", "varrat", "varrás", "varrótű", "öltés"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			keywords: &["agịga", "agịga eji akwa àkwà", "embroidery", "stitches", "sutures", "ịkwa akwa"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("saumnál"),
			keywords: &["nál", "sauma", "saumaspor", "saumnál", "sníða", "spor", "útsaumur"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			...
			keywords: &["ийне", "сайма", "тигиш", "тигүү", "тигүүчү ийне", "тикмечи", "тордоо"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["adata", "siuvimas", "siuvimo adata", "siuvinėjimas", "siūlai"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["jahit menjahit", "jahitan", "jarum", "menjahit", "sulaman", "sutur"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-054"), keywords: &["E13-054"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["ايمبرائيڊري", "سئي", "سلائي جو نيڊل", "سيئڻ", "سيوچرز", "ٽانڪا", "ٽيلرنگ"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("ihla"),
			keywords: &["ihla", "krajčír", "niť", "stehy", "vlákno", "vyšívanie", "šitie"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("šivanka"),
			keywords: &["igla", "krojenje", "spoji", "vezenje", "šivanje", "šivanka", "šivi"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["biçmek", "iňňe", "keşde", "tikin iňňesi", "tikinler", "tikmek"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["سلائی", "سلائی کی سوئی", "سوئی", "سینا", "ٹانکے", "کشیدہ کاری"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("缝合针"),
			keywords: &["线", "绣花针", "缝合", "缝合针", "缝纫", "缝线", "缝衣针", "裁剪", "针"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
...
pub const YARN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("lankakerä"),
			keywords: &["kerä", "kutominen", "lanka", "lankakerä", "neulominen", "virkkaus"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["saƙa", "ulu", "zaren saƙa", "ƙwallo", "ƙwallon zare", "ƙwanƙwasa", "ɗinki"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("fonál"),
			keywords: &["fonal", "fonál", "gombolyag", "horgol", "horgolás", "köt", "kötés", "kötöget"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			keywords: &["benang", "bola", "crochet", "menyulam", "merajut", "rajut", "sulam"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			...
			keywords: &["ចាក\u{17cb}", "ដ\u{17bb}\u{17c6}សរសៃអ\u{17c6}បោះ", "បាល\u{17cb}"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			lang:     "ml",
			tts:      Some("ചണം"),
			keywords: &["ചണം", "ത\u{d41}ന\u{d4d}നൽപ\u{d4d}പണി", "നെയ\u{d4d}യ\u{d41}ക", "ബോൾ"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["କ\u{b4d}ରକେଟ\u{b4d}\u{200c}", "ବଲ\u{b4d}\u{200c}", "ବ\u{b41}ଣ\u{b3e}"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		crate::Annotation {
			...
			keywords: &["Bọl", "To Nit Klọt", "To Wív Klọt", "Tred Wé Dẹm De Ték Mék Klọt"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-064"), keywords: &["E11-064"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("клубок"),
		...
		crate::Annotation {
			...
			keywords: &["කැට\u{dd2}න\u{dd6}ල\u{dca}", "ගෙත\u{dd4}ම", "ගොතනව\u{dcf}", "බෝලය"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			lang:     "th",
			tts:      Some("ไหมพรม"),
			keywords: &["ก\u{e49}อนไหมพรม", "ด\u{e49}าย", "ถ\u{e31}ก", "โครเชต\u{e4c}", "ไหม", "ไหมพรม"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		crate::Annotation {
			lang:     "uk",
			tts:      Some("пряжа"),
			keywords: &["в’язання", "клубок", "моток", "мотузка", "нитка", "нитки", "прядиво", "пряжа"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			lang:     "uz",
			tts:      Some("o‘ram"),
			keywords: &["koptok", "koptok iplar", "o‘ram", "o‘ram ip", "to‘qish", "yigirilgan ip"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("毛線球"),
			keywords: &["毛線", "毛線球", "球", "編織", "織", "針織", "鉤針", "鉤針編織"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("毛冷"),
			keywords: &["冷球", "毛冷", "球", "編織", "織", "織冷衫", "針織", "鈎針編織"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const KNOT: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ቋጠሮ"), keywords: &["ማሰር", "ቋጠሮ", "ገመድ"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			lang:     "as",
			tts:      Some("গ\u{9be}ঠি"),
			keywords: &["গ\u{9be}ঠি", "জট লগ\u{9be}", "ট\u{9c1}ইন", "পকোৱ\u{9be}", "ৰচী"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			lang:     "bs",
			tts:      Some("čvor"),
			keywords: &["kanap", "konopac", "uvrnuti", "zamrsiti", "zavezati", "čvor"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["nudo"] },
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("nœud"),
			keywords: &["attacher", "corde", "entrelacer", "lien", "noué", "nœud", "tordre"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		...
		crate::Annotation {
			lang:     "gd",
			tts:      Some("snaidhm"),
			keywords: &["fiar", "naisg", "nasgadh", "ròpa", "snaidhm", "snìomh", "suain", "toinn"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("ƙulli"),
			keywords: &["igiya", "karkata", "ruɗani", "zarge", "ƙulla", "ƙulli", "ɗauri"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("čvor"),
			keywords: &["ispreplesti", "užad", "uže", "zapetljano", "zapetljati", "čvor"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("csomó"),
			keywords: &["csomó", "hurok", "kötél", "madzag", "tengerészcsomó", "zsineg"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("simpul"),
			keywords: &["belitan", "buhul", "ikatan", "kusut", "puntiran", "simpul", "tali", "tambang"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("tikerrist"), keywords: &["tikerrist"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("түйін"),
		...
		crate::Annotation {
			lang:     "kok",
			tts:      Some("गाठ"),
			keywords: &["गाठ", "गाठायल\u{94d}ल\u{947}\u{902}", "टाय", "ट\u{94d}वायन", "दोर"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			lang:     "mn",
			tts:      Some("зангилаа"),
			keywords: &["зангилаа", "олс", "ороох", "орооцолдох", "орооцолдсон", "уяа"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		crate::Annotation {
			lang:     "ne",
			tts:      Some("नट"),
			keywords: &["घ\u{941}म\u{947}को", "टाइ", "डोरी", "नट", "बटारिएको", "लप\u{947}टिएको"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			lang:     "nn",
			tts:      Some("↑↑↑"),
			keywords: &["knop", "knute", "knyte", "reip", "samanfletta", "tau", "tvinne"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਗ\u{a70}ਢ"),
			keywords: &["ਗ\u{a70}ਢ", "ਬ\u{a70}ਨ\u{a4d}ਹਣਾ", "ਮਰ\u{a4b}ੜ", "ਰ\u{a71}ਸੀ", "ਵ\u{a71}ਟ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			lang:     "ro",
			tts:      Some("nod"),
			keywords: &["ață", "fir", "frânghie", "infinit", "lega", "nod", "sfoară", "încurcătură"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-055"), keywords: &["E13-055"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("узел"),
		...
		crate::Annotation {
			lang:     "si",
			tts:      Some("ගැටය"),
			keywords: &["කඹය", "ගැටය", "ටය\u{dd2}", "ට\u{dca}වය\u{dd2}න\u{dca}", "පටලැව\u{dd2}ල\u{dca}ල"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("čvor"),
			keywords: &["kanap", "konopac", "uvrnuti", "vezati", "zapetljano", "čvor"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("fakapona"), keywords: &["fakapona"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("结"),
			keywords: &["八字结", "打结", "结", "绳子", "绳扣", "绳结", "缠结", "麻线"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zu",
			tts:      Some("ifindo"),
			keywords: &["bopha", "hlanganisa", "ifindo", "intambo", "ithandelwe", "sonta"],
		},
	],
};
