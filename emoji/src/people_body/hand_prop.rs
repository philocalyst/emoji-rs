#[doc = "💅"]
pub const NAIL_POLISH: crate::Toned = crate::Toned {
	emoji: crate::Emoji {
		glyph:                "💅",
		codepoint:            &[128133u32],
