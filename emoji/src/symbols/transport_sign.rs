...
pub const ATM_SIGN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("የኤቲኤም ምልክት"),
			keywords: &["ራስ-ሰር", "ባንክ", "ኤቲኤም", "የኤቲኤም ምልክት", "የገንዘብ መክፈያ ማሽን", "ገንዘብ ከፋይ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["банкамат", "гатоўка", "знак", "знак банкамата", "наяўныя", "тэрмінал"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("знак за банкомат"),
			keywords: &["ATM", "банка", "банков автомат", "банкомат", "знак за банкомат", "пари в брой"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["atm", "automàtic", "banc", "caixer", "diners", "efectiu", "signe"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎪᎢᎷ ᎪᏪᎵ"),
			keywords: &["ᎠᏕᎳ ᏧᏂᏗᎢ", "ᎠᏕᎳ ᏧᏂᏗᎢ ᏧᎸᏫᏍᏓᏁᎯ", "ᎤᏩᏌ", "ᎪᎢᎷ", "ᎪᎢᎷ ᎪᏪᎵ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["arwydd peiriant codi arian", "atm", "awtomataidd", "banc", "clerc"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			...
			keywords: &["ATM", "Geldautomat", "Symbol „Geldautomat“"],
		},
		#[cfg(feature = "de_CH")]
		...
		crate::Annotation {
			lang:     "el",
			tts:      Some("σήμα ATM"),
			keywords: &["ATM", "αυτοματοποιημένο", "αυτόματο", "σήμα ATM", "τράπεζα", "χρήματα"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "en_001",
			tts:      None,
			keywords: &["ATM", "automated", "bank", "cash", "cashpoint", "money", "sign", "teller"],
		},
		#[cfg(feature = "en_AU")]
		...
		crate::Annotation {
			...
			keywords: &["märk", "pangaautomaat", "pank", "silt", "sularaha", "teller"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			...
			keywords: &[
				...
				"kutxazain automatikoaren seinalea",
				"kutxazaina",
		...
		crate::Annotation {
			...
			keywords: &["ATM", "automated", "bangko", "karatula", "pera", "tanda ng ATM", "teller"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			...
			keywords: &["bancaire", "banque", "gab", "guichet", "guichet automatique bancaire"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			...
			keywords: &["banco", "caixeiro", "diñeiro", "sinal de caixeiro automático"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("שלט כספומט"),
			keywords: &["בנק", "כסף", "כספומט", "למשוך כסף", "מזומן", "שלט כספומט"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["banka", "bankomat", "gotovina", "znak za bankomat"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("tanda ATM"),
			keywords: &["ATM", "bank", "cash", "otomatis", "tanda ATM", "teller", "tunai", "uang"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("akara ATM"),
			keywords: &["akara ATM", "akwụkwọ nnataego", "atm", "mmereonwe", "ụloakụ"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			...
			keywords: &["автоматты", "ақша", "банк", "банкомат", "банкомат белгісі", "есепші"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("ATM"),
			keywords: &["ATM", "에이티엠", "은행", "자동화", "현금", "현금인출기"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("एटीएम चिन\u{94d}न"),
			keywords: &["एटीएम", "एटीएम चिन\u{94d}न", "ट\u{947}लर", "ब\u{901}क", "स\u{94d}वय\u{902}चलीत"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("банкомат"),
			keywords: &["атм", "банка", "банкомат", "знак за банкомат", "кеш", "пари"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["ATM", "automaat", "bank", "geld", "pinautomaat", "pinnen"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["ATM", "bankomat", "pieniądze", "znak bankomatu"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-423"), keywords: &["E10-423"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("значок банкомата"),
			keywords: &["банкомат", "выдача", "деньги", "значок банкомата", "наличные", "терминал"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		#[cfg(feature = "sat")]
		crate::Annotation {
			lang: "sat", tts: Some("ATM ᱪᱤᱱᱦᱟᱹ"), keywords: &["ATM ᱪᱤᱱᱦᱟᱹ"]
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("اي ٽي ايم جي نشاني"),
			keywords: &["اي ٽي ايم", "اي ٽي ايم جي نشاني", "بئنڪ", "خودڪار ٿيل", "ٽيلر"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
			tts:      Some("ATM ලක\u{dd4}ණ"),
			keywords: &["ATM ලක\u{dd4}ණ", "atm", "ටෙලර\u{dca}", "ස\u{dca}වයංක\u{dca}\u{200d}ර\u{dd2}ය"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			lang:     "sr",
			tts:      Some("знак за банкомат"),
			keywords: &["банка", "банкомат", "готовина", "знак", "кеш", "новац"],
		},
		...
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("znak za bankomat"),
			keywords: &["banka", "bankomat", "gotovina", "keš", "novac", "znak"],
		},
		...
		crate::Annotation {
			...
			keywords: &["alama ya ATM", "atm", "benki", "mwenye kuhesabu", "otomatiki", "pesa"],
		},
		#[cfg(feature = "sw_KE")]
		...
		crate::Annotation {
			...
			keywords: &["аломати \"Банкомат\"", "банкомат", "бонк", "гӯянда", "худкор"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			...
			keywords: &["atm", "awtomatlaşdyrylan", "bank", "bankomat", "bankomat belgisi"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["آٹو میٹک", "اے ٹی ایم", "اے ٹی ایم کی علامت", "بنک", "خود کار بینک", "رقم"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			...
			keywords: &["ezenzekelayo", "i-atm", "ibhanki", "ithela", "uphawu lwe-ATM"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("取款机"),
			keywords: &["ATM", "取款机", "提款机", "柜员机", "标识", "银行"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("提款機"), keywords: &["提款機"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["atm", "提款", "櫃員機", "現金", "自動櫃員機", "銀行", "錢"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("uphawu lwe-ATM"),
			keywords: &["i-atm", "ibhange", "okuzenzakalelayo", "uphawu lwe-ATM", "uthela"],
		},
	],
};
#[doc = "🚮"]
pub const LITTER_IN_BIN_SIGN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ቆሻሻ", "ቆሻሻ መጣያ", "ቆሻሻሣጥን", "በቆሻሻ መጣያ ጣሉ ምልክት", "የቆሻሻ ቅርጫት"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			lang:     "as",
			tts:      Some("প\u{9be}ত\u{9cd}ৰত আৱৰ\u{9cd}জন\u{9be} পেল\u{9be}ই থক\u{9be} চিহ\u{9cd}ন"),
			keywords: &[
				"আৱৰ\u{9cd}জন\u{9be}",
				"আৱৰ\u{9cd}জন\u{9be}ৰ প\u{9be}ত\u{9cd}ৰ",
				"প\u{9be}ত\u{9cd}ৰত আৱৰ\u{9cd}জন\u{9be} পেল\u{9be}ই থক\u{9be} চিহ\u{9cd}ন",
			],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["боклук", "кошче за боклук", "символ за място за изхвърляне на боклук"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["brossa", "escombraries", "llençar", "paperera", "senyal", "signe"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["koš", "odpad", "odpadkový koš", "odpadky", "smetí", "značka odpadkového koše"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			...
			keywords: &["affald", "brug affaldsspanden", "skraldespand"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			lang:     "en_CA",
			tts:      Some("↑↑↑"),
			keywords: &["garbage", "litter", "litter bin", "litter in bin sign", "trash"],
		},
		#[cfg(feature = "en_GB")]
		...
		crate::Annotation {
			lang:     "es_US",
			tts:      Some("señal cesto de basura"),
			keywords: &["basura", "cartel cesto de basura", "cesto de basura", "señal cesto de basura"],
		},
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
		...
		crate::Annotation {
			...
			keywords: &["zabor", "zaborra ontzira botatzeko seinalea", "zaborrontzi", "zakarrontzi"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			...
			keywords: &[
				"آشغال",
				"ریختن زباله در زباله\u{200c}دان",
				"زباله",
				"زباله\u{200c}دان",
				"سطل آشغال",
		...
		crate::Annotation {
			...
			keywords: &["corbeille", "déchets", "icône Poubelle", "jeter", "poubelle"],
		},
		#[cfg(feature = "fr_CA")]
		...
		crate::Annotation {
			...
			keywords: &["biona", "biona-sgudail", "samhla “Sgudal dhan bhiona”", "sgudal"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"alamar shara a cikin mazubi",
				"daddi",
				"kwandon shara",
				"shara",
				"tsafta",
				"zuba a kwandon shara",
			],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["környezettudatosság", "szemetes", "szemét", "szemét a kukában szimbólum"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			keywords: &["merki", "merki, rusl í ruslatunnu", "rusl", "rusl í ruslatunnu", "ruslafata"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			...
			keywords: &["rereged", "tandha mbuwang rereged ing wadhahe", "wadhah sampah"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("tignit n yiḍumman"),
			keywords: &["tignit n yiḍumman"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ಕಸದ ಬುಟ\u{ccd}ಟ\u{cbf}",
				"ಕಸಹಾಕುವ ಸ\u{ccd}ಥಳ",
				"ಕಸಹಾಕುವ ಸ\u{ccd}ಥಳದ ಗುರುತು",
				"ಚ\u{cbf}ಹ\u{ccd}",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("쓰레기는 쓰레기통에"),
			keywords: &["쓰레기", "쓰레기는 쓰레기통에", "쓰레기는 쓰레기통에 표시", "쓰레기통"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["šiukšliadėžė", "šiukšlių metimo į šiukšliadėžes ženklas", "šiukšlė", "ženklas"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("atkritumu urnas zīme"),
			keywords: &["atkritumi", "atkritumu urnas zīme", "urna", "zīme"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["знак за канта за отпадоци", "канта", "канта за отпадоци", "отпадоци"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
			...
			keywords: &[
				"ചവറ\u{d41}കൾ",
				"ചവറ\u{d41}കൾ, ചവറ\u{d4d}റ\u{d41}ക\u{d41}ട\u{d4d}ടയിൽ നിക\u{d4d}ഷേപിക\u{d4d}ക\u{d41}ക",
				"ചവറ\u{d4d}റ\u{d41}ക\u{d41}ട\u{d4d}ടയിൽ നിക\u{d4d}ഷേപിക\u{d4d}ക\u{d41}ക",
		...
		crate::Annotation {
			...
			keywords: &[
				"कचरा",
				"कचरा त\u{94d}याच\u{94d}या जागीच करावा",
				"कचरा प\u{947}टी",
		...
		crate::Annotation {
			...
			keywords: &["afval", "prullenbak", "teken", "vuilnisbak"],
		},
		#[cfg(feature = "nn")]
		...
		crate::Annotation {
			...
			keywords: &["kosz", "nie śmiecić", "znak kosza na śmieci", "śmieci", "śmiecić"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			...
			keywords: &["coloque o lixo no lixo", "lata", "lixeira", "lixo", "símbolo"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		crate::Annotation {
			lang:     "qu",
			tts:      Some("chuqasqa qupapi unancha"),
			keywords: &["chuqaq", "chuqasqa qupa", "chuqasqa qupapi unancha"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-962"), keywords: &["E10-962"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("бросайте мусор в урну"),
			keywords: &["мусор", "мусорить", "мусорка", "урна"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("icyapa kigaragaza ahashyirwa imyanda"),
			keywords: &["agatebo k’imyanda", "icyapa kigaragaza ahashyirwa imyanda", "imyanda"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["koš", "koš za smeti", "smeti", "znak za smeti v košu"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["знак", "корпа", "отпад", "отпаци"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			...
			keywords: &["korpa", "otpaci", "otpad", "znak"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			...
			keywords: &["pipa la taka", "taka", "takataka", "weka taka kwenye pipa"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ల\u{c3f}టర\u{c4d}\u{200c}బ\u{c3f}న\u{c4d}",
				"ల\u{c40}టర\u{c4d}",
				"స\u{c48}న\u{c4d}",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &["ท\u{e34}\u{e49}งขยะให\u{e49}ลงถ\u{e31}ง", "ป\u{e49}ายถ\u{e31}งขยะ"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		crate::Annotation {
			...
			keywords: &["zibili bedrä taşla belgisi", "zir-zibil", "zir-zibil gutusy"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["işaret", "çöp kutusu", "çöp kutusu işareti", "çöpü yerine atın"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["знак кидати сміття в урну", "памʼятка не смітити", "смітник", "сміття", "урна"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["inkunkuma", "umgqomo wenkunkuma", "uphawu lwenkunkuma esemgqomeni"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("idoti ninu aami idɔti"),
			keywords: &["dɔ\u{300}tí", "idoti ninu aami idɔti", "ike ìdalɛ\u{300}sí"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("倒垃圾"),
			keywords: &["倒垃圾", "垃圾丢弃处", "垃圾入篓", "垃圾桶"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("垃圾桶"), keywords: &["垃圾桶"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("垃圾桶標誌"),
			keywords: &["垃圾", "垃圾桶", "垃圾桶標誌", "標誌"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const POTABLE_WATER: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["drink", "drinkbaar", "drinkbare water", "glas", "kraan", "water"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("pitná voda"),
			keywords: &["kohoutek", "nápoj", "pitná", "pití", "voda", "vodovod", "značka pitné vody"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			...
			keywords: &["آب آشامیدنی", "آب شرب", "آشامیدنی", "قابل شرب", "قابل نوشیدن", "نوشیدن"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("juomakelpoista vettä"),
			keywords: &["hana", "juoma", "juomakelpoista vettä", "juomavesi", "juotava", "vesi"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["पीन\u{947} का पानी", "पीन\u{947} क\u{947} पानी का चिह\u{94d}न", "प\u{947}यजल"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			...
			keywords: &["air", "air dapat diminum", "dapat diminum", "keran", "minum"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			...
			keywords: &["acqua", "bere", "goccia", "potabile", "rubinetto", "simbolo"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			...
			keywords: &["उदक", "पिय\u{947}वपाच\u{947}\u{902}", "पिवपाच\u{947}\u{902}"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["geriamas", "geriamasis vanduo", "gerti", "vanduo", "čiaupas"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["पानी", "पिउन योग\u{94d}य पानी", "पिउनयोग\u{94d}य", "पिउन\u{947}"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("drinkwater"),
			keywords: &["drinkwater", "drinkwatersymbool", "kraan met glas", "kraanwater"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-964"), keywords: &["E10-964"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			lang:     "rw",
			tts:      Some("amazi meza"),
			keywords: &["amazi", "amazi meza", "gishobora kunyobwa nta nkurikizi", "kunywa"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["ก\u{e4a}อก", "ก\u{e4a}อกน\u{e49}ำ", "น\u{e49}ำด\u{e37}\u{e48}ม"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("vai inu"), keywords: &["inu", "vai"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("içilebilir su"),
			keywords: &["içilebilir su", "içme suyu", "işaret", "musluk", "musluk ve bardak", "su"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
...
pub const RESTROOM: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ডব\u{9cd}লিউচি", "শৌচ\u{9be}গ\u{9be}ৰ", "ৰেষ\u{9cd}টৰ\u{9c1}ম"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["WC", "δημόσια τουαλέτα", "δημόσιες τουαλέτες", "τουαλέτα", "τουαλέτες"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		#[cfg(feature = "en_001")]
		crate::Annotation { lang: "en_001", tts: Some("toilets"), keywords: &[""] },
		#[cfg(feature = "en_AU")]
		crate::Annotation { lang: "en_AU", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_CA")]
		crate::Annotation {
		...
		#[cfg(feature = "en_GB")]
		crate::Annotation { lang: "en_GB", tts: Some("toilets"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_IN")]
		crate::Annotation { lang: "en_IN", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es")]
		crate::Annotation {
		...
		#[cfg(feature = "et")]
		crate::Annotation { lang: "et", tts: Some("tualett"), keywords: &["tualett", "wc"] },
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("komuna"),
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("banyo"),
			keywords: &["banyo", "cr", "palikuran", "rest room", "restroom", "toilet"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("toilettes"), keywords: &["toilettes"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		#[cfg(feature = "lv")]
		crate::Annotation { lang: "lv", tts: Some("tualete"), keywords: &["WC", "tualete"] },
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang: "mk", tts: Some("тоалет"), keywords: &["вц", "тоалет"]
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["casa de banho", "lavabo", "quarto de banho", "sanitário", "wc"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-975"), keywords: &["E10-975"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("уборная"),
		...
		crate::Annotation {
			...
			keywords: &["wc", "වැස\u{dd2}ක\u{dd2}ළ\u{dd2}ය", "ව\u{dd2}වේක ක\u{dcf}මරය"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang: "sr", tts: Some("тоалет"), keywords: &["ве-це", "тoaлeт"]
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("fale mālōlō"), keywords: &["fale mālōlō"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("tuvalet"),
...
pub const WATER_CLOSET: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("WC"),
			keywords: &["WC", "kamer", "kleedkamer", "ruskamer", "spoeltoilet", "toilet", "water"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("حمام"),
			keywords: &["WC", "بيت الخلاء", "حمام", "خزانة", "خلاء", "دورة مياه", "رمز", "مرحاض"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "az",
			tts:      Some("wc"),
			keywords: &["ayaqyolu", "su", "tualet", "tualet otağı", "wc"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("тоалетна"),
			keywords: &["WC", "вода", "клозет", "тоалетна"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎧᏅᏑᎸᎢ"),
			keywords: &["ᎠᎹ", "ᎡᏓᏍᏗ", "ᎧᏅᏑᎸᎢ", "ᎳᏟ", "ᏙᏱ ᎤᎾᏨᏍᏗ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
			tts:      Some("záchod"),
			keywords: &["WC", "toaleta", "voda", "wc", "záchod"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		#[cfg(feature = "da")]
		crate::Annotation { lang: "da", tts: Some("wc"), keywords: &["toilet", "wc"] },
		#[cfg(feature = "de")]
		crate::Annotation { lang: "de", tts: Some("WC"), keywords: &["Toilette", "WC"] },
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation {
			lang:     "el",
			tts:      Some("WC"),
			keywords: &["WC", "μπάνιο", "νερό", "νιπτήρας", "τουαλέτα", "τουαλέτες"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
			tts:      Some("water closet"),
			keywords: &["WC", "bathroom", "closet", "lavatory", "restroom", "toilet", "water"],
		},
		#[cfg(feature = "en_001")]
		crate::Annotation {
			lang:     "en_001",
			tts:      None,
			keywords: &["closet", "lavatory", "restroom", "toilet", "water", "wc"],
		},
		#[cfg(feature = "en_AU")]
		crate::Annotation {
			lang:     "en_AU",
			tts:      Some("WC"),
			keywords: &["amenities", "bathroom", "restroom", "toilet", "water closet"],
		},
		#[cfg(feature = "en_CA")]
		crate::Annotation { lang: "en_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_GB")]
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("servicios"),
			keywords: &["WC", "aseos", "banos", "baño", "servicios", "señal"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			lang:     "eu",
			tts:      Some("komunak"),
			keywords: &["WC", "bainugela", "garbigela", "komun-ontzia", "komuna", "komunak"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		#[cfg(feature = "fr")]
		crate::Annotation { lang: "fr", tts: Some("WC"), keywords: &["WC", "toilettes"] },
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["aseo", "baños", "váter"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			tts:      Some("વૉટર ક\u{acd}લોઝ\u{ac7}ટ"),
			keywords: &["WC", "wc", "ર\u{ac7}સ\u{acd}ટર\u{ac2}મ", "વૉટર ક\u{acd}લોઝ\u{ac7}ટ", "શૌચાલય"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
			tts:      Some("tukunyar bahaya"),
			keywords: &[
				"alamar wc",
				"bayan gida",
				"bayi",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("שלט WC"),
			keywords: &["WC", "בית שימוש", "נוחיות", "ציבוריים", "שירותים", "שלט WC"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			tts:      Some("वॉटर क\u{94d}लोस\u{947}ट"),
			keywords: &["WC", "पानी", "लावाटोरी", "वॉटर क\u{94d}लोस\u{947}ट", "शौचालय", "स\u{941}विधाघर"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("toalett"),
			keywords: &["WC", "mellékhelyiség", "mosdó", "toalett", "vécé", "wc"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "ia",
			tts:      Some("water-closet"),
			keywords: &["aqua", "cabinetto", "lavatorio", "toilette", "water-closet", "wc"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("kloset air"),
			keywords: &["air", "kamar kecil", "kloset", "lambang", "simbol", "tanda", "toilet", "wc"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			...
			keywords: &["საპირფარეშო", "საპირფარეშო ოთახი", "საჭირო ოთახი", "ტუალეტი", "წყალი"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("taslalayt"), keywords: &["taslalayt"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		#[cfg(feature = "kl")]
		crate::Annotation { lang: "kl", tts: Some("wc"), keywords: &["toilet", "wc"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
			tts:      Some("សញ\u{17d2}ញាបង\u{17d2}គន\u{17cb}"),
			keywords: &["WC", "បង\u{17d2}គន\u{17cb}", "សញ\u{17d2}ញា", "សញ\u{17d2}ញាបង\u{17d2}គន\u{17cb}"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("вц"),
			keywords: &["вода", "вц", "клозет", "тоалет"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["00", "бие засах газар", "жорлон", "жорлонгийн суултуур", "ус"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		crate::Annotation {
			lang:     "ms",
			tts:      Some("tandas pam"),
			keywords: &["air", "bilik", "tandas", "tandas pam", "wc"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["कोठा", "पानी", "पानी पाइन\u{947} ठाउ\u{901}", "शौ\u{902}चालय"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			...
			keywords: &["wc", "ଆର\u{b3e}ମକକ\u{b4d}ଷ", "ଜଳ", "ପ\u{b3e}ଇଖ\u{b3e}ନ\u{b3e}", "ଶୌଚ\u{b3e}ଳୟ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		crate::Annotation {
			...
			keywords: &["wc", "خلوت خانہ", "غسل خانہ", "لیٹرین", "پانی", "پانی آلا بیت الخلاء"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Wọ\u{301}tá Kọnténa"),
			keywords: &["Lávétri", "Rẹ\u{301}strum", "WC", "Wọ\u{301}ta", "Wọ\u{301}tá Kọnténa"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("WC"),
			keywords: &["WC", "szalet", "toaleta", "ubikacja", "ustęp"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
			tts:      Some("د تشناب د اوبو لوښی"),
			keywords: &["اوبه", "تشناب", "د آرام خونه", "د اوبو لوښی", "د تشناب د اوبو لوښی", "ډبليو سي"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("WC"),
			keywords: &["WC", "latrina", "lavabo", "privada", "toalete", "vaso sanitário"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["WC", "casa de banho"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-978"), keywords: &["E10-978"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("туалет"),
			keywords: &["WC", "общественный", "туалет", "уборная", "унитаз"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["آرام جو ڪمرو", "الماري", "غسل خانو", "پاڻي", "پاڻي جو هبار", "ڊبليوسي"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["WC", "splachovací záchod", "toaleta", "voda", "wc", "záchod"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["biyo", "musqul", "qolka biyaha", "qolka kaydinta", "suuli", "wc"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			lang:     "sr",
			tts:      Some("ве-це"),
			keywords: &["wc", "ве-це", "вода", "клозет", "нужник", "тoaлeт"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("ve-ce"),
			keywords: &["klozet", "nužnik", "toalet", "ve-ce", "voda", "wc"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("واش روم"),
			keywords: &["طہارت گاہ", "واش روم", "ٹوائلٹ", "پانی کا مخزن", "کمرہ"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("hojatxona"),
			keywords: &["hojatxona", "suv", "tualet", "wc"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			...
			keywords: &["duus", "ndox", "noppalukaay", "tuurukaayu ndox", "wanag", "wc"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("iléìyàgbɛ\u{301} olomi"),
			keywords: &[
				"ilé ìgbɔ\u{300}nshɛ\u{300}",
				"ilé ìgbɔ\u{300}nshɛ\u{300} olómi",
				"iléìyàgbɛ\u{301} olomi",
				"omi",
				"ìyàrá ìsinmi",
				"ìyɛ\u{300}wù",
			],
...
pub const PASSPORT_CONTROL: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["መቆጣጠሪያ", "ኤርፖርት መግቢያ", "ኬላ", "የፖስፖርት መቆጣጠሪያ", "ፖስፖርት"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("مراقبة جوازات السفر"),
			keywords: &["باسبور", "جواز سفر", "رمز", "سفر", "مراقبة", "مراقبة جوازات السفر"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["pasport", "pasport yoxlaması", "yoxlama"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("passport control"),
			keywords: &["kontrol", "pasaporte", "passport", "passport control"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			...
			keywords: &["કન\u{acd}ટ\u{acd}રોલ", "નિય\u{a82}ત\u{acd}રણ", "પાસપોર\u{acd}ટ"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
			tts:      Some("mai duba fasfo"),
			keywords: &["dubawa", "fasfo", "katin fasfo", "mai duba fasfo", "wajen dubawa"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["ביקורת גבולות", "דלפק דרכונים", "דרכון", "דרכונים"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["ellenőrzés", "utazás", "útlevél", "útlevél-ellenőrzés"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
			tts:      Some("անձնագրային ստուգում"),
			keywords: &["անձնագիր", "անձնագրային ստուգում", "անձնագրի ստուգում", "ստուգում"],
		},
		#[cfg(feature = "ia")]
		crate::Annotation {
			lang:     "ia",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("asenqed n umsineg"),
			keywords: &["asenqed n umsineg"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("құжаттарды тексеру"),
			keywords: &["бақылау", "паспорт", "төлқұжат", "құжаттарды тексеру"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಪಾಸ\u{ccd}\u{200c}ಪ\u{ccb}ರ\u{ccd}ಟ\u{ccd} ನ\u{cbf}ಯಂತ\u{ccd}ರಣ"),
			keywords: &["ನ\u{cbf}ಯಂತ\u{ccd}ರಣ", "ಪಾಸ\u{ccd}\u{200c}ಪ\u{ccb}ರ\u{ccd}ಟ\u{ccd}"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("출입국 심사"),
			keywords: &["수속", "여권", "출입국 심사"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["kontrole", "pase", "pasu kontrole", "robeža"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["കൺട\u{d4d}രോൾ", "പ\u{d3e}സ\u{d4d}\u{200c}പോർട\u{d4d}ട\u{d4d}"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
			tts:      Some("паспортын шалгалт"),
			keywords: &["паспортын шалгалт", "пасспорт"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		crate::Annotation {
			...
			keywords: &["ନ\u{b3f}ୟନ\u{b4d}ତ\u{b4d}ରଣ", "ପ\u{b3e}ସ\u{b4d}\u{200c}ପୋର\u{b4d}ଟ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਪਾਸਪ\u{a4b}ਰਟ ਕ\u{a70}ਟਰ\u{a4b}ਲ"),
			keywords: &["ਕ\u{a70}ਟਰ\u{a4b}ਲ", "ਪਾਸਪ\u{a4b}ਰਟ", "ਸ\u{a41}ਰ\u{a71}ਖਿਆ ਕਰਮਚਾਰੀ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			...
			keywords: &["granica", "graniczna", "kontrola", "kontrola paszportowa", "paszport"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			...
			keywords: &["control", "control pașapoarte", "graniță", "pașaport", "verificare pașapoarte"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-982"), keywords: &["E10-982"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("паспортный контроль"),
			keywords: &["контроль", "паспортный", "печать", "пограничник", "проверка"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("ahagenzurirwa pasiporo"),
			keywords: &["ahagenzurirwa pasiporo", "igenzura", "urwandiko rw’abajya mu mahanga"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("pasová kontrola"),
			keywords: &["hranica", "kontrola", "letisko", "pas", "pasová kontrola"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["கட\u{bcd}டுப\u{bcd}ப\u{bbe}டு", "ப\u{bbe}ஸ\u{bcd}போர\u{bcd}ட\u{bcd}"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
		...
		crate::Annotation {
			...
			keywords: &["контроль", "митниця", "паспортний"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("ishakoso aworan ori"),
			keywords: &["darí", "ishakoso aworan ori", "ìwé ìrìnnà"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("护照检查"),
			keywords: &["安检", "护照", "护照检查", "检查", "通行证"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("護照查驗"),
			keywords: &["入出境關卡", "護照", "護照查驗"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("通關檢查"),
			keywords: &["出入境", "海關", "護照", "護照檢查", "通關檢查"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const CUSTOMS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ጉምሩክ"), keywords: &["ማሸግ", "ጉምሩክ"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["ক\u{9be}স\u{9cd}টম", "ক\u{9be}স\u{9cd}টমস", "প\u{9cd}য\u{9be}কিং"],
		},
		#[cfg(feature = "br")]
		crate::Annotation {
			lang:     "br",
		...
		#[cfg(feature = "bs")]
		crate::Annotation { lang: "bs", tts: Some("carina"), keywords: &["carina"] },
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			tts:      Some("duana"),
		...
		#[cfg(feature = "cy")]
		crate::Annotation { lang: "cy", tts: Some("tollau"), keywords: &["tollau"] },
		#[cfg(feature = "da")]
		crate::Annotation { lang: "da", tts: Some("told"), keywords: &["told"] },
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation { lang: "en_IN", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es")]
		crate::Annotation { lang: "es", tts: Some("aduana"), keywords: &["aduana"] },
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
		...
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation { lang: "et", tts: Some("toll"), keywords: &["toll"] },
		#[cfg(feature = "eu")]
		crate::Annotation { lang: "eu", tts: Some("aduanak"), keywords: &["aduanak"] },
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("گمرک"),
		...
		#[cfg(feature = "fi")]
		crate::Annotation { lang: "fi", tts: Some("tulli"), keywords: &["paketti", "tulli"] },
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
			tts:      Some("customs"),
		...
		#[cfg(feature = "gd")]
		crate::Annotation { lang: "gd", tts: Some("cusbainn"), keywords: &["cusbainn"] },
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &["कस\u{94d}टम", "प\u{948}कि\u{902}ग", "सीमा श\u{941}ल\u{94d}क"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		#[cfg(feature = "ia")]
		crate::Annotation { lang: "ia", tts: Some("doana"), keywords: &["doana"] },
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("bea cukai"),
		...
		#[cfg(feature = "ja")]
		crate::Annotation { lang: "ja", tts: Some("税関"), keywords: &["税関", "通関"] },
		#[cfg(feature = "jv")]
		crate::Annotation { lang: "jv", tts: Some("pabean"), keywords: &["pabean"] },
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang: "ka", tts: Some("საბაჟო"), keywords: &["საბაჟო"]
		},
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("tadewwant"), keywords: &["tadewwant"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		#[cfg(feature = "kl")]
		crate::Annotation { lang: "kl", tts: Some("told"), keywords: &["told"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
			tts:      Some("សញ\u{17d2}ញាពន\u{17d2}ធគយ"),
			keywords: &["គយ", "ពន\u{17d2}ធគយ", "សញ\u{17d2}ញា", "សញ\u{17d2}ញាពន\u{17d2}ធគយ"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಕಸ\u{ccd}ಟಮ\u{ccd}ಸ\u{ccd}"),
			keywords: &["ಕಸ\u{ccd}ಟಮ\u{ccd}ಸ\u{ccd}", "ಪ\u{ccd}ಯಾಕ\u{cbf}ಂಗ\u{ccd}", "ಸುಂಕ"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		#[cfg(feature = "lb")]
		crate::Annotation { lang: "lb", tts: Some("Douane"), keywords: &["Douane"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang: "lo", tts: Some("ພາສ\u{eb5}"), keywords: &["ພາສ\u{eb5}"]
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		#[cfg(feature = "mn")]
		crate::Annotation { lang: "mn", tts: Some("гааль"), keywords: &["гааль"] },
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			tts:      Some("जकात"),
		...
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("dwana"), keywords: &["dwana"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		#[cfg(feature = "pa_Arab")]
		crate::Annotation { lang: "pa_Arab", tts: Some("رسومات"), keywords: &["رسومات"] },
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("ګمرک"), keywords: &["ګمرک"] },
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("alfândega"),
			keywords: &["aduana", "aduaneira", "alfândega", "bens", "federal", "impostos", "receita"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "qu")]
		crate::Annotation { lang: "qu", tts: Some("aduanas"), keywords: &["aduanas"] },
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("vamă"),
			keywords: &["bagaj", "graniță", "pachet", "punct vamal", "vamă", "împachetare", "împachetat"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-983"), keywords: &["E10-983"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("таможня"),
		...
		#[cfg(feature = "rw")]
		crate::Annotation { lang: "rw", tts: Some("gasutamo"), keywords: &["gasutamo"] },
		#[cfg(feature = "sd")]
		crate::Annotation { lang: "sd", tts: Some("ڪسٽمز"), keywords: &["ڪسٽمز"] },
		#[cfg(feature = "si")]
		crate::Annotation {
			lang: "si", tts: Some("රේග\u{dd4}ව"), keywords: &["රේග\u{dd4}ව"]
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		#[cfg(feature = "so")]
		crate::Annotation { lang: "so", tts: Some("canshuurta"), keywords: &["canshuurta"] },
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("doganë"),
		...
		#[cfg(feature = "tg")]
		crate::Annotation { lang: "tg", tts: Some("гумрук"), keywords: &["гумрук"] },
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang: "ti", tts: Some("ጉምሩክ"), keywords: &["ልምዲ", "ምዕሻግ"]
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("tute"), keywords: &["kasitomu", "tute"] },
		#[cfg(feature = "tr")]
		crate::Annotation { lang: "tr", tts: Some("gümrük"), keywords: &["gümrük"] },
		#[cfg(feature = "ug")]
		crate::Annotation { lang: "ug", tts: Some("تاموژنا"), keywords: &["تاموژنا"] },
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("митниця"),
		...
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang: "ur", tts: Some("کسٹمز"), keywords: &["ادارہ", "کسٹمز"]
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		#[cfg(feature = "vi")]
		crate::Annotation { lang: "vi", tts: Some("hải quan"), keywords: &["hải quan"] },
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("duwaan"), keywords: &["duwaan"] },
		#[cfg(feature = "xh")]
		crate::Annotation { lang: "xh", tts: Some("amasiko"), keywords: &["amasiko"] },
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("海關"), keywords: &["海關"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("海关"), keywords: &["海关"] },
		#[cfg(feature = "zh")]
		crate::Annotation { lang: "zh", tts: Some("海关"), keywords: &["海关", "行李打包"] },
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("海關"), keywords: &["打包", "海關"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const BAGGAGE_CLAIM: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["baqaj", "baqaj tələbi", "baqajın verilməsi", "tələb", "çamadan işarəsi"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &[
				"arrived", "baggage", "bags", "case", "checked", "claim", "journey", "packing", "plane",
				"ready", "travel", "trip",
			],
		},
		#[cfg(feature = "en_AU")]
		...
		crate::Annotation {
			...
			keywords: &["equipaxes", "maletas", "recollida", "sinal de recollida de equipaxes"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			tts:      Some("બ\u{ac5}ગ\u{ac7}જનો દાવો"),
			keywords: &["બ\u{ac5}ગ\u{ac7}જ", "બ\u{ac5}ગ\u{ac7}જ દાવો", "બ\u{ac5}ગ\u{ac7}જનો દાવો"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		crate::Annotation {
			...
			keywords: &["दावा", "पह\u{941}\u{902}चना", "ब\u{948}ग\u{947}ज", "सामान", "सामान वापसी"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			...
			keywords: &["csomag", "felvétel", "poggyász", "poggyászfelvétel", "repülő", "utazás"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
			tts:      Some("ուղեբեռի վերաբերյալ բողոք"),
			keywords: &["բողոք", "ուղեբեռ", "ուղեբեռի ստացում", "ուղեբեռի վերաբերյալ բողոք"],
		},
		#[cfg(feature = "ia")]
		crate::Annotation {
			lang:     "ia",
			tts:      Some("collecta de bagage"),
			keywords: &["bagage", "collecta", "collecta de bagage", "reception", "retiro"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("手荷物受取"),
			keywords: &["スーツケース", "バゲッジクレーム", "手荷物", "手荷物受取", "預け入れ荷物"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["atsiimti", "bagažas", "bagažo skyrius", "kelionė", "ženklas"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("bagāžas saņemšana"),
			keywords: &["bagāža", "bagāžas saņemšana", "ceļojums", "lidosta", "saņemšana"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["दावा", "सामान", "सामान ताब\u{94d}यात घ\u{947}ण\u{947}", "सामानाचा दावा"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["दावी", "ब\u{94d}याग\u{947}ज", "ब\u{94d}याग\u{947}ज क\u{94d}ल\u{947}म"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			...
			keywords: &["avião", "bagagem", "chegada", "recolha", "recolha de bagagem", "viagem"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-984"), keywords: &["E10-984"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["letalo", "potovanje", "prevzem", "prevzem prtljage", "prtljaga"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		#[cfg(feature = "tk")]
		crate::Annotation { lang: "tk", tts: Some("goş almak"), keywords: &["almak", "goş"] },
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["bagaj", "bagaj alma yeri", "bagaj teslim", "bavul", "seyahat", "çanta"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["багаж", "видача", "видача багажу", "отримання", "пункт отримання багажу"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("سامان کا کلیم"),
			keywords: &["سامان", "سامان پر دعوا کریں", "سامان کا کلیم", "سفر", "مسافرت", "کلیم"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["到達", "喼", "抵達", "旅行", "行李", "行李箱", "通過檢查", "飛機"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const LEFT_LUGGAGE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["bagasie", "bagasie gelos", "bagasiesluitkas", "sluitkas", "tas"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["багаж", "забравен багаж", "клетка", "куфар", "съхранение на багаж", "шкафче"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("consigna"),
			keywords: &["armari", "consigna", "equipatge", "maleta", "maletes", "servei de consigna"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["αποσκευές", "βαλίτσες", "ντουλάπι", "φοριαμός", "φύλαξη αποσκευών"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "es",
			tts:      Some("consigna"),
			keywords: &["consigna", "depósito", "equipaje", "servicio de equipaje en depósito"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["matkatavarat", "säilytys", "säilytyslokero", "tavarasäilytys"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["baixo chave", "consigna", "equipaxes", "maletas", "sinal de consigna"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			tts:      Some("સામાન મ\u{ac2}કો"),
			keywords: &["બ\u{ac5}ગ\u{ac7}જ", "બ\u{ac5}ગ\u{ac7}જ સ\u{ac7}વા", "સામાન", "સામાન મ\u{ac2}કો"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		crate::Annotation {
			...
			keywords: &["csomag", "csomagmegőrző", "megőrzés", "poggyász", "poggyászmegőrző"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("手荷物預かり"),
			keywords: &["コインロッカー", "スーツケース", "ロッカー", "手荷物", "手荷物預かり"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("화물 서비스"),
			keywords: &["보관함", "수하물 보관소", "짐", "케이스", "화물", "화물 서비스"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["bagažas", "lagaminas", "paliktas bagažas", "spintelė", "ženklas"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["багаж", "куфер", "оставен багаж", "чување багаж", "шкаф за багаж", "шкафче"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["سازو سامان", "سفری سامان", "قفل دار تجوری", "کھبا سفری سامان"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-985"), keywords: &["E10-985"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("забытый багаж"),
			keywords: &["багаж", "замок", "кабинка", "камера", "ключ", "хранения", "чемодан"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("ibikapu byabuze ba nyirabyo"),
			keywords: &["ahabikwa imizigo", "ibikapu byabuze ba nyirabyo", "imizigo", "umuzigo"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["batožina", "skrinka", "tašky", "úschovňa", "úschovňa batožiny"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("prtljaga v garderobi"),
			keywords: &["garderoba", "kovčki", "omarica", "prtljaga", "prtljaga v garderobi"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["bagaj", "bagaj hizmeti", "eşya emanet", "kasa", "kayıp bagaj"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["سامان", "لاکر", "محفوظ", "مقفل سامان", "چ\u{64f}ھوٹا ہوا سامان"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("saqlash xonasida qoldirilgan yuk"),
			keywords: &["bagaj", "saqlash xonasi", "saqlash xonasida qoldirilgan yuk", "yuk"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
