...
pub const NOTEBOOK_WITH_DECORATIVE_COVER: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["knjiga", "korice", "sveska", "sveska sa ukrasnim koricama", "ukrasne"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			...
			keywords: &["cuaderno", "cuaderno con tapa decorativa", "decoración", "tapa"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["dekoratiivse kaanega märkmik", "kaaned", "märkmik", "raamat"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("estalki apaingarria duen koadernoa"),
			keywords: &["apaindu", "estalki", "estalki apaingarria duen koadernoa", "koaderno", "liburu"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			...
			keywords: &["lummabók", "lummabók við prýðiligari perma", "perma", "prýðilig", "umslag"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("carnet avec couverture"),
			keywords: &["cahier", "carnet", "carnet avec couverture", "livre", "école", "écrire"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
			tts:      Some("carnet avec couverture décorative"),
			keywords: &["bloc-notes", "carnet avec couverture décorative", "couverture", "livre"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("leabhar nótaí maisithe"),
			keywords: &["leabhar", "leabhar nótaí maisithe", "scoil", "scríobh"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["caderno", "caderno de tapas decoradas", "cuberta", "decorada"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			...
			keywords: &["יומן", "כריכה", "כתיבה", "מחברת", "מחברת עם כריכה מעוטרת", "ספר"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			tts:      Some("सजावटी कवर वाली नोटब\u{941}क"),
			keywords: &["आवरण", "कवर", "किताब", "नोटब\u{941}क", "सजावट", "सजावटी कवर वाली नोटब\u{941}क"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
			tts:      Some("bilježnica s ukrasnim omotom"),
			keywords: &["bilježnica", "bilježnica s ukrasnim omotom", "knjiga", "omot", "ukras"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["գիրք", "կազմ", "ձևավոր կազմով տետր", "ձևավորված", "նոթատետր"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["glósubók", "glósubók með skrautkápu", "kápa", "skreytt glósubók"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("表紙付きノート"),
			keywords: &["ノート", "学校", "文具", "文房具", "本", "表紙付きノート"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("notebook wadhahe motif apik"),
			keywords: &["buku", "kanthong wadhah", "motif", "notebook", "notebook wadhahe motif apik"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("რვეული დეკორატიული ყდით"),
			keywords: &["დეკორირებული", "რვეული", "რვეული დეკორატიული ყდით", "ყდა", "წიგნი"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಅಲಂಕಾರ\u{cbf}ಕ ಕವರ\u{cbf}ನ ನ\u{ccb}ಟ\u{ccd}\u{200c}ಬುಕ\u{ccd}"),
			keywords: &[
				"ಅಲಂಕರ\u{cbf}ಸ\u{cbf}ದ",
				"ಅಲಂಕಾರ\u{cbf}ಕ ಕವರ\u{cbf}ನ ನ\u{ccb}ಟ\u{ccd}\u{200c}ಬುಕ\u{ccd}",
				"ಅಲಂಕಾರ\u{cbf}ಕ ಕವರ\u{ccd}\u{200c}ನ\u{cca}ಂದ\u{cbf}ಗ\u{cc6} ನ\u{ccb}ಟ\u{ccd}\u{200c}ಬುಕ\u{ccd}",
				"ಅಲಂಕೃತ",
				"ಅಲಂಕೃತ ಕವರ\u{ccd}\u{200c}ನ ನ\u{ccb}ಟ\u{ccd}\u{200c}ಬುಕ\u{ccd}",
				"ಕವರ\u{ccd}",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("표지가 있는 노트"),
			keywords: &["공책", "노트", "표지", "표지가 있는 노트", "필기", "학교"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["блокнот", "кооздолгон", "мукаба", "мукабасы кооздолгон блокнот"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		crate::Annotation {
			...
			keywords: &["imżejna", "kopertura", "ktieb", "notebook", "notebook b’kopertura dekorattiva"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			...
			keywords: &["آرائشی پن\u{651}ے نال نوٹ بک", "سجایا ہوئیا", "نوٹ بک", "ڈھکنا", "کتاب"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			...
			keywords: &["caderno", "caderno com decoração", "capa", "decorado", "livro"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"panqa",
				"sumaq",
				"yachaykunapaq panqa kacha rapiwan",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-657"), keywords: &["E10-657"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["agatabo", "gitatse", "igifuniko", "igitabo", "ikayi ifite igifuniko gitatse"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("سينگاريل پاٺي وارو ڪتاب"),
			keywords: &["سينگاريل", "سينگاريل پاٺي وارو ڪتاب", "نوٽ بوڪ", "پاٺو", "ڪتاب"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"எழுத\u{bcd}து",
				"கவர\u{bcd}",
				"நோட\u{bcd}டு புத\u{bcd}தகம\u{bcd}",
				"நோட\u{bcd}புக\u{bcd}",
				"பள\u{bcd}ளி",
				"புத\u{bcd}தகம\u{bcd}",
				"பொருள\u{bcd}",
		...
		crate::Annotation {
			...
			keywords: &[
				"అట\u{c4d}ట",
				"అలంకర\u{c3f}ంచ\u{c3f}న అట\u{c4d}టగల పుస\u{c4d}తకం",
				"అలంక\u{c3e}రం",
		...
		crate::Annotation {
			...
			keywords: &["дафтар", "дафтар бо муқоваи ороишӣ", "китоб", "муқова", "ороишдода"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ደፍተር ምስ ስልማት ሽፋን"),
			keywords: &["መጽሓፍ", "ምጽሓፍ", "ስልማት", "ሽፋን", "ቤት ትምህርቲ", "ትምህርቲ", "ዝተሰለመ", "ደፍተር"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("bezelen gapakly depderçe"),
			keywords: &["bezelen", "bezelen gapakly depderçe", "depderçe", "gapak", "kitap"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
			tts:      Some("pepa tohi teuʻi"),
			keywords: &["pepa", "pepa tohi teuʻi", "teu", "tohi"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("süslü not defteri"),
			keywords: &["dekorasyonlu not defteri", "kapak", "not defteri", "süslü not defteri"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["bìa", "sách", "sổ ghi chép", "sổ ghi chép có bìa trang trí", "trang trí"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
			tts:      Some("kàrne bu ànd ak kubéer gu rafet"),
			keywords: &["buñ-taaral", "kubéer", "kàrne", "kàrne bu ànd ak kubéer gu rafet", "téere"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("àfikọ\u{300}wé pẹ\u{300}lú ẹ\u{300}yìn ọlọ\u{301}ọ\u{300}ṣó"),
			keywords: &[
				"ilé-ìwé",
				"ohun àfi ṣẹ\u{300}ṣọ\u{301}",
				"ìwé",
				"ìwé àkọsílè\u{329}",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("àfikɔ\u{300}wé pɛ\u{300}lú ɛ\u{300}yìn ɔlɔ\u{301}ɔ\u{300}shó"),
			keywords: &[
				"ilé-ìwé",
				"ohun àfi shɛ\u{300}shɔ\u{301}",
				"ìshelɛ\u{301}shɔ\u{300}ó\u{329}",
				"ìwé",
				"ìwé àkɔsílè\u{329}",
				"ɛ\u{300}kɔ\u{301}",
				"ɛ\u{300}yìn ìwé",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("精装笔记本"),
			keywords: &["书", "写作", "学校", "封面", "教育", "笔记本", "精装笔记本"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			...
			keywords: &["ikhava", "incwadi", "incwajana", "incwajana enekhava ehlotshisiwe", "umhlobiso"],
		},
	],
};
#[doc = "📙"]
pub const ORANGE_BOOK: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["biblioteek", "boek", "fantasie", "lees", "onderwys", "oranje"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["تعليم", "دراسة", "قراءة", "كتاب", "كتاب برتقالي", "مدرسة", "مكتبة"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["библиотека", "книга", "образование", "оранжев", "оранжева книга", "четене"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["biblioteca", "educació", "fantasia", "lectura", "llibre", "taronja"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["Buch", "Orangefarbenes Buch", "orangefarben", "orangefarbenes Buch"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			...
			keywords: &["anaranjado", "educación", "escuela", "estudiar", "leer", "libro", "naranja"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			...
			keywords: &["knjiga", "narančasta knjiga", "narančasto", "obrazovanje", "čitanje"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("주황색 책"),
			keywords: &["교육", "도서관", "독서", "오렌지", "오렌지색 책", "주황색 책", "책", "판타지"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["библиотека", "едукација", "книга", "портокалова", "фантазија", "читање"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
			tts:      Some("ഓറഞ\u{d4d}ച\u{d4d} പ\u{d41}സ\u{d4d}\u{200c}തകം"),
			keywords: &["ഓറഞ\u{d4d}ച\u{d4d} പ\u{d41}സ\u{d4d}\u{200c}തകം", "പ\u{d41}സ\u{d4d}തകം"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			lang:     "ms",
			tts:      Some("buku oren"),
			keywords: &["buku", "fantasi", "jingga", "membaca", "pendidikan", "perpustakaan"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("oranje boek"),
			keywords: &["bibliotheek", "boek", "educatie", "lezen", "onderwijs", "oranje"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		...
		crate::Annotation {
			...
			keywords: &["ਕਿਤਾਬ", "ਪ\u{a41}ਸਤਕ", "ਪੜ\u{a4d}ਹਨਾ", "ਲਾਇਬਰ\u{a47}ਰੀ", "ਸ\u{a70}ਤਰੀ ਕਿਤਾਬ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			...
			keywords: &["Buk", "Ọ\u{301}rénj Kọ\u{301}lọ", "Ọ\u{301}rénj Kọ\u{301}lọ Buk"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-662"), keywords: &["E10-662"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("oranžová kniha"),
			keywords: &["kniha", "knižnica", "oranžová", "rozprávka", "učenie", "vzdelanie", "čítanie"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("oranžna knjiga"),
			keywords: &["branje", "izobrazba", "knjiga", "oranžna knjiga", "oranžno", "znanje"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["หน\u{e31}งส\u{e37}อ", "หน\u{e31}งส\u{e37}อส\u{e35}ส\u{e49}ม"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		crate::Annotation {
			...
			keywords: &["книжка", "оранжева книга", "оранжевий", "оранжевий підручник"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("نارنجی کتاب"),
			keywords: &["تعلیم", "رنگ", "علم", "مطالعہ", "نارنجی", "کتاب", "کتب خانہ", "کہانی"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("to‘q sariq kitob"),
			keywords: &["kitob", "kutubxona", "taʼlim", "toʻq sariq", "to‘q sariq kitob"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("橙色书本"),
			keywords: &["书", "书本", "图书馆", "教育", "橘皮书", "橘色", "橙色", "橙色书本", "阅读"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("橙色簿"),
			keywords: &["封面", "小説", "書本", "書籍", "橙色簿｜書｜橙色", "第四冊", "關閉"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const SCROLL: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("boekrol"),
			keywords: &["Bybel", "antieke geskrifte", "boekrol", "papier", "perkament"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ሽብልል"), keywords: &["ሽብልል", "ወረቀት"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("ورقة ملفوفة"),
			keywords: &["تاريخ", "رسالة", "مخطوطة", "ورقة", "ورقة ملفوفة"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang: "bg", tts: Some("свитък"), keywords: &["свитък", "хартия"]
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		#[cfg(feature = "bs")]
		crate::Annotation { lang: "bs", tts: Some("svitak"), keywords: &["papir", "svitak"] },
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			tts:      Some("pergamí"),
		...
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang: "chr", tts: Some("ᎦᏅᏍᎩ"), keywords: &["ᎦᏅᏍᎩ", "ᎪᏪᎵ"]
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
			tts:      Some("svitek"),
			keywords: &["listina", "papyrus", "papír", "pergamen", "svitek"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation { lang: "cy", tts: Some("sgrôl"), keywords: &["papur", "sgrôl"] },
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		#[cfg(feature = "en")]
		crate::Annotation { lang: "en", tts: Some("scroll"), keywords: &["paper", "scroll"] },
		#[cfg(feature = "en_AU")]
		crate::Annotation { lang: "en_AU", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_CA")]
		crate::Annotation { lang: "en_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["documento", "pergamino", "pergamino de papel", "título"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("طومار"),
			keywords: &["طومار", "نامه", "نوشته", "ورق", "کاغذ", "کتیبه"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			lang:     "ga",
			tts:      Some("scrolla"),
			keywords: &["páipéar", "scroll", "scrolla", "scrolla páipéir"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &[
				"કાગળનો વી\u{a82}ટો",
				"છાપ\u{ac1}\u{a82}",
				"પ\u{ac7}પર સ\u{acd}ક\u{acd}રોલ",
				"રોલ",
				"સારણી",
				"સ\u{acd}ક\u{acd}રોલ",
			],
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("gungura"),
			keywords: &["gungura", "nannaɗaɗɗiyar takarda", "nannaɗe takarda", "takarda"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &[
				"कागज\u{93c}",
				"काग\u{93c}ज\u{93c}",
				"प\u{947}पर स\u{94d}क\u{94d}रॉल",
				"स\u{942}चीपत\u{94d}र",
				"स\u{94d}क\u{94d}रॉल",
		...
		#[cfg(feature = "hr")]
		crate::Annotation { lang: "hr", tts: Some("svitak"), keywords: &["papir", "svitak"] },
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("tekercs"),
			keywords: &["papír", "papírtekercs", "pergamen", "tekercs"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("adrurem"), keywords: &["adrurem"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		#[cfg(feature = "ky")]
		crate::Annotation { lang: "ky", tts: Some("ороо"), keywords: &["кагаз", "ороо"] },
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		crate::Annotation {
			...
			keywords: &["lapas", "popierius", "susuktas lapas"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("papīra tīstoklis"),
			keywords: &["papīra tīstoklis", "papīrs", "tīstoklis"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang: "mn", tts: Some("хуйлмал"), keywords: &["хуйлмал", "цаас"]
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			...
			keywords: &[
				...
				"ग\u{941}\u{902}डाळी",
				"स\u{94d}क\u{94d}रोल",
				"स\u{94d}र\u{94d}क\u{94d}रोल",
			],
		},
		#[cfg(feature = "ms")]
		crate::Annotation { lang: "ms", tts: Some("skrol"), keywords: &["kertas", "skrol"] },
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
			tts:      Some("skrollja"),
		...
		crate::Annotation {
			...
			keywords: &["စက\u{1039}က\u{1030}လ\u{102d}ပ\u{103a}", "စာရ\u{103d}က\u{103a}"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("rol"),
			keywords: &["papier", "papierrol", "perkament", "perkamentpapier", "rol"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		crate::Annotation {
			...
			keywords: &["କ\u{b3e}ଗଜ ସ\u{b4d}କ\u{b4d}ରୋଲ\u{b4d}", "ସ\u{b4d}କ\u{b4d}ରୋଲ\u{b4d}"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਸਕਰ\u{a4b}ਲ"),
			keywords: &["ਪ\u{a47}ਪਰ", "ਫ\u{a3c}ਰਮਾਨ", "ਸਕਰ\u{a4b}ਲ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		#[cfg(feature = "pcm")]
		crate::Annotation { lang: "pcm", tts: Some("Skrol"), keywords: &["Pépa", "Skrol"] },
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("zwój"),
			keywords: &["edykt", "papier", "pergamin", "pismo", "zwój"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("اڼه اړول"), keywords: &["اڼه اړول"] },
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("pergaminho"),
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["papel", "pergaminho", "rolo de papel"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("suchuririy"),
			keywords: &["rapi", "suchuririy", "suchuriy"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("pergament"),
			keywords: &["hârtie", "pergament", "rulou", "scriere", "sul"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-665"), keywords: &["E10-665"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("свиток"),
			keywords: &["бумага", "пергамент", "свиток"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("ويڙهيل"), keywords: &["ويڙهيل", "ڪاغذ"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("zvitok"),
			keywords: &["papier", "papyrus", "písanie", "zvitok"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation { lang: "sl", tts: Some("zvitek"), keywords: &["papir", "zvitek"] },
		#[cfg(feature = "so")]
		crate::Annotation { lang: "so", tts: Some("duuban"), keywords: &["duuban", "warqad"] },
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("dorëshkrim i mbledhur rrotull"),
			keywords: &["dorëshkrim i mbledhur rrotull", "letër", "rrotull"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang: "sr", tts: Some("свитак"), keywords: &["пaпир", "свитак"]
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ప\u{c47}పర\u{c4d}",
				"మడవడం",
				"ర\u{c3e}స\u{c3f}న కవ\u{c3f}తలు",
				"సమ\u{c3e}చ\u{c3e}రం",
				"స\u{c4d}క\u{c4d}ర\u{c4b}ల\u{c4d}",
				"స\u{c4d}క\u{c4d}ర\u{c4b}ల\u{c4d} ల\u{c46}టర\u{c4d}",
			],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "tr",
			tts:      Some("parşömen"),
			keywords: &["bildiri", "kağıt", "parşömen"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang: "ug", tts: Some("سىيرىش"), keywords: &["سىيرىش", "قەغەز"]
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("сувій"),
			keywords: &["папір", "папірус", "рукопис", "сувій"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang: "ur", tts: Some("اسکرول"), keywords: &["اسکرول", "صفحہ"]
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("o‘ralgan xat"),
			keywords: &["maktub", "o‘ralgan xat", "qog‘oz"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("tawal"), keywords: &["këyit", "tawal"] },
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
			tts:      Some("skrola"),
		...
		#[cfg(feature = "yo")]
		crate::Annotation { lang: "yo", tts: Some("gbéjáde"), keywords: &["gbéjáde", "pépà"] },
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("gbéjáde"),
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("滾動"), keywords: &["滾動", "紙"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("滚动"), keywords: &["滚动", "纸"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("卷轴"),
			keywords: &["卷纸", "卷轴", "画卷", "纸", "纸卷", "羊皮纸"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["捲軸", "書卷", "紙", "羊皮紙"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation { lang: "zu", tts: Some("umqulu"), keywords: &["ikhasi", "umqulu"] },
	],
};
#[doc = "📒"]
pub const LEDGER: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("marilh"), keywords: &["karned", "marilh"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("rokovnik"),
		...
		crate::Annotation {
			...
			keywords: &["caderno", "contabilidade", "libro", "libro de contabilidade"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		#[cfg(feature = "he")]
		crate::Annotation { lang: "he", tts: Some("יומן"), keywords: &["יומן", "מחברת"] },
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			tts:      Some("ल\u{947}जर, नोटब\u{941}क"),
			keywords: &["किताब", "नोटब\u{941}क", "ल\u{947}जर", "ल\u{947}जर, नोटब\u{941}क"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("főkönyv"),
			keywords: &["füzet", "főkönyv", "jegyzetfüzet", "könyv", "notesz", "spirálos füzet"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("ambellez"), keywords: &["ambellez"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		crate::Annotation {
			...
			keywords: &["grāmata", "grāmata ar spirāli", "klade", "piezīmes", "spirāle"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["നോട\u{d4d}ട\u{d4d} ബ\u{d41}ക\u{d4d}ക\u{d4d}", "ലെഡ\u{d4d}\u{200c}ജർ"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("leġer"), keywords: &["leġer", "notebook"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("ليجر"), keywords: &["ليجر", "کاپي"] },
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		crate::Annotation {
			...
			keywords: &["panqa siwukunawan", "pʼanqa siwukunawan", "yachaykunapaq qillqa"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-655"), keywords: &["E10-655"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("блокнот"),
			keywords: &["блокнот", "блокнотик", "записная книжка", "тетрадка", "тетрадь"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		#[cfg(feature = "sd")]
		crate::Annotation { lang: "sd", tts: Some("ليجر"), keywords: &["ليجر", "نوٽ بڪ"] },
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
			tts:      Some("ලෙජරය"),
		...
		#[cfg(feature = "sw")]
		crate::Annotation { lang: "sw", tts: Some("leja"), keywords: &["daftari", "leja"] },
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["บ\u{e31}ญช\u{e35}", "สม\u{e38}ด", "หน\u{e31}งส\u{e37}อ", "โน\u{e49}ต"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang: "ti", tts: Some("መዝገብ"), keywords: &["መዝገብ", "ደፍተር"]
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("lētisa"), keywords: &["lētisa"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		#[cfg(feature = "ur")]
		crate::Annotation { lang: "ur", tts: Some("لیجر"), keywords: &["لیجر", "نوٹ بک"] },
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("賬簿"), keywords: &["筆記簿", "賬簿"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("账簿"),
...
pub const GREEN_BOOK: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("groen boek"),
			keywords: &["biblioteek", "boek", "fantasie", "groen", "lees", "onderwys"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("كتاب أخضر"),
			keywords: &["تعلم", "تعليم", "دراسة", "قراءة", "كتاب", "كتاب أخضر", "مكتبة"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("levr gwer"), keywords: &["gwer", "levr"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["biblioteca", "educació", "fantasia", "lectura", "llibre", "verd"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["ανάγνωση", "βιβλίο", "βιβλιοθήκη", "μόρφωση", "πράσινο", "φαντασία"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang: "fa", tts: Some("کتاب سبز"), keywords: &["سبز", "کتاب"]
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		#[cfg(feature = "fo")]
		crate::Annotation { lang: "fo", tts: Some("grøn bók"), keywords: &["bók", "grøn"] },
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("livre vert"),
		...
		#[cfg(feature = "he")]
		crate::Annotation {
			lang: "he", tts: Some("ספר ירוק"), keywords: &["ירוק", "ספר"]
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("zelena knjiga"),
			keywords: &["knjiga", "obrazovanje", "zelena knjiga", "zeleno", "čitanje"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		#[cfg(feature = "is")]
		crate::Annotation { lang: "is", tts: Some("græn bók"), keywords: &["bók", "græn"] },
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("libro verde"),
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("초록색 책"),
			keywords: &["교육", "녹색 책", "도서관", "독서", "책", "초록색 책", "판타지"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["ປ\u{eb7}\u{ec9}ມ", "ປ\u{eb7}\u{ec9}ມສ\u{eb5}ຂຽວ", "ສ\u{eb5}ຂຽວ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("зелена книга"),
			keywords: &["библиотека", "едукација", "зелена", "книга", "фантазија", "читање"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
			tts:      Some("പച\u{d4d}ച പ\u{d41}സ\u{d4d}\u{200c}തകം"),
			keywords: &["പച\u{d4d}ച പ\u{d41}സ\u{d4d}\u{200c}തകം", "പ\u{d41}സ\u{d4d}തകം", "ലൈബ\u{d4d}രറി"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["စာအ\u{102f}ပ\u{103a}", "အစ\u{102d}မ\u{103a}းရောင\u{103a} စာအ\u{102f}ပ\u{103a}"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("groen boek"),
			keywords: &["bibliotheek", "boek", "educatie", "groen", "lezen", "onderwijs"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("grøn bok"), keywords: &["bok", "grøn"] },
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("شنه کتاب"), keywords: &["شنه کتاب"] },
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-660"), keywords: &["E10-660"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("سائو ڪتاب"), keywords: &["سائو", "ڪتاب"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang: "si", tts: Some("කොළ පොත"), keywords: &["කොළ", "පොත"]
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
			tts:      Some("zelená kniha"),
			keywords: &["kniha", "knižnica", "vzdelanie", "zatvorená", "zelená", "čítanie"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("zelena knjiga"),
			keywords: &["branje", "izobrazba", "knjiga", "knjižnica", "zelena knjiga", "zeleno"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["หน\u{e31}งส\u{e37}อ", "หน\u{e31}งส\u{e37}อส\u{e35}เข\u{e35}ยว"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		crate::Annotation {
			...
			keywords: &["журнал", "зелена книга", "зелений", "зелений підручник", "книжка", "облік"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("سبز کتاب"),
			keywords: &["تعلیم", "رنگ", "سبز", "ع\u{650}لم", "مطالعہ", "پڑھائی", "کتاب"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("绿色书本"),
			keywords: &["书", "书本", "图书馆", "教育", "绿", "绿皮书", "绿色", "绿色书本", "阅读"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("綠色簿"),
			keywords: &["封面", "小説", "書本", "書籍", "第二冊", "綠色簿｜書｜綠色", "關閉"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const NEWSPAPER: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang: "chr", tts: Some("ᏗᎦᏃᏣᎳᏅᎢ"), keywords: &["ᎪᏪᎵ", "ᏗᎦᏃᏣᎳᏅᎢ"]
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		#[cfg(feature = "da")]
		crate::Annotation { lang: "da", tts: Some("avis"), keywords: &["avis", "nyheder"] },
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
			tts:      Some("Zeitung"),
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("journal"),
			keywords: &["actualités", "communication", "gros titres", "journal", "presse", "une"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("nuachtán"),
			keywords: &["cumarsáid", "nuacht", "nuachtán", "páipéar", "páipéar nuachta"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("pàipear-naidheachd"),
			keywords: &["naidheachd", "naidheachdan", "pàipear", "pàipear-naidheachd"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &["अखबार", "अख\u{93c}बार", "प\u{947}पर", "समाचार", "समाचारपत\u{94d}र"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("aɣmis"), keywords: &["aɣmis"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("газет"),
		...
		#[cfg(feature = "kl")]
		crate::Annotation { lang: "kl", tts: Some("avis"), keywords: &["avis", "nyheder"] },
		#[cfg(feature = "km")]
		crate::Annotation { lang: "km", tts: Some("កាសែត"), keywords: &["កាសែត"] },
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("krant"),
			keywords: &["dagblad", "krant", "nieuws", "nieuwsblad", "voorpagina", "weekblad"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["ਅਖਬਾਰ", "ਅਖ\u{a3c}ਬਾਰ", "ਖ\u{a3c}ਬਰਾ\u{a02}", "ਪ\u{a47}ਪਰ", "ਸਮਾਚਾਰ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			lang:     "ro",
			tts:      Some("ziar"),
			keywords: &["comunicare", "gazetă", "hârtie", "presă", "publicație", "ziar", "știri"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-685"), keywords: &["E10-685"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("газета"),
		...
		crate::Annotation {
			...
			keywords: &["පත\u{dca}\u{200d}රය", "ප\u{dd4}වත\u{dca}", "ප\u{dd4}වත\u{dca} පත"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
			tts:      Some("noviny"),
			keywords: &["informácie", "komunikácia", "novinky", "noviny", "papierové", "správy", "čítať"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("nusipepa"), keywords: &["nusipepa"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("gazete"),
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("報紙"), keywords: &["報紙", "新聞"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const OPEN_BOOK: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("oop boek"),
			keywords: &["biblioteek", "boek", "fantasie", "kennis", "lees", "onderwys", "oop", "romans"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("كتاب مفتوح"),
			keywords: &["امتحانات", "دراسة", "علم", "قراءة", "كتاب", "كتاب مفتوح", "مدرسة", "معرفة"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["abierto", "biblioteca", "educación", "escuela", "leer", "librería", "libro"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang: "fa", tts: Some("کتاب باز"), keywords: &["باز", "کتاب"]
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		#[cfg(feature = "fo")]
		crate::Annotation { lang: "fo", tts: Some("opin bók"), keywords: &["bók", "opin"] },
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			...
			keywords: &["iskola", "könyv", "könyvtár", "nyitott", "oktatás", "olvas", "tanul", "tudás"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("펼쳐진 책"),
			keywords: &["교육", "도서관", "독서", "소설", "지식", "책", "판타지", "펼쳐진 책", "펼침"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["ത\u{d41}റന\u{d4d}ന പ\u{d41}സ\u{d4d}\u{200c}തകം", "പ\u{d41}സ\u{d4d}തകം"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("open bok"), keywords: &["bok", "open"] },
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
			tts:      Some("ଖୋଲ\u{b3e} ବହ\u{b3f}"),
			keywords: &["ଖୋଲ\u{b3e} ବହ\u{b3f}", "ଖୋଲ\u{b3f}ବ\u{b3e}", "ପ\u{b41}ସ\u{b4d}ତକ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang: "ps", tts: Some("خلاص کتاب"), keywords: &["خلاص", "کتاب"]
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("livro aberto"),
			keywords: &["aberto", "biblioteca", "leitura", "lendo", "ler", "livraria", "livro"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-659"), keywords: &["E10-659"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("открытая книга"),
			keywords: &["книга", "книжка", "открытая", "открыть", "раскрытая", "раскрыть"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("کليل ڪتاب"), keywords: &["کليل", "ڪتاب"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["branje", "izobrazba", "knjiga", "odprta knjiga", "odprto", "znanje"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["знање", "књигa", "образовање", "отворено", "романи", "читање"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("otvorena knjiga"),
			keywords: &["knjiga", "obrazovanje", "otvoreno", "romani", "znanje", "čitanje"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ክፉት መጽሓፍ"),
			keywords: &["ልብ-ወለድ", "መጽሓፍ", "ምንባብ", "ቤተ መጻሕፍቲ", "ትምህርቲ", "ክፉት", "ፍልጠት", "ፍንጣጣ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("کھلی کتاب"),
			keywords: &["افسانہ داستان", "تعلیم", "مطالعہ", "ناول", "کتاب", "کتب خانہ", "کھلی", "کہانی"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("打開嘅書"),
			keywords: &["圖書館", "小說", "打開", "打開嘅書", "書", "書本", "書籍", "知識", "閱讀"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const BLUE_BOOK: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("синя книга"),
			keywords: &["библиотека", "книга", "образование", "син", "синя книга", "четене"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang: "bn", tts: Some("নীল বই"), keywords: &["নীল", "বই"]
		},
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("levr glas"), keywords: &["glas", "levr"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["biblioteca", "blau", "educació", "fantasia", "lectura", "llibre"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang: "chr", tts: Some("ᏌᎪᏂᎨ ᎪᏪᎵ"), keywords: &["ᎪᏪᎵ", "ᏌᎪᏂᎨ"]
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
			tts:      Some("modrá kniha"),
			keywords: &["fantasy", "kniha", "knihovna", "modrá", "učení", "vzdělání", "čtení"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("blå bog"),
			keywords: &["bibliotek", "blå bog", "bog", "læse", "læsning", "skolebog", "uddannelse"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["ανάγνωση", "βιβλίο", "βιβλιοθήκη", "διάβασμα", "εκπαίδευση", "μπλε", "φαντασία"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang: "fa", tts: Some("کتاب آبی"), keywords: &["آبی", "کتاب"]
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		#[cfg(feature = "fo")]
		crate::Annotation { lang: "fo", tts: Some("blá bók"), keywords: &["blá", "bók"] },
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("livre bleu"),
		...
		crate::Annotation {
			...
			keywords: &["bulun littafi", "karatu", "littafi", "shuɗi", "shuɗin littafi"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		#[cfg(feature = "he")]
		crate::Annotation {
			lang: "he", tts: Some("ספר כחול"), keywords: &["כחול", "ספר"]
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		#[cfg(feature = "is")]
		crate::Annotation { lang: "is", tts: Some("blá bók"), keywords: &["blá", "bók"] },
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("libro blu"),
		...
		#[cfg(feature = "kl")]
		crate::Annotation { lang: "kl", tts: Some("blå bog"), keywords: &["blå bog", "bog"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang: "ky", tts: Some("көк китеп"), keywords: &["китеп", "көк"]
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		crate::Annotation {
			...
			keywords: &["ປ\u{eb7}\u{ec9}ມ", "ປ\u{eb7}\u{ec9}ມສ\u{eb5}ຟ\u{ec9}າ", "ສ\u{eb5}ຟ\u{ec9}າ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
			tts:      Some("mėlyna knyga"),
			keywords: &["biblioteka", "išsilavinimas", "knyga", "mėlyna", "skaitymas"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("сина книга"),
			keywords: &["библиотека", "едукација", "книга", "сина", "фантазија", "читање"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("ktieb blu"), keywords: &["blu", "ktieb"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("blauw boek"),
			keywords: &["bibliotheek", "blauw", "boek", "educatie", "lezen", "onderwijs"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		...
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਨੀਲੀ ਕਿਤਾਬ"),
			keywords: &["ਕਿਤਾਬ", "ਨੀਲੀ ਕਿਤਾਬ", "ਪ\u{a41}ਸਤਕ", "ਪੜ\u{a4d}ਹਨਾ", "ਲਾਇਬਰ\u{a47}ਰੀ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		#[cfg(feature = "pt_PT")]
		crate::Annotation { lang: "pt_PT", tts: Some("↑↑↑"), keywords: &["azul", "livro"] },
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		crate::Annotation {
			...
			keywords: &["albastră", "bibliotecă", "carte", "citit", "educație", "învățământ"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-661"), keywords: &["E10-661"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("نيرو ڪتاب"), keywords: &["نيرو", "ڪتاب"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("modrá kniha"),
			keywords: &["kniha", "knižnica", "modrá", "rozprávka", "vzdelanie", "čítanie"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["библиотека", "књигa", "образовање", "плaвo", "плава књига", "плаво", "читање"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("plava knjiga"),
			keywords: &["biblioteka", "knjiga", "obrazovanje", "plava knjiga", "plavo", "čitanje"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		crate::Annotation { lang: "sv", tts: Some("blå bok"), keywords: &["blå bok", "bok"] },
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
		...
		crate::Annotation {
			...
			keywords: &["หน\u{e31}งส\u{e37}อ", "หน\u{e31}งส\u{e37}อส\u{e35}น\u{e49}ำเง\u{e34}น"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		#[cfg(feature = "tk")]
		crate::Annotation { lang: "tk", tts: Some("gök kitap"), keywords: &["gök", "kitap"] },
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang: "ug", tts: Some("كۆك كىتاب"), keywords: &["كىتاب", "كۆك"]
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("蓝色书本"),
			keywords: &["书", "书本", "图书馆", "教育", "篮", "蓝皮书", "蓝色", "蓝色书本", "阅读"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("藍色簿"),
			keywords: &["封面", "小説", "書本", "書籍", "第三冊", "藍色簿｜書｜藍色", "關閉"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("incwadi eluhlaza sasibhakabhaka"),
			keywords: &["incwadi", "incwadi eluhlaza sasibhakabhaka", "luhlaza sasibhabhaka"],
		},
	],
};
#[doc = "📕"]
pub const CLOSED_BOOK: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("levr serr"), keywords: &["levr", "serr"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["Buch", "Geschlossenes Buch", "geschlossen", "geschlossenes Buch"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang: "fa", tts: Some("کتاب بسته"), keywords: &["بسته", "کتاب"]
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["aklat", "libro", "nakasara", "nakasarang aklat", "nakasarang libro"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			...
			keywords: &["ilimi", "ja littafi", "karatu", "littafi", "rufaffe", "rufaffen littafi"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["bibliotheek", "boek", "educatie", "gesloten", "lezen", "onderwijs"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("lukka bok"), keywords: &["bok", "lukka"] },
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang: "ps", tts: Some("بند کتاب"), keywords: &["بند", "کتاب"]
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-658"), keywords: &["E10-658"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["kniha", "vzdelanie", "zatvorená", "červená kniha", "čítanie"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["చదువు", "పుస\u{c4d}తకం", "మూయడం", "మూస\u{c3f}న పుస\u{c4d}తకం"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang:     "tg",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("tohi mapuni"), keywords: &["tohi mapuni"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("閂埋嘅書"),
			keywords: &["封面", "小説", "書", "書本", "書籍", "第一冊", "簿", "紅色", "閂埋嘅書", "關閉"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const NOTEBOOK: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ማስታወሻ ደብተር"), keywords: &["ማስታወሻ ደብተር"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		#[cfg(feature = "az")]
		crate::Annotation { lang: "az", tts: Some("bloknot"), keywords: &["bloknot"] },
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("нататнік"),
		...
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang: "bg", tts: Some("бележник"), keywords: &["бележник"]
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("karned"), keywords: &["karned"] },
		#[cfg(feature = "bs")]
		crate::Annotation { lang: "bs", tts: Some("sveska"), keywords: &["sveska"] },
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			tts:      Some("llibreta"),
		...
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang: "chr", tts: Some("ᎪᏪᎵ ᏗᎪᏪᎶᏙᏗ"), keywords: &["ᎪᏪᎵ ᏗᎪᏪᎶᏙᏗ"]
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		#[cfg(feature = "en")]
		crate::Annotation { lang: "en", tts: Some("notebook"), keywords: &["notebook"] },
		#[cfg(feature = "en_AU")]
		crate::Annotation { lang: "en_AU", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_CA")]
		crate::Annotation { lang: "en_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		...
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation { lang: "et", tts: Some("päevik"), keywords: &["päevik", "raamat"] },
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("koadernoa"),
		...
		#[cfg(feature = "fil")]
		crate::Annotation { lang: "fil", tts: Some("notebook"), keywords: &["notebook"] },
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
			tts:      Some("lummabók"),
		...
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["cahier", "carnet"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		#[cfg(feature = "gl")]
		crate::Annotation { lang: "gl", tts: Some("caderno"), keywords: &["caderno"] },
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		#[cfg(feature = "hr")]
		crate::Annotation { lang: "hr", tts: Some("bilježnica"), keywords: &["bilježnica"] },
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		#[cfg(feature = "hy")]
		crate::Annotation { lang: "hy", tts: Some("տետր"), keywords: &["տետր"] },
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("imedlis"), keywords: &["imedlis"] },
		#[cfg(feature = "kk")]
		crate::Annotation { lang: "kk", tts: Some("дәптер"), keywords: &["дәптер"] },
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
			tts:      Some("notesbog"),
		...
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("공책"), keywords: &["공책", "노트"] },
		#[cfg(feature = "kok")]
		crate::Annotation { lang: "kok", tts: Some("चोपडी"), keywords: &["चोपडी"] },
		#[cfg(feature = "ky")]
		crate::Annotation { lang: "ky", tts: Some("дептер"), keywords: &["дептер"] },
		#[cfg(feature = "lb")]
		crate::Annotation { lang: "lb", tts: Some("Notizblock"), keywords: &["Notizblock"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		#[cfg(feature = "lt")]
		crate::Annotation { lang: "lt", tts: Some("užrašinė"), keywords: &["užrašinė"] },
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		#[cfg(feature = "mn")]
		crate::Annotation { lang: "mn", tts: Some("дэвтэр"), keywords: &["дэвтэр"] },
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang: "mr", tts: Some("वही"), keywords: &["नोटब\u{941}क", "वही"]
		},
		#[cfg(feature = "ms")]
		crate::Annotation { lang: "ms", tts: Some("buku nota"), keywords: &["buku nota"] },
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("notebook"), keywords: &["notebook"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		#[cfg(feature = "pa_Arab")]
		crate::Annotation { lang: "pa_Arab", tts: Some("نوٹ بک"), keywords: &["نوٹ بک"] },
		#[cfg(feature = "pcm")]
		crate::Annotation { lang: "pcm", tts: Some("Nótbuk"), keywords: &["Nótbuk"] },
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("notes"),
		...
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("کاپي"), keywords: &["کاپي"] },
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("caderno"),
		...
		#[cfg(feature = "ro")]
		crate::Annotation { lang: "ro", tts: Some("carnet"), keywords: &["caiet", "carnet"] },
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-656"), keywords: &["E10-656"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("тетрадь"),
		...
		#[cfg(feature = "sd")]
		crate::Annotation { lang: "sd", tts: Some("نوٽ بڪ"), keywords: &["نوٽ بڪ"] },
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		#[cfg(feature = "so")]
		crate::Annotation { lang: "so", tts: Some("buug"), keywords: &["buug"] },
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		#[cfg(feature = "sr")]
		crate::Annotation { lang: "sr", tts: Some("свеска"), keywords: &["свеска"] },
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation { lang: "sr_Latn", tts: Some("sveska"), keywords: &["sveska"] },
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		crate::Annotation {
		...
		#[cfg(feature = "sw")]
		crate::Annotation { lang: "sw", tts: Some("daftari"), keywords: &["daftari"] },
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		crate::Annotation {
		...
		#[cfg(feature = "tg")]
		crate::Annotation { lang: "tg", tts: Some("дафтар"), keywords: &["дафтар"] },
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		#[cfg(feature = "ti")]
		crate::Annotation { lang: "ti", tts: Some("ደፍተር"), keywords: &["ደፍተር"] },
		#[cfg(feature = "tk")]
		crate::Annotation { lang: "tk", tts: Some("depderçe"), keywords: &["depderçe"] },
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("pepa tohi"), keywords: &["pepa tohi"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang: "ur", tts: Some("نوٹ بک"), keywords: &["نوٹ بک", "کتاب"]
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		#[cfg(feature = "vi")]
		crate::Annotation { lang: "vi", tts: Some("sổ ghi chép"), keywords: &["sổ ghi chép"] },
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("kàrne"), keywords: &["kàrne"] },
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("筆記簿"), keywords: &["筆記簿"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("笔记簿"), keywords: &["笔记簿"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("笔记本"),
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("筆記本"), keywords: &["筆記本"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("筆記簿"),
		...
		#[cfg(feature = "zu")]
		crate::Annotation { lang: "zu", tts: Some("incwajana"), keywords: &["incwajana"] },
	],
};
#[doc = "📚\u{fe0f}"]
...
pub const BOOKMARK_TABS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["boekmerk", "boekmerkoortjies", "merk", "merker", "oortjies", "plekaanwyser"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["চিহ\u{9cd}ন", "চিহ\u{9cd}নিত কৰ\u{9be}", "টেব", "ব\u{9c1}কম\u{9be}ৰ\u{9cd}ক"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("отметки"),
			keywords: &["знак", "отбелязване", "отметка", "отметки"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("sinedoù"), keywords: &["merk", "sinedoù"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["llyfrnod", "marc", "nod tudalen", "tabiau", "tabiau nodau tudalen"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			...
			keywords: &["ένδειξη", "δείκτης", "καρτέλες", "καρτέλες σελιδοδεικτών", "σελιδοδείκτης"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["marcador", "marcadores", "pestañas", "pestañas de marcador"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		crate::Annotation {
			...
			keywords: &["etiquetas", "etiquetas separadoras", "marcapáginas", "pestañas"],
		},
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
		...
		crate::Annotation {
			...
			keywords: &["kirjanmerkki", "kirjanmerkkivälilehdet", "merkki", "välilehti"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["clibeanna leabharmhairc", "leabharmharc", "leabharmharcanna", "marcáil", "táib"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("tabaichean-leabhair"),
			keywords: &["comharra", "comharra-leabhair", "comharraich", "taba", "tabaichean-leabhair"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &["דפים", "מסמכים", "ניירות", "סימון", "סימניה", "סימניות", "תוויות"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			...
			keywords: &[
				"ट\u{948}ब",
				"निशान",
				"प\u{943}ष\u{94d}ठ स\u{94d}म\u{943}ति",
		...
		crate::Annotation {
			...
			keywords: &["jezičak", "kartice knjižnih oznaka", "knjižna oznaka", "marker", "oznaka"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["penanda", "penanda halaman", "penanda halaman buku", "tab", "tanda"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("taabụ bukumakị"),
			keywords: &["akara", "bukumakị", "onyee akara", "taabụ bukumakị", "taabụ gasị"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("merkiflipar"),
			keywords: &["bókamerki", "flipar", "merki", "merkiflipar"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("etichette segnalibro"),
			keywords: &["etichette segnalibro", "linguette", "segnalibro", "ufficio"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("accaren n tecraḍ"),
			keywords: &["accaren n tecraḍ"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("бетбелгілер қойындысы"),
			keywords: &["белгі", "белгілегіш", "бетбелгі", "бетбелгілер қойындысы", "қағаз", "қойынды"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("북마크 탭"),
			keywords: &["마커", "북마크", "탭", "포스트잇", "표시"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("ब\u{942}कमार\u{94d}क ट\u{945}ब\u{94d}स"),
			keywords: &["ट\u{945}ब\u{94d}स", "ब\u{942}कमार\u{94d}क", "मार\u{94d}क", "म\u{947}कर"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["Lieszeechen", "Lieszeechestickeren", "Markéierung", "Stickeren", "Zeechen"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["skirtukai", "skirtukas", "žyma", "žymeklis", "žymių skirtukai", "žymė"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["номын хавчуурга", "номын хавчуургын табууд", "табууд", "тодруулагч", "тэмдэг"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			tts:      Some("ब\u{941}कमार\u{94d}क ट\u{945}ब"),
			keywords: &["ख\u{942}ण", "ट\u{945}ब", "ब\u{941}कमार\u{94d}क", "मार\u{94d}कर"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["bookmarks", "marka", "markatur", "tabs", "tabs tal-bookmarks"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			...
			keywords: &["चिन\u{94d}ह", "ट\u{94d}याबहर\u{942}", "ब\u{941}कमार\u{94d}क", "मार\u{94d}कर"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("bladwijzertabs"),
			keywords: &["bladwijzer", "bladwijzers", "bladwijzertabs", "markering", "tabbladen", "tabs"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["بک مارک", "بک مارک ٹیبز", "لوحہ", "نشان لان آلا", "نشان لانا"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			...
			keywords: &["marcador", "marcar", "página"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("marcadores de folhas"),
			keywords: &["marcador", "marcador de página", "marcadores", "marcadores de folhas", "marcar"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("rapi chinpuqkunawan"),
			keywords: &["chinpuq", "chinpuy", "qawachiqkuna", "rapi chinpuq", "rapi chinpuqkunawan"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("marcatoare de pagini"),
			keywords: &["hârtie", "marcaj", "marcatoare de pagini", "marcator", "semn", "semn de carte"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-654"), keywords: &["E10-654"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("стикеры-закладки"),
			keywords: &["закладки", "клеящиеся", "наклейки", "отметки", "стикеры", "стикеры-закладки"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["marker", "oznaka", "zavihki", "zaznamek", "zaznamki na straneh"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["faqeshënues", "shenjë", "shënoj", "shënues", "skeda", "skedat e faqeshënuesve"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("странице са белешкама"),
			keywords: &["маркер", "обележивач страница", "ознака", "трака за обележавање"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
		...
		crate::Annotation {
			...
			keywords: &["marker", "obeleživač stranica", "oznaka", "traka za obeležavanje"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
		...
		crate::Annotation {
			...
			keywords: &["alama", "alamisho", "vichupo", "vichupo vya alamisho", "weka alama"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &["аломат", "варақаҳо", "варақаҳои хатбарак", "маркер", "хатбарак"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ዕልባት ትቦታት"),
			keywords: &["ምልክት", "ትቦታት", "ዕልባት ምልክት"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("bellikçe tablary"),
			keywords: &["alamat", "bellikçe tablary", "marker", "tablar", "ýer belligi"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["ب\u{64f}ک مارک ٹیبز", "بک مارک", "جدول", "نشانی", "ٹیبز"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("sahifalardagi xatcho‘p"),
			keywords: &["belgilash", "marker", "sahifalardagi xatcho‘p", "varaqlar", "xatchoʻp"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			...
			keywords: &["boole ci yi ma gënal", "laf yi", "xàmme", "xàmme-téere", "xàmmekaay"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
			tts:      Some("iithebhu zebhukmakhi"),
			keywords: &["ibhukmakhi", "iithebhu", "iithebhu zebhukmakhi", "isiphawuli", "uphawu"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("àmì ìwé àwọn táàbù"),
			keywords: &["ohun èlò ìfàmìsí", "táàbù", "àmì", "àmì ìwé àwọn táàbù", "ìfàmìsí"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("àmì ìwé àwɔn táàbù"),
			keywords: &["ohun èlò ìfàmìsí", "táàbù", "àmì", "àmì ìwé àwɔn táàbù", "ìfàmìsí"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("标签页"),
			keywords: &["书签", "书签页标签", "有书签的页面", "标签", "标签页"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("書籤頁"),
			keywords: &["文件", "書籤", "書籤標籤", "書籤頁", "標籤", "標記", "標記頁面", "紙"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("ama-tabs okumaka ibhuku"),
			keywords: &["ama-tabs", "ama-tabs okumaka ibhuku", "okokumaka ibhuku", "umaka"],
		},
	],
};
#[doc = "🔖"]
pub const BOOKMARK: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang: "bg", tts: Some("отметка"), keywords: &["знак", "отметка"]
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		#[cfg(feature = "bs")]
		crate::Annotation { lang: "bs", tts: Some("marker"), keywords: &["marker", "oznaka"] },
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		#[cfg(feature = "et")]
		crate::Annotation { lang: "et", tts: Some("järjehoidja"), keywords: &["järjehoidja"] },
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			...
			keywords: &["علامت", "نشان\u{200c}گذار کتاب", "چوب\u{200c}الف", "چوق\u{200c}الف"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["marcador", "marcalibros", "marcapáxinas", "punto de lectura"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		#[cfg(feature = "hu")]
		crate::Annotation { lang: "hu", tts: Some("könyvjelző"), keywords: &["könyvjelző"] },
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang: "hy", tts: Some("էջանիշ"), keywords: &["էջանիշ", "նշել"]
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		#[cfg(feature = "jv")]
		crate::Annotation { lang: "jv", tts: Some("tenger"), keywords: &["tandha", "tenger"] },
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang: "ka", tts: Some("სანიშნე"), keywords: &["სანიშნე"]
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
		...
		crate::Annotation {
			...
			keywords: &["ਚਿ\u{a70}ਨ\u{a4d}ਹ", "ਨਿਸ\u{a3c}ਾਨੀ", "ਬ\u{a41}\u{a71}ਕਮਾਰਕ", "ਮਾਰਕ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		#[cfg(feature = "pcm")]
		crate::Annotation { lang: "pcm", tts: Some("Bukmák"), keywords: &["Bukmák", "Mak"] },
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("zakładka"),
		...
		crate::Annotation {
			...
			keywords: &["marcador", "marcador de livros", "marcador de página", "marcar"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation { lang: "qu", tts: Some("chinpuq"), keywords: &["chinpuq"] },
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-722"), keywords: &["E10-722"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("закладка"),
		...
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("بڪ مارڪ"), keywords: &["بڪ مارڪ", "نشان"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["ట\u{c4d}య\u{c3e}గ\u{c4d}", "బుక\u{c4d}\u{200c}మ\u{c3e}ర\u{c4d}క\u{c4d}"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang:     "tg",
		...
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang: "ug", tts: Some("يىغقۇچ"), keywords: &["بەلگە", "يىغقۇچ"]
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		#[cfg(feature = "yo")]
		crate::Annotation { lang: "yo", tts: Some("àmì ìwé"), keywords: &["àmì", "àmì ìwé"] },
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("àmì ìwé"),
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("書籤"), keywords: &["書籤", "標記"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("书签"), keywords: &["书签", "标记"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("书签"),
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("書籤"), keywords: &["書籤"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const PAGE_FACING_UP: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("مستند"),
			keywords: &["أعلى", "صفحة", "صفحة بوجه لأعلى", "فوق", "مستند", "وجه لأعلى", "ورق", "ورقة"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("pajenn"), keywords: &["pajenn", "teul"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["dokument", "list", "papír", "strana", "stránka", "stránka lícem nahoru"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			...
			keywords: &["سند", "صفحه", "صفحه روبه\u{200c}بالا", "صفحه\u{654} روبه\u{200c}بالا"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["bræv", "pappír", "pappír sum vendur uppeftir", "prógv", "skjal"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation { lang: "fr", tts: Some("page"), keywords: &["document", "page"] },
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["duilleag", "duilleag le h-aghaidh os a cionn", "sgrìobhainn"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &["buɗe shafi", "daftari", "sabon shafi", "shafi", "shafi mai kallon sama"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang: "hy", tts: Some("էջ"), keywords: &["էջ", "փաստաթութղ"]
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("asebter"), keywords: &["asebter"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		crate::Annotation {
			...
			keywords: &["bladzijde", "document", "pagina", "pagina met bovenzijde omhoog"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-641"), keywords: &["E10-641"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("страница"),
		...
		crate::Annotation {
			...
			keywords: &["doküman", "sayfa", "yüzü yukarıda sayfa", "ön yüz", "ön yüzü görünen sayfa"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			...
			keywords: &["دستاویز", "سامنے", "صفحہ", "صفحے کا سامنے والا حصہ", "ورق", "پنہ"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			...
			keywords: &["dọ\u{301}kúmé\u{329}ẹ\u{300}tì", "oju-iwe wa loke", "ojú ìwé"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("oju-iwe wa loke"),
			keywords: &["dɔ\u{301}kúmé\u{329}ɛ\u{300}tì", "oju-iwe wa loke", "ojú ìwé"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
...
pub const PAGE_WITH_CURL: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["bladsy", "bladsy met krul", "dokument", "krul", "krullende dokument", "papier"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["صحيفة", "صفحة", "صفحة بطية", "صفحة مطوية", "صفحة ملفوفة", "مستند"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["дакумент", "завіток", "загіб", "старонка", "старонка з загібам"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
		...
		crate::Annotation {
			...
			keywords: &["doblada", "documento", "documento doblado", "hoja", "papel", "página"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
		...
		crate::Annotation {
			...
			keywords: &["تا", "جمع\u{200c}شده", "سند", "صفحه", "صفحه تاشده", "صفحه\u{654} تاشده"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["dọkụmenti", "ihuakwụkwọ", "ihuakwụkwọ nwere mpịaji", "pịajie"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			...
			keywords: &["dokumen", "klunthung", "lembaran", "salembar kertas nglunthung"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &["Dokument", "Kréngel", "Säit", "opgerullt", "opgerullte Säit"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
			tts:      Some("ເຈ\u{ec9}ຍມ\u{ec9}ວນປາຍ"),
			keywords: &["ມ\u{ec9}ວນ", "ເຈ\u{ec9}ຍມ\u{ec9}ວນປາຍ", "ເອກະສານ", "ໜ\u{ec9}າເຈ\u{ec9}ຍ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["atliekta mala", "dokuments", "lapa", "lapa ar atliektu malu"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["документ", "свиткан", "свиткан лист", "свиткана страница", "страница"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
			tts:      Some("ച\u{d41}ര\u{d41}ണ\u{d4d}ട പേജ\u{d4d}"),
			keywords: &["ച\u{d41}ര\u{d41}ണ\u{d4d}ട പേജ\u{d4d}", "ഡോക\u{d4d}യ\u{d41}മെന\u{d4d}റ\u{d4d}"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["dobra", "dobrado", "documento", "página", "página com dobra", "página dobrada"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-640"), keywords: &["E10-640"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("pepa fafatu"), keywords: &["pepa fafatu"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			...
			keywords: &["oju-iwe pẹlu lilọ", "ojú ìwé", "ìló\u{329}pọ\u{300}", "ìwé ìpamó\u{329}"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("oju-iwe pɛlu lilɔ"),
			keywords: &["oju-iwe pɛlu lilɔ", "ojú ìwé", "ìló\u{329}pɔ\u{300}", "ìwé ìpamó\u{329}"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("带卷边的页面"),
			keywords: &["卷曲", "卷边", "带卷边的页面", "文书", "文件", "文档", "纸张", "页面"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
