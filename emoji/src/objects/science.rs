...
pub const TEST_TUBE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("proefbuis"),
			keywords: &["chemie", "chemikus", "eksperiment", "laboratorium", "proefbuis", "wetenskap"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
			tts:      Some("መፈተኛ ቱቦ"),
			keywords: &["መፈተኛ ቱቦ", "ሙከራ", "ሳይንስ", "ቀማሚ", "ቤተ ሙከራ", "ኬሚስትሪ", "የሙከራ ቱቦ", "የሙከራ ክፍል"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["eksperiment", "elm", "kimya", "kimyaçı", "laboratoriya", "sınaq şüşəsi"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("прабірка"),
			keywords: &["лабараторыя", "навука", "прабірка", "хімік", "хімія", "эксперымент"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
		...
		crate::Annotation {
			lang:     "bs",
			tts:      Some("epruveta"),
			keywords: &["eksperiment", "epruveta", "hemija", "hemičar", "laboratorija", "nauka"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			tts:      Some("tub d’assaig"),
			keywords: &["ciència", "experiment", "laboratori", "químic", "química", "tub d’assaig"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎠᎦᏛᏗ ᎤᏒᏙᏂ"),
			keywords: &["ᎠᎦᏙᎲᏍᏗ ᏅᏍᏗᏓᏅᎢ", "ᎠᎦᏛᏂᏓᏍᏗ", "ᎠᎦᏛᏗ ᎤᏒᏙᏂ", "ᎠᎦᏛᏙᏗ ᎧᏅᏑᎸ", "ᏧᏓᎴᏅᏓ ᏅᏫᏘ ᎠᏑᏰᏍᎩ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			lang:     "cy",
			tts:      Some("tiwb profi"),
			keywords: &["arbrawf", "cemeg", "fferyllydd", "gwyddoniaeth", "lab", "tiwb profi"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("reagensglas"),
			keywords: &["eksperiment", "forskning", "kemi", "kemiker", "laboratorium", "reagensglas"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["δοκιμαστικός σωλήνας", "επιστήμη", "εργαστήριο", "πείραμα", "χημεία", "χημικός"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "eu",
			tts:      Some("saio-hodi"),
			keywords: &["esperimentu", "kimika", "kimikari", "laborategi", "saio-hodi", "zientzia"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("koeputki"),
			keywords: &["kemia", "kemisti", "koe", "koeputki", "laboratorio", "tiede"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["ciencia", "experimento", "laboratorio", "probeta", "química"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("epruveta"),
			keywords: &["eksperiment", "epruveta", "kemija", "kemičar", "laboratorij", "znanost"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			lang:     "hy",
			tts:      Some("փորձանոթ"),
			keywords: &["գիտություն", "լաբորատորիա", "փորձ", "փորձանոթ", "քիմիա", "քիմիկոս"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ule tube"),
			keywords: &["eksperimenti", "kemist", "kemistry", "ule tube"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("試験管"),
			keywords: &["ラボ", "化学", "化学者", "実験", "科学", "試験管"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("tabung reaksi"),
			keywords: &["ahli kimia", "eksperimen", "kimia", "laborat", "sains", "tabung reaksi"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("სინჯარა"),
			keywords: &["ექსპერიმენტი", "ლაბორატორია", "მეცნიერება", "სინჯარა", "ქიმია", "ქიმიკოსი"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("шыны түтік"),
			keywords: &["зертхана", "тәжірибе", "химик", "химия", "шыны түтік", "ғылым"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &["илим", "лаборатория", "медициналык пробирка", "тажрыйба", "химик", "химия"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["bandymas", "chemija", "chemikas", "laboratorija", "mokslas", "mėgintuvėlis"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("mēģene"),
			keywords: &["eksperiments", "laboratorija", "mēģene", "zinātne", "ķīmija", "ķīmiķis"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("епрувета"),
			keywords: &["експеримент", "епрувета", "лабораторија", "наука", "хемичар", "хемија"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "pl",
			tts:      Some("probówka"),
			keywords: &["chemia", "chemik", "eksperyment", "laboratorium", "nauka", "probówka"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-052"), keywords: &["E11-052"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("пробирка"),
		...
		crate::Annotation {
			lang:     "sl",
			tts:      Some("epruveta"),
			keywords: &["eksperiment", "epruveta", "kemija", "kemik", "laboratorij", "znanost"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "sq",
			tts:      Some("epruvetë"),
			keywords: &["eksperiment", "epruvetë", "kimi", "kimist", "laborator", "shkencë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			lang:     "sv",
			tts:      Some("provrör"),
			keywords: &["experiment", "kemi", "kemist", "labb", "provrör", "vetenskap"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
			tts:      Some("neli ya majaribio"),
			keywords: &["kemia", "maabara", "majaribio", "mwanakemia", "neli ya majaribio", "sayansi"],
		},
		#[cfg(feature = "sw_KE")]
		...
		crate::Annotation {
			...
			keywords: &[
				"ఎక\u{c4d}స\u{c4d}ప\u{c46}ర\u{c3f}మ\u{c46}ంట\u{c4d}",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"หลอด",
				"ห\u{e49}องปฏ\u{e34}บ\u{e31}ต\u{e34}การ",
				"เคม\u{e35}",
				"แล\u{e47}บ",
			],
		},
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ናይ መርመራ ሻምብቆ"),
			keywords: &["ሳይንስ", "ቤተ ፈተነ", "ቱቦ", "ኬሚስት", "ኬሚስትሪ", "ፈተነ", "ፈተና"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("probirka"),
			keywords: &["barlaghana", "himik", "himiýa", "probirka", "tejribe", "ylym"],
		},
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("tiupi kemi"), keywords: &["tiupi kemi"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("deney tüpü"),
		...
		crate::Annotation {
			lang:     "uz",
			tts:      Some("probirka"),
			keywords: &["fan", "kimyo", "kimyogar", "laboratoriya", "probirka", "tajriba"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("tubu ayewo"),
			keywords: &["ayewo", "kemisir]i", "lábù", "sayensi", "tubu ayewo"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["化學", "化學家", "實驗", "實驗室", "科學", "綠色", "藥水", "試管"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const PETRI_DISH: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["бактэрыя", "біялогія", "біёлаг", "культура", "лабараторыя", "чашка Петры"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
		...
		crate::Annotation {
			lang:     "bs",
			tts:      Some("petri jelo"),
			keywords: &["bakterija", "biolog", "biologija", "kultura", "laboratorija", "petri jelo"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			...
			keywords: &["bacteria", "bioleg", "biologydd", "dysgl petri", "lab", "meithrin"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("petriskål"),
			keywords: &["bakterie", "biolog", "biologi", "dyrkning", "laboratorie", "petriskål"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["bacteria", "bióloga", "biólogo", "cultivo", "laboratorio", "placa de petri"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("placa de Petri"),
			keywords: &["bacteria", "biología", "biólogo", "laboratorio", "microbio", "placa de Petri"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation {
			lang:     "es_US",
		...
		crate::Annotation {
			lang:     "et",
			tts:      Some("Petri tass"),
			keywords: &["Petri tass", "bakterid", "bioloog", "bioloogia", "kultuur", "labor"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("Petriren kaxa"),
			keywords: &["Petriren kaxa", "bakterio", "biologia", "biologo", "kultura", "laborategi"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			lang:     "fo",
			tts:      Some("petriskál"),
			keywords: &["lívfrøði", "náttúruvísind", "petriskál", "tilbúningarglas", "tilbúningsglas"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("placa de Petri"),
			keywords: &["Petri", "bacteria", "bioloxía", "cultivo", "laboratorio"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			...
			keywords: &[
				...
				"વિષાણ\u{ac1}\u{a82}",
				"સ\u{a82}વર\u{acd}ધન",
				"સ\u{ac1}ક\u{acd}ષ\u{acd}મજીવ",
			],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
			tts:      Some("tasar petri"),
			keywords: &[
				"alʼada",
				"binciken halittu",
				"binciken kimiyya",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("צלחת פטרי"),
			keywords: &["ביולוגיה", "חיידקים", "מעבדה", "ניסויים", "צלחת פטרי", "תרבית"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("ペトリ皿"),
			keywords: &["バクテリア", "ペトリ皿", "培養", "実験", "生物学", "生物学者"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("cawan petri"),
			keywords: &["ahli biologi", "bakteri", "biologi", "cawan petri", "kultur", "laborat"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("პეტრის თასი"),
			keywords: &["ბაქტერია", "ბიოლოგი", "ბიოლოგია", "ლაბორატორია", "პეტრის თასი"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("Петри ыдысы"),
			keywords: &["Петри ыдысы", "бактерия", "биолог", "биология", "зертхана", "мәдениет"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &[
				"ಕಲ\u{ccd}ಚರ\u{ccd}",
				"ಜ\u{cc0}ವಶಾಸ\u{ccd}ತ\u{ccd}ರ",
				"ಜ\u{cc0}ವಶಾಸ\u{ccd}ತ\u{ccd}ರಜ\u{ccd}ಞ",
				"ಪ\u{cc6}ಟ\u{ccd}ರ\u{cbf} ಡ\u{cbf}ಶ\u{ccd}",
				"ಬ\u{ccd}ಯಾಕ\u{ccd}ಟ\u{cc0}ರ\u{cbf}ಯಾ",
				"ಲ\u{ccd}ಯಾಬ\u{ccd}",
				"ಸ\u{cc2}ಕ\u{ccd}ಷ\u{ccd}ಮಾಣುಗಳನ\u{ccd}ನು ವ\u{cc0}ಕ\u{ccd}ಷ\u{cbf}ಸುವ ತಟ\u{ccd}ಟ\u{cc6}",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("페트리 접시"),
			keywords: &["미생물", "박테리아", "생물학", "생물학자", "실험실", "페트리 접시"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["Петри идиши", "бактерия", "биолог", "биология", "лаборатория", "маданият"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["бактерија", "биолог", "биологија", "култура", "лабораторија", "петриев сад"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "ps",
			tts:      Some("پيټري ډش"),
			keywords: &["بيالوژي", "بکتيريا", "د بيالوژي پوهاند", "لابراتور", "پيټري ډش", "کلتور"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["bactéria", "biologia", "cultura", "laboratório", "placa de Petri"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-053"), keywords: &["E11-053"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			lang:     "sd",
			tts:      Some("پيٽري ڊش"),
			keywords: &["بايو لاجسٽ", "بايو لاجي", "بيڪٽيريا", "ليب", "پيٽري ڊش", "ڪلچر"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			lang:     "sl",
			tts:      Some("petrijevka"),
			keywords: &["bakterije", "biolog", "biologija", "kultura", "laboratorij", "petrijevka"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "sq",
			tts:      Some("lamelë"),
			keywords: &["bakter", "biolog", "biologji", "kulturë", "laborator", "lamelë", "lamë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &["bakteria", "biolojia", "chombo cha kupondea", "maabara", "mwanabiolojia"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ፔትሪ ዲሽ"),
			keywords: &["ስነ ህይወት", "ባህሊ", "ባክተርያ", "ቤተ ፈተነ", "ተመራማሪ ስነ ህይወት", "ድስቲ", "ፔትሪ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("petri çaşkasy"),
			keywords: &["bakteriýa", "barlaghana", "biolog", "biologiýa", "kultura", "petri çaşkasy"],
		},
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("tisi kemi"), keywords: &["tisi kemi"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("petri kabı"),
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("پیٹری ڈش"),
			keywords: &["بائیالوجسٹ", "بائیالوجی", "بیکٹیریا", "ثقافت", "لیب", "پیٹری ڈش"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("petri idishi"),
			keywords: &["bakteriya", "biologiya", "laboratoriya", "petri idishi", "tajriba"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("ounje"),
			keywords: &["aarun", "asa", "bioloji", "ounje"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
		...
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("培養皿"),
			keywords: &["培養", "培養皿", "基因", "實驗", "實驗室", "生物", "生物學家", "細菌"],
		},
		#[cfg(feature = "zh_Hant_HK")]
...
pub const TELESCOPE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("ቴሌስኮፕ"),
			keywords: &["መሣሪያ", "ስለላ", "ቴሌስኮፕ", "ከዋክብትን መመልከት"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("تليسكوب"),
			keywords: &["أداة", "تليسكوب", "سماء", "علم", "فضاء", "معاينة"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("телескоп"),
			keywords: &["инструмент", "наука", "телескоп"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("teleskop"),
			keywords: &["astronomi", "redskab", "stjernekikkert", "teleskop", "videnskab", "værktøj"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
			tts:      Some("Teleskop"),
			keywords: &["Himmel", "Teleskop"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation {
			lang:     "el",
			tts:      Some("τηλεσκόπιο"),
			keywords: &["εξωγήινος", "επαφή", "επιστήμη", "εργαλείο", "τηλεσκόπιο"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["astronomía", "ciencia", "espacio", "instrumento", "telescopio"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
		...
		crate::Annotation {
			lang:     "et",
			tts:      Some("teleskoop"),
			keywords: &["kontakt", "maaväline", "teadus", "teleskoop", "tööriist"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("telescope"),
			keywords: &["e.t.", "kagamitan", "siyensiya", "telescope", "teleskopyo", "tool"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("télescope"),
			keywords: &["astronomie", "espace", "outil", "planètes", "science", "télescope"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("telescopio"),
			keywords: &["astronomía", "constelacións", "corpos celestes", "telescopio"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("טלסקופ"),
			keywords: &["טלסקופ", "כוכבים", "מדע", "מחקר", "מצפה כוכבים", "צפייה"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			tts:      Some("द\u{942}रबीन"),
			keywords: &["उपकरण", "ट\u{947}लिस\u{94d}कोप", "द\u{942}रबीन", "विज\u{94d}ञान"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
			tts:      Some("teleskop"),
			keywords: &["alat", "kontakt", "teleskop", "vanzemaljski", "znanost"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("távcső"),
			keywords: &["csillagászat", "eszköz", "felszerelés", "távcső"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("atiliskup"), keywords: &["atiliskup"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("телескоп"),
			keywords: &["телескоп", "ғылым", "құрал"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "lt",
			tts:      Some("teleskopas"),
			keywords: &["mokslas", "teleskopas", "įrankis"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("teleskops"),
			keywords: &["astronomija", "rīks", "teleskops", "zinātne"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("телескоп"),
			keywords: &["алатка", "вонземско", "наука", "телескоп"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "ms",
			tts:      Some("teleskop"),
			keywords: &["alat", "hubung", "sains", "teleskop"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["ciência", "ferramenta", "instrumento", "telescópio"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation { lang: "qu", tts: Some("telescopio"), keywords: &["telescopio"] },
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("telescop"),
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-745"), keywords: &["E10-745"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("телескоп"),
		...
		crate::Annotation {
			lang:     "sl",
			tts:      Some("teleskop"),
			keywords: &["orodje", "stik", "teleskop", "znanost"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ቴለስኮፕ"),
			keywords: &["መሳርሒ", "ርክብ", "ሳይንስ", "ቴለስኮፕ", "ውጽእ መሬት"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			lang:     "tr",
			tts:      Some("teleskop"),
			keywords: &["alet", "teleskop", "uzay", "uzay gözlemleme"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "uk",
			tts:      Some("телескоп"),
			keywords: &["астроном", "дивитися на зірки", "телескоп", "інструмент"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("ٹیلی سکوپ"),
			keywords: &["آلہ", "دور بین", "سکوپ", "ٹیلی"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("teleskop"),
			keywords: &["asbob", "ilm-fan", "teleskop"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("tɛlisikopu"),
			keywords: &["irinshɛ\u{301}", "sáyé\u{329}nsì", "tɛlisikopu"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("望远镜"),
			keywords: &["外星人", "天体", "天文", "天文学", "工具", "接触", "望远镜", "科学", "观星"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["e.t.", "工具", "接觸", "望遠鏡", "科學", "觀測｜工具"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
