...
pub const MOBILE_PHONE_WITH_ARROW: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["bir", "hezoug", "pellgomz", "pellgomzer", "pellgomzer hezoug gant bir"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("strelica pokazuje mobitel"),
			keywords: &["mobilni", "poziv", "strelica", "strelica pokazuje mobitel", "telefon"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			...
			keywords: &["ᎠᎩᏍᎩ", "ᎠᏓᏅᏏᏙᎯ", "ᎦᏝᏗ", "ᏗᏟᏃᎮᏗ", "ᏗᏟᏃᎮᏗᎢ", "ᏙᎴᎳᏊ ᏗᎵᏃᎮᏓ ᎤᎵᎪᏗ ᎦᏟᏓ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["indgående opkald", "lav et opkald", "mobil med pil", "modtag et opkald"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["flecha", "llamada", "móvil", "móvil con una flecha", "recibir", "teléfono"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["تلفن همراه", "تلفن همراه با پیکان", "دریافت", "پیکان", "گوشی"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("kännykkä ja nuoli"),
			keywords: &["kännykkä ja nuoli", "matkapuhelin", "nuoli", "puhelin", "puhelu", "saapuva"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["fartelefon", "fartelefon við píli", "kall", "uppkall", "uppringing"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			...
			keywords: &["frecha", "móbil", "recibir", "teléfono", "teléfono móbil con frecha"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			...
			keywords: &[
				...
				"પ\u{acd}રાપ\u{acd}ત કરવ\u{ac1}\u{a82}",
				"ફોન",
				"મોબાઇલ ફોન",
				"સાધન",
			],
		...
		crate::Annotation {
			...
			keywords: &["חץ", "טלפון", "טלפון נייד עם חץ", "נייד", "סלולרי", "שיחה נכנסת"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["բջջային", "բջջային հեռախոս սլաքով", "զանգել", "հեռախոս", "շարժական", "սլաք"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["nampa", "panah", "sel", "seluler", "telepon", "telepon seluler nganggo panah"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("tiliɣri tazirazt s uneccab"),
			keywords: &["tiliɣri tazirazt s uneccab"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some(
				"ಬಾಣದ ಗುರುತ\u{cbf}ನ\u{cca}ಂದ\u{cbf}ಗ\u{cc6} ಮ\u{cca}ಬ\u{cc8}ಲ\u{ccd} ಫ\u{ccb}ನ\u{ccd}",
			),
			keywords: &[
				"ಕರ\u{cc6} ಮಾಡ\u{cbf}",
				"ಫ\u{ccb}ನ\u{ccd}",
		...
		crate::Annotation {
			...
			keywords: &["फोन", "बाण", "बाण आसपी मोबायल फोन", "म\u{947}ळोवप", "मोबायल", "स\u{945}ल"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["pere", "pūkoro", "pūwhiwhi", "waea", "waea pūkoro me te pere", "waeakawe"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ਸ\u{a48}\u{a71}ਲਫ\u{a4b}ਨ ਤੀਰ ਨਾਲ",
			],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["Fon", "Mọ\u{301}bail", "Mọ\u{301}baíl Fon Wit Áro", "Risiv", "Sẹl", "Áro"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		crate::Annotation {
			...
			keywords: &["ترلاسه کول", "غشی", "غشی لرونکی ګرځنده ټېلیفون", "فون", "موبايل"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-687"), keywords: &["E10-687"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("входящий вызов"),
			keywords: &["входящий", "вызов", "мобильник", "мобильный", "смартфон", "сотовый", "телефон"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["تير", "تير سان گڏ موبائل فون", "سيل", "فون", "موبائيل", "وٺڻ", "ٽيليفون", "ڪال"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["foon", "helid", "moobil", "moobil leh xariiq", "telefoonka gacanta", "xariiq"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("celular me shigjetë"),
			keywords: &["celular", "celular me shigjetë", "marr", "shigjetë", "telefon", "telefonatë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("мобилни телефон са стрелицом"),
			keywords: &["долазни", "комуникација", "мобилни", "позив", "стрелица", "тeлeфoн"],
		},
		...
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("mobilni telefon sa strelicom"),
			keywords: &["dolazni", "komunikacija", "mobilni", "poziv", "strelica", "telefon"],
		},
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"క\u{c4a}త\u{c4d}త స\u{c4d}మ\u{c3e}ర\u{c4d}ట\u{c4d} ఫ\u{c4b}న\u{c4d}",
				"ఫ\u{c4b}న\u{c4d}\u{200c}కు స\u{c47}వ\u{c4d} చ\u{c47}య\u{c3f}",
				"బ\u{c3e}ణం గుర\u{c4d}తుత\u{c4b} సూచ\u{c3f}స\u{c4d}తున\u{c4d}న మ\u{c4a}బ\u{c48}ల\u{c4d} ఫ\u{c4b}న\u{c4d}",
				"స\u{c46}ల\u{c4d} ఫ\u{c4b}న\u{c4d}",
			],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "th",
			tts:      Some("โทรศ\u{e31}พท\u{e4c}ม\u{e37}อถ\u{e37}อพร\u{e49}อมล\u{e39}กศรช\u{e35}\u{e49}"),
			keywords: &[
				"ม\u{e37}อถ\u{e37}อ",
				"ล\u{e39}กศร",
				"โทร",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሞባይል ምስ ፍላጻ"),
			keywords: &["ምህናጽ", "ምቕባል", "ሞባይል", "ርክብ", "ስልኪ", "ቴሌፎን ስልኪ", "ዋህዮ", "ጻውዒት", "ፍላጻ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["آلہ", "تیر", "تیر کے نشان کے ساتھ موبائل فون", "فون", "موبائل", "نشان"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			...
			keywords: &["fett", "jot", "portaabal", "telefon", "telefon portaabal ak fett", "woote"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("fóònù alágbèéká pɛ\u{300}lú ofà"),
			keywords: &[
				"alágbèéká",
				"fóònù",
				"fóònù alágbèéká pɛ\u{300}lú ofà",
				"gbà",
				"tɛlifóònù",
				"ìpè",
				"ɔfà",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("個有箭嘴嘅電話"),
			keywords: &["來電", "個有箭嘴嘅電話", "手提電話", "手機", "接電話", "箭咀", "電話"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const TELEPHONE_RECEIVER: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ሪሲቨር", "ስልክ", "ቴሌፎን", "የስልክ እጀታ", "የቴሌፎን መነጋገሪያ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["комуникация", "слушалка", "телефон", "телефонна слушалка"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
			tts:      Some("টেলিফোন রিসিভ\u{9be}র"),
			keywords: &["টেলিফোন", "ফোন", "যোগ\u{9be}যোগ", "রিসিভ\u{9be}র"],
		},
		#[cfg(feature = "br")]
		crate::Annotation {
			lang:     "br",
		...
		crate::Annotation {
			...
			keywords: &["VoIP", "auricular", "auricular de telèfon", "comunicació", "telèfon"],
		},
		#[cfg(feature = "ccp")]
		crate::Annotation {
			lang:     "ccp",
		...
		crate::Annotation {
			...
			keywords: &["Hörer", "Kommunikation", "Telefon", "Telefonhörer", "anrufen"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			...
			keywords: &["phone", "receiver", "receiver ng telepono", "tagatanggap", "telepono", "voip"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			...
			keywords: &["combiné téléphonique", "communication", "téléphone"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("kan tarho"),
			keywords: &["hannun waya", "kan tarho", "sadarwa", "tangaraho", "tarho", "waya"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["אפרכסת", "בשיחה", "טלפון", "שיחה", "שפופרת"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["gagang telepon", "komunikasi", "penerima", "telepon"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			...
			keywords: &["ресивер", "телефон", "телефон ресивері", "тұтқа"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಫ\u{ccb}ನ\u{ccd}\u{200c} ರ\u{cbf}ಸ\u{cc0}ವರ\u{ccd}\u{200c}"),
			keywords: &[
				"ಟ\u{cc6}ಲ\u{cbf}ಫ\u{ccb}ನ\u{ccd}",
				"ದ\u{cc2}ರವಾಣ\u{cbf}",
				"ಫ\u{ccb}ನ\u{ccd}",
				"ರ\u{cbf}ಸ\u{cc0}ವರ\u{ccd}",
				"ವಾಯ\u{ccd}ಸ\u{ccd} ಓವರ\u{ccd} ಇಂಟರ\u{ccd}ನ\u{cc6}ಟ\u{ccd} ಪ\u{ccd}ರ\u{cca}ಟ\u{cca}ಕಾಲ\u{ccd}",
				"ವ\u{cbf}ಒಐಪ\u{cbf}",
				"ಸಂವಹನ",
			],
		},
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("수화기"),
			keywords: &["수화기", "인터넷 전화", "전화", "전화기", "커뮤니케이션"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["ຫ\u{eb9}ໂທລະສ\u{eb1}ບ", "ເຄ\u{eb7}\u{ec8}ອງຮ\u{eb1}ບ", "ໂທລະສ\u{eb1}ບ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
			tts:      Some("telefono ragelis"),
			keywords: &["prietaisas", "ragelis", "telefonas", "telefono ragelis"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("tālruņa klausule"),
			keywords: &["klausule", "saziņa", "telefons", "tālrunis", "tālruņa klausule"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["комуникација", "слушалка", "телефон", "телефонска слушалка"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["gagang telefon", "penerima", "telefon", "voip"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["bellen", "hoorn", "telefoon", "telefoonhoorn"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["rozmawiać", "słuchawka", "telefon", "telefoniczna"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			...
			keywords: &["auscultador", "auscultador de telefone", "comunicação", "telefone"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		crate::Annotation {
			...
			keywords: &["comunicare", "receptor", "receptor de telefon", "telefon", "voip"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-667"), keywords: &["E10-667"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["komunikácia", "slúchadlo", "slúchadlo telefónu", "telefón"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("telefonska slušalka"),
			keywords: &["komunikacija", "sprejemnik", "telefon", "telefonska slušalka"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["komunikim", "receptor", "receptor telefoni", "telefon", "voip"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("телефонска слушалица"),
			keywords: &["комуникација", "слушaлицa", "тeлeфoн"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("telefonska slušalica"),
			keywords: &["komunikacija", "slušalica", "telefon"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ተቐባሊ ቴሌፎን"),
			keywords: &["ርክብ", "ስልኪ", "ቮይፕ", "ተቐባሊ", "ቴሌፎን"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["слухавка", "телефон", "телефонна розмова", "телефонна слухавка"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("ٹیلیفون کا ریسیور"),
			keywords: &["ابلاغ", "برقی آلہ", "ریسیور", "فون", "ٹیلیفون کا ریسیور"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("telefon go‘shagi"),
			keywords: &["qabul qiluvchi", "telefon", "telefon go‘shagi", "uy telefoni", "voip"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("电话听筒"),
			keywords: &["听筒", "固定电话", "固话", "座机", "电话", "电话听筒", "通信"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("聽筒"), keywords: &["聽筒", "電話"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("電話筒"),
			keywords: &["溝通", "聽筒", "通訊", "電話", "電話筒"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
