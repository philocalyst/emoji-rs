...
pub const TELEPHONE: crate::Emoji = crate::Emoji {
    ...
    annotations: &[
        ...
        crate::Annotation {
            ...
            keywords: &["ದ\u{cc2}ರವಾಣ\u{cbf}", "ಫ\u{ccb}ನ\u{ccd}\u{200c}"],
        },
        #[cfg(feature = "ko")]
        crate::Annotation {
            lang: "ko",
