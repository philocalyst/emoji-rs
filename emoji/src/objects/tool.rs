#[doc = "⛓\u{fe0f}\u{200d}💥"]
pub const BROKEN_CHAIN: crate::Emoji = crate::Emoji {
	glyph:                "⛓\u{fe0f}\u{200d}💥",
	codepoint:            &[9939u32, 65039u32, 8205u32, 128165u32],
	status:               crate::Status::FullyQualified,
	introduction_version: crate::Version { major: 15u8, minor: 1u8, patch: 0u8 },
	name:                 "broken chain",
	group:                crate::Group::Objects,
	subgroup:             crate::Subgroup::Tool,
	is_variant:           false,
	variants:             &[],
	annotations:          &[],
};
...
pub const SHOVEL: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("graaf"),
			keywords: &["gat", "graaf", "grawe", "skep", "skop", "skopgraaf", "spitgraaf"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
			tts:      Some("አካፋ"),
			keywords: &["መቅበር", "መቆፈር", "ስካፕ", "በረዶ", "ተክል", "አካፋ", "አጭር አካፋ", "የአትክልት ስፍራ", "ጉድጓድ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("lopata"),
			keywords: &["jáma", "kopat", "lopata", "rostlina", "rýč", "sníh", "zahrabat", "zahrada"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			lang:     "de_CH",
			tts:      Some("Schaufel"),
			keywords: &["Loch", "Schaufel", "Spaten", "ausgraben", "graben", "schaufeln", "vergraben"],
		},
		#[cfg(feature = "el")]
		crate::Annotation {
			lang:     "el",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("shebur"),
			keywords: &["binne", "dusar ƙanƙara", "haƙa", "lambu", "ludayi", "rami", "shebur", "shuka"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("lopata"),
			keywords: &["kopati", "lopata", "motika", "rupa", "saditi", "snijeg", "vrt"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			tts:      Some("sekop"),
			keywords: &[
				"gali", "kebun", "kubur", "lubang", "salju", "sekop", "taman", "tanaman", "tumbuhan",
			],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "ky",
			tts:      Some("күрөк"),
			keywords: &["бакча", "казуу", "кар", "күрөк", "көмүү", "тешик", "өсүмдүк"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			lang:     "mr",
			tts:      Some("फावड\u{947}"),
			keywords: &["क\u{941}दळ", "खड\u{94d}डा", "खोदण\u{947}", "पोखरण\u{947}", "फावड\u{947}"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
			tts:      Some("penyodok"),
			keywords: &["cedok", "gali", "kebun", "lubang", "penyodok", "salji", "taman", "tanam"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
			tts:      Some("ဂေါ\u{103a}ပြား"),
			keywords: &["ကျင\u{103a}း", "ဂေါ\u{103a}ပြား", "တ\u{1030}း", "တ\u{103d}င\u{103a}း"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			...
			keywords: &["ਕਹੀ", "ਖ\u{a71}ਡਾ", "ਪ\u{a71}ਟਣਾ", "ਫ\u{a4b}ੜ\u{a4d}ਹਾ", "ਬ\u{a47}ਲਚਾ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			lang:     "ps",
			tts:      Some("بیلچه"),
			keywords: &["باغ", "بیلچه", "سورې", "سپیډ", "سکوپ", "نبات", "واوره", "ښخ کړه", "کیندل"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E16-002"), keywords: &["E16-002"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("лопата"),
		...
		crate::Annotation {
			lang:     "sd",
			tts:      Some("بيلچو"),
			keywords: &["اسڪوپ", "باغ", "برف", "بيلچو", "دفن", "سوراخ", "پوکڻ", "کوٽڻ", "ڪوڏر"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			lang:     "sq",
			tts:      Some("lopatë"),
			keywords: &["bimë", "borë", "gërmoj", "kopsht", "lopatë", "varros", "vrimë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &["ข\u{e38}ด", "ต\u{e31}ก", "พล\u{e31}\u{e48}ว", "หล\u{e38}ม", "เส\u{e35}ยม"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("አካፋ"),
			keywords: &["መቅበር", "መቆፈር", "ስካፕ", "በረዶ", "ተክል", "አካፋ", "የአትክልት ስፍራ", "ጉድጓድ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("pilçe"),
			keywords: &["gazmak", "kepje", "pil", "piljagaz", "pilçe", "susak", "çukur"],
		},
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("huo tata"), keywords: &["huo"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("kürek"),
		...
		crate::Annotation {
			...
			keywords: &["bù", "gbẹ\u{301}", "ihò", "ṣọ\u{300}bìrì", "ṣọ\u{300}bìrì ìgbẹ\u{301}lẹ\u{300}"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
...
pub const BOW_AND_ARROW: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("قوس وسهم"),
			keywords: &["برج", "برج الرامي", "رامي", "سلاح", "سهم", "قوس", "قوس وسهم", "وتر"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["alət", "ox", "ox və kaman", "oxatan", "silah", "tənzim etmək", "zodiak"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["ᎠᏉᏂᏍᎩ", "ᎠᏉᏅᏙᏗ", "ᎠᏍᎦᏯ ᏐᏈᎵ ᎤᎬᎭᎵ", "ᎦᎵᏣᏗ", "ᎦᎵᏣᏗ ᎠᎴ ᎠᏝᏗ", "ᎦᏝᏗ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("bue og pil"),
			keywords: &["bue", "bue og pil", "bueskytte", "pil", "skytten", "stjernetegn", "våben"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["arco", "arco y flecha", "arquero", "flecha", "sagitario", "zodiaco"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["Sagitario", "arco", "arco y flecha", "arma", "arquero", "flecha", "zodíaco"],
		},
		#[cfg(feature = "es_MX")]
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("تیر و کمان"),
			keywords: &["اسلحه", "برج فلکی", "تیر", "تیر و کمان", "زودیاک", "پیکان", "کمان"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("pana"),
			keywords: &["archer", "arkero", "mamamana", "palaso", "pana", "sagittarius", "zodiac"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			...
			keywords: &["Sagittarius", "gendewa", "gendewa lan panah", "palintangan", "pamanah", "panah"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &["жебе", "жебе мен садақ", "зодиак", "көрсеткі", "мерген", "садақшы"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("활과 화살"),
			keywords: &["궁수", "무기", "별자리", "사수자리", "장비", "화살", "활", "활과 화살"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["ຄ\u{eb1}ນທະນ\u{eb9}", "ຄ\u{eb1}ນທະນ\u{eb9} ແລະ ລ\u{eb9}ກສອນ", "ລ\u{eb9}ກສອນ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["bulta", "horoskops", "ierocis", "loks", "loks un bulta", "strēlnieks"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["arco", "arco e flecha", "arma", "flecha", "sagitário", "zodíaco"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-438"), keywords: &["E10-438"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("лук со стрелой"),
			keywords: &["знак зодиака", "лук со стрелой", "оружие", "стрелец", "стрелы"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["ආය\u{dd4}ධය", "ඊතලය", "ද\u{dd4}න\u{dca}න", "ද\u{dd4}න\u{dca}න සහ ඊතලය"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			...
			keywords: &["armë", "hark", "hark dhe shigjetë", "harkëtar", "shigjetari zodiak"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ቀስቲን ፍላጻን"),
			keywords: &["መሳርሒ", "ሳጂታሪየስ", "ቀስተ ደመና", "ቀስቲ", "ቅስቀሳ", "ዕጥቂ", "ዞድያክ", "ፍላጻ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			lang:     "vi",
			tts:      Some("cung tên"),
			keywords: &["Nhân Mã", "cung", "cung hoàng đạo", "cung thủ", "cung tên", "mũi tên"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("弓箭"),
			keywords: &["射手", "射手座", "射箭", "工具", "弓", "弓箭", "星座", "武器", "箭头"],
		},
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("弓和箭"),
			keywords: &["人马座", "射手", "射手座", "射箭", "弓", "弓和箭", "弓箭", "箭"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
...
pub const CARPENTRY_SAW: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "as",
			tts:      Some("কৰত"),
			keywords: &["ক\u{9be}ঠ", "ক\u{9be}ঠ মিস\u{9cd}ক\u{9cd}ৰী", "কৰত", "স\u{981}জ\u{9c1}লি"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
			tts:      Some("əl mişarı"),
			keywords: &["alət", "bıçqı", "dülgər", "kəsmək", "taxta-şalban", "əl mişarı"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			lang:     "de",
			tts:      Some("Handsäge"),
			keywords: &["Handsäge", "Holz", "Säge", "Tischler", "Werkzeug", "sägen", "trimmen"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("scie"),
			keywords: &["bois", "outil", "scie", "scie à bois", "scie égoïne", "scier"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["acainn", "fiodh", "inneal", "saoirsinneachd", "saor", "saorsainneachd", "sàbh"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			...
			keywords: &["kafinta", "katako", "kayan aiki", "yanka", "zarto", "zarton kafinta"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("מסור"),
			keywords: &["כלי עבודה", "מנסר", "מסור", "מסור ידני", "נגר", "נגרייה", "ניסור"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["asztalos", "fa", "fűrész", "rókafarkú", "szerszám", "vágás", "ács"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ọwa osisi"),
			keywords: &["belata", "ngwá ọrụ", "onye ọkwá nkà", "ọkwá nkà", "ọwa osisi"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "kk",
			tts:      Some("ара"),
			keywords: &["ара", "араланған материал", "ағаш ұстасы", "кесу", "қол арасы", "құрал"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("목공 톱"),
			keywords: &["도구", "목공 톱", "목수", "목재", "자르기", "장비", "톱", "톱질", "트림"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["darbarīks", "galdnieks", "kokmateriāli", "vienrokas zāģis", "zāģis", "zāģēt"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("столарска пила"),
			keywords: &["алат", "алатка", "дрво", "пила", "сече", "столар", "столарска пила"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["တ\u{1030}းလ\u{103a}", "ပရ\u{102d}ဘောဂ", "လက\u{103a}သမား", "လ\u{103d}\u{103e}"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("serrote"),
			keywords: &["carpinteiro", "cortar", "ferramenta", "madeira", "serra", "serrar", "serrote"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-061"), keywords: &["E13-061"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["drevo", "nástroj", "píla", "píliť", "rezať", "tesár", "tesárska píla"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("lisičja žaga"),
			keywords: &["lisičja žaga", "lisičji rep", "mizar", "orodje", "rezati", "žaga", "žagati"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["dru", "marangoz", "pres", "sharrë", "sharrë marangozi", "shkurtoj", "vegël"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("kili"), keywords: &["kili", "tufunga"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("testere"),
			keywords: &["alet", "eşya", "kereste", "kesmek", "marangoz", "odun", "testere"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		crate::Annotation {
			...
			keywords: &["آرا", "آری", "آلہ", "اوزار", "بڑھئی", "بڑھئی کا آرا", "لکڑی"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
...
pub const LADDER: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "as",
			tts:      Some("জখল\u{9be}"),
			keywords: &["জখল\u{9be}", "জখল\u{9be}ৰ ক\u{9be}ঠ", "পদক\u{9cd}ষেপ", "বগোৱ\u{9be}"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("skeul"), keywords: &["skabell", "skeul"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("ljestve"),
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("žebřík"),
			keywords: &["lezení", "nářadí", "příčka", "schod", "schůdky", "šplhat", "šprušel", "žebřík"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			lang:     "de",
			tts:      Some("Leiter"),
			keywords: &["Holzleiter", "Leiter", "Sprosse", "Stufe", "hochsteigen", "klettern"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation {
			lang:     "el",
			tts:      Some("σκάλα"),
			keywords: &["ανεβαίνω", "κατεβαίνω", "σκάλα", "σκαλί", "σκαλοπάτι", "σκαρφαλώνω"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["bajar", "escalar", "escalera", "escalerilla", "escalón", "peldaño", "subir"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("échelle"),
			keywords: &["ascension", "barreau", "escabeau", "grimper", "monter", "échelle", "échelon"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			lang:     "gd",
			tts:      Some("fàradh"),
			keywords: &["ceum", "dìreadh", "dìrich", "fàradh", "rang", "reang", "rong", "sreap", "àradh"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("tangga"),
			keywords: &["alat panjat", "anak tangga", "panjat", "tangga", "tangga kayu"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			lang:     "it",
			tts:      Some("scala"),
			keywords: &["arrampicarsi", "oggetto", "piolo", "scala", "scala a pioli", "scalino"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಏಣ\u{cbf}"),
			keywords: &["ಏಣ\u{cbf}", "ಮ\u{cc6}ಟ\u{ccd}ಟ\u{cbf}ಲು", "ರಂಗ\u{ccd}", "ಹತ\u{ccd}ತ\u{cbf}"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		#[cfg(feature = "ky")]
		crate::Annotation { lang: "ky", tts: Some("тепкич"), keywords: &["тепкич"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["चड\u{94d}न\u{941}", "चरण", "झर\u{94d}\u{200d}याङ", "भर\u{94d}\u{200d}याङ", "रङ"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("ladder"),
			keywords: &["klimmen", "ladder", "omhoog", "omlaag", "sport", "trede", "voorwerp"],
		},
		#[cfg(feature = "nn")]
		...
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਪ\u{a4c}ੜੀ"),
			keywords: &["ਕਦਮ", "ਚੜ\u{a4d}ਹਨਾ", "ਪ\u{a4c}ੜੀ", "ਪ\u{a4c}ੜੀ ਦਾ ਡ\u{a70}ਡਾ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-064"), keywords: &["E13-064"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("лестница"),
			keywords: &["залезать", "лезть", "лестница", "перекладина", "стремянка", "ступень"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["ඉණ\u{dd2}මං පෙත\u{dca}ත", "ඉණ\u{dd2}මඟ", "නග\u{dd2}න\u{dca}න", "ප\u{dd2}යවර"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			lang:     "ta",
			tts:      Some("ஏணி"),
			keywords: &["ஏணி", "ஏணிப\u{bcd}படி", "ஏனிப\u{bcd}படி", "ஏறுதல\u{bcd}", "படி"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
		...
		crate::Annotation {
			...
			keywords: &["ก\u{e49}าว", "ข\u{e31}\u{e49}น", "บ\u{e31}นได", "ป\u{e35}น", "ไต\u{e48}"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
...
pub const BOOMERANG: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("бумеранг"),
			keywords: &["Австралия", "аборигени", "бумеранг", "връщане", "оръжие", "откат"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("bumerang"),
			keywords: &["Austràlia", "aborigen", "arma", "bumerang", "rebot", "repercussió"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["ανακάμπτω", "επιστρέφω", "μπούμερανγκ", "παιχνίδι", "πετάω", "όπλο"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["Australia", "boomerang", "bumerán", "búmeran", "indígena", "juego", "lanzar"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("bumerangi"),
			keywords: &["ase", "australia", "bumerangi", "kimmota takaisin", "seuraus"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("boomerang"),
			keywords: &["aborigène", "australie", "boomerang", "jeu", "outil", "retour", "répercussion"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			lang:     "ga",
			tts:      Some("búmarang"),
			keywords: &["an Astráil", "anonn is anall", "astrálach", "búmarang", "filleadh"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("bùmarang"),
			keywords: &["Astràilia", "ath-leum", "buaidh", "buil", "bùmarang", "tilleadh"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("majefi"),
			keywords: &["Ostiraliya", "kere", "komabaya", "majefi", "makami", "sake dawowa", "yaƙi"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("bumeráng"),
			keywords: &["ausztrália", "bumeráng", "fegyver", "visszajön", "visszarepül"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("ブーメラン"),
			keywords: &["オーストラリア", "ブーメラン", "武器", "玩具", "跳ね返り", "返って来る"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang: "ky", tts: Some("бумеранг"), keywords: &["бумеранг"]
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("bumerangs"),
			keywords: &["Austrālija", "atlēciens", "atsitiens", "bumerangs", "ierocis"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("boemerang"),
			keywords: &["Australië", "boemerang", "buiten", "reactie", "spel", "terugslag"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("bumerangue"),
			keywords: &["aborígene", "arma", "austrália", "bumerangue", "rebote", "repercussão"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		crate::Annotation {
			lang:     "ro",
			tts:      Some("bumerang"),
			keywords: &["armă", "bumerang", "recuperare", "repercusiune", "revenire", "înapoi"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-062"), keywords: &["E13-062"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("бумеранг"),
			keywords: &["абориген", "австралия", "бумеранг", "возврат", "оружие", "последствия"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("bumerang"),
			keywords: &["aborigén", "austrálsky", "bumerang", "následky", "návrat", "zbraň"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			lang:     "sq",
			tts:      Some("bumerang"),
			keywords: &["aborigjen", "armë", "australi", "bumerang", "pasojë", "rikthim"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			lang:     "tk",
			tts:      Some("bumerang"),
			keywords: &["awstraliýa", "bumerang", "degip gaýtmak", "garşy", "seslenme"],
		},
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("pūmalengi"), keywords: &["pūmalengi"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("bumerang"),
		...
		crate::Annotation {
			lang:     "uz",
			tts:      Some("bumerang"),
			keywords: &["aborigen", "aks-sado", "avstraliya", "bumerang", "qaytish", "qurol"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("bumơrang"),
			keywords: &["australia", "boomerang", "bumơrang", "bật lại", "dội lại", "thổ dân", "vũ khí"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("迴力鏢"),
			keywords: &["原住民的", "回飛棒", "武器", "澳洲", "迴力鏢", "迴旋", "迴旋鏢"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
...
pub const HAMMER: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("hamer"),
			keywords: &["gereedskap", "hamer", "herstelwerk", "huisverbetering", "kap", "werktuig"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		#[cfg(feature = "az")]
		crate::Annotation { lang: "az", tts: Some("çəkic"), keywords: &["alət", "çəkic"] },
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("малаток"),
		...
		#[cfg(feature = "bs")]
		crate::Annotation { lang: "bs", tts: Some("čekić"), keywords: &["alat", "čekić"] },
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			tts:      Some("martell"),
		...
		#[cfg(feature = "eu")]
		crate::Annotation { lang: "eu", tts: Some("mailua"), keywords: &["mailua", "tresna"] },
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang: "fa", tts: Some("چکش"), keywords: &["ابزار", "پتک", "چکش"]
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation { lang: "ga", tts: Some("casúr"), keywords: &["casúr", "uirlis"] },
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("òrd"),
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("guduma"),
			keywords: &["guduma", "gyara", "hamma", "kafinta", "katako", "kayan aiki"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang: "hy", tts: Some("մուրճ"), keywords: &["գործիք", "մուրճ"]
		},
		#[cfg(feature = "id")]
		crate::Annotation { lang: "id", tts: Some("palu"), keywords: &["alat", "palu"] },
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("nkụigwe"),
		...
		#[cfg(feature = "is")]
		crate::Annotation { lang: "is", tts: Some("hamar"), keywords: &["hamar", "verkfæri"] },
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("martello"),
		...
		#[cfg(feature = "jv")]
		crate::Annotation { lang: "jv", tts: Some("pukul"), keywords: &["bekakas", "pukul"] },
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("ჩაქუჩი"),
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("tafḍist"), keywords: &["tafḍist"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("балға"),
		...
		#[cfg(feature = "kok")]
		crate::Annotation { lang: "kok", tts: Some("घण"), keywords: &["घण", "साधन"] },
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang: "ky", tts: Some("балка"), keywords: &["балка", "курал"]
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		crate::Annotation {
			...
			keywords: &["ຄ\u{ec9}ອນຕ\u{eb5}", "ເຄ\u{eb7}\u{ec8}ອງມ\u{eb7}", "ໄມ\u{ec9}ຄ\u{ec9}ອນ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		#[cfg(feature = "mi")]
		crate::Annotation { lang: "mi", tts: Some("hama"), keywords: &["hama", "utauta"] },
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("чекан"),
			keywords: &["алатка", "подобрување на домот", "поправка", "поправки", "чекан"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		#[cfg(feature = "mn")]
		crate::Annotation { lang: "mn", tts: Some("алх"), keywords: &["алх", "багаж"] },
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang: "mr", tts: Some("हातोडा"), keywords: &["साधन", "हातोडा"]
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		#[cfg(feature = "ne")]
		crate::Annotation { lang: "ne", tts: Some("घन"), keywords: &["उपकरण", "घन"] },
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("hamer"),
		...
		crate::Annotation {
			...
			keywords: &["ଉପକରଣ", "ହ\u{b3e}ତ\u{b41}ଡ\u{b3c}\u{b3f}", "ହ\u{b3e}ମ\u{b3e}ର\u{b4d}"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਹਥ\u{a4c}ੜਾ"),
			keywords: &["ਔਜ\u{a3c}ਾਰ", "ਟ\u{a42}ਲ", "ਸ\u{a70}ਦ", "ਹਥ\u{a4c}ੜਾ", "ਹਥ\u{a4c}ੜੀ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		#[cfg(feature = "pcm")]
		crate::Annotation { lang: "pcm", tts: Some("Háma"), keywords: &["Háma", "Tul"] },
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("młotek"),
		...
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("څټک"), keywords: &["اله", "څټک"] },
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("martelo"),
		...
		crate::Annotation {
			lang:     "ro",
			tts:      Some("ciocan"),
			keywords: &["bricolaj", "ciocan", "construcții", "cui", "instrument", "reparații", "unealtă"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-740"), keywords: &["E10-740"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("молоток"),
		...
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("هٿوڙو"), keywords: &["اوزار", "هٿوڙو"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("kladivo"),
			keywords: &["búchanie", "domáce práce", "domáci majster", "kladivo", "kutil", "nástroj"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		#[cfg(feature = "so")]
		crate::Annotation { lang: "so", tts: Some("dube"), keywords: &["dube", "qalab"] },
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("çekiç"),
		...
		#[cfg(feature = "sw")]
		crate::Annotation { lang: "sw", tts: Some("nyundo"), keywords: &["nyundo", "zana"] },
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		crate::Annotation {
		...
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang: "tg", tts: Some("болға"), keywords: &["асбоб", "болға"]
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		#[cfg(feature = "tk")]
		crate::Annotation { lang: "tk", tts: Some("çekiç"), keywords: &["gural", "çekiç"] },
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("hamala"), keywords: &["hamala"] },
		#[cfg(feature = "tr")]
		crate::Annotation { lang: "tr", tts: Some("çekiç"), keywords: &["araç", "çekiç"] },
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang: "ug", tts: Some("بولقا"), keywords: &["بولقا", "قورال"]
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		#[cfg(feature = "uz")]
		crate::Annotation { lang: "uz", tts: Some("bolg‘a"), keywords: &["asbob", "bolg‘a"] },
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("búa"),
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("錘"), keywords: &["工具", "錘"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("锤"), keywords: &["工具", "锤"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("锤子"),
			keywords: &["修理", "家居修缮", "工具", "敲", "施工", "砸", "铁锤", "锤子"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("鎚子"), keywords: &["榔頭", "鎚子"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("鎚仔"),
...
pub const AXE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "el",
			tts:      Some("τσεκούρι"),
			keywords: &["ξύλο", "πέλεκυς", "σχίζω", "τεμαχίζω", "τσεκουράκι", "τσεκούρι"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["cortar", "dividir", "hacha", "hachuela", "leña", "madera", "talar"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			lang:     "gd",
			tts:      Some("tuagh"),
			keywords: &["bris", "briseadh", "fiodh", "maide", "sgoilt", "sgoltadh", "tuagh"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("gatari"),
			keywords: &["gatari", "itace", "kurada", "sara", "saran ice", "tsaga", "ƙaramin gatari"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["औज\u{93c}ार", "काटना", "क\u{941}ल\u{94d}हाड\u{93c}ी", "लकड\u{93c}ी"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("tacaqurt"), keywords: &["tacaqurt"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("балта"),
		...
		crate::Annotation {
			...
			keywords: &["កាប\u{17cb}", "ឈើ", "ព\u{17bb}ះ", "ព\u{17bc}ថៅ", "ព\u{17bc}ថៅដៃ"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			lang:     "lo",
			tts:      Some("ຂວານ"),
			keywords: &["ຂວານ", "ຂວານໄມ\u{ec9}", "ຕ\u{eb1}ດ", "ຟ\u{eb1}ນ", "ຟ\u{eb1}ນ\u{200b}ໄມ\u{ec9}"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["चिर\u{94d}न\u{941}", "दाउरा", "धार", "बन\u{94d}चरो", "विभाजित"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("bijl"),
			keywords: &["bijl", "gereedschap", "hakken", "hout", "houthakker", "splijten"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			lang:     "ro",
			tts:      Some("topor"),
			keywords: &["despica", "lemn", "reteza", "secure", "topor", "toporișcă", "tăiat"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E12–072"), keywords: &["E12–072"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("топор"),
		...
		crate::Annotation {
			lang:     "si",
			tts:      Some("පොරොව"),
			keywords: &["අත\u{dca} පොරොව", "කැප\u{dd4}ම", "දැව", "පැළ\u{dd4}ම", "පොරොව"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			lang:     "th",
			tts:      Some("ขวาน"),
			keywords: &["ขวาน", "ผ\u{e48}าฟ\u{e37}น", "ฟ\u{e31}น", "ส\u{e31}บ", "ไม\u{e49}"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("toki"), keywords: &["toki"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("balta"),
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("کلہاڑا"),
			keywords: &["جنگل", "لکڑی", "ٹکڑے کرنا", "کاٹنا", "کلہاڑا", "کلہاڑی", "کٹائی", "کھدائی"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("séemeñ"), keywords: &[""] },
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("àáké"),
...
pub const HOOK: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "az",
			tts:      Some("qarmaq"),
			keywords: &["cəftə", "qarmaq", "satış nöqtəsi", "tutmaq", "tələyə salmaq", "əyri"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("кручок"),
			keywords: &["абыход", "гак", "крук", "кручок", "лавіць", "прынада", "чапляць"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("кука"),
			keywords: &["гега", "извивка", "кука", "примка", "търговско предимство", "хващане"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("krog"), keywords: &["higennañ", "krog"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("udica"),
			keywords: &["hvatanje", "udica", "uhvatiti u zamku", "ulov", "uloviti", "upecati"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			tts:      Some("ham"),
			keywords: &["atrapar", "corba", "ganxo", "ham", "pescar", "punt de venda"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("hák"),
			keywords: &["chytit", "hák", "háček", "lovit", "nářadí", "polapit", "zahnutý"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
			tts:      Some("bachyn"),
			keywords: &["bachyn", "cromlin", "dal", "maglu", "pwynt gwerthu", "troseddwr"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			lang:     "en_AU",
			tts:      Some("↑↑↑"),
			keywords: &["catch", "crook", "curve", "ensnare", "fishing", "hook", "selling point"],
		},
		#[cfg(feature = "en_CA")]
		crate::Annotation { lang: "en_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_GB")]
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["agarrar", "anzuelo", "atrapar", "gancho", "garfio", "pescar"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["gancho"] },
		#[cfg(feature = "es_US")]
		crate::Annotation {
			lang:     "es_US",
			tts:      Some("anzuelo"),
			keywords: &["agarrar", "anzuelo", "atrapar", "gancho", "garfio", "punto de venta"],
		},
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
			tts:      Some("konks"),
			keywords: &["kala", "kinnitamine", "konks", "kõver", "müümine", "püük", "tõstmine"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("amu"),
			keywords: &["amu", "bihurritu", "harrapatu", "makurra", "okerra", "saltokia"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("قلاب"),
			keywords: &["انحنا", "به\u{200c}دام انداختن", "خمیدگی", "قلاب", "نقطه فروش", "گرفتن"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("kawit"),
			keywords: &["huli", "kawit", "sabit", "selling point"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation { lang: "fo", tts: Some("krókur"), keywords: &["krókur"] },
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("crochet"),
		...
		crate::Annotation {
			lang:     "ga",
			tts:      Some("crúca"),
			keywords: &["croch", "crúca", "duán"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("dubhan"),
			keywords: &["cromag", "cròcag", "cròicean", "dubhan", "huca", "reic", "rib"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
			tts:      Some("gancho"),
			keywords: &["anzol", "enganchar", "pescar"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		#[cfg(feature = "he")]
		crate::Annotation {
			lang: "he", tts: Some("קרס"), keywords: &["אנקול", "וו", "קרס"]
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("udica"),
			keywords: &["kuka", "prodajno mjesto", "udica", "uhvatiti", "uloviti", "zakrivljeno"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ngu"),
			keywords: &["ebe ire ere", "jide", "krook", "ngu"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("フック"),
			keywords: &["フック", "引っかけ", "引っ掛け", "掛け金", "留め金", "鉤"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("pancing"),
			keywords: &["bengkok", "kurpa", "nangkap", "pancing", "panjerat", "seng utama"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಕ\u{cca}ಕ\u{ccd}ಕ\u{cc6}"),
			keywords: &[
				"ಕರ\u{ccd}ವ\u{ccd}",
				"ಕ\u{cca}ಂಡ\u{cbf}",
				"ಕ\u{cca}ಕ\u{ccd}ಕ\u{cc6}",
				"ಕ\u{ccd}ಯಾಚ\u{ccd}",
				"ಗಾಳ",
				"ಮಾರಾಟದ ಸ\u{ccd}ಥಳ",
				"ಹುಕ\u{ccd}ಕು",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("갈고리"),
			keywords: &["갈고리", "걸리게 하다", "고리", "곡선", "팔리는", "후크", "훅"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		#[cfg(feature = "ky")]
		crate::Annotation { lang: "ky", tts: Some("илгич"), keywords: &["илгич"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
			tts:      Some("ຕະຂ\u{ecd}"),
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("āķis"),
			keywords: &["makšķerēšana", "pievilināt", "pārdošanas arguments", "uzķeršanās", "āķis"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("кука"),
			keywords: &["кука", "свиок", "свиткано", "јадица", "јамка"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("gancho"),
			keywords: &["atração para venda", "bandido", "curva", "gancho", "pegar", "prender"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["gancho", "prender"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("gancho"),
			keywords: &["gacho", "gancho", "muyuna", "rantipaq kiti", "suwa"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-065"), keywords: &["E13-065"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("крюк"),
		...
		crate::Annotation {
			lang:     "sq",
			tts:      Some("kanxhë"),
			keywords: &["bisht", "grep", "kanxhë", "kapëse", "kunj", "pikë shitjeje", "varëse"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("кука"),
			keywords: &["кука", "удица", "уловити", "ухватити"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("kuka"),
			keywords: &["kuka", "udica", "uhvatiti", "uloviti"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			lang:     "sw",
			tts:      Some("ndoano"),
			keywords: &["bakora", "kishawishi cha mauzo", "ndoana", "ndoano", "pinda", "shika", "tega"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			lang:     "th",
			tts:      Some("ตะขอ"),
			keywords: &["งอ", "จ\u{e31}บ", "ตกปลา", "ตะขอ", "เบ\u{e47}ด", "โค\u{e49}ง"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("መፈንጠሪ"),
			keywords: &["መስመር ምጥዋይ", "መንጠልጠሊ", "መጻወድያ ምእታው", "ምሓዝ", "ምሻጥ", "ነጥቢ", "ዕሱብ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("ilgençek"),
			keywords: &["egri", "ilgençek", "mahabat nokady", "tora salmak", "tutmak", "çeňňek"],
		},
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("mātaʻu"), keywords: &["mātaʻu"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("çengel"),
			keywords: &["askı", "asmak", "eğri", "eşya", "kanca", "çengel", "çengellemek"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("ہک"),
			keywords: &["بیچنے کا مقام", "ترشول", "خمیدہ", "پکڑنا", "پھانسنا", "کھونٹا", "ہک"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("ilgak"),
			keywords: &["egri", "ilgak", "ilib olish", "ilintirish", "ilish", "ilmoq", "savdo nuqtasi"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("móc"),
			keywords: &["bẫy", "bắt", "cái móc", "móc", "điểm bán hàng", "đường cong"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("lonka"), keywords: &[""] },
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("ako"),
			keywords: &["ako", "ibi títà", "mu", "yi"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("挂钩"),
			keywords: &["卖点", "弯钩", "抓", "挂钩", "曲线", "钩子", "钩状物", "鱼钩"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["勾", "掛鉤", "船錨", "鉤", "魚鈎"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("i-hook"),
			keywords: &["catch", "crook", "curve", "ensnare", "i-hook", "selling point"],
		},
	],
};
#[doc = "💣\u{fe0f}"]
...
pub const NUT_AND_BOLT: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["bout", "bout en moer", "gereedskap", "huisverbetering", "hulpmiddel", "moer"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["اصلاح", "برغي", "تصليح", "صامولة", "صامولة ومسمار", "عدة", "عزقة", "مسمار"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["cargol", "cargol i femella", "eina", "femella", "reforma de la llar"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["ανακαίνιση", "βίδα", "βίδα και παξιμάδι", "εργαλείο", "μπουλόνι", "παξιμάδι"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["औज\u{93c}ार", "नट", "नट और बोल\u{94d}ट", "प\u{947}\u{902}च", "बोल\u{94d}ट"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			...
			keywords: &["ინსტრუმენტი", "ქანჩი", "ქანჩი და ჭანჭიკი", "ჭანჭიკი", "ხელსაწყო"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("볼트와 너트"),
			keywords: &["나사", "너트", "도구", "볼트", "볼트와 너트", "주택 개조", "주택 수리"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["remonts", "skrūve", "skrūve un uzgrieznis", "tapa", "uzgrieznis"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["खीळ", "नट", "नट आणि बोल\u{94d}ट", "नट-बोल\u{94d}ट", "बोल\u{94d}ट", "साधन"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["gwint", "mocowanie", "nakrętka", "narzędzia", "śruba", "śruba i nakrętka"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			...
			keywords: &["bricolaj", "instrument", "piuliță", "unealtă", "șurub", "șurub și piuliță"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-741"), keywords: &["E10-741"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("болт и гайка"),
		...
		crate::Annotation {
			...
			keywords: &["agafata iburo", "iburo", "iburo n’agafungisho", "igikoresho"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["bulon", "bulon dhe dado", "dado", "përmirësimi i shtëpisë", "vegël"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &["น\u{e47}อต", "สล\u{e31}กเกล\u{e35}ยว", "เคร\u{e37}\u{e48}องม\u{e37}อ"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		crate::Annotation {
			...
			keywords: &["آلہ", "بولٹ", "ترمیم", "مرمت", "نٹ", "نٹ اور بولٹ", "گھر کی مرمت"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			...
			keywords: &["imortyisi", "imortyisi nesikhonkwane", "isikhonkwane", "isixhobo"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("nọti ati botu"),
			keywords: &["bóòtù", "irinṣé\u{329}", "nó\u{329}ọ\u{300}tì", "nọti ati botu"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("nɔti ati botu"),
			keywords: &["bóòtù", "irinshé\u{329}", "nó\u{329}ɔ\u{300}tì", "nɔti ati botu"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
...
pub const WRENCH: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["gereedskap", "huisverbetering", "moersleutel", "selfdoen", "skroefsleutel"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		#[cfg(feature = "fa")]
		crate::Annotation { lang: "fa", tts: Some("آچار"), keywords: &["آچار", "ابزار"] },
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("jakoavain"),
		...
		crate::Annotation {
			lang:     "hi",
			tts:      Some("पाना"),
			keywords: &["उपकरण", "औज\u{93c}ार", "पाना", "र\u{947}\u{902}च", "र\u{948}\u{902}च"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			...
			keywords: &["សោម\u{17bc}ល", "សោសម\u{17d2}រាប\u{17cb}ម\u{17bd}លខ\u{17d2}ចៅ"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang: "mr", tts: Some("पाना"), keywords: &["पाना", "साधन"]
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("moersleutel"),
			keywords: &["engelse sleutel", "gereedschap", "moersleutel", "schroefsleutel"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		...
		crate::Annotation {
			...
			keywords: &["ਔਜ\u{a3c}ਾਰ", "ਚਾਬੀ", "ਟ\u{a42}ਲ", "ਰ\u{a48}\u{a02}ਚ", "ਸ\u{a70}ਦ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			...
			keywords: &["klucz", "klucz warsztatowy", "mechanik", "narzędzia", "narzędzie", "warsztat"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-739"), keywords: &["E10-739"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["domáci majster", "domácnosť", "francúzsky kľúč", "klúč", "nástroj"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("ključ za matice"),
			keywords: &["francoski ključ", "ključ za matice", "orodje", "vijačni ključ"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("sipana"), keywords: &["sipana"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("kle"), keywords: &["jumtukaay", "kle"] },
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("oolu"),
			keywords: &["irinṣẹ\u{301}", "irinṣẹ\u{301} afagbára dè", "oolu", "sípánà"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("oolu"),
			keywords: &["irinshɛ\u{301}", "irinshɛ\u{301} afagbára dè", "oolu", "sípánà"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("扳手"), keywords: &["扳手"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("士巴拿"),
...
pub const LINK: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "az")]
		crate::Annotation { lang: "az", tts: Some("zəncir"), keywords: &["zəncir"] },
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		#[cfg(feature = "bs")]
		crate::Annotation { lang: "bs", tts: Some("karika"), keywords: &["karika"] },
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			tts:      Some("enllaç"),
		...
		#[cfg(feature = "chr")]
		crate::Annotation { lang: "chr", tts: Some("ᎫᏓᎸᏙᏗ"), keywords: &["ᎫᏓᎸᏙᏗ"] },
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		#[cfg(feature = "cy")]
		crate::Annotation { lang: "cy", tts: Some("dolen"), keywords: &["dolen", "linc"] },
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("link"),
		...
		#[cfg(feature = "en")]
		crate::Annotation { lang: "en", tts: Some("link"), keywords: &["link", "links"] },
		#[cfg(feature = "en_AU")]
		crate::Annotation { lang: "en_AU", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_CA")]
		crate::Annotation { lang: "en_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		...
		crate::Annotation { lang: "en_IN", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es")]
		crate::Annotation { lang: "es", tts: Some("eslabón"), keywords: &["eslabón"] },
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("eslabones de cadena"),
			keywords: &["cadena", "enlace", "enlaces", "eslabones", "eslabones de cadena", "vínculo"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation { lang: "et", tts: Some("lüli"), keywords: &["ahel", "lüli"] },
		#[cfg(feature = "eu")]
		crate::Annotation { lang: "eu", tts: Some("kate-maila"), keywords: &["kate-maila"] },
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("حلقه\u{654} زنجیر"),
			keywords: &["اتصال", "حلقه", "حلقه\u{654} زنجیر", "دانه زنجیر", "دانه\u{654} زنجیر", "پیوند"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation { lang: "fi", tts: Some("lenkki"), keywords: &["ketju", "lenkki"] },
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
			tts:      Some("kawing"),
		...
		crate::Annotation {
			lang:     "fo",
			tts:      Some("liður"),
			keywords: &["leinkja", "liður", "samband", "sambinding", "sambindingarliður"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation { lang: "ga", tts: Some("nasc"), keywords: &["naisc", "nasc"] },
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("ceangal"),
		...
		#[cfg(feature = "hy")]
		crate::Annotation { lang: "hy", tts: Some("օղակ"), keywords: &["օղակ"] },
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("tautan"),
		...
		#[cfg(feature = "ig")]
		crate::Annotation { lang: "ig", tts: Some("njikọ"), keywords: &["njikọ"] },
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("aseɣwen"), keywords: &["aseɣwen"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("шынжыр"),
		...
		#[cfg(feature = "kl")]
		crate::Annotation { lang: "kl", tts: Some("link"), keywords: &["link", "link-tegn"] },
		#[cfg(feature = "km")]
		crate::Annotation { lang: "km", tts: Some("ត\u{17c6}ណ"), keywords: &["ត\u{17c6}ណ"] },
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಲ\u{cbf}ಂಕ\u{ccd}"),
			keywords: &["ಕ\u{cca}ಂಡ\u{cbf}", "ಲ\u{cbf}ಂಕ\u{ccd}", "ಸಂಪರ\u{ccd}ಕ ಕ\u{cca}ಂಡ\u{cbf}"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang: "kok", tts: Some("लि\u{902}क"), keywords: &["लि\u{902}क"]
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang: "ky", tts: Some("тогоо"), keywords: &["илмек", "тогоо"]
		},
		#[cfg(feature = "lb")]
		crate::Annotation { lang: "lb", tts: Some("Glidd"), keywords: &["Glidd"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
			tts:      Some("ຂ\u{ecd}\u{ec9}ຕ\u{ecd}\u{ec8}"),
			keywords: &["ຂ\u{ecd}\u{ec9}ຕ\u{ecd}\u{ec8}", "ລ\u{eb4}\u{ec9}ງ", "ໂຊ\u{ec9}"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		#[cfg(feature = "mi")]
		crate::Annotation { lang: "mi", tts: Some("hononga"), keywords: &["hononga"] },
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("алка"),
		...
		crate::Annotation {
			...
			keywords: &["ലിങ\u{d4d}ക\u{d4d}", "ലിങ\u{d4d}ക\u{d4d} ചിഹ\u{d4d}നം", "സിംബൽ"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation { lang: "mn", tts: Some("гогцоо"), keywords: &["гогцоо"] },
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			tts:      Some("साखळी"),
			keywords: &["दोन गोल कड\u{94d}या", "लि\u{902}क", "लि\u{902}क चिन\u{94d}ह", "साखळी"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation { lang: "ms", tts: Some("pautan"), keywords: &["pautan", "rantai"] },
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("katina"), keywords: &["katina"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang: "ne", tts: Some("लि\u{902}क"), keywords: &["लि\u{902}क"]
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਲਿ\u{a70}ਕ"),
			keywords: &["ਕੜੀ", "ਦ\u{a4b} ਕੜ\u{a47}", "ਲਿ\u{a70}ਕ", "ਲਿ\u{a70}ਕ ਨਿਸ\u{a3c}ਾਨ", "ਲੜੀ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation { lang: "pa_Arab", tts: Some("ربط کرو"), keywords: &["ربط کرو"] },
		#[cfg(feature = "pcm")]
		crate::Annotation { lang: "pcm", tts: Some("Link"), keywords: &["Link"] },
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("ogniwa"),
		...
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("ربط"), keywords: &["ربط"] },
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("link"),
		...
		crate::Annotation {
			lang:     "ro",
			tts:      Some("za"),
			keywords: &["conexiune", "lanț", "legătură", "link", "verigă", "za", "zale"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-723"), keywords: &["E10-723"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("гиперссылка"),
			keywords: &["гиперссылка", "звенья", "связывание", "связь", "ссылка", "цепочка", "цепь"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation { lang: "rw", tts: Some("ihuza"), keywords: &["ihuza"] },
		#[cfg(feature = "sd")]
		crate::Annotation { lang: "sd", tts: Some("ڪڙي"), keywords: &["ڪڙي"] },
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["odkaz", "prepojenie", "reťaz", "spojenie", "spojovací článok"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation { lang: "sl", tts: Some("člen"), keywords: &["člen", "členi"] },
		#[cfg(feature = "so")]
		crate::Annotation { lang: "so", tts: Some("liinki"), keywords: &["liinki"] },
		#[cfg(feature = "sq")]
		crate::Annotation { lang: "sq", tts: Some("lidh"), keywords: &["lidh", "zinxhir"] },
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("карике"),
		...
		crate::Annotation {
			...
			keywords: &["అభ\u{c47}ద\u{c4d}యమ\u{c48}న", "కలయ\u{c3f}క", "ల\u{c3f}ంకు", "ల\u{c3f}ంకులు"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation { lang: "tg", tts: Some("пайванд"), keywords: &["пайванд"] },
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
			tts:      Some("ส\u{e31}ญล\u{e31}กษณ\u{e4c}การล\u{e34}งก\u{e4c}"),
			keywords: &["ล\u{e34}งก\u{e4c}", "ส\u{e31}ญล\u{e31}กษณ\u{e4c}การล\u{e34}งก\u{e4c}"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang: "ti", tts: Some("ሊንክ"), keywords: &["ሊንክ", "መላግቦታት"]
		},
		#[cfg(feature = "tk")]
		crate::Annotation { lang: "tk", tts: Some("bag"), keywords: &["bag"] },
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		#[cfg(feature = "ug")]
		crate::Annotation { lang: "ug", tts: Some("ئۇلانما"), keywords: &["ئۇلانما"] },
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		#[cfg(feature = "vi")]
		crate::Annotation { lang: "vi", tts: Some("mắt xích"), keywords: &["mắt xích"] },
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("lëkkalekaay"), keywords: &["lëkkalekaay"] },
		#[cfg(feature = "xh")]
		crate::Annotation { lang: "xh", tts: Some("ikhonkco"), keywords: &["ikhonkco"] },
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("連結"), keywords: &["連結"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("连结"), keywords: &["连结"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("链接"),
		...
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation { lang: "zh_Hant_HK", tts: Some("↑↑↑"), keywords: &["連結"] },
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const WHITE_CANE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("gidsstok"),
			keywords: &["beweeglikheid", "blind", "blinde", "gestremde", "gidsstok", "toeganklikheid"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
			tts:      Some("ከዘራ"),
			keywords: &["ተደራሽነት", "እውር", "ከዘራ", "ዓይነ ስውር", "የዓይነ ስውር ከዘራ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("عصا سير"),
			keywords: &["أداة", "أعمى", "إمكانية الوصول", "احتياجات خاصة", "ضرير", "عصا سير", "كفيف"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "az",
			tts:      Some("zond"),
			keywords: &["kor", "zond", "çəlik", "əlverişlilik", "əlçatımlılıq", "əsa"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("бял бастун"),
			keywords: &["бастун за незрящи", "бял бастун", "достъпна среда", "достъпност", "незрящ"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
			...
			keywords: &[
				"অন\u{9cd}ধ",
				"অন\u{9cd}ধ ব\u{9cd}যক\u{9cd}তি",
				"অন\u{9cd}ধের ল\u{9be}ঠি",
		...
		crate::Annotation {
			...
			keywords: &["accessibilitat", "bastó per a invidents", "cec", "cega", "invident"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["Barrierefreiheit", "Behinderung", "Blindenstock", "Gehstock", "blind"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			...
			keywords: &["accessibility", "blind", "long mobility cane", "white cane"],
		},
		#[cfg(feature = "en_CA")]
		crate::Annotation {
			lang:     "en_CA",
			tts:      Some("↑↑↑"),
			keywords: &["accessibility", "blind", "guide cane", "white cane"],
		},
		#[cfg(feature = "en_GB")]
		crate::Annotation { lang: "en_GB", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_IN")]
		...
		crate::Annotation {
			lang:     "es",
			tts:      Some("bastón"),
			keywords: &["accesibilidad", "bastón", "ceguera", "ciega", "ciego", "invidente"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("عصای سفید"),
			keywords: &["دسترس\u{200c}پذیری", "عصای سفید", "قابلیت دسترسی", "نابینا", "کور"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("baston"),
			keywords: &["baston", "blind", "bulag", "pagiging naa-access", "pwd"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
			tts:      Some("blindastavur"),
			keywords: &["blind", "blindastavur", "blindur", "brek", "handikapp", "stavur"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("canne blanche"),
			keywords: &["accessibilité", "aveugle", "canne blanche", "déficient visuel", "malvoyant"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		...
		crate::Annotation {
			...
			keywords: &["cegueira", "discapacidade"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"अ\u{902}धी",
				"छड\u{93c}ी",
				"दिव\u{94d}या\u{902}ग की छड\u{93c}ी",
		...
		crate::Annotation {
			...
			keywords: &["bijeli štap", "pomagalo", "sljepoća", "štap za slijepe"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			lang:     "ig",
			tts:      Some("mkipisi ocha"),
			keywords: &["kpuru ìsì", "mkipisi", "nnweta", "nyocha", "ọcha"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "kk",
			tts:      Some("таяқ"),
			keywords: &["мүгедек", "мүмкіндігі шектеулі", "соқыр", "таяқ"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ຕາ\u{200b}ບອດ",
				"ໄມ\u{ec9}ຄ\u{eb1}ນເທ\u{ebb}\u{ec9}າ",
				"ໄມ\u{ec9}ນຳທາງ",
		...
		crate::Annotation {
			...
			keywords: &["aklas", "neregio lazda", "neregys", "neįgaliųjų prieinamumas", "prieinamumas"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("baltais atbalsta spieķis"),
			keywords: &["akls", "baltais atbalsta spieķis", "neredzīgs", "pieejamība"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ക\u{d3e}ഴ\u{d4d}ച വൈകല\u{d4d}യം",
				"പ\u{d4d}രോബിംഗ\u{d4d} ക\u{d3e}ൻ",
				"പ\u{d4d}രോബിംഗ\u{d4d} കെയ\u{d4d}ൻ",
				"ബ\u{d4d}ലൈൻഡ\u{d4d}",
			],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			...
			keywords: &["хараагүй хүн", "хараагүй хүний таяг", "хүртээмжтэй байдал", "цагаан таяг"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		crate::Annotation {
			...
			keywords: &["buta", "kebolehcapaian", "tongkat", "tongkat penduga"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("taststok"),
			keywords: &["blind", "blindenstok", "lopen", "taststok", "toegankelijkheid"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["ਟਟ\u{a4b}ਲਣ ਲਈ ਸ\u{a4b}ਟੀ", "ਨ\u{a47}ਤਰਹੀਣ", "ਪਹ\u{a41}\u{a70}ਚਯ\u{a4b}ਗਤਾ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			...
			keywords: &["acessibilidade", "bengala", "cega", "cego", "cegueira", "deficiente", "visual"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("bengala para invisuais"),
			keywords: &["acessibilidade", "bengala para invisuais", "cegueira", "invisual"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation { lang: "qu", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ro")]
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E12–035"), keywords: &["E12–035"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("белая трость"),
			keywords: &["белая", "инвалид", "палка", "слепой", "трость", "ходьба"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["අන\u{dca}ධ", "ඒෂණ දණ\u{dca}ඩ", "ළඟ\u{dcf}ව\u{dd2}ය හැක\u{dd2} බව"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			...
			keywords: &["dostopnost", "invalid", "palica za slepe", "slepota"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["i verbër", "qasshmëri", "shkop", "shkop gjurmimi", "shkop për të ecur"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("бели штап"),
			keywords: &["бело", "помоћ", "приступачност", "слеп", "штап"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("бијели штап"),
			keywords: &["бијели штап", "доступност", "слијеп"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("beli štap"),
			keywords: &["belo", "pomoć", "pristupačnost", "slep", "štap"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("bijeli štap"),
			keywords: &["bijeli štap", "dostupnost", "slijep"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &["alama ya kipofu", "kipofu", "mkongojo wa vipofu", "ufikivu"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		crate::Annotation {
			...
			keywords: &[
				...
				"வ\u{bbe}க\u{bcd}கிங\u{bcd} ஸ\u{bcd}டிக\u{bcd}",
			],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ጻዕዳ በትሪ"),
			keywords: &["መርመራ ምግባር", "በትሪ", "ተበጻሕነት", "ዕዉር", "ፃዕዳ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			lang:     "uz",
			tts:      Some("hassa"),
			keywords: &["hassa", "koʻr", "nogironlik", "tayoq"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("egba funfun"),
			keywords: &["aye ona", "egba funfun", "fọ\u{301}jú"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("egba funfun"),
			keywords: &["aye ona", "egba funfun", "fɔ\u{301}jú"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("導盲拐杖"),
			keywords: &["導盲拐杖", "手杖", "無障礙", "白手杖", "盲人", "瞎", "視障"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const SCREWDRIVER: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("šroubovák"),
			keywords: &["nástroj", "náčiní", "nářadí", "šroub", "šroubovat", "šroubovák"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			...
			keywords: &["Schraube", "Schraubendreher", "Schraubenzieher", "Werkzeug", "schrauben"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["arreglar", "atornillador", "destornillador", "herramienta", "plano", "tornillo"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["destornillador"] },
		#[cfg(feature = "es_US")]
		crate::Annotation {
			lang:     "es_US",
			tts:      Some("↑↑↑"),
			keywords: &["atornillador", "desarmador", "destornillador", "herramienta", "tornillo"],
		},
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
		...
		crate::Annotation {
			...
			keywords: &["ابزار", "اشیا", "پیچ", "پیچ گوشتی", "پیچ گوشتی تخت", "پیچ\u{200c}گوشتی"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["kayan aiki", "kwancewa", "noti", "sukundireba", "sukuru", "sukurudireba"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("obeng"),
			keywords: &["alat", "obeng", "obeng lurus", "obeng minus", "peralatan", "perkakas"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			lang:     "it",
			tts:      Some("cacciavite"),
			keywords: &["avvitare", "cacciavite", "oggetto", "svitare", "utensile", "vite"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
			tts:      Some("ねじ回し"),
			keywords: &["ねじ回し", "スクリュードライバー", "ドライバー", "マイナスドライバー", "工具"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation { lang: "jv", tts: Some("obeng"), keywords: &["bekakas", "obeng"] },
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("სახრახნისი"),
		...
		crate::Annotation {
			...
			keywords: &["ទ\u{17bd}រណ\u{17ba}វ\u{17b7}ស", "វ\u{17b8}ស", "ឧបករណ\u{17cd}"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			...
			keywords: &["साधन", "स\u{94d}क\u{94d}र\u{941}", "स\u{94d}क\u{94d}र\u{941}ड\u{94d}रायवर"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang: "ky", tts: Some("отвертка"), keywords: &["отвертка"]
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["gereedschap", "klussen", "repareren", "schroef", "schroevendraaier"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["ਔਜ\u{a3c}ਾਰ", "ਪ\u{a47}ਚ", "ਪ\u{a47}ਚਕਸ", "ਲ\u{a70}ਮਾ ਪ\u{a47}ਚਕਸ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			...
			keywords: &["aparafusar", "cabeça chata", "chave de fendas", "ferramenta", "útil"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-063"), keywords: &["E13-063"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("отвертка"),
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("skrutkovač"),
			keywords: &["nástroj", "plochý skrutkovač", "skrutka", "skrutkovač", "šikovný"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["கருவி", "திருப\u{bcd}புளி", "ஸ\u{bcd}க\u{bcd}ரூடிரைவர\u{bcd}"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
		...
		crate::Annotation {
			lang:     "th",
			tts:      Some("ไขควง"),
			keywords: &["ซ\u{e48}อม", "ปากแบน", "สกร\u{e39}", "เคร\u{e37}\u{e48}องม\u{e37}อ", "ไขควง"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("vetesikalu"), keywords: &["vetesikalu"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("tornavida"),
...
pub const TOOLBOX: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("የመፍቻ ሳጥን"),
			keywords: &["መሳሪያ", "መሳሪያዎች መያዣ ሳጥን", "ሜካኒክ", "ሳጥን", "ቀይ ሳጥን", "የመፍቻ ሳጥን"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["caixa", "caixa d’eines", "caixa vermella", "eines", "mecànic"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			...
			keywords: &["håndværker", "mekaniker", "skruenøgle", "værktøj", "værktøjskasse"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["εργαλείο", "εργαλειοθήκη", "κόκκινο κουτί", "μηχανικός", "μπαούλο"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["caja", "caja de herramientas", "cajón", "herramientas", "mecánico"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
		...
		crate::Annotation {
			...
			keywords: &["laatikko", "mekaaninen", "pakki", "työkalu", "työkalulaatikko", "työkalupakki"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["igbe", "igbe ngwaọrụ", "mekaniiki", "ngwá ọrụ", "obi", "uhie"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("工具箱"),
			keywords: &["ツールボックス", "メカニック", "工具箱", "整備士", "機械工", "箱", "赤い箱"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["darbarīku kaste", "instrumenti", "kaste", "mehānisks", "rīks"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["doos", "gereedschap", "gereedschapskist", "kist", "monteur", "rode kist"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		...
		crate::Annotation {
			...
			keywords: &["ajedrez", "llamkana", "llamkanakuna huñusqa", "mecanico", "tawa kuchu"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-058"), keywords: &["E11-058"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["mehanik", "orodje", "rdeč zaboj", "zaboj", "zaboj za orodje"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
...
pub const MAGNET: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("imant"),
			keywords: &["atracció", "ferradura", "forma d’U", "imant", "magnètic", "positiu negatiu"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("magnet"),
			keywords: &["magnet", "magnetizam", "megnetizam", "potkova", "privlačenje"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("U字型磁石"),
			keywords: &["U字型磁石", "マグネット", "引き付ける", "正負", "磁石", "蹄鉄"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["ការឆក\u{17cb}", "ក\u{17d2}រចកជើងសេះ", "ឆក\u{17cb}", "ដែកឆក\u{17cb}"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("자석"),
			keywords: &["u자", "마그넷", "말굽 자석", "양극 음극", "자력", "자석", "편자"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("च\u{941}\u{902}बक"),
			keywords: &["आकर\u{94d}शण", "घोड\u{94d}यानाळ", "च\u{941}\u{902}बक", "च\u{941}\u{902}बकीय"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("magnēts"),
			keywords: &["magnētisks", "magnēts", "pakavs", "pievilkšana", "pievilkšanās"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("магнет"),
			keywords: &["магнет", "магнетно", "негативно", "позитивно", "потковица", "привлекување"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
			tts:      Some("ക\u{d3e}ന\u{d4d}തം"),
			keywords: &["ആകർഷണം", "ക\u{d3e}ന\u{d4d}തം", "ക\u{d3e}ന\u{d4d}തികം", "ക\u{d41}തിരല\u{d3e}ടം"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["ଆକର\u{b4d}ଷଣ", "ଚ\u{b41}\u{b4d}ମ\u{b4d}ବକ", "ହର\u{b4d}ସ\u{b4d}\u{200c}ଶ\u{b41}"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("ímã"),
			keywords: &["atração", "ferradura", "magnético", "positivo-negativo", "ímã"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		crate::Annotation {
			lang:     "ro",
			tts:      Some("magnet"),
			keywords: &["atracție", "formă de u", "magnet", "magnetic", "potcoavă", "pozitiv negativ"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-060"), keywords: &["E11-060"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("магнит"),
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ማግኔት"),
			keywords: &["ማግኔታዊ", "ማግኔት", "ስሕበት", "ቅርጺ", "ኣሉታዊ", "ኣወንታዊ", "ዩ", "ጫማ ፈረስ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("makinito"), keywords: &["makinito"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("mıknatıs"),
		...
		crate::Annotation {
			lang:     "uz",
			tts:      Some("magnit"),
			keywords: &["itarish", "magnit", "qizil magnit", "taqa", "taqasimon magnit", "tortish"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("nam châm"),
			keywords: &["chữ u", "móng ngựa", "nam châm", "sức hút", "từ tính", "âm dương"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("磁鐵"),
			keywords: &["U 型", "五金", "吸引", "正負", "磁力", "磁吸", "磁鐵", "馬蹄"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["U形", "正極", "正負極", "磁力", "磁石", "磁鐵", "負極", "馬蹄形"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
