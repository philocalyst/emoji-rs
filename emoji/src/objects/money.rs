...
pub const YEN_BANKNOTE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["bank", "banknoot", "geld", "geldeenheid", "jen", "jenbanknoot", "noot"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["ধন", "নোট", "বিল", "বেংক", "বেংকনোট", "ম\u{9c1}দ\u{9cd}ৰ\u{9be}", "য\u{9bc}েন"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["Японія", "банкнот іены", "валюта", "грошы", "купюра", "іена"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("банкнота със знак за йена"),
			keywords: &["банкнота", "банкнота със знак за йена", "валута", "йена", "пари"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["arcʼhant", "bilhed", "bilhed e yenoù", "moneiz", "unanenn", "yen"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["ᎠᏕᎳ", "ᎠᏕᎳ ᏧᏂᏗᎢ ᎪᏪᎵ", "ᎤᎾᏓᏚᎬ", "ᎤᏃᏍᏓ", "ᎪᏪᎵ", "ᏤᏈᏂᏏ ᎠᏕᎳ", "ᏤᏈᏂᏏ ᎠᏕᎳ ᏧᏂᏗᎢ ᎪᏪᎵ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["arian cyfredol", "banc", "papur arian", "papur arian yen", "yen"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			...
			keywords: &["γιεν", "λογαριασμός", "νόμισμα", "τράπεζα", "χαρτονόμισμα", "χρήματα"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["billete", "billete de banco", "billete de yen", "dinero", "yen"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["jeen", "jeeni rahatäht", "pank", "raha", "rahatäht", "valuuta"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			...
			keywords: &["argent", "billet", "billet de banque", "billet en yens", "payer", "yens"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["billet", "yen"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("nóta bainc yen"),
			keywords: &["airgead", "airgeadra", "nóta bainc", "nóta bainc yen", "nóta yen", "yen"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["नोट", "प\u{948}स\u{947}", "बिल", "ब\u{948}\u{902}कनोट", "य\u{947}न"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
			tts:      Some("novčanica sa znakom jena"),
			keywords: &["banka", "jen", "novac", "novčanica", "novčanica sa znakom jena", "valuta"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["bank", "kas", "mata uang", "uang", "uang kertas", "uang kertas yen", "yen"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			...
			keywords: &["Giappone", "Yen", "banca", "banconota", "denaro", "soldi", "valuta"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			...
			keywords: &["dhuwit", "dhuwit kertas", "dhuwit kertas yen", "mata uang", "yen"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &["ақша", "банкнота", "валюта", "йена", "йена банкнотасы", "шот", "қағаз ақша"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &["चलन", "नोट", "पयश\u{947}", "ब\u{901}कनोट", "बील", "य\u{947}न"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
			tts:      Some("иена банкнотасы"),
			keywords: &["акча", "банкнота", "валюта", "иена", "иена банкнотасы", "эсеп"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
			tts:      Some("Yen"),
			keywords: &["Bank", "Geld", "Geldschäin", "Rechnung", "Schäin", "Suen", "Währung", "Yen"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["bankas", "banknotas", "jena", "jenos banknotas", "pinigai", "valiuta"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["momo moni", "moni", "monipepa", "pepa", "pire", "pēke", "yen"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("банкнота на јен"),
			keywords: &["банка", "банкнота", "банкнота на јен", "валута", "пари", "јен"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["Bil", "Bánknot", "Kọ\u{301}rẹ\u{301}nsi", "Mọní", "Not", "Yẹn", "Yẹn Pépá Mọní"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["banco", "dinheiro", "iene", "moeda", "nota", "nota bancária", "nota de iene"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-625"), keywords: &["E10-625"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("банкнота иены"),
			keywords: &["банкнота", "банкнота иены", "валюта", "деньги", "иена", "япония"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["apoen", "banka", "bankovec", "bankovec za jen", "denar", "jen", "valuta"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("lacag yeen ah"),
			keywords: &["biil", "lacag", "lacag yeen ah", "warqad", "warqad bangi", "yeen"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("kartëmonedhë jeni"),
			keywords: &["faturë", "jen", "kartëmonedhë", "kartëmonedhë jeni", "valutë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &["асъор", "бонк", "йен", "пул", "қоғази пул", "қоғази пули йен"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
			tts:      Some("ธนบ\u{e31}ตรเยน"),
			keywords: &["ธนบ\u{e31}ตร", "เง\u{e34}น", "เยน", "แบงค\u{e4c}", "แลกเปล\u{e35}\u{e48}ยน"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		crate::Annotation {
			...
			keywords: &["bank", "banknot", "kagyz pul", "pul", "pul birligi", "ýen banknot", "ýena"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			lang:     "ug",
			tts:      Some("يېن"),
			keywords: &["ئاقچا", "بانكا", "تەڭگە", "قەغەز پۇل", "يارماق", "يېن", "پۇل"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("єнові банкноти"),
			keywords: &["банк", "банкнота", "валюта", "гроші", "купюра", "єна", "єнові банкноти"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["banknot", "hisob", "iyena banknotasi", "pul", "pul birligi", "valyuta", "yen"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("tiền giấy yên"),
			keywords: &["hoá đơn", "tiền", "tiền giấy", "tiền giấy yên", "tiền tệ", "yên"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("owo yen"),
			keywords: &["ilé-ìfowópamó\u{329}", "owo yen", "owó", "owó bánkì", "yẹn", "ìwó iye owó"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("owo yen"),
			keywords: &["ilé-ìfowópamó\u{329}", "owo yen", "owó", "owó bánkì", "yɛn", "ìwó iye owó"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("日圆纸币"),
			keywords: &["帐单", "日圆", "日圆纸币", "纸币", "货币", "钱", "银纸", "银行"],
		},
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
		...
		crate::Annotation {
			...
			keywords: &["ibhange", "imali", "imali eyiyeni", "isikweletu", "iyeni", "uhlobo lwemali"],
		},
	],
};
#[doc = "🪙"]
pub const COIN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["أشياء", "ثري", "ذهب", "عملة معدنية", "فضة", "كنز", "مال", "معدن"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("монета"),
			keywords: &["долар", "евро", "злато", "метал", "монета", "пари", "сребро", "съкровище"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("moneda"),
			keywords: &["diners", "dòlar", "euro", "metall", "moneda", "or", "plata", "ric", "tresor"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎢᏯᏓᏅᏖᏗ"),
			keywords: &["ᎠᏕᎳ", "ᎠᏕᎳ ᎤᏁᎦ", "ᎠᏕᎳ ᏓᎶᏂᎨ", "ᎢᏯᏓᏅᏖᏗ", "ᏔᎷᎩᏍᎩ", "ᏧᎬᏩᎶᏗ ᎠᏍᏆᏂᎪᏛ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			tts:      Some("Münze"),
			keywords: &[
				"Dollar", "Euro", "Geld", "Gold", "Goldesel", "Metall", "Münze", "Schatz", "Silber",
				"bezahlen", "reich", "sparen",
			],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		...
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["moneda"] },
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
			tts:      Some("münt"),
			keywords: &["dollar", "euro", "hõbe", "kuld", "metall", "münt", "raha", "rikas", "varandus"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("سکه"),
			keywords: &["دلار", "سکه", "طلا", "فلز", "نقره", "پول", "پولدار", "گنجینه", "یورو"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["argent", "monnaie", "métal", "or", "pièce de monnaie", "trésor"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			...
			keywords: &["अमीर", "खजाना", "धन", "धात\u{941}", "प\u{948}सा", "रजत", "सिक\u{94d}का", "सोना"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("érme"),
			keywords: &["arany", "dollár", "euró", "ezüst", "fém", "kincs", "pénz", "érme"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			tts:      Some("moneta"),
			keywords: &[
				"argento", "denaro", "dollaro", "euro", "metallo", "moneta", "oro", "ricco", "soldi",
				"tesoro",
			],
		},
		#[cfg(feature = "ja")]
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("aṣurdi"), keywords: &["aṣurdi"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("тиын"),
			keywords: &["алтын", "ақша", "бай", "доллар", "евро", "күміс", "металл", "тиын", "қазына"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("동전"),
			keywords: &["골드", "금", "금속", "달러", "돈", "동전", "보물", "부자", "유로", "은", "코인"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		#[cfg(feature = "ky")]
		crate::Annotation { lang: "ky", tts: Some("тыйын"), keywords: &["тыйын"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
			tts:      Some("ຫ\u{ebc}ຽນ"),
		...
		crate::Annotation {
			lang:     "lt",
			tts:      Some("moneta"),
			keywords: &["auksas", "lobis", "metalas", "moneta", "pinigai", "sidabras"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("monēta"),
			keywords: &["bagātība", "eiro", "metāls", "monēta", "nauda", "sudrabs", "zelts"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			lang:     "ne",
			tts:      Some("सिक\u{94d}का"),
			keywords: &["खजाना", "चा\u{901}दी", "धात\u{941}", "प\u{948}सा", "सिक\u{94d}का", "स\u{941}न"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("munt"),
			keywords: &["dollar", "euro", "geld", "goud", "metaal", "munt", "rijk", "schat", "zilver"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Kọin"),
			keywords: &["Gold", "Kọin", "Mẹ\u{301}tal", "Mọní", "Sílva", "Trẹ\u{301}zhọ"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		crate::Annotation {
			...
			tts:      Some("moeda"),
			keywords: &[
				"dinheiro", "dólar", "euro", "metal", "moeda", "ouro", "prata", "real", "rica", "rico",
				"tesouro",
			],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["dinheiro", "metal", "moeda", "ouro", "prata", "rico", "tesouro"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E13-060"), keywords: &["E13-060"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("монета"),
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("minca"),
			keywords: &["bohatstvo", "dolár", "euro", "minca", "peniaz", "peniaze", "poklad", "zlato"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("kovanec"),
			keywords: &["bogat", "denar", "evro", "kovanec", "kovina", "srebro", "zaklad", "zlato"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			tts:      Some("monedhë"),
			keywords: &[
				"ar", "argjend", "dollar", "euro", "flori", "i pasur", "metal", "monedhë", "para", "thesar",
			],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "sw",
			tts:      Some("sarafu"),
			keywords: &["chuma", "dhahabu", "hazina", "hela", "pesa", "sarafu", "shaba", "shilingi"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሰልዲ"),
			keywords: &["ሃብታም", "ሃፍቲ", "ሳንቲም", "ብረት", "ብሩር", "ወርቂ", "ዩሮ", "ዶላር", "ገንዘብ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("سکہ"),
			keywords: &["امیر", "خزانہ", "دھات", "رقم", "سونا", "سکہ", "مالدار", "چاندی", "ڈالر", "کوئن"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("tanga"),
			keywords: &["boy", "kumush", "metall", "oltin", "pul", "tanga", "tilla", "xazina"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("硬币"),
			keywords: &["富有", "欧元", "硬币", "美元", "财富", "金", "金属", "金币", "钱", "银"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("硬幣"),
			keywords: &["寶藏", "歐元", "硬幣", "金", "金屬", "金幣", "銀", "錢", "錢幣"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
...
pub const DOLLAR_BANKNOTE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["bank", "banknoot", "dollar", "dollarbanknoot", "geld", "geldeenheid", "noot"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["ডল\u{9be}ৰ", "ধন", "নোট", "বিল", "বেংক", "বেংকনোট", "ম\u{9c1}দ\u{9cd}ৰ\u{9be}"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["банкнота", "банкнота със знак за долар", "валута", "долар", "пари"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["arcʼhant", "bilhed", "bilhed e dollaroù", "dollar", "moneiz", "unanenn"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["ᎠᎹᏰᏟ ᎤᏃᏍᏓ", "ᎠᏕᎳ", "ᎠᏕᎳ ᏧᏂᏗᎢ ᎪᏪᎵ", "ᎤᎾᏓᏚᎬ", "ᎤᏃᏍᏓ", "ᎤᏃᏍᏓ ᎠᏕᎳ ᏧᏂᏗᎢ ᎪᏪᎵ", "ᎪᏪᎵ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
			tts:      Some("dolarová bankovka"),
			keywords: &["banka", "bankovka", "dolar", "dolarová bankovka", "měna", "peníze"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
			tts:      Some("papur arian doler"),
			keywords: &["arian cyfredol", "banc", "doler", "papur arian", "papur arian doler"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("dollarseddel"),
			keywords: &["dollar", "dollarseddel", "penge", "pengesedler", "seddelbundt", "sedler"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["billete", "billete de banco", "billete de dólar", "dinero", "dólar"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["dollar", "dollari rahatäht", "pank", "raha", "rahatäht", "valuuta"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("dolar billetea"),
			keywords: &["bankua", "billetea", "dirua", "dolar billetea", "dolarra", "moneta"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			...
			keywords: &["dollari", "dollariseteli", "pankki", "raha", "seteli", "valuutta"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["argent", "billet", "billet de banque", "billet en dollars", "dollar", "payer"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["billet", "dollar"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			lang:     "gu",
			tts:      Some("ડૉલર નોટ"),
			keywords: &["ડૉલર", "નોટ", "પ\u{ac8}સા", "બિલ", "બ\u{ac7}\u{a82}કનોટ", "માયા", "માલ"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		crate::Annotation {
			...
			keywords: &["banka", "dolar", "novac", "novčanica", "novčanica sa znakom dolara", "valuta"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["bank", "dolar", "kas", "mata uang", "uang", "uang kertas", "uang kertas dolar"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("akwụkwọego dọlla"),
			keywords: &["akwụkwọego dọlla", "akwụkwọego ụlọakụ", "dọlla", "ego", "ụgwọ", "ụlọakụ"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("dollaraseðill"),
			keywords: &["dollaraseðill", "dollari", "gjaldmiðill", "peningaseðill", "peningur", "seðill"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			...
			keywords: &["dhuwit", "dhuwit kertas", "dhuwit kertas dolar", "euro", "mata uang"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &["ақша", "банкнота", "валюта", "доллар", "доллар банкнотасы", "шот", "қағаз ақша"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("달러"),
			keywords: &["달러", "달러화", "돈", "미국 돈", "미국 화폐", "은행", "지폐", "화폐"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			lang:     "ky",
			tts:      Some("доллар банкнотасы"),
			keywords: &["акча", "банкнота", "валюта", "доллар", "доллар банкнотасы", "эсеп"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
			tts:      Some("Dollar"),
			keywords: &["Bank", "Dollar", "Geld", "Geldschäin", "Rechnung", "Schäin", "Suen", "Währung"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["bankas", "banknotas", "dolerio banknotas", "doleris", "pinigai", "valiuta"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["momo moni", "moni", "monipepa", "pepa", "pire", "pēke", "tāra"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("банкнота на долар"),
			keywords: &["банка", "банкнота", "банкнота на долар", "валута", "долар", "пари"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["dinheiro", "dólar", "moeda", "nota", "nota bancária", "nota de dólar"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["banco", "dinheiro", "dólar", "moeda", "nota", "nota bancária", "nota de dólar"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-626"), keywords: &["E10-626"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			lang:     "rw",
			tts:      Some("idolari"),
			keywords: &["banki", "idolari", "idovize", "ifaranga", "inoti", "urupapuro mvunjwafaranga"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["apoen", "banka", "bankovec", "denar", "dolar", "dolarski bankovec", "valuta"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("lacag doolar ah"),
			keywords: &["biil", "doolar", "lacag", "lacag doolar ah", "warqad", "warqad bangi"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("kartëmonedhë dollari"),
			keywords: &["bankë", "dollar", "faturë", "kartëmonedhë", "kartëmonedhë dollari", "monedhë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &["асъор", "бонк", "доллар", "пул", "қоғази пул", "қоғази пули доллар"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			...
			keywords: &["banknot", "basma pul", "dollar", "kagyz pul", "pul", "pul birligi"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			lang:     "ug",
			tts:      Some("دوللار"),
			keywords: &["ئاقچا", "بانكا", "تەڭگە", "دوللار", "قەغەز پۇل", "يارماق", "پۇل"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("доларові банкноти"),
			keywords: &["банк", "банкнота", "валюта", "гроші", "долар", "доларові банкноти", "купюра"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["hoá đơn", "tiền", "tiền giấy", "tiền giấy đô la", "tiền tệ", "đô la"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
			tts:      Some("biye dolaar"),
			keywords: &["biye", "biye dolaar", "bànk", "dollar", "koppar", "xaalis", "xaalisu këyit"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("owo dọla"),
			keywords: &["dọ\u{301}là", "ilé-ìfowópamó", "owo dọla", "owó", "owó bánkì", "ìwó iye owó"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("owo dɔla"),
			keywords: &["dɔ\u{301}là", "ilé-ìfowópamó", "owo dɔla", "owó", "owó bánkì", "ìwó iye owó"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("美元纸币"),
			keywords: &["帐单", "纸币", "美元", "美元纸币", "货币", "钱", "银纸", "银行"],
		},
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
		...
		crate::Annotation {
			...
			keywords: &["ibhange", "idola", "imali", "imali eyidola", "isikweletu", "uhlobo lwemali"],
		},
	],
};
#[doc = "💸"]
pub const MONEY_WITH_WINGS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["መክፈያ", "ብረር", "ክንፍ ያለው ገንዘብ", "የብር ኖት", "የወረቀት ገንዘብ", "የገንዘብ ኖት", "ገንዘብ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["উৰণ", "ধন", "প\u{9be}খি", "প\u{9be}খিয\u{9c1}ক\u{9cd}ত ধন", "বিল", "বেংকনোট"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
			tts:      Some("qanadlı pullar"),
			keywords: &["bank", "dollar", "hesab", "not", "pul", "qanadlı pullar", "valyuta", "əskinaz"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("грошы з крыламі"),
			keywords: &["грошы", "грошы з крыламі", "долар", "крылы", "купюра", "палёт"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("пари с крила"),
			keywords: &["банкнота", "долар", "крила", "милиард", "милион", "пари", "пари с крила"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["adenydd", "arian cyfredol", "arian gydag adenydd", "banc", "papur arian"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			...
			keywords: &["Bank", "Euro", "Geld", "Geldschein mit Flügeln", "Knete", "Moneten"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			...
			keywords: &[
				"bank", "banknote", "bill", "billion", "cash", "dollar", "fly", "million", "money", "note",
				"pay", "wings",
			],
		},
		#[cfg(feature = "en_AU")]
		...
		crate::Annotation {
			...
			keywords: &["billete", "billete con alas", "billete de banco", "dinero", "dinero con alas"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["ارز", "اسکناس", "اسکناس بال\u{200c}دار", "بال", "بانک", "پول"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("rahalla on siivet"),
			keywords: &["pankki", "raha", "rahalla on siivet", "seteli", "siivet", "valuutta"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			lang:     "hy",
			tts:      Some("փող թևերով"),
			keywords: &["բանկ", "դոլար", "թղթադրամ", "թռչել", "թևեր", "փող", "փող թևերով"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("羽が生えたお金"),
			keywords: &["お札", "お金", "ドル", "支払い", "札束", "紙幣", "羽が生えたお金"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("dhuwit nduwe swiwi"),
			keywords: &["dhuwit", "dhuwit kertas", "dhuwit nduwe swiwi", "mabur", "swiwi"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("ფული ფრთებით"),
			keywords: &["ბანკნოტი", "დოლარი", "ფრენა", "ფრთები", "ფული", "ფული ფრთებით"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
			tts:      Some("idrimen s yiferrawen"),
			keywords: &["idrimen s yiferrawen"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("қанаты бар ақша"),
			keywords: &["ақша", "банкнота", "шот", "қанаттар", "қанаты бар ақша", "ұшу"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ರ\u{cc6}ಕ\u{ccd}ಕ\u{cc6}ಗಳ\u{cca}ಂದ\u{cbf}ಗ\u{cc6} ಹಣ"),
			keywords: &[
				"ಕ\u{ccd}ಯಾಶ\u{ccd}",
				"ಡಾಲರ\u{ccd}",
				"ನಗದು",
				...
				"ರ\u{cc6}ಕ\u{ccd}ಕ\u{cc6}ಗಳ\u{cbf}ರುವ ನ\u{ccb}ಟು",
				"ರ\u{cc6}ಕ\u{ccd}ಕ\u{cc6}ಗಳು",
				"ರ\u{cc6}ಕ\u{ccd}ಕ\u{cc6}ಗಳ\u{cca}ಂದ\u{cbf}ಗ\u{cc6} ಹಣ",
				"ಹಣ",
				"ಹಾರಾಡುವ ಬ\u{ccd}ಯಾಂಕ\u{ccd}\u{200c}ನ\u{ccb}ಟ\u{ccd}",
				"ಹಾರು",
			],
		},
		#[cfg(feature = "ko")]
		...
		crate::Annotation {
			...
			keywords: &["bankas", "banknotas", "doleris", "pinigai", "pinigai su sparnais"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("banknote ar spārniem"),
			keywords: &["banknote", "banknote ar spārniem", "lidot", "nauda", "spārni"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ചിറക\u{d41}ള\u{d4d}ള ബ\u{d3e}ങ\u{d4d}ക\u{d4d} നോട\u{d4d}ട\u{d41}കൾ",
				"നോട\u{d4d}ട\u{d4d}",
				"പണം",
		...
		crate::Annotation {
			...
			keywords: &[
				"उडणारी ब\u{901}कनोट",
				"उडणार\u{947} प\u{948}स\u{947}",
				"उडण\u{947}",
				"नोट",
				"प\u{902}ख",
				"प\u{902}ख असल\u{947}ला प\u{948}सा",
				"प\u{902}ख असल\u{947}ल\u{947} प\u{948}स\u{947}",
				"प\u{948}सा",
				"ब\u{901}क",
				"ब\u{901}कनोट",
				"बिल",
		...
		crate::Annotation {
			lang:     "nn",
			tts:      Some("pengar med venger"),
			keywords: &["bank", "flygande setel", "pengar", "pengar med venger", "setel"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["Bil", "Bánknot", "Flai", "Mọní", "Mọní Wé Gẹ\u{301}t Wing", "Wing"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		crate::Annotation {
			...
			keywords: &["بل", "د بانک نوټ", "وزرې", "پيسې", "پيسې د وزرونو", "پیسې د وزرونو"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("dinheiro voando"),
			keywords: &["asas", "banco", "cédula", "dinheiro", "dinheiro indo embora", "nota", "voando"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("dinheiro com asas"),
			keywords: &["asas", "banco", "dinheiro", "dinheiro com asas", "dólar", "nota", "voar"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("qullqi raprakunawan"),
			keywords: &["billete", "chanin", "paway", "qullqi", "qullqi raprakunawan", "raprakuna"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-629"), keywords: &["E10-629"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["اڏڻ", "بئنڪ", "بل", "رقم", "نوٽ", "پر", "پرن وارا پئسا", "ڊالر"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["bankovka", "dolár", "krídla", "lietať", "peniaze", "peniaze s krídlami"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["baalal", "biil", "duulid", "lacag", "lacag baalal leh", "warqad bangi"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("para me krahë"),
			keywords: &["bankë", "dollar", "fluturoj", "kartëmonedhë", "krahë", "para", "para me krahë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("новац са крилима"),
			keywords: &["крилa", "лeтeњe", "милион", "нoвaц", "нoвчaницa", "новац са крилима"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("novac sa krilima"),
			keywords: &["krila", "letenje", "milion", "novac", "novac sa krilima", "novčanica"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			...
			keywords: &["benki", "dola", "mabawa", "noti", "pepea", "pesa", "pesa za noti zenye mabawa"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ఫ\u{c4d}ల\u{c48}",
				"మన\u{c40}",
				"మన\u{c40} వ\u{c3f}త\u{c4d} వ\u{c3f}ంగ\u{c4d}స\u{c4d}",
				"ర\u{c46}క\u{c4d}కలు",
				"వ\u{c3f}ంగ\u{c4d}",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &["асъор", "бонк", "пул", "пул бо қанотҳо", "қанотҳо", "қоғази пул"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("有翼嘅钱"),
			keywords: &["帐单", "有翼嘅钱", "纸币", "美元", "翼", "钱", "银纸", "银行", "飞"],
		},
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("长翅膀的钱"),
			keywords: &["纸币", "翅膀", "花钱", "钱", "长翅膀的钱", "飞"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("錢飛了"),
			keywords: &["沒錢了", "錢跑了", "錢飛了"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
...
pub const CHART_INCREASING_WITH_YEN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("مخطط لبيانات متزايدة مع الين"),
			keywords: &[
				"أسهم مرتفعة",
				"ارتفاع",
				"اسهم",
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("възходяща диаграма със знак за йена"),
			keywords: &[
				"валута",
		...
		crate::Annotation {
			...
			keywords: &["grafik", "kreskiñ", "krommenn", "krommenn kreskiñ ar yen", "moneiz", "yen"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["opadgående graf", "stigende marked", "tendens", "vækst", "yen"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["alza", "mercado", "mercado al alza", "mercado alcista", "tabla"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation { lang: "es_419", tts: Some("mercado en alza"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("↑↑↑"),
		...
		crate::Annotation {
			...
			keywords: &["alza", "crecimiento", "dinero", "gráfica", "gráfica de alza con yen", "yen"],
		},
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
			tts:      Some("tõusev graafik jeenisümboliga"),
			keywords: &["graafik", "jeen", "kasv", "turg", "tõusev graafik jeenisümboliga", "valuuta"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			...
			keywords: &["gráfico", "ien", "mercado", "mercado de iens en alza", "tendencia"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			...
			keywords: &[
				...
				"રકમ",
				"ર\u{ac2}પીયા",
				"શ\u{ac7}રબજારમા\u{a82} પ\u{acd}રગતિ",
			],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["גרף", "יואן", "ין", "יפן", "כלכלה", "כסף", "סין", "עולה", "צמיחה"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["hækkar", "jákvætt", "markaður á uppleið", "verðbréfamarkaður", "á uppleið"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("為替"),
			keywords: &["グラフ", "チャート", "円", "円高", "市場", "株", "株価", "為替"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("grafik mata uang yen mundhak"),
			keywords: &["dhuwit", "grafik", "grafik mata uang yen mundhak", "mundhak", "yen"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &["ក\u{17c6}ណើន", "តារាង", "តារាងក\u{17c6}ណើនល\u{17bb}យយេន", "ល\u{17bb}យយេន"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
			tts:      Some(
				"ಯ\u{cc6}ನ\u{ccd}\u{200c}ನ\u{cca}ಂದ\u{cbf}ಗ\u{cc6} ಏರುತ\u{ccd}ತ\u{cbf}ರುವ ಚಾರ\u{ccd}ಟ\u{ccd}",
			),
			keywords: &[
				"ಏರ\u{cbf}ಕ\u{cc6}",
				"ಏರುಗತ\u{cbf}ಯ ಚಾರ\u{ccd}ಟ\u{ccd}",
				"ಕರ\u{cc6}ನ\u{ccd}ಸ\u{cbf}",
				"ಗ\u{ccd}ರಾಫ\u{ccd}",
				"ಚಾರ\u{ccd}ಟ\u{ccd}",
				"ಟ\u{ccd}ರ\u{cc6}ಂಡ\u{ccd}",
				"ನ\u{ccb}ಟು",
				"ಬ\u{cc6}ಳವಣ\u{cbf}ಗ\u{cc6}",
				"ಬ\u{ccd}ಯಾಂಕ\u{ccd}",
		...
		crate::Annotation {
			...
			keywords: &[
				"आल\u{947}ख",
				"ऊर\u{94d}ध\u{94d}वगामी चार\u{94d}ट",
				"चार\u{94d}ट",
				"प\u{948}सा",
				"बाजार",
				"य\u{947}न",
		...
		crate::Annotation {
			...
			keywords: &["وده", "يين", "پېسې", "چارټ", "چارټ د یین سره زیاتیږي", "ګراف"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		crate::Annotation {
			lang:     "qu",
			tts:      Some("tawa kuchu yaparispa yenwan"),
			keywords: &[
				"qullqi",
				"siqisiqi",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-630"), keywords: &["E10-630"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("биржа"),
			keywords: &["биржа", "валюта", "деньги", "курс", "рост", "рынок", "тенденция"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["korid", "lacag", "shax", "shaxan", "shaxan muujinaya yeen kordhaysa", "yeen"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"பங\u{bcd}குச\u{bcd}சந\u{bcd}தை",
				"போக\u{bcd}கு",
				"யென\u{bcd}",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"డబ\u{c4d}బు",
				"మ\u{c3e}ర\u{c4d}క\u{c46}ట\u{c4d}",
				"య\u{c46}న\u{c4d}",
				"య\u{c46}న\u{c4d} చ\u{c3f}హ\u{c4d}నంత\u{c4b} ప\u{c48}క\u{c3f} చూపుతున\u{c4d}న చ\u{c3e}ర\u{c4d}ట\u{c4d}",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ห\u{e38}\u{e49}น",
				"อ\u{e31}ตราแลกเปล\u{e35}\u{e48}ยน",
				"เยน",
				"แนวโน\u{e49}ม",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &["paʻanga fakasiapani", "siate tupulaki", "siate tupulaki, paʻanga fakasiapani"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			...
			keywords: &["اضافہ", "بنک", "رقم", "چارٹ", "گراف", "ین", "ین کے ساتھ صعودی چارٹ"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("àtɛ n pɔsi pɛlu yɛn"),
			keywords: &[
				"ilà atɔ\u{301}ka àwòrán",
				"ilé ìfowópamɔ\u{301}n",
				"owó",
				"yen",
				"àtɛ",
				"àtɛ n pɔsi pɛlu yɛn",
...
pub const EURO_BANKNOTE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("ورقة يورو"),
			keywords: &["أموال", "اموال", "بانكنوت", "مال", "مصاري", "نقود", "ورقة يورو", "يورو", "١٠٠"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
			tts:      Some("ইউৰ’ বেংকনোট"),
			keywords: &["ইউৰ’", "ধন", "নোট", "বিল", "বেংক", "বেংকনোট", "ম\u{9c1}দ\u{9cd}ৰ\u{9be}"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["банкнота", "банкнота със знак за евро", "валута", "евро", "пари"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["arcʼhant", "bilhed", "bilhed en euroioù", "euro", "moneiz", "unanenn"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["ᎠᏕᎳ", "ᎠᏕᎳ ᏧᏂᏗᎢ ᎪᏪᎵ", "ᎤᎾᏓᏚᎬ", "ᎤᏃᏍᏓ", "ᎪᏪᎵ", "ᏳᎳᏈ ᎠᏕᎳ", "ᏳᎳᏈ ᎠᏕᎳ ᏧᏂᏗᎢ ᎪᏪᎵ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["arian cyfredol", "banc", "ewro", "papur arian", "papur arian ewro"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			...
			keywords: &["billete", "billete de banco", "billete de euro", "dinero", "euro"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["bankua", "billetea", "dirua", "euro billetea", "euroa", "moneta"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			...
			keywords: &["argent", "billet", "billet de banque", "billet en euros", "euros", "payer"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["100", "नोट", "प\u{948}स\u{947}", "बिल", "ब\u{948}\u{902}क नोट", "य\u{942}रो"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
			tts:      Some("novčanica sa znakom eura"),
			keywords: &["banka", "euro", "novac", "novčanica", "novčanica sa znakom eura", "valuta"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["akwụkwọego euro", "akwụkwọego ụlọakụ", "ego", "euro", "ụgwọ", "ụlọakụ"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("유로"),
			keywords: &["100", "부자", "유럽 돈", "유럽 화폐", "유로", "유로화", "은행", "지폐", "화폐"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["акча", "банкнота", "валюта", "евро", "евро банкнотасы", "эсеп"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
			tts:      Some("Euro"),
			keywords: &["Bank", "Euro", "Geld", "Geldschäin", "Rechnung", "Schäin", "Suen", "Währung"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["bankas", "banknotas", "euras", "euro banknotas", "pinigai", "valiuta"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["momo moni", "moni", "monipepa", "pepa", "pire", "pēke", "uro"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["bank", "banknot", "euro", "pieniądze", "płacić", "rachunek", "waluta"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["banco", "dinheiro", "euro", "moeda", "nota", "nota bancária", "nota de euro"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-627"), keywords: &["E10-627"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			lang:     "rw",
			tts:      Some("iyero"),
			keywords: &["banki", "idovize", "ifaranga", "inoti", "iyero", "urupapuro mvunjwafaranga"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["apoen", "banka", "bankovec", "denar", "evro", "evrski bankovec", "valuta"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("lacag yuuro ah"),
			keywords: &["biil", "lacag", "lacag yuuro ah", "warqad", "warqad bangi", "yuuro"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			...
			keywords: &["banka", "evro", "novac", "novčanica", "novčanica sa znakom evra", "valuta"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			...
			keywords: &["асъор", "бонк", "евро", "пул", "қоғази пул", "қоғази пули евро"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ናይ ዩሮ ኖት"),
			keywords: &["100", "ሓፍታም", "ሕሳብ", "መተሓሳሰቢ", "ባንክ", "ባጤራ", "ኖት ባንክ", "ዩሮ", "ገንዘብ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("ýewro banknot"),
			keywords: &["banknot", "basma pul", "kagyz pul", "pul", "pul birligi", "ýewro"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			lang:     "ug",
			tts:      Some("ياۋرو"),
			keywords: &["ئاقچا", "بانكا", "تەڭگە", "قەغەز پۇل", "يارماق", "ياۋرو", "پۇل"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("єврові банкноти"),
			keywords: &["банк", "банкнота", "валюта", "гроші", "купюра", "євро", "єврові банкноти"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["euro", "hoá đơn", "tiền", "tiền giấy", "tiền giấy euro", "tiền tệ"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("owo uro"),
			keywords: &["ilé-ìfowópamó\u{329}", "owo uro", "owó", "owó bánkì", "ìwó iye owó", "úrò"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
		...
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("欧元纸币"),
			keywords: &["帐单", "欧元", "欧元纸币", "纸币", "货币", "钱", "银纸", "银行"],
		},
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("歐元紙幣"),
			keywords: &["€", "歐元", "歐元紙幣", "歐羅", "現金", "紙幣", "貨幣", "鈔票", "銀行", "錢"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("imali yase-euro"),
			keywords: &["i-euro", "ibhange", "imali", "imali yase-euro", "isikweletu", "uhlobo lwemali"],
		},
	],
};
#[doc = "🧾"]
...
pub const POUND_BANKNOTE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["መክፈያ", "ምንዛሬ", "የወረቀት ገንዘብ", "የገንዘብ ኖት", "ገንዘብ", "ፓውንድ የወረቀት ገንዘብ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["Вялікабрытанія", "банкнот фунта", "валюта", "грошы", "купюра", "фунт"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
		...
		crate::Annotation {
			...
			keywords: &["arcʼhant", "bilhed", "bilhed e lurioù", "lur", "moneiz", "unanenn"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["ᎠᏕᎳ", "ᎠᏕᎳ ᏧᏂᏗᎢ ᎪᏪᎵ", "ᎤᎾᏓᏚᎬ", "ᎤᏃᏍᏓ", "ᎩᎵᏏᏲ ᎠᏕᎳ", "ᎩᎵᏏᏲ ᎠᏕᎳ ᏧᏂᏗᎢ ᎪᏪᎵ", "ᎪᏪᎵ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
			tts:      Some("librová bankovka"),
			keywords: &["banka", "bankovka", "hotovost", "libra", "librová bankovka", "měna", "peníze"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
			tts:      Some("papur arian punt"),
			keywords: &["arian cyfredol", "banc", "papur arian", "papur arian punt", "punt"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			lang:     "en_001",
			tts:      None,
			keywords: &["banknote", "bill", "currency", "money", "note", "pound", "sterling"],
		},
		#[cfg(feature = "en_AU")]
		crate::Annotation { lang: "en_AU", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_CA")]
		...
		crate::Annotation {
			...
			keywords: &["nael", "naela rahatäht", "naelsterling", "pank", "rahatäht", "valuuta"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("libera billetea"),
			keywords: &["banku", "billete", "diru", "faktura", "libera", "libera billetea", "moneta"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			...
			keywords: &["pankki", "punta", "puntaseteli", "raha", "seteli", "valuutta"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["argent", "billet", "billet de banque", "billet en livres", "livres", "payer"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["billet", "livre"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			...
			keywords: &["כסף", "לירה שטרלינג", "מטבע", "סטפה", "פאונד", "שטר", "שטר לירה שטרלינג"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			tts:      Some("पाउ\u{902}ड नोट"),
			keywords: &["नोट", "पाउ\u{902}ड", "प\u{948}स\u{947}", "ब\u{948}\u{902}कनोट"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
			tts:      Some("novčanica sa znakom funte"),
			keywords: &["banka", "funta", "novac", "novčanica", "novčanica sa znakom funte", "valuta"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["akwụkwọego pound", "akwụkwọego ụlọakụ", "ego", "pound", "ụgwọ", "ụlọakụ"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("ポンド札"),
			keywords: &["お札", "お金", "ポンド", "ポンド札", "札束", "現金", "紙幣", "通貨"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["ақша", "банкнота", "валюта", "фунт", "фунт банкнотасы", "шот", "қағаз ақша"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &["चलन", "नोट", "पयश\u{947}", "पाव\u{902}ड", "ब\u{901}कनोट", "बील"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
			tts:      Some("фунт банкнотасы"),
			keywords: &["акча", "банкнота", "валюта", "фунт", "фунт банкнотасы", "эсеп"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
			tts:      Some("Pound"),
			keywords: &["Bank", "Geld", "Geldschäin", "Pound", "Rechnung", "Schäin", "Suen", "Währung"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
			tts:      Some("ໃບເງ\u{eb4}ນປອນ"),
			keywords: &["ທະນະບ\u{eb1}ດ", "ທະນາຄານ", "ປອນ", "ໃບເງ\u{eb4}ນ", "ໃບເງ\u{eb4}ນປອນ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["momo moni", "moni", "monipepa", "pauna", "pepa", "pire", "pēke"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["banco", "dinheiro", "libra", "moeda", "nota", "nota bancária", "nota de libra"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("libras esterlinas billete"),
			keywords: &["billete", "chanin", "libras esterlinas", "libras esterlinas billete", "qullqi"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-628"), keywords: &["E10-628"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			lang:     "rw",
			tts:      Some("ipawundi"),
			keywords: &["banki", "idovize", "ifaranga", "inoti", "ipawundi", "urupapuro mvunjwafaranga"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["apoen", "banka", "bankovec", "bankovec za funt", "denar", "funt", "valuta"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("lacag bownd ah"),
			keywords: &["biil", "bownd", "lacag", "lacag bownd ah", "warqad", "warqad bangi"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			...
			keywords: &["асъор", "бонк", "пул", "фунт", "қоғази пул", "қоғази пули фунт"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ፓውንድ ኖት"),
			keywords: &["ሕሳብ", "መተሓሳሰቢ", "ቢልዮን", "ባንክ", "ባጤራ", "ኖት ባንክ", "ገንዘብ", "ጥረ ገንዘብ", "ፓውንድ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["ئاقچا", "بانكا", "تەڭگە", "قەغەز پۇل", "يارماق", "پوند", "پوندستېرلىڭ", "پۇل"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("фунтові банкноти"),
			keywords: &["банк", "банкнота", "валюта", "гроші", "купюра", "фунт", "фунтові банкноти"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["bảng", "hoá đơn", "tiền", "tiền giấy", "tiền giấy bảng", "tiền tệ"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
			tts:      Some("piye pound"),
			keywords: &["biye", "bànk", "koppar", "piye pound", "pound", "xaalis", "xaalisu këyit"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("英镑纸币"),
			keywords: &["帐单", "纸币", "英镑", "英镑纸币", "货币", "钱", "银纸", "银行"],
		},
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("英鎊紙幣"),
			keywords: &["£", "現金", "紙幣", "英鎊", "英鎊紙幣", "貨幣", "鈔票", "銀行", "錢"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
