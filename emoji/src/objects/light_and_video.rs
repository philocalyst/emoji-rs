...
pub const MOVIE_CAMERA: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["تسجيل", "سينما", "صناعة افلام", "فيلم", "كاميرا", "كاميرا أفلام", "هوليوود"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
			tts:      Some("চলচিত\u{9cd}ৰৰ কেমেৰ\u{9be}"),
			keywords: &["কেমেৰ\u{9be}", "চলচিত\u{9cd}ৰ", "চলচিত\u{9cd}ৰৰ কেমেৰ\u{9be}", "চিনেম\u{9be}"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("kamera"), keywords: &["kamera", "sinema"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("kamera"),
		...
		crate::Annotation {
			...
			keywords: &["cine", "cámara", "cámara de cine", "entretenimiento", "película"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["cine", "cámara", "cámara de filmar", "entretenimiento", "película"],
		},
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("caméra"),
			keywords: &["caméra", "cinéma", "film", "filmer", "réalisateur", "réalisatrice", "vidéo"],
		},
		#[cfg(feature = "fr_CA")]
		...
		crate::Annotation {
			...
			keywords: &["ceamara", "ceamara scannáin", "cinecheamara", "scannán", "siamsaíocht"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["cine", "cámara cinematográfica", "filmar", "filme", "película"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			...
			keywords: &["מסרטה", "מצלמה", "מצלמת קולנוע", "סרט", "פילם", "צילום", "קולנוע"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["igwefòto", "ihe nkiri", "ihe nkiri igwefòto", "ụlọ ihe nkiri"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			...
			keywords: &["бейнефильм түсіретін камера", "видео", "камера", "кино", "фильм"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &["កាមេរ\u{17c9}ា", "កាមេរ\u{17c9}ាថតក\u{17bb}ន", "ថតក\u{17bb}ន", "ភាពយន\u{17d2}ត"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			...
			keywords: &["ກ\u{ec9}ອງ", "ກ\u{ec9}ອງຖ\u{ec8}າຍຮ\u{eb9}ບເງ\u{ebb}າ", "ຮ\u{eb9}ບເງ\u{ebb}າ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["боливуд", "камера", "кино", "снима", "филм", "филмска камера", "холивуд"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["bollywood", "filem", "hollywood", "kamera", "pawagam", "rakaman", "wayang"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("filmcamera"),
			keywords: &["bioscoop", "bollywood", "camera", "film", "filmcamera", "hollywood", "opnemen"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["cinema", "câmera", "entretenimento", "filmar", "filme", "hollywood"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("câmara de filmar"),
			keywords: &["cinema", "câmara", "câmara de filmar", "entretenimento", "filme"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-357"), keywords: &["E10-357"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("кинокамера"),
			keywords: &["видеокамера", "камера", "кино", "кинокамера", "снять", "съемка", "фильм"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("kamera ifata videwo"),
			keywords: &["19900", "amashusho agenda", "kamera", "kamera ifata videwo", "sinema"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["කැමර\u{dcf}ව", "ච\u{dd2}ත\u{dca}\u{200d}රපට", "ස\u{dd2}නම\u{dcf}ව"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
			tts:      Some("filmová kamera"),
			keywords: &["bollywood", "film", "filmová kamera", "hollywood", "kamera", "kino", "zábava"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("مووی کیمرا"),
			keywords: &["بالیوڈ", "سینما", "فلم", "لالیوڈ", "مووی کیمرا", "کیمرا", "ہالیوڈ"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			...
			keywords: &["bollywood", "hollywood", "máy quay phim", "phim", "rạp chiếu phim"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("电影摄影机"),
			keywords: &["录像", "摄像机", "摄录机", "摄影", "摄影机", "电影", "电影摄影机"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["bollywood", "hollywood", "攝影機", "波里活", "荷里活", "記錄", "錄影", "電影"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const FILM_FRAMES: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["bioskoop", "film", "filmraampies", "fliek", "raam", "raampies", "rolprent"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["চলচিত\u{9cd}ৰ", "চিনেম\u{9be}", "ফিল\u{9cd}ম", "ফ\u{9cd}ৰেইম"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["Филмови кадри", "кадри", "кино", "лента", "филм", "филмови кадри"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["cinema", "fotograma", "fotograma de pel·lícula", "fotogrames", "pel·lícula"],
		},
		#[cfg(feature = "ccp")]
		crate::Annotation {
			lang:     "ccp",
		...
		crate::Annotation {
			...
			keywords: &["camara", "cine", "cuadros de película", "fotograma", "película"],
		},
		#[cfg(feature = "es_MX")]
		...
		crate::Annotation {
			...
			keywords: &["cinema", "frame ng film", "mga frame", "palabas", "pelikula"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("fotograma de película"),
			keywords: &["cine", "fotograma", "fotograma de película", "negativo", "película"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("filmkockák"),
			keywords: &["film", "filmkockák", "filmtekercs", "kocka", "kockák", "mozi"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			keywords: &["fremụ gasi", "fremụ ihe nkiri gasị", "ihe nkiri", "ụlọ ihe nkiri"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("kvikmyndafilma"),
			keywords: &["bíómynd", "kvikmynd", "kvikmyndafilma", "kvikmyndalist", "rammi"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("映画フィルム"),
			keywords: &["シネマ", "フィルム", "フレーム", "ムービー", "映画", "映画フィルム"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["ភាពយន\u{17d2}ត", "ហ\u{17d2}វ\u{17b8}ល", "ហ\u{17d2}វ\u{17b8}លភាពយន\u{17d2}ត"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			...
			keywords: &["चौकटी", "फिल\u{94d}म", "फिल\u{94d}म चौकट", "म\u{941}व\u{94d}ही", "सिन\u{947}मा"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["кадар", "кадри", "кино", "филм", "филмска лента", "филмски кадар"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("filmframes"),
			keywords: &["bioscoop", "film", "filmframes", "filmrol", "films", "frames"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["ਥੀਏਟਰ", "ਫਿਲਮ", "ਫਿਲਮ ਫਰ\u{a47}ਮ", "ਮ\u{a42}ਵੀ", "ਰੀਲ", "ਸਿਨ\u{a47}ਮਾ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			...
			keywords: &["cine", "kanchakuna", "kanchakuna peliculamanta", "pelicula", "pelikula"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-350"), keywords: &["E10-350"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("кинопленка"),
			keywords: &["кадр", "кинематограф", "кино", "кинопленка", "пленка", "фильм"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("amakadiri ya filime"),
			keywords: &["amakadiri", "amakadiri ya filime", "filime", "filimi", "sinema"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["кадр на плівці", "кадри", "кадри кіноплівки", "кіно", "плівка", "фільм"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["ifilimu", "imuvi", "isinema", "izakhelo", "izakhelo zefilimu"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("影片帧"),
			keywords: &["帧", "影片帧", "电影", "电影胶卷", "电影胶片", "胶卷", "胶片"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			...
			keywords: &["amafreymi amafilimu", "amafreymu", "ifilimu", "imuvi", "isinema"],
		},
	],
};
#[doc = "📽\u{fe0f}"]
pub const FILM_PROJECTOR: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ሲኒማ", "ቪዲዮ", "የድሮ", "የፊልም ፕሮጄክተር", "ፊልም", "ፕሮጄክተር"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["film", "kino", "kino projektoru", "kinofilm", "projector", "video"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["видео", "кино", "кинопроектор", "проектор", "филм"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
			tts:      Some("ফিল\u{9cd}ম প\u{9cd}রজেক\u{9cd}টর"),
			keywords: &["প\u{9cd}রজেক\u{9cd}টর", "ফিল\u{9cd}ম", "ভিডিও", "ম\u{9c1}ভি", "সিনেম\u{9be}"],
		},
		#[cfg(feature = "br")]
		crate::Annotation {
			lang:     "br",
		...
		crate::Annotation {
			...
			keywords: &["cinema", "pel·lícula", "projector", "projector cinematogràfic", "vídeo"],
		},
		#[cfg(feature = "ccp")]
		crate::Annotation {
			lang:     "ccp",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["cine", "película", "películas", "proyector", "proyector de cine", "video"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			...
			keywords: &["elokuva", "elokuvakone", "elokuvaprojektori", "projektori", "video"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
			tts:      Some("film projector"),
			keywords: &["cinema", "film projector", "palabas", "pelikula", "projector", "sine", "video"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			...
			keywords: &["cinéma", "film", "projecteur", "projecteur cinématographique", "vidéo"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			...
			keywords: &["cineama", "físeán", "pictiúrlann", "scannán", "teilgeoir", "teilgeoir scannáin"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["וידאו", "מסרטה", "מקרן", "סרט", "קולנוע"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["film", "filmski projektor", "kino", "projektor", "video", "videozapis"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("filmvetítő"),
			keywords: &["film", "filmvetítő", "mozi", "vetítő", "vetítőgép", "videó"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
			tts:      Some("ժապավենային պրոյեկտոր"),
			keywords: &["ժապավեն", "ժապավենային պրոյեկտոր", "կինո", "պրոյեկտոր", "վիդեո", "ֆիլմ"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["bíómynd", "kvikmynd", "kvikmyndalist", "myndband", "sýningarvél"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("映写機"),
			keywords: &["ビデオ", "フィルム", "プロジェクター", "ムービー", "映写機", "映画"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["ვიდეო", "კინო", "კინოთეატრი", "კინოპროექტორი", "პროექტორი", "ფილმი"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
		...
		crate::Annotation {
			lang:     "kk",
			tts:      Some("кинопроектор"),
			keywords: &["бейне", "бейнефильм", "видео", "кино", "кинопроектор", "проектор", "фильм"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಫ\u{cbf}ಲ\u{ccd}ಮ\u{ccd} ಪ\u{ccd}ರ\u{cca}ಜ\u{cc6}ಕ\u{ccd}ಟರ\u{ccd}"),
			keywords: &[
				"ಚಲನಚ\u{cbf}ತ\u{ccd}ರ",
				"ಪ\u{ccd}ರ\u{cca}ಜ\u{cc6}ಕ\u{ccd}ಟರ\u{ccd}",
				"ಫ\u{cbf}ಲ\u{ccd}ಮ\u{ccd} ಪ\u{ccd}ರ\u{cca}ಜ\u{cc6}ಕ\u{ccd}ಟರ\u{ccd}",
				"ಮ\u{cc2}ವ\u{cbf}",
				"ಮ\u{cc2}ವ\u{cc0}",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("영화 프로젝터"),
			keywords: &["무비", "비디오", "시네마", "영사기", "영화", "프로젝터"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["filmas", "filmų projektorius", "kinas", "projektorius", "vaizdo įrašas"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("filmu projektors"),
			keywords: &["filma", "filmu projektors", "kino", "projektors", "video"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["film", "filmat", "projettur", "projettur tal-filmati", "vidjo", "ċinema"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			...
			keywords: &["Fim", "Fím Projẹ\u{301}ktọ", "Múvi", "Projẹ\u{301}ktọ", "Sinẹmá", "Vídio"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("projektor filmowy"),
			keywords: &["film", "filmowy", "kino", "projekcja", "projektor"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
			tts:      Some("د فلم پروجیکټر"),
			keywords: &["د فلم پروجیکټر", "سنيما", "فلم", "مووي", "ويډيو", "پروجيکټر"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		crate::Annotation {
			...
			keywords: &["cine", "pelicula", "pelikula", "proyector", "proyector cinepaq", "video"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-698"), keywords: &["E10-698"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("кинопроектор"),
		...
		crate::Annotation {
			...
			keywords: &["borojektar", "borojektarka filimada", "fiidiyow", "filim", "sinimoo"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			...
			keywords: &["биоскоп", "видео", "прojeктoр", "филм"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("filmski projektor"),
			keywords: &["bioskop", "film", "projektor", "video"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			...
			keywords: &["filamu", "projekta", "projekta ya filamu", "sinema", "video"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		crate::Annotation {
			...
			keywords: &[
				"ஃபிலிம\u{bcd}",
				"சினிம\u{bbe}",
				"தியேட\u{bcd}டர\u{bcd}",
				"திரைப\u{bcd}படம\u{bcd}",
				"பிலிம\u{bcd}",
				"புரொஜக\u{bcd}டர\u{bcd}",
		...
		crate::Annotation {
			...
			keywords: &["видео", "кино", "проектор", "проектори филм", "синамо", "филм"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ፊልም ፕሮጀክተር"),
			keywords: &["ሲነማ", "ቪዲዮ", "ፊልም", "ፕሮጀክተር"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("film proýektory"),
			keywords: &["film", "film proýektory", "kino", "kinoteatr", "proýektor", "wideo"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
		...
		crate::Annotation {
			...
			keywords: &["відео", "кіно", "кінопроектор", "перегляд", "проектор", "фільм"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["máy chiếu", "máy chiếu phim", "phim", "rạp chiếu phim", "video"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			...
			keywords: &["ifilimu", "imuvi", "iprojektha", "iprojektha yefilimu", "isinema", "ividiyo"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("è\u{329}rɔ agbéwòrán jáde"),
			keywords: &[
				"fídíò",
				"fíìmù",
				"pìròjɛ\u{301}kítɔ\u{300}",
				"sínímà",
				"è\u{329}rɔ agbéwòrán jáde",
			],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("電影放映機"),
			keywords: &["影片", "放映機", "電影", "電影放映機"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["投影機", "放映機", "電影", "電影放映機", "電影院"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const CLAPPER_BOARD: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ক\u{9cd}লেপ\u{9be}ৰ", "ক\u{9cd}লেপ\u{9be}ৰ ব’ৰ\u{9cd}ড", "চলচিত\u{9cd}ৰ"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang: "bg", tts: Some("клапа"), keywords: &["клапа", "филмова"]
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("klek"), keywords: &["film", "klek"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			lang:     "es",
			tts:      Some("claqueta"),
			keywords: &["cine", "claqueta", "claqueta de cine", "entretenimiento", "película"],
		},
		#[cfg(feature = "es_419")]
		...
		#[cfg(feature = "eu")]
		crate::Annotation { lang: "eu", tts: Some("klaketa"), keywords: &["film", "klaketa"] },
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("کلاکت"),
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("clapper board"),
			keywords: &["action", "board", "clapper", "direk", "palabas", "pelikula", "sine"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		#[cfg(feature = "hr")]
		crate::Annotation { lang: "hr", tts: Some("klapa"), keywords: &["film", "klapa"] },
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("csapó"),
			keywords: &["csapó", "film", "filmfelvétel", "filmforgatás", "forgatás", "mozi"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "km",
			tts:      Some("ក\u{17d2}តារធ\u{17d2}វើជាសញ\u{17d2}ញាពេលចាប\u{17cb}ផ\u{17d2}តើមថតក\u{17bb}ន"),
			keywords: &[
		...
		crate::Annotation {
			...
			keywords: &["क\u{94d}ल\u{947}पर", "क\u{94d}ल\u{947}पर बोर\u{94d}ड", "म\u{941}व\u{94d}ही"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["ຮ\u{eb9}ບເງ\u{ebb}າ", "ແຄລບເປ\u{eb5}", "ແຜ\u{ec8}ນແຄລບເປ\u{eb5}"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["ക\u{d4d}ല\u{d3e}പ\u{d4d}പർ ബോർഡ\u{d4d}", "ഷ\u{d42}ട\u{d4d}ടിംഗ\u{d4d}", "സിനിമ"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation { lang: "mn", tts: Some("кадр"), keywords: &["кадр", "кино"] },
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		crate::Annotation {
			...
			keywords: &["action", "film", "filming", "filmklappar", "klappar", "underhaldning"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-364"), keywords: &["E10-364"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["aksion", "film", "tabelë dublimi", "tabelë dublimi e skenës"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &["filamu", "ubao wa kuanzisha matukio wakati wa kutengeneza filamu"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("papapasi"), keywords: &["papapasi"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang: "ug", tts: Some("چىك-چاك"), keywords: &["كىنو", "چىك-چاك"]
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("klapet"), keywords: &["filmu", "klapet"] },
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("拍板"), keywords: &["拍板", "電影"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("拍板"), keywords: &["拍板", "电影"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("场记板"),
...
pub const TELEVISION: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "cy")]
		crate::Annotation { lang: "cy", tts: Some("teledu"), keywords: &["fideo", "teledu"] },
		#[cfg(feature = "da")]
		crate::Annotation { lang: "da", tts: Some("tv"), keywords: &["fjernsyn", "tv"] },
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
			tts:      Some("Fernseher"),
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("tiliẓri"), keywords: &["tiliẓri"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("теледидар"),
		...
		#[cfg(feature = "kl")]
		crate::Annotation { lang: "kl", tts: Some("tv"), keywords: &["fjernsyn", "tv"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
			tts:      Some("ទ\u{17bc}រទស\u{17d2}សន\u{17cd}"),
			keywords: &["TV", "ទ\u{17bc}រទស\u{17d2}សន\u{17cd}", "វ\u{17b8}ដេអ\u{17bc}"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			...
			keywords: &["टीव\u{94d}ही", "ट\u{947}लिव\u{94d}हिजन", "द\u{942}रदर\u{94d}शन"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["ଟ\u{b3f}ଭ\u{b3f}", "ଟେଲ\u{b3f}ଭ\u{b3f}ଜନ\u{b4d}", "ଦ\u{b42}ରଦର\u{b4d}ଶନ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-695"), keywords: &["E10-695"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("телевизор"),
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("televīsone"), keywords: &["televīsone"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("televizyon"),
		...
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("tele"), keywords: &["tele", "wideo"] },
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("電視機"), keywords: &["影片", "電視機"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("电视机"),
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("電視"), keywords: &["電視"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const CAMERA: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("kamera"),
			keywords: &["foto", "kamera", "kiek", "reis", "selfie", "toerisme", "video"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("càmera"),
			keywords: &["autofoto", "càmera", "foto", "instagram", "instantània", "viatge", "vídeo"],
		},
		#[cfg(feature = "ccp")]
		crate::Annotation {
			lang: "ccp", tts: Some("𑄇𑄬𑄟𑄬𑄢"), keywords: &["𑄇𑄬𑄟𑄬𑄢"]
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		#[cfg(feature = "cy")]
		crate::Annotation { lang: "cy", tts: Some("camera"), keywords: &["camera", "fideo"] },
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("kamera"),
		...
		crate::Annotation {
			...
			keywords: &["cámara", "cámara de fotos", "cámara fotográfica", "foto", "fotografía", "fotos"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		#[cfg(feature = "eu")]
		crate::Annotation { lang: "eu", tts: Some("kamera"), keywords: &["bideo", "kamera"] },
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("دوربین"),
		...
		crate::Annotation {
			lang:     "ga",
			tts:      Some("ceamara"),
			keywords: &["ceamara", "físeán", "grianghraf", "grianghrafadán", "instagram"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation { lang: "gd", tts: Some("camara"), keywords: &["camara", "video"] },
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
			tts:      Some("cámara de fotos"),
		...
		#[cfg(feature = "id")]
		crate::Annotation { lang: "id", tts: Some("kamera"), keywords: &["kamera", "video"] },
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("igwefòto"),
		...
		#[cfg(feature = "ja")]
		crate::Annotation { lang: "ja", tts: Some("カメラ"), keywords: &["カメラ", "写真"] },
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("kamera"),
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("Takamiṛat"), keywords: &["Takamiṛat"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("камера"),
		...
		#[cfg(feature = "kl")]
		crate::Annotation { lang: "kl", tts: Some("kamera"), keywords: &["kamera", "video"] },
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang: "ky", tts: Some("камера"), keywords: &["видео", "камера"]
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang: "mn", tts: Some("камер"), keywords: &["видео", "камер"]
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("kamera"), keywords: &["kamera", "vidjo"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("camera"),
			keywords: &["camera", "fotocamera", "fotograferen", "selfie", "snap", "video"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		...
		crate::Annotation {
			...
			keywords: &["ਕ\u{a48}ਮਰਾ", "ਤਸਵੀਰ", "ਫ\u{a3c}\u{a4b}ਟ\u{a4b}", "ਵੀਡੀਓ", "ਸ\u{a48}ਲਫੀ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			...
			keywords: &["aparat", "fotografia", "fotograficzny", "robić zdjęcie", "wideo", "zdjęcie"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang: "ps", tts: Some("کامره"), keywords: &["ويډيو", "کامره"]
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		crate::Annotation {
			...
			keywords: &["câmara", "foto", "fotografia", "máquina fotográfica", "selfie", "vídeo"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation { lang: "qu", tts: Some("camara"), keywords: &["camara", "video"] },
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-692"), keywords: &["E10-692"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		#[cfg(feature = "rw")]
		crate::Annotation { lang: "rw", tts: Some("kamera"), keywords: &["kamera", "videwo"] },
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("ڪئميرا"), keywords: &["ويڊيو", "ڪئميرا"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		#[cfg(feature = "sq")]
		crate::Annotation { lang: "sq", tts: Some("kamerë"), keywords: &["kamerë", "video"] },
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("фотоапарат"),
		...
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		crate::Annotation { lang: "sv", tts: Some("kamera"), keywords: &["kamera", "video"] },
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
			tts:      Some("kamera"),
		...
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang: "tg", tts: Some("камера"), keywords: &["видео", "камера"]
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		#[cfg(feature = "tk")]
		crate::Annotation { lang: "tk", tts: Some("kamera"), keywords: &["kamera", "wideo"] },
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("faitā"), keywords: &["faitā"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang: "ug", tts: Some("كامېرا"), keywords: &["سىن", "كامېرا"]
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("фотоапарат"),
			keywords: &["відео", "знімки", "камера", "на згадку", "фото", "фотоапарат", "фотограф"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("相機"), keywords: &["影片", "相機"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("相机"), keywords: &["影片", "相机"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("相机"),
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("相機"), keywords: &["相機"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const CAMERA_WITH_FLASH: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["flits", "foto", "kamera", "kamera met flits", "video", "videokamera"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["fleş işığı olan kamera", "işıq", "işıqlı kamera", "kamera", "video"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["lucʼheder", "lucʼhskeudennerez", "lucʼhskeudennerez gant lucʼheder", "video"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["aparát", "blesk", "fotoaparát s bleskem", "fotografický", "foťák", "video"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			...
			keywords: &["βίντεο", "βιντεοκάμερα", "φλας", "φωτογραφική μηχανή με φλας"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["ceamara", "ceamara le splanc", "físeán", "grianghrafadán", "splanc"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["הבזק", "לצלם", "מבזק", "מצלמה", "מצלמה עם פלאש", "פלאש", "צילום"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["bljeskalica", "fotoaparat", "fotoaparat s bljeskalicom", "kamera", "video"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("fényképező vakuval"),
			keywords: &["fényképező vakuval", "fényképezőgép", "kamera", "vaku", "videó"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
			tts:      Some("ֆոտոապարատ լուսաթարթիչով"),
			keywords: &["լուսաթարթիչ", "վիդեո", "ֆոտոապարատ", "ֆոտոապարատ լուսաթարթիչով"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["kamera", "kamera mawa lampu jepret", "lampu jepret", "vidio"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &["Blëtz", "Flash", "Fotoapparat", "Fotoapparat mat Blëtz", "Kamera", "Video"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["blykstė", "fotoaparatas", "fotoaparatas su blykste", "vaizdo įrašas"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("fotokamera ar zibspuldzi"),
			keywords: &["fotoaparāts", "fotokamera", "fotokamera ar zibspuldzi", "kamera", "zibspuldze"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
			tts:      Some("pūwhakaahua whai hikohiko"),
			keywords: &["ataata", "hikohiko", "pūwhakaahua", "pūwhakaahua whai hikohiko"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("фотоапарат со блиц"),
			keywords: &["блиц", "видео", "камера", "камера со блиц", "фотоапарат", "фотоапарат со блиц"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["camera", "camera met flitser", "flitser", "fotograferen", "video"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		...
		crate::Annotation {
			...
			keywords: &["Flash", "Kámẹ\u{301}ra", "Kámẹ\u{301}ra Wé Gẹ\u{301}t Flash", "Vídio"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-693"), keywords: &["E10-693"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["bliskavica", "fotoaparat", "fotoaparat z bliskavico", "slika", "video"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("kamarad khashaafad leh"),
			keywords: &["fiidiyow", "kamarad", "kamarad khashaafad leh", "khashaafad"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
		...
		crate::Annotation {
			...
			keywords: &["กล\u{e49}อง", "กล\u{e49}องเป\u{e34}ดแฟลช", "ว\u{e34}ด\u{e35}โอ", "แฟลช"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		crate::Annotation {
			...
			keywords: &["відео", "камера", "спалах", "фото", "фотоапарат зі спалахом"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["flash", "nataalukaay", "nataalukaay bu ànd ak flaas", "wideo"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			...
			keywords: &["fídíò", "fílásì", "kámẹ\u{301}rà", "kámẹ\u{301}rà pẹlu filaṣi"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("kámɛ\u{301}rà pɛlu filashi"),
			keywords: &["fídíò", "fílásì", "kámɛ\u{301}rà", "kámɛ\u{301}rà pɛlu filashi"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("开闪光灯的相机"),
			keywords: &["带闪光灯的相机", "开闪光灯的相机", "拍照", "相机", "闪光灯", "闪光灯打开"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("開咗閃光燈嘅相機"),
			keywords: &["影片", "影相", "照", "相機", "相片", "閃光燈", "開咗閃光燈嘅相機", "開閃光燈"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const VIDEO_CAMERA: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["kamera", "kameraopnemer", "nostalgie", "video", "videokamera"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["cámara", "grabación", "grabar", "película", "video", "videocámara"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			...
			keywords: &["bidiyo", "hoto", "kyamara", "kyamarar bidiyo", "ɗaukar hoto"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("ビデオカメラ"),
			keywords: &["カメラ", "ビデオ", "ビデオカメラ", "ムービー", "動画", "録画"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["កាមេរ\u{17c9}ា", "កាមេរ\u{17c9}ាថតវ\u{17b8}ដេអ\u{17bc}", "វ\u{17b8}ដេអ\u{17bc}"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			...
			keywords: &["ກ\u{ec9}ອງ", "ກ\u{ec9}ອງວ\u{eb4}ດ\u{eb5}ໂອ", "ວ\u{eb4}ດ\u{eb5}ໂອ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			...
			keywords: &["क\u{945}म\u{947}रा", "व\u{94d}हिडिओ", "व\u{94d}हिडिओ क\u{945}म"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["ਕ\u{a48}ਮਕ\u{a4b}ਰਡਰ", "ਕ\u{a48}ਮਰਾ", "ਤਸਵੀਰ", "ਵੀਡੀਓ", "ਵੀਡੀਓ ਕ\u{a48}ਮ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang: "ps", tts: Some("ویډیو کامره"), keywords: &["ویډیو کامره"]
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-694"), keywords: &["E10-694"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("видеокамера"),
		...
		crate::Annotation {
			...
			keywords: &["කැමර\u{dcf}ව", "ව\u{dd3}ඩ\u{dd2}යෝ කැමර\u{dcf}ව", "ව\u{dd3}ඩ\u{dd2}යෝව"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			...
			keywords: &["กล\u{e49}อง", "กล\u{e49}องว\u{e34}ด\u{e35}โอ", "ว\u{e34}ด\u{e35}โอ"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("faitā vitiō"), keywords: &["faitā vitiō"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("video kamera"),
...
pub const VIDEOCASSETTE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["VHS", "band", "kasset", "ouskool", "vhs", "video", "videokasset"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["VHS", "kazeta", "pásek", "páska", "retro", "vhs", "video", "videokazeta"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			...
			keywords: &["vhs", "βίντεο", "βιντεοκασέτα", "κασέτα", "παλιομοδίτικος", "παραδοσιακός"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["cassette vidéo", "magnétoscope", "vhs", "vidéocassette", "vintage"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["bidiyo", "kaset", "kaset na bidiyo", "kaset ɗin bidiyo", "vhs"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "hy",
			tts:      Some("տեսաերիզ"),
			keywords: &["vcr", "vhs", "երիզ", "հին", "տեսա", "տեսաերիզ", "տեսապարկուճ"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["VHS", "cassetta", "registrare", "video", "videocassetta", "vintage"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
			tts:      Some("ビデオテープ"),
			keywords: &["VHS", "テープ", "ビデオ", "ビデオカセット", "ビデオテープ", "動画"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &["ກະແຊ\u{eb1}ດ", "ກະແຊ\u{eb1}ດວ\u{eb4}ດ\u{eb5}ໂອ", "ວ\u{eb4}ດ\u{eb5}ໂອ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
			tts:      Some("vaizdo įrašų kasetė"),
			keywords: &["VHS", "juosta", "kasetė", "senovinė", "vaizdo įrašas", "vaizdo įrašų kasetė"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
		...
		crate::Annotation {
			...
			keywords: &["ट\u{947}प", "व\u{94d}हिएचएस", "व\u{94d}हिडिओ", "व\u{94d}हिडिओक\u{945}स\u{947}ट"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["ट\u{947}प", "भिएचएस", "भिडियो", "भिडियो क\u{94d}यास\u{947}ट"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			...
			keywords: &["cassete", "cassete de vídeo", "fita", "vhs", "videocassete", "vídeo"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-697"), keywords: &["E10-697"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("видеокассета"),
		...
		crate::Annotation {
			...
			keywords: &["kanda", "kaseti ya video", "kaseti ya zamani", "vhs", "video"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &["eski maktab", "tasma", "vhs", "video", "videokasseta", "videol videokasseta"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
...
pub const MAGNIFYING_GLASS_TILTED_LEFT: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["መሣሪያ", "መነጽር", "ማጉያ", "አጉሊ መነጽር", "ግራ ጠቋሚ ማጉያ መነጽር", "ፍለጋ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("عدسة مكبرة اتجاه اليسار"),
			keywords: &[
				"بحث",
				"تكبير",
				"عدسة",
		...
		crate::Annotation {
			...
			keywords: &["лупа павернута ўлева", "павелічэнне", "пошук", "шкло", "інструмент"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("наклонена наляво лупа"),
			keywords: &["инструмент", "лаборатория", "лупа", "наклонена наляво лупа", "наука", "търсене"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["alat", "povećalo", "povećalo okrenuto ulijevo", "staklo", "traženje"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			...
			keywords: &[
				...
				"laboratori",
				"lent",
				"lent d’augment cap a l’esquerra",
				"lupa",
		...
		crate::Annotation {
			...
			keywords: &["ᎠᎦᏍᎦᏂ ᎠᎦᏙᏗ ᎠᏔᏃᎯᏍᏗᏍᎩ ᎤᎸᏌᏗ", "ᎠᏔᏃᎯᏍᏗᏍᎩ", "ᎠᏱᏍᏗᎢ", "ᎤᎸᏌᏗ", "ᎬᏔᏂᏓᏍᏗ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["chwilio", "chwyddwydr", "chwyddwydr yn wynebu’r chwith", "gwydr", "offeryn"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			lang:     "de_CH",
			tts:      Some("↑↑↑"),
			keywords: &["Lupe nach links", "Suche", "Vergrösserungsglas"],
		},
		#[cfg(feature = "el")]
		crate::Annotation {
			lang:     "el",
		...
		crate::Annotation {
			...
			keywords: &["otsi", "suurendusklaas", "tööriist", "vasakule kallutatud luup"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("ezkerrera begira dagoen lupa"),
			keywords: &["beira", "bilatu", "ezkerrera begira dagoen lupa", "lupa", "tresna"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("ذره\u{200c}بین روبه\u{200c}چپ"),
			keywords: &["ابزار", "جستجو", "ذره\u{200c}بین", "ذره\u{200c}بین روبه\u{200c}چپ", "شیشه"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("suurennuslasi vasemmalle"),
			keywords: &["etsi", "haku", "lasi", "suurennuslasi", "suurennuslasi vasemmalle", "työkalu"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["lesiglas", "luppur", "luppur á skák til vinstru", "sjóneyka", "størkingarglas"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			lang:     "fr_CA",
			tts:      Some("↑↑↑"),
			keywords: &["agrandir", "loupe", "loupe orientée à gauche", "outil", "rechercher"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("gloine formhéadúcháin ar chlé"),
			keywords: &["gloine formhéadúcháin ar chlé", "uirlis"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["בלש", "זכוכית", "זכוכית מגדלת נוטה שמאלה", "חיפוש", "מגדלת", "שרלוק"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["alat", "povećalo", "povećalo nagnuto ulijevo", "staklo", "traženje"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("balra mutató nagyító"),
			keywords: &["balra mutató nagyító", "keresés", "lencse", "nagyító", "nyomozó"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
			tts:      Some("ձախ ուղղված խոշորացույց"),
			keywords: &["ապակի", "գործիք", "խոշորացնող", "ձախ ուղղված խոշորացույց", "որոնել"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("kaca pembesar arah kiri"),
			keywords: &["alat", "kaca", "kaca pembesar arah kiri", "pembesar", "penelusuran"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ènyò mbawanye na-atụga akaekpe"),
			keywords: &["chọọ", "mbawanye", "ngwaọrụ", "ènyò", "ènyò mbawanye na-atụga akaekpe"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("stækkunargler sem vísar til vinstri"),
			keywords: &["leita", "stækkunargler", "stækkunargler sem vísar til vinstri"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("虫眼鏡左"),
			keywords: &["ルーペ", "拡大鏡", "検索", "科学", "虫めがね", "虫眼鏡左"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("suryakantha minger ngiwa"),
			keywords: &["kaca", "nggedhekkake", "nggoleki", "pranti", "suryakantha minger ngiwa"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &["검색", "검색하기", "과학", "도구", "연구실", "왼쪽으로 향한 돋보기", "유리"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["Glas", "Lupp", "Utensil", "no lénks geriicht Lupp", "sichen"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["lupa", "meklēšana", "pa kreisi vērsta lupa", "palielināt", "zinātne"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
			tts:      Some("kārāhe whārahi anga mauī"),
			keywords: &["karāhe", "kārāhe whārahi anga mauī", "rapu", "utauta", "whārahi"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["зүүн", "зүүн тийш хазайлгасан томруулагч шил", "томруулагч", "шил"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			...
			keywords: &[
				"काच",
				"डावीकड\u{947}-वाकल\u{947}ली",
				"डावीकड\u{947}-वाकल\u{947}ल\u{947} भि\u{902}ग",
		...
		crate::Annotation {
			...
			keywords: &["forstørring", "forstørringsglas mot venstre", "glas", "lupe", "søk"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["اوزار", "وڈا کرنا", "کھبے ـ اشارہ کردا وڈا کرن آلا شیشہ", "کھوج لانا", "گلاس"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Magnifáyín Glas Wé Bẹ\u{301}nd Lẹft"),
			keywords: &["Glas", "Magnifáyin", "Magnifáyín Glas Wé Bẹ\u{301}nd Lẹft", "Sach", "Tul"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("lupa pochylona w lewo"),
			keywords: &["detektyw", "lupa", "pochylona", "skierowana", "szukaj", "w lewo"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
			tts:      Some("لويوونکې ښيښه چپ اړخ ته کږه"),
			keywords: &["اله", "لويوونکې", "لويوونکې ښيښه چپ اړخ ته کږه", "لټون", "ښيښه"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		crate::Annotation {
			lang:     "qu",
			tts:      Some("lupa lluqiman"),
			keywords: &["chuya", "llamkana", "lupa", "lupa lluqiman", "maskay"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-713"), keywords: &["E10-713"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["gutubura", "igikoresho", "ikirahuri", "ishakisha", "rupe ireba ibumoso"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("ميگنيفائينگ کاٻي پاسي مڙيل شيشو"),
			keywords: &["اوزار", "شيشو", "ميگنيفائينگ", "ميگنيفائينگ کاٻي پاسي مڙيل شيشو", "ڳولڻ"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["doľava naklonená lupa", "hľadanie", "lupa", "nástroj", "priblíženie"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["алат", "лупа", "налево", "наука", "стaклo", "трaжeњe"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("лупа усмјерена налијево"),
			keywords: &["aлaт", "лупа", "лупа усмјерена налијево", "стaклo", "трaжeњe"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("lupa usmerena nalevo"),
			keywords: &["alat", "lupa", "nalevo", "nauka", "staklo", "traženje"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("lupa usmjerena nalijevo"),
			keywords: &["alat", "lupa", "lupa usmjerena nalijevo", "staklo", "traženje"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"టూల\u{c4d}",
				"భూతద\u{c4d}దం",
				"మగ\u{c4d}న\u{c3f}ఫయ\u{c3f}ంగ\u{c4d}",
				"ల\u{c4d}య\u{c3e}బ\u{c4d}",
				"శ\u{c4b}ధన చ\u{c3f}హ\u{c4d}నం",
				"స\u{c46}ర\u{c4d}చ\u{c4d}",
		...
		crate::Annotation {
			...
			keywords: &["асбоб", "бузургкунӣ", "пурбини ба тарафи чап ишоракунанда", "шиша", "ҷустуҷӯ"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("መጉልሒ ብርጭቆ ንጸጋም ተገልቢጡ"),
			keywords: &["መሳርሒ", "ምዕባይ", "ምድላይ", "ሳይንስ", "ቤተ ፈተነ", "ብርጭቆ", "ተገልቢጡ", "ንጸጋም ዘመልክት", "ጸጋም"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["ئىزدەش", "ئەينەك", "سولغا قارىغان چوڭايتقۇچ", "قورال", "چوڭايتقۇچ"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		crate::Annotation {
			...
			keywords: &["آلہ", "اشارہ", "بائیں", "بائیں اشارہ کرتا محدب عدسہ", "سمت", "عدسہ", "محدب"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			...
			keywords: &["dụng cụ", "kính", "kính phóng đại nghiêng sang trái", "phóng đại", "tìm kiếm"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("gilasi itɔka-osi amohun tobi"),
			keywords: &[
				"díígí",
...
pub const MAGNIFYING_GLASS_TILTED_RIGHT: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "ar",
			tts:      Some("عدسة مكبرة اتجاه اليمين"),
			keywords: &[
				"اداة",
				"بحث",
				"عدسة",
		...
		crate::Annotation {
			...
			keywords: &["alət", "axtarmaq", "böyüdücü", "sağa yönəlmiş böyüdücü şüşə", "şüşə"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("лупа павернута ўправа"),
			keywords: &["лупа павернута ўправа", "павелічэнне", "пошук", "шкло", "інструмент"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
		...
		crate::Annotation {
			...
			keywords: &["alat", "povećalo", "povećalo okrenuto udesno", "staklo", "traženje"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			...
			keywords: &["chwilio", "chwyddo", "chwyddwydr yn wynebu’r dde", "gwydr", "offeryn"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
		...
		crate::Annotation {
			...
			keywords: &["Lupe", "Lupe nach rechts", "Suche", "Vergrößerungsglas"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation {
			lang:     "de_CH",
			tts:      Some("↑↑↑"),
			keywords: &["Lupe nach rechts", "Suche", "Vergrösserungsglas"],
		},
		#[cfg(feature = "el")]
		crate::Annotation {
			lang:     "el",
		...
		crate::Annotation {
			...
			keywords: &["otsi", "paremale kallutatud luup", "suurendusklaas", "tööriist"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("eskuinera begira dagoen lupa"),
			keywords: &["beira", "bilatu", "eskuinera begira dagoen lupa", "lupa", "tresna"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("ذره\u{200c}بین روبه\u{200c}راست"),
			keywords: &["ابزار", "جستجو", "ذره\u{200c}بین", "ذره\u{200c}بین روبه\u{200c}راست", "شیشه"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("suurennuslasi oikealle"),
			keywords: &["etsi", "haku", "lasi", "suurennuslasi", "suurennuslasi oikealle", "työkalu"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["lesiglas", "luppur", "luppur á skák til høgru", "sjóneyka", "størkingarglas"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			lang:     "fr_CA",
			tts:      Some("↑↑↑"),
			keywords: &["agrandir", "loupe", "loupe orientée à droite", "outil", "rechercher"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			...
			keywords: &["בלש", "זכוכית", "זכוכית מגדלת נוטה ימינה", "חוקר", "חיפוש", "מגדלת"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["alat", "povećalo", "povećalo nagnuto udesno", "staklo", "traženje"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["ապակի", "աջ ուղղված խոշորացույց", "գործիք", "խոշորացնող", "որոնել"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("kaca pembesar arah kanan"),
			keywords: &["alat", "kaca", "kaca pembesar arah kanan", "pembesar", "penelusuran"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ènyò mbawanye na-atụga akanri"),
			keywords: &["chọọ", "mbawanye", "ngwaọrụ", "ènyò", "ènyò mbawanye na-atụga akanri"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("虫眼鏡右"),
			keywords: &["ルーペ", "拡大鏡", "検索", "科学", "虫めがね", "虫眼鏡右"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("suryakantha minger nengen"),
			keywords: &["kaca", "nggedhekkake", "nggoleki", "pranti", "suryakantha minger nengen"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			...
			keywords: &["оң жақты көрсететін үлкейткіш әйнек", "шыны", "іздеу", "құрал", "үлкейту"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ಬಲಕ\u{ccd}ಕ\u{cc6} ತ\u{ccb}ರ\u{cbf}ಸುವ ಭ\u{cc2}ತಗನ\u{ccd}ನಡ\u{cbf}",
		...
		crate::Annotation {
			...
			keywords: &["검색", "검색하기", "과학", "도구", "돋보기", "오른쪽으로 향한 돋보기"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["Glas", "Lupp", "Utensil", "no riets geriicht Lupp", "sichen"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["didinimo", "didinimo stiklas į dešinę", "paieška", "stiklas", "įrankis"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("pa labi vērsta lupa"),
			keywords: &["lupa", "meklēšana", "pa labi vērsta lupa", "palielināt", "rīks"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
			tts:      Some("karāhe whārahi anga matau"),
			keywords: &["karāhe", "karāhe whārahi anga matau", "rapu", "utauta", "whārahi"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["баруун", "баруун тийш хазайлгасан томруулагч шил", "томруулагч", "шил"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			...
			keywords: &[
				"उजवीकड\u{947}-वाकल\u{947}ली",
				"उजवीकड\u{947}-वाकल\u{947}ल\u{947} भि\u{902}ग",
		...
		crate::Annotation {
			...
			keywords: &["forstørring", "forstørringsglas mot høgre", "glas", "lupe", "søk"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["اوزار", "سجے ـ اشارہ کردا وڈا کرن آلا شیشہ", "وڈا کرنا", "کھوج لانا", "گلاس"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Magnifáyín Glas Wé Bẹ\u{301}nd Rait"),
			keywords: &["Glas", "Magnifáyin", "Magnifáyín Glas Wé Bẹ\u{301}nd Rait", "Sach", "Tul"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("lupa pochylona w prawo"),
			keywords: &["detektyw", "lupa", "pochylona", "skierowana", "szukaj", "w prawo"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			lang:     "qu",
			tts:      Some("lupa pañaman"),
			keywords: &["chuya", "llamkana", "lupa", "lupa pañaman", "lupa pañawan", "maskay"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-714"), keywords: &["E10-714"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["gutubura", "igikoresho", "ikirahuri", "ishakisha", "rupe ireba iburyo"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("ميگنيفائينگ ساڄي پاسي مڙيل شيشو"),
			keywords: &["اوزار", "شيشو", "ميگنيفائينگ", "ميگنيفائينگ ساڄي پاسي مڙيل شيشو", "ڳولڻ"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["алат", "лупа", "надесно", "наука", "стaклo", "трaжeњe"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("лупа усмјерена надесно"),
			keywords: &["aлaт", "лупа", "лупа усмјерена надесно", "стaклo", "трaжeњe"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("lupa usmerena nadesno"),
			keywords: &["alat", "lupa", "nadesno", "nauka", "staklo", "traženje"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("lupa usmjerena nadesno"),
			keywords: &["alat", "lupa", "lupa usmjerena nadesno", "staklo", "traženje"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &["glasi", "kioo cha ukuzaji kinachoelekeza kulia", "kukuza", "tafuta", "zana"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &["асбоб", "бузургкунӣ", "пурбини ба тарфи рост ишоракунанда", "шиша", "ҷустуҷӯ"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			...
			keywords: &["ئوڭغا قارىغان چوڭايتقۇچ", "ئىزدەش", "ئەينەك", "قورال", "چوڭايتقۇچ"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		crate::Annotation {
			...
			keywords: &["آلہ", "اشارہ", "دائیں", "دائیں اشارہ کرتا محدب عدسہ", "سمت", "عدسہ", "محدب"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("gilasi itɔka-ɔtun amohun tobi"),
			keywords: &[
				"díígí",
...
pub const CANDLE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation { lang: "am", tts: Some("ሻማ"), keywords: &["ሻማ", "ብርሃን"] },
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("شمعة"),
		...
		#[cfg(feature = "as")]
		crate::Annotation { lang: "as", tts: Some("মম"), keywords: &["পোহৰ", "মম"] },
		#[cfg(feature = "az")]
		crate::Annotation { lang: "az", tts: Some("şam"), keywords: &["işıq", "şam"] },
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("свечка"),
		...
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang: "bg", tts: Some("свещ"), keywords: &["светлина", "свещ"]
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("svíčka"),
			keywords: &["oheň", "plamen", "plamínek", "romantika", "svícen", "svíčka", "světlo"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		#[cfg(feature = "de")]
		crate::Annotation { lang: "de", tts: Some("Kerze"), keywords: &["Kerze", "Licht"] },
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation { lang: "el", tts: Some("κερί"), keywords: &["κερί", "φως"] },
		#[cfg(feature = "en")]
		crate::Annotation { lang: "en", tts: Some("candle"), keywords: &["candle", "light"] },
		#[cfg(feature = "en_AU")]
		crate::Annotation { lang: "en_AU", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_CA")]
		crate::Annotation { lang: "en_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		...
		crate::Annotation { lang: "en_IN", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es")]
		crate::Annotation { lang: "es", tts: Some("vela"), keywords: &["luz", "vela"] },
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
		...
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation { lang: "et", tts: Some("küünal"), keywords: &["küünal", "valgus"] },
		#[cfg(feature = "eu")]
		crate::Annotation { lang: "eu", tts: Some("kandela"), keywords: &["argi", "kandela"] },
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("شمع"),
		...
		#[cfg(feature = "he")]
		crate::Annotation { lang: "he", tts: Some("נר"), keywords: &["אור", "להבה", "נר"] },
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		#[cfg(feature = "hy")]
		crate::Annotation { lang: "hy", tts: Some("մոմ"), keywords: &["լույս", "մոմ"] },
		#[cfg(feature = "id")]
		crate::Annotation { lang: "id", tts: Some("lilin"), keywords: &["cahaya", "lilin"] },
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		#[cfg(feature = "is")]
		crate::Annotation { lang: "is", tts: Some("kerti"), keywords: &["kerti", "ljós"] },
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("candela"),
		...
		#[cfg(feature = "jv")]
		crate::Annotation { lang: "jv", tts: Some("lilin"), keywords: &["cahya", "lilin"] },
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("სანთელი"),
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("tacemmuεt"), keywords: &["tacemmuεt"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang: "kk", tts: Some("майшам"), keywords: &["майшам", "шам"]
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "km",
			tts:      Some("ទៀន"),
			keywords: &["ទៀន", "ពន\u{17d2}ល\u{17ba}", "ភ\u{17d2}លើងទៀនភ\u{17d2}ល\u{17b8}"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("양초"), keywords: &["빛", "양초", "캔들"] },
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		#[cfg(feature = "ky")]
		crate::Annotation { lang: "ky", tts: Some("шам"), keywords: &["жарык", "шам"] },
		#[cfg(feature = "lb")]
		crate::Annotation { lang: "lb", tts: Some("Käerz"), keywords: &["Käerz", "Luucht"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
			tts:      Some("ທຽນ"),
		...
		#[cfg(feature = "lt")]
		crate::Annotation { lang: "lt", tts: Some("žvakė"), keywords: &["šviesa", "žvakė"] },
		#[cfg(feature = "lv")]
		crate::Annotation { lang: "lv", tts: Some("svece"), keywords: &["svece", "uguns"] },
		#[cfg(feature = "mi")]
		crate::Annotation { lang: "mi", tts: Some("kānara"), keywords: &["kānara", "rama"] },
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang: "mk", tts: Some("свеќа"), keywords: &["светло", "свеќа"]
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		#[cfg(feature = "mn")]
		crate::Annotation { lang: "mn", tts: Some("лаа"), keywords: &["гэрэл", "лаа"] },
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		#[cfg(feature = "ms")]
		crate::Annotation { lang: "ms", tts: Some("lilin"), keywords: &["cahaya", "lilin"] },
		#[cfg(feature = "mt")]
		crate::Annotation { lang: "mt", tts: Some("xemgħa"), keywords: &["dawl", "xemgħa"] },
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		#[cfg(feature = "or")]
		crate::Annotation {
			lang: "or", tts: Some("ମହମ"), keywords: &["ଆଲୋକ", "ମହମ"]
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		#[cfg(feature = "pcm")]
		crate::Annotation { lang: "pcm", tts: Some("Kándul"), keywords: &["Kándul", "Lait"] },
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("świeca"),
		...
		#[cfg(feature = "ps")]
		crate::Annotation { lang: "ps", tts: Some("شمع"), keywords: &["رڼا", "شمع"] },
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("vela"),
		...
		#[cfg(feature = "pt_PT")]
		crate::Annotation { lang: "pt_PT", tts: Some("↑↑↑"), keywords: &["luz", "vela"] },
		#[cfg(feature = "qu")]
		crate::Annotation { lang: "qu", tts: Some("vela"), keywords: &["kanchay", "vela"] },
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("lumânare"),
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-792"), keywords: &["E10-792"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("свеча"),
		...
		#[cfg(feature = "rw")]
		crate::Annotation { lang: "rw", tts: Some("buji"), keywords: &["Ikeye", "buji"] },
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("ميڻ بتي"),
		...
		#[cfg(feature = "sl")]
		crate::Annotation { lang: "sl", tts: Some("sveča"), keywords: &["luč", "sveča"] },
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("shamac"),
		...
		#[cfg(feature = "sq")]
		crate::Annotation { lang: "sq", tts: Some("qiri"), keywords: &["dritë", "qiri"] },
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang: "sr", tts: Some("свећа"), keywords: &["светлo", "свећа"]
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
		...
		crate::Annotation {
			...
			keywords: &["క\u{c4a}వ\u{c4d}వ\u{c4a}త\u{c4d}త\u{c3f}", "ద\u{c40}పం", "వ\u{c46}లుగు"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang: "tg", tts: Some("шамъ"), keywords: &["рӯшноӣ", "шамъ"]
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang: "ti", tts: Some("ሽምዓ"), keywords: &["ሽምዓ", "ብርሃን"]
		},
		#[cfg(feature = "tk")]
		crate::Annotation { lang: "tk", tts: Some("şem"), keywords: &["çyra", "şem"] },
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("teʻelango"), keywords: &["teʻelango"] },
		#[cfg(feature = "tr")]
		crate::Annotation { lang: "tr", tts: Some("mum"), keywords: &["mum", "ışık"] },
		#[cfg(feature = "ug")]
		crate::Annotation { lang: "ug", tts: Some("شام"), keywords: &["شام", "چىراق"] },
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang: "uk", tts: Some("свічка"), keywords: &["світло", "свічка"]
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		#[cfg(feature = "vi")]
		crate::Annotation { lang: "vi", tts: Some("nến"), keywords: &["nến", "ánh sáng"] },
		#[cfg(feature = "wo")]
		crate::Annotation { lang: "wo", tts: Some("sondeel"), keywords: &["làmp", "sondeel"] },
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
			tts:      Some("ikhandlela"),
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("蠟燭"), keywords: &["光", "蠟燭"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("蜡烛"), keywords: &["光", "蜡烛"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("蜡烛"),
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("蠟燭"), keywords: &["光亮", "蠟燭"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
...
pub const LIGHT_BULB: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("አምፖል"),
			keywords: &["ሐሳብ", "ብልጭ ማለት", "ብርሃን", "አምፖል", "አስቂኝ", "አዲስ ሐሳብ", "ኤሌክትሪክ", "ፍንጭ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["elektrik", "ideya", "işıq", "işıq lampası", "komik", "lampa"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("лямпачка"),
			keywords: &["комікс", "лямпа", "лямпачка", "святло", "электрычнасць", "эўрыка", "ідэя"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("електрическа крушка"),
			keywords: &["електрическа крушка", "идея", "комикс", "крушка", "светлина"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("foco"), keywords: &["foco"] },
		#[cfg(feature = "es_US")]
		crate::Annotation {
			lang:     "es_US",
			tts:      Some("foco"),
		...
		crate::Annotation {
			...
			keywords: &["bolgán", "bolgán solais", "leictreach", "smaoineamh", "solas", "solus"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("bohlam"),
			keywords: &["bohlam", "bola lampu", "cahaya", "elektrik", "ide", "komik", "lampu"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("светилка"),
			keywords: &["електрична", "идеја", "светилка", "светло", "сијалица", "стрип"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["гэрлийн чийдэн", "гэрэл", "инээдмийн", "санаа", "цахилгаан", "чийдэн"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		crate::Annotation {
			...
			keywords: &["cahaya", "elektrik", "idea", "komik", "mentol", "mentol lampu"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("gloeilamp"),
			keywords: &["elektrisch", "gloeilamp", "idee", "lamp", "licht", "peertje", "strip"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
			tts:      Some("↑↑↑"),
			keywords: &["elektrisitet", "idé", "lys", "lyspære", "pære", "teikneserie"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["بتی", "بتی آلا بلب", "برقی", "بلب", "رائے", "م\u{64f}ضح\u{650}کہ خیز"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			lang:     "ps",
			tts:      Some("د رڼا بلب"),
			keywords: &["برېښنايي", "بلب", "د رڼا بلب", "د رڼا ګروپ", "رڼا", "لکۍ دار", "نظر"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("lâmpada"),
			keywords: &["elétrica", "ideia", "luz", "lâmpada", "quadrinhos", "tenho uma ideia"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["desenho", "eletricidade", "elétrica", "ideia", "luz", "lâmpada"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-606"), keywords: &["E10-606"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("лампочка"),
			keywords: &["идея", "лампа", "лампочка", "свет", "эврика", "электричество"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("ampule"),
			keywords: &["ampule", "cy’amashanyarazi", "gishekeje", "igitekerezo", "urumuri"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("žiarovka"),
			keywords: &["elektrické", "komiks", "komixové", "nápad", "svetlo", "žiarivka", "žiarovka"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("žarnica"),
			keywords: &["električno", "luč", "strip", "svetilka", "zamisel", "žarnica"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "tg",
			tts:      Some("чароғак"),
			keywords: &["барқӣ", "идея", "мазҳакавӣ", "рӯшноӣ", "фурӯзонак", "чароғак"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("foʻi ʻuhila"), keywords: &["foʻi ʻuhila"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("ampul"),
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("لائٹ بلب"),
			keywords: &["برقی", "بلب", "خیال", "روشنی", "سجھائو", "لائٹ بلب", "نور", "کامک"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("elektr lampasi"),
			keywords: &["elektr", "elektr lampasi", "fikr", "gʻoya", "latifa", "yorugʻlik"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			...
			keywords: &["ibhalbhu", "ibhalbhu yesibane", "ingcinga", "isibane", "ukuhlekisa", "yombane"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("燈泡"), keywords: &["燈泡"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("燈膽"),
		...
		crate::Annotation {
			...
			keywords: &["igilobhu", "igilobhu likagesi", "opopayi", "ugesi", "ukukhanya", "umbono"],
		},
	],
};
#[doc = "🔦"]
pub const FLASHLIGHT: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("фенерче"),
			keywords: &["електрическа", "електрическо", "инструмент", "светлина", "фенерче"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("llanterna"),
			keywords: &["eina", "electricitat", "elèctric", "elèctrica", "llanterna", "llum"],
		},
		#[cfg(feature = "ccp")]
		crate::Annotation {
			lang:     "ccp",
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("baterka"),
			keywords: &["baterka", "elektrický", "nástroj", "nářadí", "svítilna", "světlo"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("torche"),
			keywords: &["lampe torche", "lampe électrique", "lumière", "outil", "torche"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["dealanach", "inneal", "lòchran", "solas", "toirds", "toirds dealain"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("tocila"),
			keywords: &["fitila", "haske", "kayan aiki", "na lantarki", "tocila", "wuta"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		#[cfg(feature = "he")]
		crate::Annotation {
			lang: "he", tts: Some("פנס"), keywords: &["אור", "פנס", "תאורה"]
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			tts:      Some("टॉर\u{94d}च"),
			keywords: &["टॉर\u{94d}च", "प\u{94d}रकाश", "फ\u{93c}\u{94d}ल\u{948}शलाइट", "बिजली"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("zseblámpa"),
			keywords: &["elektronikus", "elemlámpa", "fény", "világítás", "zseblámpa"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "ka",
			tts:      Some("ფანარი"),
			keywords: &["ელექტრო", "ინსტრუმენტი", "სინათლე", "ფანარი", "შუქი", "ხელსაწყო"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("жарқыл жарығы"),
			keywords: &["алау", "жарық", "жарқыл жарығы", "шам", "электрлік", "құрал"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &["टॉर\u{94d}च", "फ\u{94d}ल\u{945}शलायट", "लायट", "विद\u{94d}य\u{941}त", "साधन"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["алатка", "батериска ламба", "батерија", "електричен", "светилка", "светло"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["प\u{94d}रकाश", "ब\u{945}टरी", "मशाल", "विज\u{947}री", "विद\u{94d}य\u{941}त"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["eletricidade", "elétrica", "ferramenta", "lanterna", "luz", "utensílio"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-738"), keywords: &["E10-738"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("фонарик"),
		...
		crate::Annotation {
			lang:     "th",
			tts:      Some("ไฟฉาย"),
			keywords: &["เคร\u{e37}\u{e48}องม\u{e37}อ", "แสง", "ไฟฉาย", "ไฟฟ\u{e49}า"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("kasa"), keywords: &["kasa"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("el feneri"),
		...
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("手電筒"), keywords: &["手電筒"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("電筒"),
...
pub const RED_PAPER_LANTERN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["bar", "fənər", "işıq", "qırmızı", "qırmızı kağız fənər", "yapon"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
			tts:      Some("чырвоны папяровы ліхтар"),
			keywords: &["святло", "чырвоны", "чырвоны папяровы ліхтар", "японскі", "ідзакая"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
		...
		crate::Annotation {
			...
			keywords: &["crveni papirni fenjer", "crveno", "kineska lampa", "svjetlo"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			...
			keywords: &["kulørte lamper", "lanterne", "papirlampe", "papirlanterne", "rød lygte"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
			tts:      Some("rote Papierlaterne"),
			keywords: &["Izakaya", "Japanische Laterne", "japanisches Lokal", "rote Papierlaterne"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation {
			...
			keywords: &["ιαπωνικό", "κόκκινο", "κόκκινο χάρτινο φανάρι", "φανάρι", "φως"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("↑↑↑"),
			keywords: &["farol", "farol de papel japonés", "izakaya", "linterna", "papel"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation {
			lang:     "es_US",
			tts:      Some("linterna de papel roja"),
			keywords: &["izakaya", "linterna", "linterna de papel roja", "luz", "roja"],
		},
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
		...
		crate::Annotation {
			...
			keywords: &["argi", "faroltxo", "gorri", "japonia", "paper gorrizko faroltxoa", "taberna"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("فانوس کاغذی قرمز"),
			keywords: &["فانوس", "فانوس کاغذی قرمز", "قرمز", "میخانه", "می\u{200c}فروشی", "نور"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
			tts:      Some("punainen paperilyhty"),
			keywords: &["Japani", "baari", "lyhty", "punainen", "punainen paperilyhty", "valo"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["japonais", "lampion rouge", "lanterne", "lumière", "restaurant", "rouge"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
			tts:      Some("lanterne d’izakaya"),
			keywords: &["japonais", "lanterne", "lanterne d’izakaya", "lumière", "rouge"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("laindéar dearg"),
			keywords: &["Seapánach", "bialann", "dearg", "izakaya", "laindéar dearg", "laintéar"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
			tts:      Some("lanntair-pàipeir dearg"),
			keywords: &["bàr", "dearg", "lanntair", "lanntair-pàipeir dearg", "solas"],
		},
		#[cfg(feature = "gl")]
		crate::Annotation {
			lang:     "gl",
			tts:      Some("lanterna de papel vermella"),
			keywords: &["lanterna", "lanterna de papel vermella", "luz", "vermella", "xaponesa"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			tts:      Some("લાલ ફાનસ"),
			keywords: &["ઇઝાક\u{acd}યા", "ફાનસ", "બાર", "ર\u{ac7}સ\u{acd}ટોરન\u{acd}ટ", "લાલ"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		crate::Annotation {
			...
			keywords: &["क\u{902}दील", "लाल", "लाल काग\u{93c}ज\u{93c}ी लालट\u{947}न", "लालट\u{947}न"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			...
			keywords: &["բար", "թղթե կարմիր լապտեր", "լապտեր", "լույս", "կարմիր", "ճապոնական"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["жапон", "тақта", "шам", "қағаз шам", "қағаздан жасалған қызыл шам", "қызыл"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &["жапончо", "жарык", "кызыл", "кызыл кагаздан жасалган лампа", "лампа"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
			tts:      Some("roude Lampion"),
			keywords: &["Bar", "Lampion", "Lanter", "Luucht", "roude Lampion", "rout"],
		},
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			...
			keywords: &["bārs", "japāņu", "laterna", "papīrs", "sarkana papīra laterna", "sarkans"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["aħmar", "bar", "dawl", "lanterna", "lanterna tal-karti ħamra"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			...
			keywords: &["प\u{94d}रकाश", "बार", "रातो", "रातो पानाको लालटिन", "लालटिन"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			...
			keywords: &["bar", "izakaya", "lampe", "lanterne", "lykt", "raud", "raud papirlykt"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["bar izakaya", "czerwony lampion", "izakaya", "japonia", "lampa", "lampion"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			...
			keywords: &["bar", "izakaya", "lanterna", "papel", "restaurante", "vermelha"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-430"), keywords: &["E10-430"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["itara", "itara ry’umutuku", "itoroshi", "umurongo", "urumuri"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["bar", "japonsko", "lampijon", "luč", "rdeče", "rdeči lampijon"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			...
			keywords: &["dritë", "fener me letër të kuqe", "i kuq", "japoneze", "restorant"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("↑↑↑"),
			keywords: &["бар", "лампион", "лампион од црвеног папира", "свјетло", "црвена"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
		...
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("↑↑↑"),
			keywords: &["bar", "crvena", "lampion", "lampion od crvenog papira", "svjetlo"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &["baa", "kijapani", "mwanga", "nyekundu", "taa", "taa nyekundu ya karatasi"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &["bar", "fener", "izakaya", "kırmızı", "kırmızı kağıt fener", "restoran"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("红灯笼"),
			keywords: &["光", "喜庆", "居酒屋", "日本", "灯笼", "红灯笼", "节日", "酒馆", "餐馆"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			...
			keywords: &["ibha", "ilambu", "ilambu elibomvu", "japanese", "okubomvu", "ukukhanya"],
		},
	],
};
#[doc = "🪔"]
pub const DIYA_LAMP: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["Indies", "Indiese olielamp", "Indië", "diya", "lampie", "olie", "olielamp"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("چراغ دایا"),
			keywords: &["دایا", "روغن", "فتیله", "چراغ", "چراغ روغنی", "چراغ فتیله\u{200c}ای"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang: "kk", tts: Some("дия"), keywords: &["дия", "май", "шам"]
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &["എണ\u{d4d}ണ", "ചിര\u{d3e}ത\u{d4d}", "ദിയ\u{d3e}", "വിളക\u{d4d}ക\u{d4d}"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			lang:     "mr",
			tts:      Some("पणती"),
			keywords: &["ज\u{94d}योत", "त\u{947}ल", "दिवा", "दिवाळी", "दीपावली", "पणती"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["त\u{947}ल", "दियो", "दियो बत\u{94d}ती", "ल\u{94d}याम\u{94d}प"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਦੀਵਾ"),
			keywords: &["ਜ\u{a4b}ਤ", "ਤ\u{a47}ਲ ਦਾ ਦੀਵਾ", "ਦੀਪਕ", "ਦੀਵਾ", "ਲ\u{a48}\u{a02}ਪ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		#[cfg(feature = "pt_PT")]
		crate::Annotation { lang: "pt_PT", tts: Some("lâmpada diya"), keywords: &["↑↑↑"] },
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E12–073"), keywords: &["E12–073"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["තෙල\u{dca}", "ද\u{dd2}ය\u{dcf}", "ල\u{dcf}ම\u{dca}ප\u{dd4}ව"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("maama tia"), keywords: &["maama tia"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("diya lamba"),
