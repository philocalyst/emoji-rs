...
pub const RED_HAIR: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		#[cfg(feature = "am")]
		crate::Annotation {
			lang: "am", tts: Some("ቀይ ጸጉር"), keywords: &["ቀይ ጸጉር", "ጂንጀር"]
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["rudé vlasy", "rusé vlasy", "ryšavé vlasy", "zrzavé vlasy", "zrzek", "zrzka"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("pelirrojo"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("موقرمز"),
			keywords: &["سرخ\u{200c}مو", "سرخ\u{200c}موی", "موسرخ", "موقرمز", "موی قرمز"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["capillos rosse", "rossa", "rossastre", "rubee", "rubie", "rubre"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["ಕ\u{cc6}ಂಪು ಕ\u{cc2}ದಲು", "ಕ\u{cc6}ಂಪು ತಲ\u{cc6}", "ಶುಂಠ\u{cbf}"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		crate::Annotation {
			...
			keywords: &["ച\u{d41}വന\u{d4d}ന മ\u{d41}ടി", "ച\u{d41}വന\u{d4d}നതല", "ജിഞ\u{d4d}ചർ"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["ချင\u{103a}းတက\u{103a}န\u{102e}ရောင\u{103a}", "ဆ\u{1036}ပင\u{103a}န\u{102e}"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			...
			keywords: &["ଅଦ\u{b3e}", "ନ\u{b3e}ଲ\u{b3f} କେଶ", "ନ\u{b3e}ଲ\u{b3f} ମ\u{b41}ଣ\u{b4d}ଡ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਲਾਲ ਰ\u{a70}ਗ ਦ\u{a47} ਵਾਲ"),
			keywords: &["ਲਾਲ ਰ\u{a70}ਗ ਦ\u{a47} ਵਾਲ", "ਲਾਲ ਵਾਲ", "ਲਾਲੀ ਮਾਰਦਾ ਪੀਲਾ ਰ\u{a70}ਗ"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-033"), keywords: &["E11-033"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		#[cfg(feature = "sat")]
		crate::Annotation {
			lang: "sat", tts: Some("ᱟᱨᱟᱜ ᱩᱵ"), keywords: &["ᱟᱨᱟᱜ ᱩᱵ"]
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["ඉඟ\u{dd4}ර\u{dd4}", "රත\u{dd4} කොණ\u{dca}ඩය", "රත\u{dd4} පැහැත\u{dd2}"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			...
			keywords: &["சிவப\u{bcd}பு தலை", "சிவப\u{bcd}பு முடி", "ஜிஞ\u{bcd}சர\u{bcd}"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
		...
		#[cfg(feature = "zh")]
		crate::Annotation { lang: "zh", tts: Some("红发"), keywords: &["姜黄色", "红发"] },
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("紅髮"), keywords: &["紅髮", "薑黃"] },
...
pub const CURLY_HAIR: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["afro", "kovrdžav", "kovrdžava", "kovrdžava kosa", "kovrdže", "uvojci"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			...
			keywords: &["afro", "kudrnaté vlasy", "kudrny", "prstýnky", "vlnité vlasy"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			...
			keywords: &["afro", "bucle", "pelo rizado", "rizado", "rizo", "tirabuzón"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation { lang: "es_419", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_MX")]
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("موفرفری"),
			keywords: &["تابدار", "فرفری", "مجعد", "موفرفری", "موی فرفری", "موی مجعد"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["afro", "gbakọrọ agbakọ", "ntutu isi gbakọrọ agbakọ", "ringlets"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			...
			keywords: &["afro", "kręcone", "kręcone włosy", "kędzierzawe", "kędzierzawy"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-034"), keywords: &["E11-034"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("кудрявые волосы"),
			keywords: &["афро", "кудри", "кудрявые волосы", "кудрявый", "химическая завивка", "химия"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
			tts:      Some("گهنگرالو وار"),
			keywords: &["ايفرو", "رنگليٽس", "گهنگرالو وار", "گهنگهرالو", "گهنگهرالو وار"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["ஆஃப\u{bcd}ரோ", "சுருட\u{bcd}டை", "சுருட\u{bcd}டை முடி", "சுருள\u{bcd}"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
		...
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang: "ti", tts: Some("ቁርጽራጽ ጸጉሪ"), keywords: &["ጥምዛዝ ጸጉሪ ርእሲ"]
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["афро", "волосся", "кудрі", "кучеряве волосся", "кучерявий", "кучері"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["dúdúláwọ\u{300}", "irun rírọ\u{300}", "rírọ\u{300}", "àwọn ríngì"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("irun rírɔ\u{300}"),
			keywords: &["dúdúláwɔ\u{300}", "irun rírɔ\u{300}", "rírɔ\u{300}", "àwɔn ríngì"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
...
pub const BALD: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("bles"),
			keywords: &["afgeskeer", "bles", "chemoterapie", "geen", "haarloos", "hare"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["без коса", "без коса от лъчетерапия", "избръснат", "няма коса", "плешив човек"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		#[cfg(feature = "br")]
		crate::Annotation { lang: "br", tts: Some("moal"), keywords: &["blev", "moal"] },
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("ćelavo"),
			keywords: &["bez kose", "hemoterapija", "obrijan", "obrijana", "obrijano", "ćelavo"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
			tts:      Some("calvície"),
			keywords: &["calb", "calba", "calvície", "cap afaitat", "quimioteràpia", "sense cabells"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("bez vlasů"),
			keywords: &["bez vlasů", "chemoterapie", "pleš", "skin", "skinhead", "vyholená hlava"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("skaldet"),
			keywords: &["barberet", "ingen hår", "kemoterapi", "kronraget", "skaldet"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			lang:     "es",
			tts:      Some("sin pelo"),
			keywords: &["afeitado", "bola de billar", "calvo", "quimioterapia", "sin pelo"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation { lang: "es_419", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("↑↑↑"),
			keywords: &["calvo", "quimioterapia", "rapado", "sin cabello", "sin pelo"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("calvo"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		crate::Annotation {
			lang:     "et",
			tts:      Some("kiilaspea"),
			keywords: &["juukseid pole", "juusteta", "keemiaravi", "kiilaspea", "raseeritud"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("burusoil"),
			keywords: &["burusoil", "ilegabe", "ilerik gabe", "kimioterapia", "soildu"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
			tts:      Some("تاس"),
			keywords: &["بدون مو", "بی\u{200c}مو", "تاس", "تراشیده", "شیمی\u{200c}درمانی", "طاس", "کچل"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("chauve"),
			keywords: &["chauve", "chimiothérapie", "imberbe", "rasé", "sans cheveux"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("maol"),
			keywords: &["bearrtha", "blagaid", "ceimiteiripe", "gan ghruaig", "gruaig ar bith", "maol"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "gu",
			tts:      Some("ટાલ"),
			keywords: &["કીમોથ\u{ac7}રાપી", "ટકો", "ટાલ", "વાળ નહી\u{a82}", "વાળ વગર"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
			tts:      Some("sanƙo"),
			keywords: &["aske", "babu gashi", "jiyyar cutar sankara", "mara gashi", "sanƙo"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "is",
			tts:      Some("skalli"),
			keywords: &["hárleysi", "hárlos", "lyfjameðferð", "rakað höfuð", "skalli"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			lang:     "jv",
			tts:      Some("buthak"),
			keywords: &["buthak", "gundhul", "kemoterapi", "ora duwe rambut", "plenthas"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("aferḍas"), keywords: &["aferḍas"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("тақырбас"),
			keywords: &["тақырбас", "химиотерапия", "шаш жоқ", "шашсыз", "қырып тастаған"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("ќелав"),
			keywords: &["без влакна", "без коса", "избричено", "хемотерапија", "ќелав"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "mn",
			tts:      Some("халзан"),
			keywords: &["халзан", "химийн эмчилгээ", "үс байхгүй", "үсгүй", "үсээ хусуулсан"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		crate::Annotation {
			lang:     "ms",
			tts:      Some("botak"),
			keywords: &["bercukur", "botak", "kemoterapi", "tiada rambut", "tidak berambut"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("kaal"),
			keywords: &["chemotherapie", "geen haar", "geschoren", "haarloos", "kaal"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
			tts:      Some("skalla"),
			keywords: &["barbert", "cellegiftbehandling", "hårlaus", "kjemoterapi", "skalla", "utan hår"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Bọld"),
			keywords: &["Bọld", "Kimótẹ\u{301}rápi", "Nó Hea", "Shév Ọ\u{301}l Hea Kọmọ\u{301}t Fọ Hẹd"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
			tts:      Some("łysy"),
			keywords: &["bez włosów", "bezwłosa", "bezwłosy", "chemioterapia", "ogolona", "łysy"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("careca"),
			keywords: &["careca", "nenhum cabelo", "quimioterapia", "raspado", "sem cabelo"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["careca", "nenhum cabelo", "quimioterapia", "rapado", "raspado"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("paqla"),
			keywords: &["hairless", "mana chukchayuq", "paqla", "quimioterapia", "rutusqa"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-035"), keywords: &["E11-035"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("без волос"),
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("holá hlava"),
			keywords: &["bezvlasý", "holá hlava", "lysý", "plešatý", "plešivý", "vyholený"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			lang:     "sw",
			tts:      Some("upara"),
			keywords: &["bila nywele", "kichwa kilichonyolewa", "tibakemikali", "upara"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			lang:     "uk",
			tts:      Some("лисина"),
			keywords: &["без волосся", "виголений", "лисий", "немає волосся", "хіміотерапія", "хімія"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("orí pípá"),
			keywords: &["kimotẹ\u{301}rápì", "kòsí irun", "orí pípá", "àìínírun", "ìfárí"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("orí pípá"),
			keywords: &["kimotɛ\u{301}rápì", "kòsí irun", "orí pípá", "àìínírun", "ìfárí"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zu",
			tts:      Some("imbungculu"),
			keywords: &["chemotherapy", "hairless", "imbungculu", "no hair", "shaven"],
		},
	],
};
#[doc = "🦳"]
pub const WHITE_HAIR: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["চ\u{9c1}লি", "পক\u{9be} চ\u{9c1}লি", "বগ\u{9be}", "বয\u{9bc}স\u{9cd}ক"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			...
			keywords: &["চ\u{9c1}ল", "ধ\u{9c2}সর", "প\u{9cd}রবীণ", "স\u{9be}দ\u{9be}"],
		},
		#[cfg(feature = "br")]
		crate::Annotation {
			lang:     "br",
		...
		crate::Annotation {
			...
			keywords: &["grau", "graues Haar", "grauhaarig", "weißes Haar", "weißhaarig"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation {
			lang:     "de_CH",
		...
		crate::Annotation {
			lang:     "fa",
			tts:      Some("موسفید"),
			keywords: &["خاکستری", "سفید", "موسفید", "موی خاکستری", "موی سفید", "پیر"],
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			...
			keywords: &["बाल", "भ\u{942}रा", "व\u{943}द\u{94d}ध", "सफ\u{93c}\u{947}द"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			...
			keywords: &["ចាស\u{17cb}", "ស", "សក\u{17cb}", "សក\u{17cb}ស", "ស\u{17d2}ក\u{17bc}វ"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಬ\u{cbf}ಳ\u{cbf} ಕ\u{cc2}ದಲು"),
			keywords: &["ಕ\u{cc2}ದಲು", "ಬ\u{cbf}ಳ\u{cbf}", "ಬ\u{cc2}ದು", "ಹಳ\u{cc6}ಯ"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		crate::Annotation {
			...
			keywords: &["ഗ\u{d4d}രേ", "മ\u{d41}ടി", "വയസ\u{d4d}സ\u{d3e}യത\u{d4d}", "വെള\u{d4d}ള"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			...
			keywords: &["करड\u{947}", "क\u{947}स", "पा\u{902}ढर\u{947}", "पिकल\u{947}ल\u{947}"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-036"), keywords: &["E11-036"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("седые волосы"),
			keywords: &["волосы", "пожилой", "седина", "седой", "седые волосы", "старый"],
		},
		#[cfg(feature = "sat")]
		crate::Annotation {
			lang: "sat", tts: Some("ᱯᱩᱸᱱᱰ ᱩᱵ"), keywords: &["ᱯᱩᱸᱱᱰ ᱩᱵ"]
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("ʻulu hinā"), keywords: &["hinā", "ʻulu"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("beyaz saç"),
		...
		crate::Annotation {
			...
			keywords: &["gray", "hair", "izinwele ezimhlophe", "izinwele ezimpunga", "old", "white"],
		},
	],
};
