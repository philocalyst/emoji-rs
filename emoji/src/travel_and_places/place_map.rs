...
pub const GLOBE_SHOWING_EUROPE_AFRICA: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("aardbol met Europa en Afrika"),
			keywords: &[
				"Afrika",
				"Europa",
				"aardbol",
				"aardbol met Europa en Afrika",
				"aardbol wys Europa en Afrika",
				"aarde",
				"wêreld",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &["ሉል", "መሬት", "አውሮጳ", "አውሮፓና አፍሪካ የሚያሳይ ሉል", "አፍሪካ", "ዓለም"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("كرة أرضية تعرض أوروبا وإفريقيا"),
			keywords: &["أوروبا", "أوروبا وإفريقيا", "إفريقيا", "الأرض", "العالم", "كرة أرضية"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["афрыка", "еўропа", "зямля", "зямны шар (еўропа і афрыка)", "свет"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("глобус с Европа и Африка"),
			keywords: &["африка", "глобус", "глобус с Европа и Африка", "европа", "земята"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["Zemlja", "globus", "globus prikazuje Evropu i Afriku", "kugla", "svijet"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			...
			keywords: &["ᎡᎶᎯ", "ᎡᎶᎯ ᏗᏟᎶᏍᏔᏅ", "ᎡᎶᎯ ᏗᏟᎶᏍᏔᏅ ᎬᏂᎨᏒ ᏂᎬᎾ ᏳᎳᏈ-ᎬᎿᎨᏍᏛ", "ᎧᎵ ᎡᎶᎯ", "ᎬᎿᎨᏍᏛᎢ", "ᏳᎳᏈ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["Affrica", "Ewrop", "byd", "glôb yn dangos Ewrop-Affrica", "y ddaear"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("globus med Europa og Afrika"),
			keywords: &["Afrika", "Europa", "globus med Europa og Afrika", "jorden", "verden"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
			tts:      Some("Globus mit Europa und Afrika"),
			keywords: &["Afrika", "Erde", "Europa", "Globus mit Europa und Afrika", "Weltkugel"],
		},
		#[cfg(feature = "de_CH")]
		...
		crate::Annotation {
			...
			keywords: &["Africa", "Europe", "Europe-Africa", "earth", "globe", "showing", "world"],
		},
		#[cfg(feature = "en_AU")]
		...
		crate::Annotation {
			...
			keywords: &["Aafrika", "Euroopa", "Euroopa-Aafrika", "gloobus", "maa", "maailm"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			...
			keywords: &["africa", "europe", "globo", "globong nagpapakita sa europe at africa", "mundo"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			...
			keywords: &["Afrique", "Europe", "globe", "globe qui montre l’Europe et l’Afrique", "monde"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("globo terráqueo Europa-África"),
			keywords: &["Europa", "Terra", "globo terráqueo Europa-África", "mundo", "África"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("taswirar duniya mai nuna Turai-Afirka"),
			keywords: &[
				"Afirka",
				"Turai",
				"duniya",
		...
		crate::Annotation {
			...
			keywords: &["אירופה", "אפריקה", "גלובוס", "גלובוס עם אירופה ואפריקה", "כדור הארץ", "עולם"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["Afrika", "Eropa", "Eropa-Afrika", "bola dunia", "bumi", "dunia", "globe"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ụwa na-egosi Europe-Afrika"),
			keywords: &["Afrika", "Europe", "ụwa", "ụwa dum", "ụwa na-egosi Europe-Afrika"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("hnöttur sem sýnir Evrópu-Afríku"),
			keywords: &["Afríka", "Evrópa", "hnöttur sem sýnir Evrópu-Afríku", "jörðin"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			...
			keywords: &["アフリカ", "ヨーロッパ", "世界", "地球", "地球（ヨーロッパとアフリカ）"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ევროპა",
				"მსოფლიო",
				"რომელზეც ჩანს ევროპა და აფრიკა",
			],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some(
				"ಯ\u{cc2}ರ\u{ccb}ಪ\u{ccd}-ಆಫ\u{ccd}ರ\u{cbf}ಕಾ ತ\u{ccb}ರ\u{cbf}ಸುತ\u{ccd}ತ\u{cbf}ರುವ ಭ\u{cc2}ಗ\u{ccb}ಳ",
			),
			keywords: &[
				"ಗ\u{ccd}ಲ\u{ccb}ಬ\u{ccd}",
				"ಜಗತ\u{ccd}ತು",
				"ಭ\u{cc2}ಮ\u{cbf}",
				"ಯುರ\u{ccb}ಪ\u{ccd}",
				"ಯುರ\u{ccb}ಪ\u{ccd}-ಆಫ\u{ccd}ರ\u{cbf}ಕಾ",
				"ಯುರ\u{ccb}ಪ\u{ccd}-ಆಫ\u{ccd}ರ\u{cbf}ಕಾವನ\u{ccd}ನು ತ\u{ccb}ರ\u{cbf}ಸುವ ಗ\u{ccd}ಲ\u{ccb}ಬ\u{ccd}",
				"ಯ\u{cc2}ರ\u{ccb}ಪ\u{ccd}-ಆಫ\u{ccd}ರ\u{cbf}ಕಾ ತ\u{ccb}ರ\u{cbf}ಸುತ\u{ccd}ತ\u{cbf}ರುವ ಜಗತ\u{ccd}ತು",
				"ಯ\u{cc2}ರ\u{ccb}ಪ\u{ccd}-ಆಫ\u{ccd}ರ\u{cbf}ಕಾ ತ\u{ccb}ರ\u{cbf}ಸುತ\u{ccd}ತ\u{cbf}ರುವ ಭ\u{cc2}ಗ\u{ccb}ಳ",
				"ವ\u{cbf}ಶ\u{ccd}ವ",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &["африка", "дүйнө", "европа", "европа-африканы көрсөткөн глобус", "жер"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		crate::Annotation {
			...
			keywords: &["Uropi", "ao", "ao whakakite Uropi-Āwherika", "whenua", "Āwherika"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["Африк", "Европ", "Европ-Африкийг харуулсан бөмбөрцөг", "бөмбөрцөг", "дэлхий"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			...
			keywords: &[
				...
				"य\u{941}रोप-आफ\u{94d}रीका दर\u{94d}शविणारा प\u{943}थ\u{94d}वीचा गोल",
			],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			...
			keywords: &["afrika", "bumi", "dunia", "eropah", "glob", "peta glob Eropah-Afrika"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
			tts:      Some("globu juri l-Ewropa-Afrika"),
			keywords: &["Afrika", "dinja", "globu", "globu juri l-Ewropa-Afrika", "l-Ewropa"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
			tts:      Some(
				"ဥရောပန\u{103e}င\u{1037}\u{103a} အာဖရ\u{102d}ကပြ ကမ\u{1039}ဘာလ\u{102f}\u{1036}း",
			),
			keywords: &[
				"ကမ\u{1039}ဘာ",
		...
		crate::Annotation {
			lang:     "nn",
			tts:      Some("↑↑↑"),
			keywords: &["Afrika", "Europa", "jorda", "jordklode med Europa og Afrika"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["اروپا", "افريقا", "زمکه", "نړۍ", "نړۍ ښيي اروپا-افریقا", "کره"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
			tts:      Some("globo mostrando Europa e África"),
			keywords: &["Europa", "Terra", "globo mostrando Europa e África", "África"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-212"), keywords: &["E10-212"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["آفريقا، زمين، يورپ، گلوب، دنيا", "گلوب يورپ ايشيا ڏيکاري پيو"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
			tts:      Some("ය\u{dd4}රෝප\u{dcf}-අප\u{dca}\u{200d}ර\u{dd2}ක\u{dcf}ව පෙන\u{dca}වන ලෝක ගෝලය"),
			keywords: &[
		...
		crate::Annotation {
			...
			keywords: &["Afrikë", "Bota", "Evropa", "Globi", "globi që tregon Evropën dhe Afrikën"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("глобус са Европом и Африком"),
			keywords: &["Африкa", "Еврoпa", "Европа-Африка", "Земља", "глобус", "зeмљa", "кугла", "свeт"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("↑↑↑"),
			keywords: &["Африкa", "Еврoпa", "Земља", "глобус", "глобус са Европом и Африком", "свијет"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
		...
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("↑↑↑"),
			keywords: &["Afrika", "Evropa", "Zemlja", "globus", "globus sa Evropom i Afrikom", "svijet"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
			...
			keywords: &[
				...
				"jordglob som visar Europa och Afrika",
			],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			...
			keywords: &[
				...
				"dunia",
				"tufe",
				"tufe linaloonyesha ulaya na afrika",
		...
		crate::Annotation {
			lang:     "te",
			tts:      Some("యూరప\u{c4d}-ఆఫ\u{c4d}ర\u{c3f}క\u{c3e}ను చూప\u{c47} గ\u{c4d}ల\u{c4b}బ\u{c4d}"),
			keywords: &[
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"замин",
				"ки Аврупо-Африкаро намоиш медиҳад",
				"ҷаҳон",
			],
		},
		#[cfg(feature = "th")]
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ኤውሮጳ-ኣፍሪቃ ዘርኢ ሉል"),
			keywords: &["ምድሪ", "ኣፍሪቃ", "ኤውሮጳ", "ኤውሮጳ-ኣፍሪቃ", "ዓለም", "ዘርኢ", "ግሎብ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["kolope", "kolope ʻasi mai ʻEulope-ʻAfilika", "māmani", "ʻAfilika", "ʻEulope"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			...
			keywords: &["Africa", "glob", "glob buy wane ërop ak afrik", "suuf", "Ërop", "àdduna"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Gulobu To N Shafihan Uropu-Afirika"),
			keywords: &[
		...
		crate::Annotation {
			...
			keywords: &["世界", "地球", "地球儀", "歐洲", "非洲", "顯示歐洲 - 非洲嘅地球儀"],
		},
		#[cfg(feature = "yue_Hans")]
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("显示欧洲 - 非洲嘅地球仪"),
			keywords: &["世界", "地球", "地球仪", "显示欧洲 - 非洲嘅地球仪", "欧洲", "非洲"],
		},
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
		...
		crate::Annotation {
			...
			keywords: &["afrika", "europe", "igilobhu", "igilobhu eliveza i-europe-afrika", "umhlaba"],
		},
	],
};
#[doc = "🌎"]
pub const GLOBE_SHOWING_AMERICAS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ሉል", "መሬት", "ሰሜንና ደቡብ አሜሪካ", "ሰሜንና ደቡብ አሜሪካ የሚያሳይ ሉል", "ዓለም"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("كرة أرضية تعرض الأمريكتين"),
			keywords: &[
				"أمريكا",
				"أميركا",
				"الارض",
		...
		crate::Annotation {
			...
			keywords: &["Amerika", "bed", "boul", "boul douar o tiskouez Amerika", "douar"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
		...
		crate::Annotation {
			...
			keywords: &["ᎠᎺᎵᎧᏏ", "ᎡᎶᎯ", "ᎡᎶᎯ ᏗᏟᎶᏍᏔᏅ", "ᎡᎶᎯ ᏗᏟᎶᏍᏔᏅ ᎬᏂᎨᏒ ᏂᎬᎾ ᎠᎹᏰᎵ", "ᎧᎵ ᎡᎶᎯ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["Erde", "Globus", "Globus mit Amerika", "Nordamerika", "Südamerika", "Weltkugel"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		crate::Annotation {
			...
			keywords: &["Αμερική", "γη", "κόσμος", "υδρόγειος", "υδρόγειος με Βόρεια και Νότια Αμερική"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			...
			keywords: &["Ameerika", "gloobus", "maa", "maailm"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("america ikusgai duen lur-globoa"),
			keywords: &["america ikusgai duen lur-globoa", "amerika", "globo", "lur", "mundu"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			...
			keywords: &["Amerikka", "maailma", "maapallo", "maapallo jossa näkyy Amerikka"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["Amerika", "globus", "globus har Amerika sæst", "heimurin", "jørðin", "verðin"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("taswirar duniya mai nuna Ƙasashen Amurka"),
			keywords: &[
				"duniya",
				"nahiyar amurka",
				"taswira",
		...
		crate::Annotation {
			...
			keywords: &["Amerika", "Amerikát mutató földgömb", "föld", "földgömb", "földrajz", "világ"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
			tts:      Some("Ամերիկաները պատկերող գլոբուս"),
			keywords: &["Ամերիկաներ", "Ամերիկաները պատկերող գլոբուս", "աշխարհ", "գլոբուս", "երկիր"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
			tts:      Some("bola dunia Amerika"),
			keywords: &["Amerika", "bola dunia", "bumi", "dunia", "globe"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ụwa dum na-egosi Amerikansị"),
			keywords: &["Amerikansi", "ụwa", "ụwa dum", "ụwa dum na-egosi Amerikansị"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("hnöttur sem sýnir Ameríku"),
			keywords: &["Ameríka", "N- og S-Ameríka", "hnöttur sem sýnir Ameríku", "jörðin"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("America"),
			keywords: &["America", "Americhe", "globo", "mappamondo", "natura", "pianeta", "terra"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
			tts:      Some("地球（アメリカ大陸）"),
			keywords: &["アメリカ", "アメリカ大陸", "世界", "地球", "地球（アメリカ大陸）"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("globe sing nuduhake benua Amerika"),
			keywords: &["Amerika", "bumi", "donya", "globe", "globe sing nuduhake benua Amerika"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			lang:     "kl",
			tts:      Some("globus med nord- og sydamerika"),
			keywords: &["Amerika", "Nord- og Sydamerika", "globus med nord- og sydamerika", "jorden"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಅಮ\u{cc6}ರ\u{cbf}ಕ ತ\u{ccb}ರ\u{cbf}ಸುತ\u{ccd}ತ\u{cbf}ರುವ ಭ\u{cc2}ಗ\u{ccb}ಳ"),
			keywords: &[
				"ಅಮ\u{cc6}ರ\u{cbf}ಕ ತ\u{ccb}ರ\u{cbf}ಸುತ\u{ccd}ತ\u{cbf}ರುವ ಜಗತ\u{ccd}ತು",
				"ಅಮ\u{cc6}ರ\u{cbf}ಕ ತ\u{ccb}ರ\u{cbf}ಸುತ\u{ccd}ತ\u{cbf}ರುವ ಭ\u{cc2}ಗ\u{ccb}ಳ",
				"ಅಮ\u{cc6}ರ\u{cbf}ಕವನ\u{ccd}ನು ತ\u{ccb}ರ\u{cbf}ಸುವ ಗ\u{ccd}ಲ\u{ccb}ಬ\u{ccd}",
				"ಅಮ\u{cc6}ರ\u{cbf}ಕಾ",
				"ಗ\u{ccb}ಳ",
				"ಗ\u{ccd}ಲ\u{ccb}ಬ\u{ccd}",
				"ಭ\u{cc2}ಮ\u{cbf}",
		...
		crate::Annotation {
			...
			keywords: &["америка", "американы көрсөткөн глобус", "глобус", "дүйнө", "жер"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		crate::Annotation {
			...
			keywords: &["Америк", "Америкийг харуулсан бөмбөрцөг", "бөмбөрцөг", "дэлхий", "харуулах"],
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
		...
		crate::Annotation {
			lang:     "my",
			tts:      Some(
				"အမေရ\u{102d}ကတ\u{102d}\u{102f}က\u{103a}များပြ ကမ\u{1039}ဘာလ\u{102f}\u{1036}း",
			),
			keywords: &[
				"ကမ\u{1039}ဘာ",
				"ကမ\u{1039}ဘာမြေ",
		...
		crate::Annotation {
			...
			keywords: &["ارض نما کرہ", "امریکہ دے رہن آلے", "دنیا", "زمین", "گلوب امریکہ یکھا رہیا اے"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
			...
			keywords: &[
				"Glob",
				"Nọ\u{301}t An Saút Amẹ\u{301}ríka",
				"Raúnd Wọ\u{301}ld Map Wé De Shó Amẹ\u{301}ríkas",
				"Raúnd Wọ\u{301}ld Map Wé De Shó Nọ\u{301}t An Saút Amẹ\u{301}ríka",
				"Wọld",
				"Ẹt",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &["América", "Terra", "as Américas", "globo mostrando as Américas"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("globo com as Américas visíveis"),
			keywords: &["Américas", "Terra", "globo", "globo com as Américas visíveis", "mundo"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("saywasiqʼi america qawachkan"),
			keywords: &["America", "kawsay pacha", "pacha", "saywasiqʼi america qawachkan"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-213"), keywords: &["E10-213"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("Америка на земном шаре"),
			keywords: &["Америка", "глобус", "земной", "мир", "шар"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("umubumbe w’isi werekana Amerika zombi"),
			keywords: &["Amerika", "isi", "umubumbe w’isi", "umubumbe w’isi werekana Amerika zombi"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["Amerikat", "Bota", "Globi", "Toka", "globi që tregon Amerikat"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("глобус са Америком"),
			keywords: &["Америка", "Земља", "глобус", "зeмљa", "кугла", "свeт", "северна", "јужна"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
		...
		crate::Annotation {
			...
			keywords: &["Amerika", "Zemlja", "globus", "južna", "kugla", "severna", "svet", "zemlja"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation {
			lang:     "sr_Latn_BA",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"jordglob som visar nord- och sydamerika",
				"nord- och sydamerika",
			],
		},
		#[cfg(feature = "sw")]
		...
		crate::Annotation {
			...
			keywords: &["ล\u{e39}กโลก", "ล\u{e39}กโลกแสดงทว\u{e35}ปอเมร\u{e34}กา", "อเมร\u{e34}กา"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ንኣሜሪካታት ዘርኢ ግሎብ"),
			keywords: &["ምድሪ", "ኣሜሪካ", "ዓለም", "ዘርኢ", "ግሎብ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("Amerikany görkezýän globus"),
			keywords: &["Amerika", "Amerikany görkezýän globus", "dünýä", "ýer", "ýer togalagy"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
			tts:      Some("kolope ʻasi mai ongo ʻAmelika"),
			keywords: &["kolope", "kolope ʻasi mai ongo ʻAmelika", "māmani", "ʻAmelika"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			...
			keywords: &["ئامېرىكا", "ئىككى ئامېرىكىنى كۆرسەتكەن گىلوبۇس", "دۇنيا", "يەرشارى", "گىلوبۇس"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		crate::Annotation {
			...
			keywords: &["amerika", "dunyo", "globus", "globusda amerika qit’asi", "yer"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("địa cầu thể hiện Châu Mỹ"),
			keywords: &["Châu Mỹ", "thế giới", "thể hiện", "trái đất", "địa cầu"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			...
			keywords: &["I-Americas", "iglobhu", "iglobhu ebonisa i-America", "ihlabathi", "umhlaba"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("Gulobu To N Ṣafihan Amẹrika"),
			keywords: &["Gulobu To N Ṣafihan Amẹrika", "ayé", "gúlóbù", "àgbáyé", "àwọn amẹ\u{301}ríkà"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Gulobu To N Shafihan Amɛrika"),
			keywords: &["Gulobu To N Shafihan Amɛrika", "ayé", "gúlóbù", "àgbáyé", "àwɔn amɛ\u{301}ríkà"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("地球上的美洲"),
			keywords: &["世界", "全球", "地球", "地球上的美洲", "美洲"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("美洲"), keywords: &["地球", "美洲"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("顯示美洲嘅地球"),
			keywords: &["世界", "地球", "美洲", "美洲地球", "顯示美洲嘅地球", "顯示美洲的地球"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const GLOBE_SHOWING_ASIA_AUSTRALIA: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("aardbol met Asië en Australië"),
			keywords: &[
				"Asië",
				"Australië",
				"aardbol",
		...
		crate::Annotation {
			...
			keywords: &["ሉል", "መሬት", "አውስትራሊያ", "እስያ", "እስያና አውስትራሊያ የሚያሳይ ሉል", "ዓለም"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("كرة أرضية تعرض آسيا وأستراليا"),
			keywords: &[
				"آسيا",
				"آسيا وأستراليا",
				"أرض",
		...
		crate::Annotation {
			...
			keywords: &["азія", "аўстралія", "зямля", "зямны шар (аўстралія і азія)", "свет"],
		},
		#[cfg(feature = "bg")]
		crate::Annotation {
			lang:     "bg",
			tts:      Some("глобус с Азия и Австралия"),
			keywords: &["австралия", "азия", "глобус", "глобус с Азия и Австралия", "земята"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			...
			keywords: &["Asia", "Awstralia", "byd", "glôb yn dangos Asia-Awstralia", "y ddaear"],
		},
		#[cfg(feature = "da")]
		crate::Annotation {
			lang:     "da",
			tts:      Some("globus med Asien og Australien"),
			keywords: &["Asien", "Australien", "globus med Asien og Australien", "jorden", "verden"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["Aasia", "Aasia-Austraalia", "Austraalia", "gloobus", "maa", "maailm"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
		...
		crate::Annotation {
			...
			keywords: &["Asie", "Australie", "globe", "globe qui montre l’Asie et l’Australie", "monde"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			...
			keywords: &["Asia", "Australia", "Terra", "globo terráqueo Asia-Australia", "mundo"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("taswirar duniya mai nuna Asiya-Ostiraliya"),
			keywords: &[
				"Asiya",
				"Ostiraliya",
				"duniya",
		...
		crate::Annotation {
			...
			keywords: &["אוסטרליה", "אסיה", "גלובוס", "גלובוס עם אסיה ואוסטרליה", "כדור הארץ"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			...
			keywords: &["Asia", "Asia-Australia", "Australia", "bola dunia", "bumi", "dunia", "globe"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ụwa dum na-egosi Asia-Australia"),
			keywords: &["Asia", "Australia", "ụwa", "ụwa dum", "ụwa dum na-egosi Asia-Australia"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("hnöttur sem sýnir Asíu-Ástralíu"),
			keywords: &["Asía", "hnöttur sem sýnir Asíu-Ástralíu", "jörðin", "Ástralía"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"დედამიწა",
				"მსოფლიო",
				"რომელზეც ჩანს აზია და ავსტრალია",
			],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "kk",
			tts:      Some("Азия мен Аустралия көрсетілген глобус"),
			keywords: &[
				"Азия",
		...
		crate::Annotation {
			lang:     "kl",
			tts:      Some("globus med asien og australien"),
			keywords: &["Asien", "Australien", "globus med asien og australien", "jorden"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some(
				"ಏಷ\u{cbf}ಯಾ-ಆಸ\u{ccd}ಟ\u{ccd}ರ\u{cc7}ಲ\u{cbf}ಯಾ ತ\u{ccb}ರ\u{cbf}ಸುತ\u{ccd}ತ\u{cbf}ರುವ ಭ\u{cc2}ಗ\u{ccb}ಳ",
			),
			keywords: &[
				"ಆಸ\u{ccd}ಟ\u{ccd}ರ\u{cc7}ಲ\u{cbf}ಯಾ",
				"ಏಷ\u{cbf}ಯಾ-ಆಸ\u{ccd}ಟ\u{ccd}ರ\u{cc7}ಲ\u{cbf}ಯಾ ತ\u{ccb}ರ\u{cbf}ಸುತ\u{ccd}ತ\u{cbf}ರುವ ಜಗತ\u{ccd}ತು",
				"ಏಷ\u{cbf}ಯಾ-ಆಸ\u{ccd}ಟ\u{ccd}ರ\u{cc7}ಲ\u{cbf}ಯಾ ತ\u{ccb}ರ\u{cbf}ಸುತ\u{ccd}ತ\u{cbf}ರುವ ಭ\u{cc2}ಗ\u{ccb}ಳ",
				"ಏಷ\u{ccd}ಯಾ",
				"ಏಷ\u{ccd}ಯಾ-ಆಸ\u{ccd}ಟ\u{ccd}ರ\u{cc7}ಲ\u{cbf}ಯಾ",
				"ಏಷ\u{ccd}ಯಾ-ಆಸ\u{ccd}ಟ\u{ccd}ರ\u{cc7}ಲ\u{cbf}ಯಾವನ\u{ccd}ನು ತ\u{ccb}ರ\u{cbf}ಸುವ ಗ\u{ccd}ಲ\u{ccb}ಬ\u{ccd}",
				"ಗ\u{ccb}ಳ",
				"ಗ\u{ccd}ಲ\u{ccb}ಬ\u{ccd}",
				"ಭ\u{cc2}ಮ\u{cbf}",
				"ಭ\u{ccb}ಗ\u{ccb}ಳ",
		...
		crate::Annotation {
			...
			keywords: &["австралия", "азия", "азия-австралияны көрсөткөн глобус", "дүйнө", "жер"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		crate::Annotation {
			...
			keywords: &["Ahitereiria", "ao", "ao whakakite Āhia-Ahitereiria", "whenua", "Āhia"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["asia", "australia", "bumi", "dunia", "glob", "peta glob Asia-Australia"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
			tts:      Some("globu juri l-Asja-Awstralja"),
			keywords: &["dinja", "globu", "globu juri l-Asja-Awstralja", "l-Asja", "l-Awstralja"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
			tts:      Some("အာရ\u{103e}−ဩစတြေးလျပြ ကမ\u{1039}ဘာလ\u{102f}\u{1036}း"),
			keywords: &[
				"ကမ\u{1039}ဘာ",
				"ကမ\u{1039}ဘာမြေ",
				"ကမ\u{1039}ဘာလ\u{102f}\u{1036}း",
		...
		crate::Annotation {
			lang:     "nn",
			tts:      Some("↑↑↑"),
			keywords: &["Asia", "Australia", "jorda", "jordklode med Asia og Australia"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-214"), keywords: &["E10-214"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["ايشيا، آسٽريليا، زمين، گلوب، دنيا", "گلوب ايشيا آسٽريليا ڏيکاري پيو"],
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			...
			keywords: &["Australi", "Azi", "Bota", "globi që tregon Azinë dhe Australinë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"jordglob som visar Asien och Australien",
			],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"замин",
				"ки Осиё-Австралияро намоиш медиҳад",
				"ҷаҳон",
			],
		},
		#[cfg(feature = "th")]
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ኤስያ-ኣውስትራልያ ዘርኢ ግሎብ"),
			keywords: &["ምድሪ", "ኣውስትራልያ", "ኤስያ", "ኤስያ-ኣውስትራልያ", "ዓለም", "ዘርኢ", "ግሎብ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["Asi", "glob", "glob buy wane asi ak óstraali", "ostralia", "suuf", "àdduna"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Gulobu To N Shafihan Ashia-Ɔsiteria"),
			keywords: &[
		...
		crate::Annotation {
			...
			keywords: &["世界", "亞洲", "地球", "地球儀", "澳洲", "顯示亞洲 - 澳洲嘅地球儀"],
		},
		#[cfg(feature = "yue_Hans")]
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("显示亚洲 - 澳洲嘅地球仪"),
			keywords: &["世界", "亚洲", "地球", "地球仪", "显示亚洲 - 澳洲嘅地球仪", "澳洲"],
		},
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
		...
		crate::Annotation {
			...
			keywords: &["asia", "australia", "igilobhu", "igilobhu eliveza asia-australia", "umhlaba"],
		},
	],
};
#[doc = "🌐"]
pub const GLOBE_WITH_MERIDIANS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ሉል", "መሬት", "ሜሪዲያኖች", "ሜሪዲያኖች ያሉበት ሉል", "ኬክሮስ ኬንትሮስ", "ዓለም"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("كرة أرضية بخطوط طول"),
			keywords: &["الارض", "انترنت", "خطوط طول", "خطوط عرض", "رمز", "كرة أرضية بخطوط طول", "نت"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			...
			keywords: &["dünya", "meridianlar", "meridianları olan qlobus", "qlobus", "yer kürəsi"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["bed", "boul", "boul douar gant hedredennoù", "douar", "hedredennoù"],
		},
		#[cfg(feature = "bs")]
		crate::Annotation {
			lang:     "bs",
			tts:      Some("globus s meridijanima"),
			keywords: &["Zemlja", "globus s meridijanima", "meridijani", "svijet", "zemaljska kugla"],
		},
		#[cfg(feature = "ca")]
		crate::Annotation {
			lang:     "ca",
		...
		crate::Annotation {
			...
			keywords: &["ᎡᎶᎯ", "ᎡᎶᎯ ᏗᏟᎶᏍᏔᏅ", "ᎡᎶᎯ ᏗᏟᎶᏍᏔᏅᎢ ᎬᏩᏠᏯᏍᏗ ᎹᎵᏗᏂᏱᏏ", "ᎧᎵ ᎡᎶᎯ", "ᎹᎵᏗᏯᏂᎢ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			...
			keywords: &["Tierra", "globo", "globo terráqueo con meridianos", "meridianos", "mundo"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["gloobus", "maa", "maailm", "meridiaanid", "meridiaanidega gloobus"],
		},
		#[cfg(feature = "eu")]
		crate::Annotation {
			lang:     "eu",
			tts:      Some("globoa eta meridianoak"),
			keywords: &["globo", "globoa eta meridianoak", "lur", "meridiano", "mundu"],
		},
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang:     "fa",
		...
		crate::Annotation {
			...
			keywords: &["internet", "maailma", "maapallo", "netti", "pituuspiirit"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			...
			keywords: &["globe", "globe qui montre les méridiens", "monde", "méridiens", "terre"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("globo terráqueo con meridianos"),
			keywords: &["Terra", "globo", "globo terráqueo con meridianos", "meridianos", "mundo"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("taswirar duniya mai nuna layukan lokaci"),
			keywords: &[
				"duniya",
				"layukan lokaci",
				"taswirar duniya",
		...
		crate::Annotation {
			...
			keywords: &["גלובוס", "גלובוס עם קווי אורך ורוחב", "כדור הארץ", "קווי אורך", "קווי רוחב"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("globus s meridijanima"),
			keywords: &["globus", "globus s meridijanima", "meridijani", "svijet", "zemlja"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			...
			keywords: &["աշխարհ", "գլոբուս", "երկիր", "միջօրեականներ", "միջօրեականներով գլոբուս"],
		},
		#[cfg(feature = "id")]
		crate::Annotation {
			lang:     "id",
		...
		crate::Annotation {
			...
			keywords: &["breiddargráður", "hnöttur sem sýnir lengdarbauga", "lengdargráður"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("globo con meridiani"),
			keywords: &["globo", "globo con meridiani", "meridiani"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
			tts:      Some("子午線のある地球"),
			keywords: &["インターネット", "地球", "子午線", "子午線のある地球"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
			tts:      Some("globe mawa garis meridian"),
			keywords: &["bumi", "donya", "globe", "globe mawa garis meridian", "meridian"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
			tts:      Some("გლობუსი მერიდიანებით"),
			keywords: &["გლობუსი", "გლობუსი მერიდიანებით", "დედამიწა", "მერიდიანები", "მსოფლიო"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("Меридиандары көрсетілген глобус"),
			keywords: &["Меридиандары көрсетілген глобус", "глобус", "жер", "меридиан сызықтары", "әлем"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "kn",
			tts:      Some("ಮ\u{cc6}ರ\u{cbf}ಡ\u{cbf}ಯನ\u{ccd}\u{200c}ಗಳ\u{cbf}ರುವ ಭ\u{cc2}ಗ\u{ccb}ಳ"),
			keywords: &[
				"ಅಂತರ\u{ccd}ಜಾಲ",
				"ಇಂಟರ\u{ccd}ನ\u{cc6}ಟ\u{ccd}",
				"ಗ\u{ccd}ಲ\u{ccb}ಬ\u{ccd}",
				"ಜಗತ\u{ccd}ತು",
				"ಭ\u{cc2}ಮ\u{cbf}",
				"ಭ\u{ccb}ಗ\u{ccb}ಳ",
				"ಮ\u{cc6}ರ\u{cbf}ಡ\u{cbf}ಯನ\u{ccd}ಸ\u{ccd}",
				"ಮ\u{cc6}ರ\u{cbf}ಡ\u{cbf}ಯನ\u{ccd}\u{200c}ಗಳ\u{cbf}ರುವ ಭ\u{cc2}ಗ\u{ccb}ಳ",
				"ಮ\u{cc6}ರ\u{cbf}ಡ\u{cbf}ಯನ\u{ccd}\u{200c}ಗಳ\u{cca}ಂದ\u{cbf}ಗ\u{cc6} ಜಗತ\u{ccd}ತು",
				"ವ\u{cbf}ಶ\u{ccd}ವ",
				"ವ\u{cbf}ಶ\u{ccd}ವಾದ\u{ccd}ಯಂತ",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("자오선 지구"),
			keywords: &["경도", "세계", "월드와이드", "웹", "위도", "인터넷", "자오선", "지구"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["глобус", "дүйнө", "жер", "меридиан сызыктары менен глобус", "меридиандар"],
		},
		#[cfg(feature = "lb")]
		crate::Annotation {
			lang:     "lb",
		...
		crate::Annotation {
			...
			keywords: &["Internet", "bumi", "dunia", "glob", "glob dengan garisan meridian", "meridian"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["jorda", "jordklode med meridianar", "lengde- og breiddegrader"],
		},
		#[cfg(feature = "or")]
		crate::Annotation {
			lang:     "or",
		...
		crate::Annotation {
			...
			keywords: &["ارض نما کرہ", "دنیا", "زمین", "طول البدل نال گلوب", "نصف النہار"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			...
			keywords: &["د نصف لنهار ليکه", "نصف لنهار", "نړۍ", "نړۍ د نصف لنهارليکې سره", "ځمکه", "کره"],
		},
		#[cfg(feature = "pt")]
		crate::Annotation {
			lang:     "pt",
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["Terra", "globo", "globo com meridianos", "internet", "meridianos", "mundo"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("saywasiqʼi meridianoswan"),
			keywords: &["kawsay pacha", "meridianos", "pacha", "saywasiqʼi meridianoswan"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-215"), keywords: &["E10-215"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("меридианы"),
			keywords: &["Земля", "глобус", "земной", "меридиан", "меридианы", "мир", "шар"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			...
			keywords: &["glóbus", "poludníky", "svet", "web", "zem", "zemeguľa", "zemeguľa s poludníkmi"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
			tts:      Some("globus s poldnevniki"),
			keywords: &["globus", "globus s poldnevniki", "poldnevniki", "splet", "svet", "zemlja"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
			tts:      Some("adduunka oo leh dhigo"),
			keywords: &["adduunka", "adduunka oo leh dhigo", "dhigo", "dhulka", "dunida"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("globi me meridianë"),
			keywords: &["botë", "globi", "internet", "meridianë", "toka"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			lang:     "sr_Cyrl_BA",
			tts:      Some("↑↑↑"),
			keywords: &["глoбус", "глобус са меридијанима", "зeмљa", "мeридиjaни", "свијeт"],
		},
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
		...
		crate::Annotation {
			lang:     "sr_Latn_BA",
			tts:      Some("↑↑↑"),
			keywords: &["globus", "globus sa meridijanima", "meridijani", "svijet", "zemlja"],
		},
		#[cfg(feature = "sv")]
		crate::Annotation {
			lang:     "sv",
		...
		crate::Annotation {
			...
			keywords: &["dunia", "meridiani", "tufe", "tufe lenye meridiani", "ulimwengu"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"మ\u{c46}ర\u{c3f}డ\u{c3f}యన\u{c4d}స\u{c4d}",
				"మ\u{c46}ర\u{c3f}డ\u{c3f}యన\u{c4d}స\u{c4d} త\u{c4b} గ\u{c4d}ల\u{c4a}బ\u{c4d}",
				"వరల\u{c4d}డ\u{c4d}\u{200c}వ\u{c48}డ\u{c4d} వ\u{c46}బ\u{c4d}",
			],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			...
			keywords: &["глобус", "глобус бо меридианаҳо", "замин", "меридианҳо", "ҷаҳон"],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
			lang:     "th",
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ግሎብ ምስ ሜሪድያን"),
			keywords: &["መርበብ ሓበሬታ", "ሜሪድያን", "ምድሪ", "ኢንተርነት", "ኣብ መላእ ዓለም", "ዓለም", "ግሎብ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("meridianly globus"),
			keywords: &["dünýä", "meridianlar", "meridianly globus", "ýer", "ýer togalagy"],
		},
		#[cfg(feature = "to")]
		crate::Annotation {
			lang:     "to",
			tts:      Some("kolope moe ngaahi melitiane"),
			keywords: &["kolope", "kolope moe ngaahi melitiane", "melitiane", "māmani"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("meridyenli yerküre"),
			keywords: &["boylamlar", "dünya", "meridyen", "meridyenli yerküre", "yerküre"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
			tts:      Some("مېردىيانلىق گىلوبۇس"),
			keywords: &["دۇنيا", "مېردىيان", "مېردىيانلىق گىلوبۇس", "يەرشارى", "گىلوبۇس"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
		...
		crate::Annotation {
			...
			keywords: &["glob", "glob buy wane merijeŋ yi", "merijeŋ", "suuf", "àdduna"],
		},
		#[cfg(feature = "xh")]
		crate::Annotation {
			lang:     "xh",
			tts:      Some("iglobhu enemeridian"),
			keywords: &["i-meridians", "iglobhu", "iglobhu enemeridian", "ihlabathi", "umhlaba"],
		},
		#[cfg(feature = "yo")]
		crate::Annotation {
			lang:     "yo",
			tts:      Some("Gulobu Pẹlu Mẹridiani"),
			keywords: &["Gulobu Pẹlu Mẹridiani", "ayé", "gúlóbù", "mẹ\u{300}rídíánì", "àgbáyé"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Gulobu Pɛlu Mɛridiani"),
			keywords: &["Gulobu Pɛlu Mɛridiani", "ayé", "gúlóbù", "mɛ\u{300}rídíánì", "àgbáyé"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("带经纬线的地球"),
			keywords: &["世界", "全球", "地球", "子午线", "带经纬线的地球", "经纬", "经线"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
		...
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("帶有經緯嘅地球"),
			keywords: &["www", "世界", "互聯網", "地球", "帶有經緯嘅地球", "經緯", "經緯線", "網絡"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
			tts:      Some("igilobhu elinemeridians"),
			keywords: &["igilobhu", "igilobhu elinemeridians", "meridians", "umhlaba"],
		},
	],
};
#[doc = "🗺\u{fe0f}"]
pub const WORLD_MAP: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["kaart", "sewe vastelande", "skematiese voorstelling", "wêreld", "wêreldkaart"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		#[cfg(feature = "en")]
		crate::Annotation { lang: "en", tts: Some("world map"), keywords: &["map", "world"] },
		#[cfg(feature = "en_AU")]
		crate::Annotation { lang: "en_AU", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "en_CA")]
		crate::Annotation { lang: "en_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("mapamundi"),
			keywords: &["atlas", "mapa", "mapa del mundo", "mapa mundial", "mapamundi", "mundo"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["carte", "monde"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			...
			keywords: &["જમીન", "ધરતી", "ધરા", "નકશો", "વિશ\u{acd}વ", "વિશ\u{acd}વનો નકશો"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		#[cfg(feature = "ig")]
		crate::Annotation { lang: "ig", tts: Some("maapụ ụwa"), keywords: &["maapụ", "ụwa"] },
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("heimskort"),
		...
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang: "kk", tts: Some("карта"), keywords: &["карта", "әлем"]
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &["ផែនទ\u{17b8}", "ផែនទ\u{17b8}ព\u{17b7}ភពលោក", "ព\u{17b7}ភពលោក"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("세계 지도"), keywords: &["세계", "지도"] },
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		#[cfg(feature = "mi")]
		crate::Annotation { lang: "mi", tts: Some("mahere ao"), keywords: &["ao", "mahere"] },
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			...
			keywords: &["ਨਕਸ\u{a3c}ਾ", "ਮ\u{a48}ਪ", "ਸ\u{a70}ਸਾਰ", "ਸ\u{a70}ਸਾਰ ਦਾ ਨਕਸ\u{a3c}ਾ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-830"), keywords: &["E10-830"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("карта мира"),
		...
		crate::Annotation {
			...
			keywords: &["உலக வரைபடம\u{bcd}", "உலகம\u{bcd}", "மேப\u{bcd}", "வரைபடம\u{bcd}"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
			tts:      Some("ప\u{c4d}రపంచపటం"),
			keywords: &["ప\u{c4d}రపంచం", "ప\u{c4d}రపంచపటం", "మ\u{c4d}య\u{c3e}ప\u{c4d}"],
		},
		#[cfg(feature = "tg")]
		crate::Annotation {
			lang:     "tg",
		...
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation { lang: "zh_Hant_HK", tts: Some("世界"), keywords: &["↑↑↑"] },
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const MAP_OF_JAPAN: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["Japan", "Tokio", "eilande", "eilandnasie", "kaart", "kaart van Japan"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["Japon", "carte"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
		...
		crate::Annotation {
			...
			keywords: &["Giappone", "Mappa del Giappone", "mappa", "mappa del Giappone"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		#[cfg(feature = "ko")]
		crate::Annotation { lang: "ko", tts: Some("일본 지도"), keywords: &["일본", "지도"] },
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			...
			keywords: &["Јапонија", "карта", "карта на Јапонија", "мапа", "мапа на Јапонија"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("kaart van Japan"),
			keywords: &["Japan", "japan", "kaart", "kaart van Japan", "kaart van japan"],
		},
		#[cfg(feature = "nn")]
		...
		crate::Annotation {
			...
			keywords: &["Japonia", "harta Japoniei", "harta japoniei", "hartă", "japonia"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-834"), keywords: &["E10-834"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["ජප\u{dcf}නය", "ජප\u{dcf}නයේ ස\u{dd2}ත\u{dd2}යම", "ස\u{dd2}ත\u{dd2}යම"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		crate::Annotation {
			...
			keywords: &["Japonska", "japonska", "zemljevid", "zemljevid Japonske", "zemljevid japonske"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang: "ti", tts: Some("ካርታ ጃፓን"), keywords: &["ካርታ", "ጃፓን"]
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
...
pub const COMPASS: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("kompas"),
			keywords: &["kompas", "magneties", "navigasie", "oriëntering", "rigting"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
			tts:      Some("ኮምፓስ"),
			keywords: &["ማሰስ", "ማቅጠጥ", "ማግኔቲክ", "አቅጣጫ", "ኮምፓስ", "የባህር ጉዞ", "ጉዞ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			lang:     "bg",
			tts:      Some("компас"),
			keywords: &["компас", "магнит", "навигация", "ориентиране"],
		},
		#[cfg(feature = "bn")]
		crate::Annotation {
			lang:     "bn",
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("brúixola"),
			keywords: &["brúixola", "direcció", "magnètic", "magnètica", "navegació", "orientació"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
			tts:      Some("ᎠᎳᏂ ᎠᎦᏙᏗ"),
			keywords: &["ᎠᎳᏂ ᎠᎦᏙᏗ", "ᎠᎾᏓᎪᎾᏗᏍᎬ ᎡᎶᎯ ᎠᏟᎶᎥᎢ ᎬᏔᏅᎢ", "ᎠᏓᏘᏂᏙᎯ", "ᏔᎷᎩᏍᎩ ᎦᏌᏁᏍᎩ"],
		},
		#[cfg(feature = "cs")]
		crate::Annotation {
			lang:     "cs",
		...
		crate::Annotation {
			lang:     "da",
			tts:      Some("kompas"),
			keywords: &["kompas", "magnetisk", "navigation", "orientering", "verdenshjørne"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			lang:     "es",
			tts:      Some("brújula"),
			keywords: &["brújula", "compás", "magnético", "navegación", "orientación"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("↑↑↑"),
			keywords: &["brújula", "dirección", "magnetismo", "navegación", "orientación", "rumbo"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("boussole"),
			keywords: &["boussole", "compas", "direction", "magnétique", "navigation", "orientation"],
		},
		#[cfg(feature = "fr_CA")]
		...
		crate::Annotation {
			lang:     "gl",
			tts:      Some("compás"),
			keywords: &["magnético", "navegación", "orientación"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			...
			keywords: &[
				...
				"પહો\u{a82}ચ",
				"માર\u{acd}ગ",
				"માર\u{acd}ગદર\u{acd}શન",
				"મ\u{ac7}ગ\u{acd}ન\u{ac7}ટિક",
				"સફર",
				"સીમા",
				"હોકાય\u{a82}ત\u{acd}ર",
			],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
			tts:      Some("kamfas"),
			keywords: &["fuskantarwa", "kamfas", "kewayawa", "kewaye", "maganaɗisu", "neman hanya"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("מצפן"),
			keywords: &["התמצאות", "כיוון", "מגנטי", "מצפן", "ניווט", "צפון"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
			...
			keywords: &[
				...
				"क\u{902}पास",
				"च\u{941}\u{902}बकीय",
				"डायर\u{947}क\u{94d}शन",
				"दक\u{94d}षिण",
				"दिशा",
				"दिशा स\u{942}चक य\u{902}त\u{94d}र",
				"दिशास\u{942}चक",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("iránytű"),
			keywords: &["irány", "iránytű", "mágneses", "navigáció", "tájékozódás"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "is",
			tts:      Some("áttaviti"),
			keywords: &["kompás", "leiðarlýsing", "leiðsögn", "segulmagn", "áttaviti"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("bussola"),
			keywords: &["bussola", "direzione", "magnetica", "navigazione", "orientamento"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
			tts:      Some("コンパス"),
			keywords: &["オリエンテーリング", "コンパス", "方位磁針", "方角", "磁石", "航海", "航空"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("tabuṣult"), keywords: &["tabuṣult"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("компас"),
			keywords: &["бағыт", "бағыт алу", "компас", "магнит", "навигация"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("나침반"),
			keywords: &["길찾기", "나침반", "네비게이션", "오리엔티어링", "자석"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
		...
		crate::Annotation {
			lang:     "lt",
			tts:      Some("kompasas"),
			keywords: &["kompasas", "kryptis", "magnetinis", "navigacija", "orientacinis"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("kompass"),
			keywords: &["kompass", "magnētisks", "navigācija", "orientēšanās", "virziens"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
			tts:      Some("компас"),
			keywords: &["компас", "магнетно", "навигација", "насока", "ориентирање"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ओरिय\u{902}टरि\u{902}ग",
				"च\u{941}\u{902}बकीय",
				"दिशानिर\u{94d}द\u{947}श",
		...
		crate::Annotation {
			lang:     "ms",
			tts:      Some("kompas"),
			keywords: &["arah", "bermagnet", "kompas", "magnet", "mengorientasi", "navigasi", "panduan"],
		},
		#[cfg(feature = "my")]
		crate::Annotation {
			lang:     "my",
		...
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Kọ\u{301}mpas"),
			keywords: &[
				"Kọ\u{301}mpas",
				"Kọ\u{301}mpas: Sọ\u{301}mtin Wé Go Hẹ\u{301}lẹ\u{301}p Yú Faínd Wiá Yu De Gò",
				"Magnẹ\u{301}tọ",
				"To Faínd Di Rod Wé Yu Go Fọ\u{301}ló Gó Sọm Ples",
				"Ọriẹ\u{301}ntirin: Átlẹ\u{301}tík Spọts Wé Pípul De Ték Lẹg Waká Fọ Bush Kwík Kwik",
			],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["bússola", "direção", "navegação", "orientação"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("compas"),
			keywords: &["compas", "magnetico", "navegacion", "tarikuynin"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("busolă"),
			keywords: &["busolă", "compas", "direcție", "magnetic", "navigație", "orientare", "pol"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-055"), keywords: &["E11-055"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("компас"),
		...
		crate::Annotation {
			lang:     "sl",
			tts:      Some("kompas"),
			keywords: &["kompas", "magnet", "navigacija", "orientacija", "smer"],
		},
		#[cfg(feature = "so")]
		crate::Annotation {
			lang:     "so",
		...
		crate::Annotation {
			lang:     "sq",
			tts:      Some("busull"),
			keywords: &["busull", "drejtim", "fushë magnetike", "magnetik", "orientim"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
		...
		crate::Annotation {
			lang:     "sw",
			tts:      Some("dira"),
			keywords: &["dira", "kuelekeza", "maelekezo", "smaku", "usafiri"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		crate::Annotation {
			...
			keywords: &[
				...
				"திசை",
				"திசைக\u{bbe}ட\u{bcd}டி",
				"நேவிகேஷன\u{bcd}",
				"மேக\u{bcd}னட\u{bcd}டிக\u{bcd}",
				"வழி",
				"வழிச\u{bcd}செலுத\u{bcd}தல\u{bcd}",
			],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			...
			keywords: &[
				...
				"కంప\u{c3e}స\u{c4d}",
				"డ\u{c48}ర\u{c46}క\u{c4d}షన\u{c4d}",
				"ద\u{c3f}క\u{c4d}సూచ\u{c3f}",
				"ద\u{c3f}శల సూచ\u{c3f}క",
				"న\u{c3e}వ\u{c3f}గ\u{c47}షన\u{c4d}",
				"మ\u{c3e}గ\u{c4d}న\u{c46}ట\u{c3f}క\u{c4d}",
			],
		},
		#[cfg(feature = "th")]
		crate::Annotation {
		...
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ኮምፓስ"),
			keywords: &["ማግኔታዊ", "ናይ ምጉዓዝ መንገዲ", "ኣንፈት", "ኣንፈት ምምራሕ", "ኮምፓስ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("kāpasa"), keywords: &["kāpasa"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("pusula"),
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("atọ\u{301}nà"),
			keywords: &["atọ\u{301}nà", "lílẹ\u{300}mọ\u{301}", "sísọfún"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("atɔ\u{301}nà"),
			keywords: &["atɔ\u{301}nà", "lílɛ\u{300}mɔ\u{301}", "sísɔfún"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("指南针"),
			keywords: &["定向", "导航", "指南针", "方向", "磁性", "罗盘"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("指南針"),
			keywords: &["定向", "導航", "指南針", "方向", "磁鐵", "羅盤"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("↑↑↑"),
			keywords: &["導航", "指南針", "方向", "磁力", "磁場", "野外定向"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
