...
pub const BELLHOP_BELL: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["ሆቴል", "መጥሪያ", "የሆቴል ሻንጣ ተቀባይ ደወል", "ደወል"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("جرس فندق"),
			keywords: &["اوتيل", "جرس", "فندق", "مساعدة"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "bn",
			tts:      Some("বেলহপ বেল"),
			keywords: &["ঘণ\u{9cd}ট\u{9be}", "বেয\u{9bc}\u{9be}র\u{9be}", "বেলহপ", "বেলহপ বেল", "হোটেল"],
		},
		#[cfg(feature = "br")]
		crate::Annotation {
			lang:     "br",
		...
		crate::Annotation {
			...
			keywords: &["hotel", "hotelklokke", "klokke", "reception"],
		},
		#[cfg(feature = "de")]
		crate::Annotation {
			lang:     "de",
		...
		crate::Annotation {
			...
			keywords: &["cloche", "cloche de comptoir", "clochette", "hôtel", "réception", "sonnette"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
			tts:      Some("↑↑↑"),
			keywords: &["cloche", "comptoir", "hôtel"],
		},
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("clog óstáin"),
			keywords: &["clog", "clog óstáin", "giolla cloig", "óstán"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &["campaíña", "campaíña de recepción", "hotel", "recepción", "timbre"],
		},
		#[cfg(feature = "gu")]
		crate::Annotation {
			lang:     "gu",
			tts:      Some("બ\u{ac7}લહોપ ઘ\u{a82}ટડી"),
			keywords: &["ઘ\u{a82}ટડી", "ઘ\u{a82}ટી", "બ\u{ac7}લહોપ ઘ\u{a82}ટડી", "સાધન", "હોટલ"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		crate::Annotation {
			...
			keywords: &["घ\u{902}टी", "ब\u{947}लहॉप घ\u{902}टी", "ब\u{947}लहॉप घ\u{902}टी, होटल", "होटल"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("bel meja"),
			keywords: &["bel", "bel meja", "hotel", "lonceng"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			...
			keywords: &["campanello", "campanello da hotel", "campanello d’hotel", "hotel", "reception"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			...
			keywords: &["កណ\u{17d2}ដ\u{17b9}ង", "កណ\u{17d2}ត\u{17b9}ង", "កន\u{17d2}ត\u{17b9}ង"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
			...
			keywords: &[
				"ಗಂಟ\u{cc6}",
				"ಬ\u{cc6}ಲ\u{ccd}",
				"ಬ\u{cc6}ಲ\u{ccd}\u{200c}ಹಾಪ\u{ccd}",
		...
		crate::Annotation {
			...
			keywords: &["ब\u{945}ल", "ब\u{945}लहोप", "ब\u{945}लहोप ब\u{947}ल", "हॉट\u{947}ल"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			...
			keywords: &["портир", "рецепција", "хотел", "ѕвонче", "ѕвонче на рецепција"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			...
			keywords: &["ब\u{947}ल", "ब\u{947}लहप", "ब\u{947}लहप घन\u{94d}टी", "होट\u{947}ल"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("piccolobel"),
			keywords: &["balie", "baliebel", "bel", "hotel", "piccolobel"],
		},
		#[cfg(feature = "nn")]
		...
		crate::Annotation {
			...
			keywords: &["ਘ\u{a70}ਟੀ", "ਟ\u{a71}ਲੀ", "ਦਰਬਾਨ", "ਹ\u{a4b}ਟਲ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
			tts:      Some("وردی پوش دربان دی گھنٹی"),
			keywords: &["وردی پوش دربان دی گھنٹی", "کلب دا وردی پوش دربان", "گھنٹی", "ہوٹل"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			...
			keywords: &["dzwonek", "dzwonek w recepcji", "hotel", "przywołać", "recepcja"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("sineta"),
			keywords: &["hotel", "portaria", "sineta", "sino"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("campainha de receção"),
			keywords: &["campainha", "campainha de receção", "hotel", "paquete", "rececionista"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		crate::Annotation {
			...
			keywords: &["clopoțel", "hotel", "recepție", "sonerie", "sonerie de recepție"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-989"), keywords: &["E10-989"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
		...
		crate::Annotation {
			...
			keywords: &["звoнo", "рeцeпциja", "хoтeл"],
		},
		...
		crate::Annotation {
			...
			keywords: &["hotel", "recepcija", "zvono"],
		},
		...
		crate::Annotation {
			...
			keywords: &["hotell", "klocka", "piccolo", "plingklocka", "receptionsklocka"],
		},
		#[cfg(feature = "sw")]
		crate::Annotation {
			lang:     "sw",
		...
		crate::Annotation {
			...
			keywords: &[
				"அழைக\u{bcd}கும\u{bcd} மணி",
				"அழைப\u{bcd}பு மணி",
				"க\u{bbe}லிங\u{bcd} பெல\u{bcd}",
				"பெல\u{bcd}",
			],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			...
			keywords: &[
				"బ\u{c46}ల\u{c4d}",
				"బ\u{c46}ల\u{c4d}\u{200c}హ\u{c3e}ప\u{c4d}",
				"సర\u{c4d}వర\u{c4d}",
				"సర\u{c4d}వర\u{c4d}\u{200c}న\u{c3f} ప\u{c3f}లవడ\u{c3e}న\u{c3f}క\u{c3f} వ\u{c3e}డ\u{c47} బ\u{c46}ల\u{c4d}",
				"హ\u{c4b}టల\u{c4d}",
			],
		...
		crate::Annotation {
			...
			keywords: &["กระด\u{e34}\u{e48}ง", "กระด\u{e34}\u{e48}งโรงแรม", "พน\u{e31}กงาน", "โรงแรม"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ቤልሆፕ ደወል"),
			keywords: &["ሆቴል", "ቤልሆፕ", "ደወል"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["готель", "готельний дзвоник", "дзвоник", "сервіс"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("بیل ہاپ بیل"),
			keywords: &["بیل", "بیل ہاپ", "ہوٹل"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("agogo alágbágbɛ\u{301}rùn ilé ìtura"),
			keywords: &[
				"agogo",
				"agogo alágbágbɛ\u{301}rùn ilé ìtura",
				"alágbágbɛ\u{301}rùn ilé ìtura",
				"ilé ìtura",
			],
		},
		#[cfg(feature = "yue")]
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("服务铃"),
			keywords: &["服务铃", "行李员", "酒店", "铃"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation { lang: "zh_Hant", tts: Some("服務鈴"), keywords: &["服務鈴"] },
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("叮叮鐘"),
			keywords: &["㩒鐘", "叮叮鐘", "按鈴", "按鐘", "撳鐘", "服務鈴", "服務鐘", "酒店", "鐘"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const LUGGAGE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("bagasie"),
			keywords: &["bagasie", "inpak", "pak", "reis", "tas", "tas op wieletjies"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["পেকিং", "ম\u{9be}লবস\u{9cd}ত\u{9c1}", "য\u{9be}ত\u{9cd}ৰ\u{9be}"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
		...
		crate::Annotation {
			lang:     "de",
			tts:      Some("Gepäck"),
			keywords: &["Ballast", "Gepäck", "Hartschalenkoffer", "Koffer", "Reise", "Trolley-Tasche"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			...
			keywords: &["matka", "matkalaukku", "matkatavara", "matkustus", "pakkaaminen"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("kaya"),
			keywords: &["akwati mai taya", "kaya", "shirin tafiya", "shiryawa", "tafiya"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "hu",
			tts:      Some("bőrönd"),
			keywords: &["bőrönd", "csomag", "csomagolás", "gurulós", "poggyász", "utazás"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("koper"),
			keywords: &["bepergian", "berkemas", "jalan-jalan", "koper", "mengepak", "roda", "tas"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("スーツケース"),
			keywords: &["キャリーケース", "スーツケース", "パッキング", "旅行", "旅行かばん"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		#[cfg(feature = "ky")]
		crate::Annotation { lang: "ky", tts: Some("жүк"), keywords: &["жүк", "саякат"] },
		#[cfg(feature = "lo")]
		crate::Annotation {
			lang:     "lo",
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("bagāža"),
			keywords: &["bagāža", "ceļojums", "koferis", "koferis uz ritenīšiem", "pakošanās"],
		},
		#[cfg(feature = "mk")]
		crate::Annotation {
			lang:     "mk",
		...
		crate::Annotation {
			lang:     "ml",
			tts:      Some("ലഗേജ\u{d4d}"),
			keywords: &["പ\u{d3e}ക\u{d4d}കിംഗ\u{d4d}", "യ\u{d3e}ത\u{d4d}ര", "ലഗേജ\u{d4d}"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			lang:     "ne",
			tts:      Some("लग\u{947}ज"),
			keywords: &["प\u{94d}याक गर\u{94d}न\u{947} कार\u{94d}य", "यात\u{94d}रा", "लग\u{947}ज"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("bagage"),
			keywords: &["bagage", "inpakken", "koffer", "reis", "reizen", "rolkoffer", "trolley"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		crate::Annotation {
			...
			keywords: &["ପ\u{b4d}ୟ\u{b3e}କ\u{b3f}ଂ", "ଯ\u{b3e}ତ\u{b4d}ର\u{b3e}", "ଲଗେଜ\u{b4d}\u{200d}"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		#[cfg(feature = "qu")]
		crate::Annotation { lang: "qu", tts: Some("equipaje"), keywords: &["equipaje"] },
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("bagaj"),
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E11-061"), keywords: &["E11-061"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("багаж"),
		...
		crate::Annotation {
			...
			keywords: &["ඇස\u{dd4}ර\u{dd4}ම", "ගමන\u{dca} කරනව\u{dcf}", "ගමන\u{dca} මල\u{dd4}"],
		},
		#[cfg(feature = "sk")]
		crate::Annotation {
			lang:     "sk",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("katoleta"), keywords: &["katoleta"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("bavul"),
			keywords: &["bagaj", "bavul", "seyahat", "tatil", "valiz", "yol", "yolculuk", "çanta"],
		},
		#[cfg(feature = "uk")]
		crate::Annotation {
			lang:     "uk",
			tts:      Some("багаж"),
			keywords: &["багаж", "валіза", "пакувати", "подорож", "торба на коліщатках", "чемодан"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("سامان"),
			keywords: &["سامان", "سامان، پیکنگ، سفر، سوٹ کیس، رولر بیگ", "سفر", "پیکنگ"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
		...
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("行李"), keywords: &["旅行", "行李"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation { lang: "yue_Hans", tts: Some("行李"), keywords: &["旅行", "行李"] },
		#[cfg(feature = "zh")]
		crate::Annotation {
			lang:     "zh",
			tts:      Some("行李箱"),
