...
pub const CHURCH: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("ቤተክርስትያን"),
			keywords: &["ሕንጻ", "መስቀል", "ቅዱስ", "ቤተ መቅደስ", "ቤተ ክርስቲያን", "ቤተክርስትያን", "ኃይማኖት", "ክርስትያን"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("كنيسة"),
			keywords: &["كنيسة", "مبنى", "مسيحية"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "de",
			tts:      Some("Kirche"),
			keywords: &["Christ", "Christentum", "Gebäude", "Kirche", "Kreuz", "Religion", "christlich"],
		},
		#[cfg(feature = "de_CH")]
		...
		crate::Annotation {
			lang:     "en",
			tts:      Some("church"),
			keywords: &["Christian", "bless", "chapel", "church", "cross", "religion"],
		},
		#[cfg(feature = "en_AU")]
		...
		crate::Annotation {
			lang:     "fo",
			tts:      Some("kirkja"),
			keywords: &["kirkja", "kristin", "religión", "trúgv", "átrúnaður", "átrúni"],
		},
		#[cfg(feature = "fr")]
		crate::Annotation {
			lang:     "fr",
			tts:      Some("église"),
			keywords: &["bâtiment", "chapelle", "chrétien", "croix", "religion", "voyage", "église"],
		},
		#[cfg(feature = "fr_CA")]
		...
		crate::Annotation {
			lang:     "ga",
			tts:      Some("séipéal"),
			keywords: &["Críostaí", "creideamh", "cros", "foirgneamh", "séipéal"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ખ\u{acd}રિસ\u{acd}તી પ\u{ac2}જાસ\u{acd}થાન",
				"ચર\u{acd}ચ",
				"દ\u{ac7}વળ",
				"ધર\u{acd}મ",
				"ભવન",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("coci"),
			keywords: &["Kirista", "addini", "coci", "ikilisiya", "kuros", "majamiʼa", "wajen ibada"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			...
			keywords: &["चर\u{94d}च", "चर\u{94d}च, भवन", "धर\u{94d}म", "भवन"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("gereja"),
			keywords: &["Kristen", "Kristiani", "agama", "berkah", "berkat", "gereja", "kapel", "salib"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ụlọụkà"),
			keywords: &["Ndị òtù Christi", "gozie", "obe", "okpukperechi", "ụlọụkà"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("教会"),
			keywords: &["キリスト教", "チャペル", "十字架", "宗教", "建物", "教会", "礼拝堂"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		crate::Annotation {
			lang:     "ka",
			tts:      Some("ეკლესია"),
			keywords: &["ეკლესია", "რელიგია", "ქრისტიანობა", "ქრისტიანული", "შენობა", "ჯვარი"],
		},
		#[cfg(feature = "kab")]
		crate::Annotation {
			lang:     "kab",
			tts:      Some("tamezgida n yimasiḥiyen"),
			keywords: &["tamezgida n yimasiḥiyen"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("шіркеу"),
			keywords: &["дін", "крест", "христиан", "шіркеу", "ғибадатхана", "ғимарат", "құру"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			lang:     "ko",
			tts:      Some("교회"),
			keywords: &["건물", "교회", "기독교", "빌딩", "십자가", "예배당", "종교", "축복", "크리스찬"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("चर\u{94d}च"),
			keywords: &["किरिस\u{94d}ता\u{902}व", "क\u{94d}रॉस", "चर\u{94d}च", "धर\u{94d}म"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("baznīca"),
			keywords: &["baznīca", "kristieši", "krusts", "lūgties", "māja", "reliģija", "ēka"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &[
				"ക\u{d4d}രിസ\u{d4d}ത\u{d4d}യൻ പള\u{d4d}ളി",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("kerk"),
			keywords: &["christelijk", "geloof", "kapel", "kerk", "kruis", "religie"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation {
			lang:     "nn",
		...
		crate::Annotation {
			...
			keywords: &["କୋଠ\u{b3e}", "ଗୀର\u{b4d}ଜ\u{b3e}", "ଚର\u{b4d}ଚ\u{b4d}", "ଚର\u{b4d}ଚ\u{b4d}ଚ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਗਿਰਜਾ ਘਰ"),
			keywords: &["ਇਮਾਰਤ", "ਕ\u{a4d}ਰਾਸ", "ਗਿਰਜਾ ਘਰ", "ਚਰਚ", "ਧਰਮ", "ਪਾਦਰੀ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("igreja"),
			keywords: &["capela", "cristã", "cristão", "igreja", "missa", "prédio", "religião"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["capela", "cristã", "cristão", "cruz", "igreja", "religião"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-109"), keywords: &["E10-109"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("церковь"),
			keywords: &["здание", "монастырь", "религия", "собор", "храм", "христианство", "церковь"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			lang:     "so",
			tts:      Some("Kaniisad"),
			keywords: &["Kaniisad", "diin", "mactab", "masiixi"],
		},
		#[cfg(feature = "sq")]
		crate::Annotation {
			lang:     "sq",
			tts:      Some("kishë"),
			keywords: &["bekim", "e krishterë", "fe", "kishë", "kryq", "ndërtesë"],
		},
		#[cfg(feature = "sr")]
		crate::Annotation {
			lang:     "sr",
			tts:      Some("црква"),
			keywords: &["згрaдa", "капела", "крст", "рeлигиja", "хришћaнствo", "црква"],
		},
		...
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("crkva"),
			keywords: &["crkva", "hrišćanstvo", "kapela", "krst", "religija", "zgrada"],
		},
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"క\u{c4d}ర\u{c40}స\u{c4d}తు ఆలయం",
				"క\u{c4d}ర\u{c40}స\u{c4d}తు మతం",
				"చర\u{c4d}చ\u{c3f}",
				"చర\u{c4d}చ\u{c4d}",
				"చ\u{c3e}ప\u{c46}ల\u{c4d}",
				"బ\u{c4d}ల\u{c46}స\u{c4d}",
				"మతం",
			],
		},
		#[cfg(feature = "tg")]
		...
		crate::Annotation {
			lang:     "th",
			tts:      Some("โบสถ\u{e4c}"),
			keywords: &["คร\u{e34}สต\u{e4c}", "ศาสนสถาน", "ศาสนา", "โบสถ\u{e4c}", "ไม\u{e49}กางเขน"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ቤተ ክርስትያን"),
			keywords: &["ሃይማኖት", "ህንጻ", "መስቀል", "ቤተ ክርስትያን", "ቤተክርስትያን", "ክርስትና", "ክርስትያን"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		#[cfg(feature = "to")]
		crate::Annotation { lang: "to", tts: Some("falelotu"), keywords: &["falelotu"] },
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("kilise"),
			keywords: &["Hristiyan", "bina", "din", "haç", "hristiyan", "kilise", "papaz"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "uk",
			tts:      Some("церква"),
			keywords: &["будівля", "релігія", "хрест", "християнський", "церква"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("گرجا گھر"),
			keywords: &["دعا", "عمارت", "عیسائیت", "کراس", "کلیسہ", "گرجا گھر"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("cherkov"),
			keywords: &["bino", "cherkov", "din", "nasroniylik", "xoch", "xristian"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("nhà thờ"),
			keywords: &["cây thánh giá", "cầu nguyện", "nhà thờ", "tôn giáo", "Đạo cơ đốc"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("Ṣọọṣi"),
			keywords: &["àgbélèbú", "Ṣọọṣi", "ẹlẹ\u{301}sìn ìgbàgbó\u{329}", "ẹ\u{300}sìn"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Shɔɔshi"),
			keywords: &["Shɔɔshi", "àgbélèbú", "ɛlɛ\u{301}sìn ìgbàgbó\u{329}", "ɛ\u{300}sìn"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
...
pub const MOSQUE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("moskee"),
			keywords: &["Islam", "Moslem", "godsdiens", "islam", "masiet", "moskee", "moslem"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
			tts:      Some("መስጂድ"),
			keywords: &["መስጂድ", "መስጊድ", "ሙስሊም", "ኃይማኖት", "እስላም"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("mesquita"),
			keywords: &["islam", "mesquita", "musulmana", "musulmà", "religió"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			lang:     "cs",
			tts:      Some("mešita"),
			keywords: &["islám", "mešita", "muslim", "náboženství", "vyznání", "víra"],
		},
		#[cfg(feature = "cy")]
		crate::Annotation {
			lang:     "cy",
		...
		crate::Annotation {
			lang:     "en",
			tts:      Some("mosque"),
			keywords: &["Muslim", "islam", "masjid", "mosque", "religion"],
		},
		#[cfg(feature = "en_001")]
		crate::Annotation {
			lang:     "en_001",
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("mosquée"),
			keywords: &["islam", "mosquée", "musulman", "musulmane", "religion", "voyage"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ઇસ\u{acd}લામ",
				"ઈબાદત",
				"ઈશ\u{acd}વરભક\u{acd}તિ",
				"ધર\u{acd}મ",
				"ધર\u{acd}મમાર\u{acd}ગ",
				"નમાજ",
				"પ\u{ac2}જા",
				"પ\u{acd}રાર\u{acd}થના",
				"પ\u{acd}રાર\u{acd}થનાભવન",
				"મસ\u{acd}જિદ",
				"મ\u{ac1}સલમાન",
				"મ\u{ac1}સ\u{acd}લિમ",
			],
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("masallaci"),
			keywords: &["Musulmi", "addini", "islam", "islama", "masallaci", "masjid", "musulunci"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("masjid"),
			keywords: &["Islam", "Muslim", "agama", "masjid", "mushalla", "musola"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
			tts:      Some("ụlọ ekpere ndị Alakụba"),
			keywords: &["Ndị Alakụba", "okpukperechi", "ụka Alakụba", "ụlọ ekpere ndị Alakụba"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("tamezgida n yinselmen"),
			keywords: &["tamezgida n yinselmen"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("мешіт"),
			keywords: &["дін", "ислам", "мешіт", "мұсылман", "ғимарат"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ಧರ\u{ccd}ಮ",
				"ಮಸ\u{cc0}ದ\u{cbf}",
				"ಮುಸ\u{ccd}ಲ\u{cbf}ಂರ ಪ\u{ccd}ರಾರ\u{ccd}ಥನಾ ಮಂದ\u{cbf}ರ",
			],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
			tts:      Some("모스크"),
			keywords: &["모스크", "무슬림", "사원", "이슬람", "종교"],
		},
		#[cfg(feature = "kok")]
		crate::Annotation {
			lang:     "kok",
			tts:      Some("मश\u{94d}जीद"),
			keywords: &["ईस\u{94d}लाम", "धर\u{94d}म", "मश\u{94d}जीद", "म\u{941}सलमान"],
		},
		#[cfg(feature = "ky")]
		crate::Annotation {
			lang:     "ky",
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("mošeja"),
			keywords: &["islams", "lūgties", "mošeja", "musulmaņi", "māja", "reliģija", "ēka"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("џамија"),
			keywords: &["Муслиман", "ислам", "муслиман", "муслиманска", "религија", "џамија"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "ms",
			tts:      Some("masjid"),
			keywords: &["agama", "islam", "masjid", "muslim", "orang islam", "sembahyang"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["इस\u{94d}लाम", "धर\u{94d}म", "मस\u{94d}जिद", "म\u{941}स\u{94d}लिम"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("moskee"),
			keywords: &["geloof", "islam", "moskee", "moslim", "religie"],
		},
		#[cfg(feature = "nn")]
		...
		crate::Annotation {
			...
			keywords: &["ଇସଲ\u{b3e}ମ", "ଧର\u{b4d}ମ", "ମସଜ\u{b3f}ଦ\u{b4d}", "ମ\u{b41}ସଲମ\u{b3e}ନ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		crate::Annotation {
			lang:     "pl",
			tts:      Some("meczet"),
			keywords: &["islam", "meczet", "muzułmanin", "religia", "świątynia"],
		},
		#[cfg(feature = "ps")]
		crate::Annotation {
			lang:     "ps",
		...
		crate::Annotation {
			lang:     "ro",
			tts:      Some("moschee"),
			keywords: &["cult", "islam", "masjid", "moschee", "musulman", "religie"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-765"), keywords: &["E10-765"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("мечеть"),
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("mešita"),
			keywords: &["budova", "islam", "mešita", "moslim", "náboženstvo", "viera"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["ม\u{e31}สย\u{e34}ด", "ม\u{e38}สล\u{e34}ม", "ศาสนา", "อ\u{e34}สลาม"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation { lang: "ti", tts: Some("መስጊድ"), keywords: &["መስጊድ"] },
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
			tts:      Some("metjit"),
		...
		crate::Annotation {
			...
			keywords: &["falelotu", "falelotu fakaʻisilami", "ʻisilami"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("مسجد"),
			keywords: &["اسلام", "سجدہ گاہ", "عبادت", "عمارت", "مذہب", "مسجد", "مسلمان"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("masjid"),
			keywords: &["din", "islom", "masjid", "muslim", "musulmon"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Mɔ\u{301}sháláshí"),
			keywords: &["Mùsùlùmí", "Mɔ\u{301}sháláshí", "Ìmàle", "ɛ\u{300}sìn"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
...
pub const HINDU_TEMPLE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["Hindoe", "Hindoetempel", "Indies", "Indië", "aanbidding", "hindoe", "tempel"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
			tts:      Some("የሂንዱ ምኩራብ"),
			keywords: &["ሂንዱ", "ምኩራብ", "ቤተመቅደስ", "የሂንዱ ምኩራብ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("معبد هندوسي"),
			keywords: &["أماكن", "ديانة", "طقوس دينية", "معبد", "هندوسي", "هندوسية", "هندي"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
		...
		crate::Annotation {
			lang:     "de",
			tts:      Some("Hindutempel"),
			keywords: &["Gebäude", "Hindu", "Hindutempel", "Tempel"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["hinduismo", "hindú", "templo"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		#[cfg(feature = "fa")]
		crate::Annotation {
			lang: "fa", tts: Some("معبد هندو"), keywords: &["معبد", "هندو"]
		},
		#[cfg(feature = "fi")]
		crate::Annotation {
			lang:     "fi",
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("hindu temple"),
			keywords: &["hindu", "sambahan", "temple", "templo"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["hindou", "temple"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("teampall hiondúch"),
			keywords: &["Hiondúch", "hiondúch", "teampall"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("gidan ibanda na hindu"),
			keywords: &[
				"addini",
				"bauta",
				"gidan ibada",
				"gidan ibada na hindu",
		...
		crate::Annotation {
			...
			keywords: &["म\u{902}दिर", "हि\u{902}द\u{942}", "हिन\u{94d}द\u{942} मन\u{94d}दिर"],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("pura"),
			keywords: &["candi", "hindu", "kuil", "pura"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation { lang: "ig", tts: Some("ulo hindu"), keywords: &["hindu", "ulo"] },
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
			tts:      Some("hindúahof"),
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("tamesgida handu"),
			keywords: &["tamesgida handu"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("үнді ғибадатханасы"),
			keywords: &["индуизм", "ғибадатхана", "ғимарат", "үнді", "үнді ғибадатханасы"],
		},
		#[cfg(feature = "km")]
		crate::Annotation {
			lang:     "km",
		...
		crate::Annotation {
			...
			keywords: &["ದ\u{cc7}ವಸ\u{ccd}ಥಾನ", "ದ\u{cc7}ವಾಲಯ", "ಹ\u{cbf}ಂದ\u{cc2}"],
		},
		#[cfg(feature = "ko")]
		crate::Annotation {
			lang:     "ko",
		...
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang: "mn", tts: Some("хиндү сүм"), keywords: &["сүм", "хиндү"]
		},
		#[cfg(feature = "mr")]
		crate::Annotation {
			lang:     "mr",
			tts:      Some("हि\u{902}द\u{942} म\u{902}दिर"),
			keywords: &["म\u{902}दिर", "म\u{902}दीर", "हि\u{902}द\u{942}"],
		},
		#[cfg(feature = "ms")]
		crate::Annotation {
			lang:     "ms",
		...
		crate::Annotation {
			...
			keywords: &["मन\u{94d}दिर", "हिन\u{94d}द\u{941}को मन\u{94d}दिर", "हिन\u{94d}द\u{942}"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
		...
		crate::Annotation {
			...
			keywords: &["ਪ\u{a42}ਜਾ ਸਥਾਨ", "ਮ\u{a70}ਦਰ", "ਮ\u{a70}ਦਿਰ", "ਹਿ\u{a70}ਦ\u{a42}"],
		},
		#[cfg(feature = "pcm")]
		crate::Annotation {
			lang:     "pcm",
		...
		crate::Annotation {
			lang:     "qu",
			tts:      Some("templo indu"),
			keywords: &["indu", "templo"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
			tts:      Some("templu hindus"),
			keywords: &["clădire", "hinduism", "hindus", "templu"],
		},
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E12–008"), keywords: &["E12–008"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("индуистский храм"),
			keywords: &["ашрам", "индийский", "индуизм", "храм", "церковь"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang: "sd", tts: Some("هندو مندر"), keywords: &["مندر", "هندو"]
		},
		#[cfg(feature = "si")]
		crate::Annotation {
			lang:     "si",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("hinduistický chrám"),
			keywords: &["chrám", "hinduista", "hinduistický chrám", "hinduizmus", "svätyňa"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["hekalu", "hekalu la kihindi", "kihindi", "mhindu"],
		},
		#[cfg(feature = "sw_KE")]
		crate::Annotation { lang: "sw_KE", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ta")]
		crate::Annotation {
			...
			keywords: &[
				"ஆன\u{bcd}ம\u{bc0}கம\u{bcd}",
				"ஆலயம\u{bcd}",
				"இந\u{bcd}து",
				"கோபுரம\u{bcd}",
				"கோயில\u{bcd}",
				"கோவில\u{bcd}",
				"தெய\u{bcd}வ\u{bc0}கம\u{bcd}",
				"பிர\u{bbe}ர\u{bcd}த\u{bcd}தனை",
				"வழிப\u{bbe}டு",
			],
		},
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"ฮ\u{e34}นด\u{e39}",
				"โบสถ\u{e4c}ฮ\u{e34}นด\u{e39}",
			],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ቤተ መቕደስ ሂንዱ"),
			keywords: &["ሂንዱ", "ቤተ መቕደስ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["falelotu", "falelotu fakahinitū", "hinitū"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("ہندو مندر"),
			keywords: &["مندر", "ہندو", "ہندو عبادت گاہ"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("hindu ibodatxonasi"),
			keywords: &["hindu", "hindu ibodatxonasi", "hinduizm", "ibodatxona", "sigʻinish"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo",
			tts:      Some("ilé ìjọ\u{301}sìn Hindu"),
			keywords: &["hindù", "ibi ijọ\u{301}sìn", "ilé ìjọ\u{301}sìn Hindu"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("ilé ìjɔ\u{301}sìn Hindu"),
			keywords: &["hindù", "ibi ijɔ\u{301}sìn", "ilé ìjɔ\u{301}sìn Hindu"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation { lang: "yue", tts: Some("印度寺"), keywords: &["印度寺", "寺廟"] },
		#[cfg(feature = "yue_Hans")]
		crate::Annotation {
			lang:     "yue_Hans",
			tts:      Some("印度寺"),
...
pub const SYNAGOGUE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "af",
			tts:      Some("sinagoge"),
			keywords: &["Jood", "Joods", "Judaïsme", "godsdiens", "joods", "sinagoge", "tempel"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
			tts:      Some("ቤተ መቅደስ"),
			keywords: &["ቤተ መቅደስ", "ኃይማኖት", "አይሁዳዊ", "አይሁድ", "የዳዊት ኮከብ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
		...
		crate::Annotation {
			...
			keywords: &["আৰ\u{9be}ধন\u{9be}লয\u{9bc}", "ইহ\u{9c1}দি", "ধৰ\u{9cd}ম", "মন\u{9cd}দিৰ"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
			tts:      Some("sinaqoq"),
			keywords: &["din", "iudaizm", "məbəd", "sinaqoq", "yəhudi"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			lang:     "ca",
			tts:      Some("sinagoga"),
			keywords: &["judaisme", "jueu", "jueva", "religió", "sinagoga", "temple"],
		},
		#[cfg(feature = "chr")]
		crate::Annotation {
			lang:     "chr",
		...
		crate::Annotation {
			lang:     "el",
			tts:      Some("συναγωγή"),
			keywords: &["Ιουδαϊσμός", "εβραίος", "εβραϊκός", "θρησκεία", "ναός", "συναγωγή"],
		},
		#[cfg(feature = "en")]
		crate::Annotation {
			lang:     "en",
		...
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["edificio", "judaísmo", "religión", "signagoga", "sinagoga", "templo"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation { lang: "es_MX", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "es_US")]
		...
		crate::Annotation {
			lang:     "fi",
			tts:      Some("synagoga"),
			keywords: &["juutalaisuus", "rakennus", "synagoga", "temppeli", "uskonto"],
		},
		#[cfg(feature = "fil")]
		crate::Annotation {
			lang:     "fil",
			tts:      Some("sinagoga"),
			keywords: &["Hudyo", "Judaismo", "relihiyon", "sambahan", "sinagoga", "templo"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("synagogue"),
			keywords: &["judaïsme", "juif", "juive", "religion", "synagogue", "temple", "voyage"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		...
		crate::Annotation {
			...
			keywords: &[
				...
				"म\u{902}दिर",
				"यह\u{942}दी",
				"यह\u{942}दी प\u{94d}रार\u{94d}थनाग\u{943}ह",
			],
		},
		#[cfg(feature = "hr")]
		crate::Annotation {
			lang:     "hr",
			tts:      Some("sinagoga"),
			keywords: &["hram", "judaizam", "religija", "sinagoga", "židovi", "židovstvo"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("zsinagóga"),
			keywords: &["judaizmus", "szentély", "templom", "vallás", "zsidó", "zsinagóga"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			lang:     "id",
			tts:      Some("sinagog"),
			keywords: &["Yahudi", "agama", "bait suci", "judaisme", "kuil", "sinagog"],
		},
		#[cfg(feature = "ig")]
		crate::Annotation {
			lang:     "ig",
		...
		crate::Annotation {
			lang:     "is",
			tts:      Some("sýnagóga"),
			keywords: &["gyðingatrú", "gyðingur", "samkunduhús", "sýnagóga", "trúarbrögð"],
		},
		#[cfg(feature = "it")]
		crate::Annotation {
			lang:     "it",
			tts:      Some("sinagoga"),
			keywords: &["Ebraismo", "ebraismo", "religione", "sinagoga", "tempio ebraico"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			lang:     "jv",
			tts:      Some("sinagoga"),
			keywords: &["Yahudi", "agama", "kuil", "sinagog", "wong Yahudi"],
		},
		#[cfg(feature = "ka")]
		crate::Annotation {
			lang:     "ka",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("tamezgida n wudayen"),
			keywords: &["tamezgida n wudayen"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("синагога"),
			keywords: &["дін", "еврей", "иврит", "иудаизм", "синагога", "храм", "ғимарат"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &["វ\u{17b7}ហារ", "វ\u{17b7}ហារជនជាត\u{17b7}ជ\u{17d2}វ\u{17b8}ស"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
			...
			keywords: &[
				...
				"ಮಂದ\u{cbf}ರ",
				"ಯಹ\u{cc2}ದ\u{cbf}",
				"ಯಹ\u{cc2}ದ\u{cbf} ಪ\u{cc2}ಜಾ ಮನ\u{cc6}",
				"ಯಹ\u{cc2}ದ\u{cbf}ಯರ ಗುಡ\u{cbf}",
				"ಸ\u{cbf}ನಗಾಗ\u{ccd}",
			],
		},
		#[cfg(feature = "ko")]
		...
		crate::Annotation {
			lang:     "lt",
			tts:      Some("sinagoga"),
			keywords: &["pastatas", "religija", "sinagoga", "šventykla", "žydas", "žydų"],
		},
		#[cfg(feature = "lv")]
		crate::Annotation {
			lang:     "lv",
			tts:      Some("sinagoga"),
			keywords: &["ebreji", "lūgties", "māja", "reliģija", "sinagoga", "templis", "ēka"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("синагога"),
			keywords: &["Евреин", "евреин", "религија", "синагога", "храм", "јудаизам"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
			tts:      Some("ജ\u{d42}തദേവ\u{d3e}ലയം"),
			keywords: &["ജ\u{d42}തദേവ\u{d3e}ലയം", "ജ\u{d42}തപള\u{d4d}ളി", "ജ\u{d42}തമതം"],
		},
		#[cfg(feature = "mn")]
		crate::Annotation {
			lang:     "mn",
		...
		crate::Annotation {
			lang:     "ne",
			tts:      Some("आराधनालय"),
			keywords: &["आराधनालय", "धर\u{94d}म", "प\u{941}जनिय स\u{94d}थल", "मन\u{94d}दिर"],
		},
		#[cfg(feature = "nl")]
		crate::Annotation {
			lang:     "nl",
			tts:      Some("synagoge"),
			keywords: &["geloof", "jodendom", "jood", "joods", "religie", "synagoge", "tempel"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		...
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Juu Pípul Dẹm Preya Haus"),
			keywords: &["Gọd-Haus", "Juu", "Juu Pípul", "Juu Pípul Dẹm Preya Haus", "Rilíjọn"],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
			lang:     "pl",
		...
		crate::Annotation {
			lang:     "pt",
			tts:      Some("sinagoga"),
			keywords: &["judaísmo", "judeu", "judia", "religião", "sinagoga", "templo"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
			tts:      Some("↑↑↑"),
			keywords: &["judaica", "judaísmo", "judeu", "religião", "sinagoga", "templo"],
		},
		#[cfg(feature = "qu")]
		crate::Annotation {
			lang:     "qu",
			tts:      Some("sinagoga"),
			keywords: &["Judío", "religion", "sinagoga", "templo"],
		},
		#[cfg(feature = "ro")]
		crate::Annotation {
			lang:     "ro",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-766"), keywords: &["E10-766"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("синагога"),
			keywords: &["евреи", "здание", "иудаизм", "религия", "синагога", "церковь"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("isinagogi"),
			keywords: &["Ufitanye isano n’Abayahudi", "Umuyahudi", "idini", "isinagogi", "urusengero"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			...
			keywords: &["ஜெப ஆலயம\u{bcd}", "மதம\u{bcd}", "யூத மதம\u{bcd}", "யூதர\u{bcd}கள\u{bcd}"],
		},
		#[cfg(feature = "te")]
		crate::Annotation {
			lang:     "te",
		...
		crate::Annotation {
			...
			keywords: &["ย\u{e34}ว", "ย\u{e39}ดาย", "ศาสนา", "โบสถ\u{e4c}", "โบสถ\u{e4c}ย\u{e34}ว"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ምኩራብ"),
			keywords: &["ሃይማኖት", "ምኩራብ", "ቤተ መቕደስ", "ኣይሁዳዊ", "ኣይሁድነት"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["falelotu", "falelotu fakasiu", "siu"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("sinagog"),
			keywords: &["Yahudi", "din", "musevi", "sinagog", "tapınak", "yahudi"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "uk",
			tts:      Some("синагога"),
			keywords: &["релігія", "синагога", "храм", "єврей", "єврейський", "іудаїзм"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
		...
		crate::Annotation {
			...
			keywords: &["do thái", "giáo đường Do thái", "người do thái", "tôn giáo", "đền"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			...
			keywords: &["Eẹlẹ\u{301}sìn júù", "Sínágọ\u{301}gù", "júù", "tẹ\u{301}pílì", "ẹ\u{300}sìn"],
		},
		#[cfg(feature = "yo_BJ")]
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Sínágɔ\u{301}gù"),
			keywords: &["Eɛlɛ\u{301}sìn júù", "Sínágɔ\u{301}gù", "júù", "tɛ\u{301}pílì", "ɛ\u{300}sìn"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
		...
		crate::Annotation {
			lang:     "zh",
			tts:      Some("犹太教堂"),
			keywords: &["会堂", "宗教", "犹太", "犹太教", "犹太教堂"],
		},
		#[cfg(feature = "zh_Hant")]
		crate::Annotation {
			lang:     "zh_Hant",
			tts:      Some("猶太教堂"),
			keywords: &["教堂", "猶太教", "猶太教堂"],
		},
		#[cfg(feature = "zh_Hant_HK")]
		crate::Annotation {
			lang:     "zh_Hant_HK",
			tts:      Some("猶太教會"),
			keywords: &["宗教", "寺廟", "猶太", "猶太人", "猶太教", "猶太教堂", "猶太教會"],
		},
		#[cfg(feature = "zu")]
		crate::Annotation {
			lang:     "zu",
...
pub const SHINTO_SHRINE: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			...
			keywords: &["altaar", "godsdiens", "heiligdom", "sjinto", "sjinto-altaar", "tempel"],
		},
		#[cfg(feature = "am")]
		crate::Annotation {
			lang:     "am",
		...
		crate::Annotation {
			...
			keywords: &["din", "məbəd", "məqbərə", "sinto", "sinto məbədi", "türbə"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			...
			keywords: &["japón", "religión", "santuario", "santuario sintoísta", "sintoísmo"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
		...
		crate::Annotation {
			...
			keywords: &["religion", "sanctuaire shinto", "shinto", "voyage"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation {
			lang:     "fr_CA",
		...
		crate::Annotation {
			...
			keywords: &["જાપાની ધર\u{acd}મસ\u{acd}થળ", "ધર\u{acd}મ", "શિ\u{a82}ટો શ\u{acd}રાઇન", "સમાધી"],
		},
		#[cfg(feature = "ha")]
		crate::Annotation {
			lang:     "ha",
		...
		crate::Annotation {
			...
			keywords: &["hram", "religija", "svetište", "šintoistički hram", "šintoizam"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
			tts:      Some("sintó szentély"),
			keywords: &["japán", "sintó", "szentély", "vallás"],
		},
		#[cfg(feature = "hy")]
		crate::Annotation {
			lang:     "hy",
		...
		crate::Annotation {
			...
			keywords: &["Cina", "Jinja", "cinese", "jinja", "religione", "santuario shintoista"],
		},
		#[cfg(feature = "ja")]
		crate::Annotation {
			lang:     "ja",
		...
		crate::Annotation {
			lang:     "kab",
			tts:      Some("asebdad shrine"),
			keywords: &["asebdad shrine"],
		},
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("синтоистік храм"),
			keywords: &["дін", "синтоизм", "синтоистік", "храм", "ғибадатхана"],
		},
		#[cfg(feature = "kl")]
		crate::Annotation {
			lang:     "kl",
		...
		crate::Annotation {
			...
			keywords: &["lūgties", "reliģija", "sintoisms", "sintoistu svētnīca", "svētnīca"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			...
			keywords: &["ဘာသာရေး", "ဘ\u{102f}ရားကျောင\u{103a}း", "ရ\u{103e}င\u{103a}တ\u{102d}\u{102f}"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			...
			keywords: &["ଧର\u{b4d}ମ", "ପବ\u{b3f}ତ\u{b4d}ରସ\u{b4d}ଥଳ", "ଶ\u{b3f}ଣ\u{b4d}ଟୋ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
		...
		crate::Annotation {
			lang:     "pcm",
			tts:      Some("Shínto Jujú Haus"),
			keywords: &[
				"Jujú Haus",
				"Rilíjọn",
				"Shínto Jujú Haus",
				"Shínto: Wọ\u{301}n Ọf Japán Rílíjọn",
			],
		},
		#[cfg(feature = "pl")]
		crate::Annotation {
		...
		crate::Annotation {
			...
			keywords: &["japonês", "oriental", "religião", "santuário", "xintoísmo"],
		},
		#[cfg(feature = "pt_PT")]
		crate::Annotation {
			lang:     "pt_PT",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-108"), keywords: &["E10-108"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("синтоистский храм"),
			keywords: &["Япония", "религия", "святилище", "синто", "синтоизм", "синтоистский", "храм"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
			tts:      Some("aho bashengerera h’idini ya shinto"),
			keywords: &["aho bashengerera", "aho bashengerera h’idini ya shinto", "idini", "shinto"],
		},
		#[cfg(feature = "sd")]
		crate::Annotation {
			lang:     "sd",
		...
		crate::Annotation {
			lang:     "sr",
			tts:      Some("шинтоистички храм"),
			keywords: &["рeлигиja", "свeтилиштe", "хрaм", "шинтoизaм"],
		},
		#[cfg(feature = "sr_Cyrl_BA")]
		crate::Annotation { lang: "sr_Cyrl_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sr_Latn")]
		crate::Annotation {
			lang:     "sr_Latn",
			tts:      Some("šintoistički hram"),
			keywords: &["hram", "religija", "svetilište", "šintoizam"],
		},
		#[cfg(feature = "sr_Latn_BA")]
		crate::Annotation { lang: "sr_Latn_BA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "sv")]
		...
		crate::Annotation {
			...
			keywords: &["ช\u{e34}นโต", "ล\u{e31}ทธ\u{e34}", "ศาลเจ\u{e49}า", "ศาลเจ\u{e49}าช\u{e34}นโต"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ሺንቶ ዝበሃል መቕደስ"),
			keywords: &["ሃይማኖት", "መቕደስ", "ሺንቶ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["Siapani", "falelotu", "falelotu fakasiapani"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("Şinto tapınağı"),
			keywords: &["din", "tapınak", "Şinto tapınağı", "şinto", "şinto tapınağı"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "ur",
			tts:      Some("شنٹو مزار"),
			keywords: &["درگاہ", "شنٹو مزار", "مذہب", "مزار"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("shinto shrin"),
			keywords: &["din", "maqbara", "shinto", "shrin", "ziyoratgoh"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
			tts:      Some("đền thờ Nhật Bản"),
			keywords: &["thần đạo", "tôn giáo", "đền thờ", "đền thờ Nhật Bản"],
		},
		#[cfg(feature = "wo")]
		crate::Annotation {
			lang:     "wo",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("ilé òrìshà shíntò"),
			keywords: &["ilé òrìshà", "ilé òrìshà shíntò", "shíntò", "ɛ\u{300}sìn"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
...
pub const KAABA: crate::Emoji = crate::Emoji {
	...
	annotations:          &[
		...
		crate::Annotation {
			lang:     "am",
			tts:      Some("የሙስሊም ካባ"),
			keywords: &["ሙስሊም", "ኃይማኖት", "ኡመራ", "እስላም", "ካባ", "የሙስሊም ካባ"],
		},
		#[cfg(feature = "ar")]
		crate::Annotation {
			lang:     "ar",
			tts:      Some("الكعبة"),
			keywords: &["إسلام", "الكعبة", "حج", "دين", "طواف", "كعبة", "مسلم"],
		},
		#[cfg(feature = "as")]
		crate::Annotation {
			lang:     "as",
			tts:      Some("ক\u{9be}ব\u{9be}"),
			keywords: &["ইছ\u{9cd}ল\u{9be}ম", "ক\u{9be}ব\u{9be}", "ধৰ\u{9cd}ম", "ম\u{9c1}ছলম\u{9be}ন"],
		},
		#[cfg(feature = "az")]
		crate::Annotation {
			lang:     "az",
			tts:      Some("kəbə"),
			keywords: &["din", "həc", "islam", "kəbə", "müsəlman", "ümrə"],
		},
		#[cfg(feature = "be")]
		crate::Annotation {
			lang:     "be",
		...
		crate::Annotation {
			lang:     "de",
			tts:      Some("Kaaba"),
			keywords: &["Hajj", "Islam", "Kaaba", "Moslem", "Muslim", "Religion"],
		},
		#[cfg(feature = "de_CH")]
		crate::Annotation { lang: "de_CH", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "el")]
		...
		crate::Annotation {
			lang:     "en",
			tts:      Some("kaaba"),
			keywords: &["Muslim", "hajj", "islam", "kaaba", "religion", "umrah"],
		},
		#[cfg(feature = "en_001")]
		crate::Annotation {
			lang:     "en_001",
		...
		crate::Annotation {
			lang:     "es",
			tts:      Some("Kaaba"),
			keywords: &["Kaaba", "hach", "islam", "musulmán", "religión", "umrah"],
		},
		#[cfg(feature = "es_419")]
		crate::Annotation {
			lang:     "es_419",
			tts:      Some("↑↑↑"),
			keywords: &["Kaaba", "edificio", "islam", "kaaba", "musulmán", "religión"],
		},
		#[cfg(feature = "es_MX")]
		crate::Annotation {
			lang:     "es_MX",
			tts:      Some("↑↑↑"),
			keywords: &["El Cubo", "Kaaba", "edificio", "islam", "musulmán", "religión"],
		},
		#[cfg(feature = "es_US")]
		crate::Annotation { lang: "es_US", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "et")]
		...
		crate::Annotation {
			lang:     "fil",
			tts:      Some("kaaba"),
			keywords: &["cube", "hajj", "islam", "kaaba", "muslim", "relihiyon", "umrah"],
		},
		#[cfg(feature = "fo")]
		crate::Annotation {
			lang:     "fo",
		...
		crate::Annotation {
			lang:     "fr",
			tts:      Some("kaaba"),
			keywords: &["Kaaba", "islam", "kaaba", "musulman", "musulmane", "religion", "voyage"],
		},
		#[cfg(feature = "fr_CA")]
		crate::Annotation { lang: "fr_CA", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "ga")]
		crate::Annotation {
			lang:     "ga",
			tts:      Some("cába"),
			keywords: &["Muslamach", "creideamh", "cába", "ioslam", "moslamach", "reiligiún"],
		},
		#[cfg(feature = "gd")]
		crate::Annotation {
			lang:     "gd",
		...
		crate::Annotation {
			lang:     "ha",
			tts:      Some("ɗakin kaaba"),
			keywords: &["Musulmi", "Musulunci", "addini", "arfa", "hajji", "umara", "ɗakin kaaba"],
		},
		#[cfg(feature = "ha_NE")]
		crate::Annotation {
			lang:     "ha_NE",
		...
		crate::Annotation {
			lang:     "he",
			tts:      Some("כעבה"),
			keywords: &["איסלם", "דת", "חאג׳", "כעבה", "מוסלמי", "מכה"],
		},
		#[cfg(feature = "hi")]
		crate::Annotation {
			lang:     "hi",
		...
		crate::Annotation {
			lang:     "hr",
			tts:      Some("kaba"),
			keywords: &["islam", "kaba", "muslimani", "religija", "umrah"],
		},
		#[cfg(feature = "hu")]
		crate::Annotation {
			lang:     "hu",
		...
		crate::Annotation {
			lang:     "ig",
			tts:      Some("kaaba"),
			keywords: &["Ndị Alakụba", "hajj", "kaaba", "okpukperechi", "umrah", "ụka Alakụba"],
		},
		#[cfg(feature = "is")]
		crate::Annotation {
			lang:     "is",
		...
		crate::Annotation {
			lang:     "ja",
			tts:      Some("カーバ"),
			keywords: &["イスラム教", "カーバ", "メッカ", "宗教", "巡礼", "建物", "聖地"],
		},
		#[cfg(feature = "jv")]
		crate::Annotation {
			lang:     "jv",
		...
		#[cfg(feature = "kab")]
		crate::Annotation { lang: "kab", tts: Some("lkaɛva"), keywords: &["lkaɛva"] },
		#[cfg(feature = "kk")]
		crate::Annotation {
			lang:     "kk",
			tts:      Some("Қағба"),
		...
		crate::Annotation {
			...
			keywords: &["វ\u{17b7}ហារ", "វ\u{17b7}ហារកាបា (សាសនាអ\u{17ca}\u{17b8}ស\u{17d2}លាម)", "សាសនា"],
		},
		#[cfg(feature = "kn")]
		crate::Annotation {
			lang:     "kn",
		...
		crate::Annotation {
			...
			keywords: &["ມ\u{eb8}ດສະລ\u{eb4}ມ", "ວ\u{eb4}ຫານ", "ວ\u{eb4}ຫານກະບະ", "ສາສະໜາ"],
		},
		#[cfg(feature = "lt")]
		crate::Annotation {
			lang:     "lt",
		...
		crate::Annotation {
			lang:     "lv",
			tts:      Some("kaaba"),
			keywords: &["islams", "islāms", "kaaba", "lūgties", "musulmaņi", "māja", "reliģija", "ēka"],
		},
		#[cfg(feature = "mi")]
		crate::Annotation {
			lang:     "mi",
		...
		crate::Annotation {
			lang:     "mk",
			tts:      Some("ќаба"),
			keywords: &["Муслиман", "аџилак", "ислам", "муслиманска", "религија", "хаџ", "ќаба"],
		},
		#[cfg(feature = "ml")]
		crate::Annotation {
			lang:     "ml",
		...
		crate::Annotation {
			lang:     "ms",
			tts:      Some("kaabah"),
			keywords: &["agama", "haji", "islam", "kaabah", "muslim", "orang islam", "umrah", "ziarah"],
		},
		#[cfg(feature = "mt")]
		crate::Annotation {
			lang:     "mt",
		...
		crate::Annotation {
			...
			keywords: &["ကပ\u{103a}ဘာ", "ဘာသာရေး", "မ\u{1030}ဆလင\u{103a}", "အစ\u{1039}စလာမ\u{103a}"],
		},
		#[cfg(feature = "ne")]
		crate::Annotation {
			lang:     "ne",
		...
		crate::Annotation {
			lang:     "nl",
			tts:      Some("kaäba"),
			keywords: &["bedevaart", "geloof", "islam", "kaäba", "mekka", "moslim", "religie"],
		},
		#[cfg(feature = "nn")]
		crate::Annotation { lang: "nn", tts: Some("↑↑↑"), keywords: &["↑↑↑"] },
		#[cfg(feature = "or")]
		crate::Annotation {
			...
			keywords: &["ଇସଲ\u{b3e}ମ", "କ\u{b3e}ବ\u{b3e}", "ଧର\u{b4d}ମ", "ମ\u{b41}ସଲମ\u{b3e}ନ"],
		},
		#[cfg(feature = "pa")]
		crate::Annotation {
			lang:     "pa",
			tts:      Some("ਕਾਬਾ"),
			keywords: &["ਇਸਲਾਮ", "ਕਾਬਾ", "ਧਰਮ", "ਮ\u{a41}ਸਲਮਾਨ", "ਮ\u{a71}ਕਾ", "ਹ\u{a71}ਜ"],
		},
		#[cfg(feature = "pa_Arab")]
		crate::Annotation {
			lang:     "pa_Arab",
		...
		#[cfg(feature = "root")]
		crate::Annotation { lang: "root", tts: Some("E10-764"), keywords: &["E10-764"] },
		#[cfg(feature = "ru")]
		crate::Annotation {
			lang:     "ru",
			tts:      Some("Кааба"),
			keywords: &["Кааба", "ислам", "мусульмане", "религия", "святыня", "хадж"],
		},
		#[cfg(feature = "rw")]
		crate::Annotation {
			lang:     "rw",
		...
		crate::Annotation {
			lang:     "sk",
			tts:      Some("kába"),
			keywords: &["Hadždž", "cestovanie", "islam", "kába", "moslim", "moslimstvo", "náboženstvo"],
		},
		#[cfg(feature = "sl")]
		crate::Annotation {
			lang:     "sl",
		...
		crate::Annotation {
			...
			keywords: &["ม\u{e38}สล\u{e34}ม", "ว\u{e34}หารกะอ\u{e4c}บะฮ\u{e4c}", "ศาสนา", "อ\u{e34}สลาม"],
		},
		#[cfg(feature = "ti")]
		crate::Annotation {
			lang:     "ti",
			tts:      Some("ካባ"),
			keywords: &["ሃይማኖት", "ሓጅ", "ኡምራ", "ኣስላማይ", "እስልምና", "ካባ"],
		},
		#[cfg(feature = "tk")]
		crate::Annotation {
			lang:     "tk",
		...
		crate::Annotation {
			...
			keywords: &["fale", "fale māʻoniʻoni fakaʻisilami", "māʻoniʻoni", "ʻisilami"],
		},
		#[cfg(feature = "tr")]
		crate::Annotation {
			lang:     "tr",
			tts:      Some("Kâbe"),
			keywords: &["Kâbe", "din", "islam", "kabe", "kâbe", "müslüman"],
		},
		#[cfg(feature = "ug")]
		crate::Annotation {
			lang:     "ug",
		...
		crate::Annotation {
			lang:     "uk",
			tts:      Some("Кааба"),
			keywords: &["Кааба", "кааба", "мусульманський", "релігія", "хадж", "іслам"],
		},
		#[cfg(feature = "ur")]
		crate::Annotation {
			lang:     "ur",
			tts:      Some("کعبہ"),
			keywords: &["حج", "عبادت", "عمارت", "عمرہ", "مسلمان", "مکہ", "کعبہ"],
		},
		#[cfg(feature = "uz")]
		crate::Annotation {
			lang:     "uz",
			tts:      Some("kabatulloh"),
			keywords: &["din", "haj", "islom", "islom dini", "kabatulloh", "muslim", "musulmon", "umra"],
		},
		#[cfg(feature = "vi")]
		crate::Annotation {
			lang:     "vi",
		...
		crate::Annotation {
			lang:     "yo_BJ",
			tts:      Some("Kaaba"),
			keywords: &["Kaaba", "Mùsùlùmí", "Ìmàle", "ɛ\u{300}sìn"],
		},
		#[cfg(feature = "yue")]
		crate::Annotation {
			lang:     "yue",
